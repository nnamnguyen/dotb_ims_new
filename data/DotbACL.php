...
class DotbACL
{
     ...
     *
     * @param string $module
     * @param array $acldata Array of DotbACLStrategy objects that implement needed ACL
     */
    ...
    public static function loadACLs($module, $context = array())
    {
        if(!isset(self::$acls[$module])) {
            ...
            $acl_list = array_merge($acl_list, DotbBean::getDefaultACL($name));
    ...
    public static function listFilter($module, &$list, $context = array(), $options = array())
    {
        ...
        if(empty($options['min_access'])) {
            ...
            if($options['min_access'] >= DotbACL::ACL_READ_WRITE) {
                $min_access = "edit";
            }
        }

...
class FilterDuplicateCheck extends DuplicateCheckStrategy
{
    ...
    */
    ...
    {
        //Check duplicate Phone Number - By Lap Nguyen
        $field_type = $this->bean->field_defs[$inField]['type'];
        if(!empty($field_type) && $field_type =='phone')
            $this->bean->$inField =  formatPhoneNumber($this->bean->$inField);
        //END
    ...
    */
    ...
    protected function callFilterApi($filter)
    {
        ...
        $filterArgs = array(
            ...
            'team_security' => false, //check duplicate on all records - By Lap Nguyen

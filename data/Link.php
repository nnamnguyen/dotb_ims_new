...
class Link {
    ...
    public function __construct($relName, $bean, $fieldDef, $tableName = '', $keyName = '')
    {
        ...
        $this->_bean = $bean;
		$this->_relationship = DotbRelationshipFactory::getInstance()->getRelationship($this->_relationship_name);
    ...
    public static function get_link_table_definition($table_name, $relationshipName, $def_name)
	{
        ...
        foreach(DotbAutoLoader::existingCustom("metadata/{$relationshipName}MetaData.php") as $file) {
            include $file;
        }

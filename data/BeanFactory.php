...
class BeanFactory {
    ...
    /**
     * Returns a DotbBean object by id. The Last 10 loaded beans are cached in memory to prevent multiple retrieves per request.
     ...
     * @param Bool $deleted @see DotbBean::retrieve
     ...
     *
     * @param DotbBean $bean Loaded bean
     * @param array $params Current parameters
     * @return bool
     */
    private static function loadedBeanHasCompatibleParams(DotbBean $bean, array $params) : bool
    {
     ...
     *
     * Currently this method returns a shared DotbBean instance, but in the future it may return an object
     * implementing only the definition-related part of the DotbBean's methods and not implementing
     ...
     * @param string $module
     * @param string $id
     * @return DotbBean|null return bean in case we need it for something, or null if no such module
     */
     ...
     * @static
     * @param  string|DotbBean $objectNameOrBean the object name of DotbBean or the object of DotbBean
     * @return false|string
     */
    public static function getModuleName($objectNameOrBean)
    {
        ...
        } else if ($objectNameOrBean instanceof \DotbBean) {

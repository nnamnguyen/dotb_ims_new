...
class DotbRelationshipFactory {
    ...
    /**
     * @static
     * @return DotbRelationshipFactory
     */
    public static function getInstance()
    {
        if (is_null(self::$rfInstance)) {
            self::$rfInstance = new DotbRelationshipFactory();
        }
    ...
    {
        if(dotb_is_file($this->getCacheFile())) {
    ...
    protected function buildRelationshipCache($modules = array())
    {
        ...
        //Save it out
        dotb_mkdir(dirname($this->getCacheFile()), null, true);
        $out = "<?php \n \$relationships = " . var_export($relationships, true) . ";";
        dotb_file_put_contents_atomic($this->getCacheFile(), $out);
    ...
    protected function getCacheFile() {
        return dotb_cached("Relationships/relationships.cache.php");
    }

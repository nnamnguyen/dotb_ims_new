...
* Does not actively do work but is used by dotbbean to manipulate relationships.
...
class Link2 {
    ...
    /**
     * @var DotbRelationship relationship
     */
    protected $relationship; //relationship object this link is tied to.
    protected $focus;  //DotbBean this link uses as the context for its calls.
     ...
     * @param  $bean DotbBean focus bean for this link (one half of a relationship)
    ...
    function __construct($linkName, $bean, $linkDef = false){
        ...
        $this->relationship = DotbRelationshipFactory::getInstance()->getRelationship($this->def['relationship']);
    ...
    /**
     * @return DotbBean The parent Bean this link references
     */
    ...
    /**
     * @return DotbRelationship the relationship object this link references
     */
    ...
    /**
     * Build a Relationship Join with a DotbQuery Object
     ...
     * @return array of DotbBeans related through this link.
     */
     ...
     * @param $relBean DotbBean
     * @return void
     */
    public function refreshRelationshipFields(DotbBean $relBean){
     ...
     * @param $relBean DotbBean, relative Bean
     * @return void
     */
    protected function populateRelationshipOnlyFields(array $relationshipFields, array $relData, DotbBean $relBean)
    {
     ...
     */
    protected function getRelationshipFields(DotbBean $relBean){
     ...
     */
    public function getRelationshipFieldMapping(DotbBean $seed = null){
        if ($seed == null)
            $seed = $this->focus;
        $relationshipFields = array();
        if (!empty($this->def['rel_fields']))
     ...
     *
     * @param string|DotbBean|string[]|DotbBean[] $rel_keys array of ids or DotbBean objects. If you have the bean in memory, pass it in.
     ...
     * @param $id id of the Parent/Focus DotbBean
     * @param string $related_id id or DotbBean to unrelate. Pass a DotbBean if you have it.
    ...
    /**
     * Returns a DotbBean with the given ID from the related module.

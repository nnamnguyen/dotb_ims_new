...
class DotbACLOAuthKeys extends DotbACLStrategy
{
    ...
    public function checkAccess($module, $view, $context) {
        ...
        if ( isset($context['bean']) && is_a($context['bean'],'DotbBean') ) {
            if( $view == 'edit' || ( isset($context['action']) && $context['action'] == 'edit' ) ) {
                if ( $context['bean']->c_key == 'dotb' || $context['bean']->c_key == 'support_portal' ) {
                    return false;
                }
            }
        }

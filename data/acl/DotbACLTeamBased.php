 ...
 */
class DotbACLTeamBased extends DotbACLStrategy
{
    /**
    ...
    public function checkAccess($module, $action, $context)
    {
        ...
        if ($isOwner) {
            ...
            // role is "Owner & Selected Teams" and empty context which, according to DotbACLStrategy::checkAccess(),

<?php if(!defined('dotbEntry') || !dotbEntry) die('Not A Valid Entry Point');
...
/**
 * Generic retrieve for getting data from a dotbbean
 */
...
if(!empty($dotb_config['session_dir'])) {
	...
	$GLOBALS['log']->debug("JSON_SERVER:session_save_path:".$dotb_config['session_dir']);
}
...
if(strtolower($_SERVER['REQUEST_METHOD'])== 'get') {
	...
	// else act as a JSON-RPC server for DotBCRM
	// create result array
	$response = array();

...
//	DOTB.themes.resizeSearch();
//    if(DOTB.App == undefined) {
//	    DOTB.themes.resizeMenu();
//    }
	//setup for action menus
	DOTB.themes.actionMenu();
	//setup event handler for search results
//	DOTB.themes.searchResults();
    //setup footer for toggling
//    DOTB.themes.toggleFooter();
    //initialize global tooltips
//	DOTB.themes.globalToolTips();
//
//    DOTB.themes.currentMenuIndex =  $("#themeTabGroupMenu_All" ).children("li").index($("#themeTabGroupMenu_All").children("li.current"));
//
...
//            DOTB.themes.clearSearch();
//        }
//    });
});

DOTB.themes = DOTB.namespace("themes");
//if(Get_Cookie("dotb_theme_menu_load") == null) {
//	Set_Cookie('dotb_theme_menu_load','false',30,'/','','');
//}
DOTB.append(DOTB.themes, {
//    setRightMenuTab: function(el, params) {
//
//        var extraMenu = "#moduleTabExtraMenu"+dotb_theme_gm_current;
//        var moreItemsContainer = "#moduleTabMore"+dotb_theme_gm_current;
//
//		//Check if the menu we want to show is in the more menu
//		if($(el).parents().is(extraMenu)) {
//            var menuNode = $(el).parent();
//            menuNode.remove();
//            $("#moduleTabExtraMenu" + dotb_theme_gm_current).before(menuNode);
...
//			DOTB.themes.loadModuleList();
//
//		}
//    },
//    setCurrentTab: function(params) {
//        var el = '#moduleTab_'+ dotb_theme_gm_current + params.module;
//        if ($(el) && $(el).parent()) {
//            DOTB.themes.setRightMenuTab(el, params);
//            var currActiveTab = "#themeTabGroupMenu_"+dotb_theme_gm_current+" li.current";
//            if ($(currActiveTab)) {
...
//        var retainItem = $("#themeTabGroupMenu_" + dotb_theme_gm_current),
...
//    	if(Get_Cookie("dotb_theme_menu_mode") == 'click') {
//    		Set_Cookie('dotb_theme_menu_mode','hover',30,'/','','');
//    	} else {
//    		Set_Cookie('dotb_theme_menu_mode','click',30,'/','','');
//    	}
//    	location.reload();
//    },
//    getMenuMode: function() {
//
//    	if(Get_Cookie("dotb_theme_menu_mode") == null) {
//    		Set_Cookie('dotb_theme_menu_mode','hover',30,'/','','');
//    	}
//
//    	if(Get_Cookie("dotb_theme_menu_mode") == 'click') {
...
//                display: 'show'
//            },
//			firstOnClick: DOTB.themes.getMenuMode(),
//			autoArrows: false,
//			dropShadows: false,
...
//        if(DOTB.themes.enableResizeSearch) {
//            $('#moduleList').attr("width", $('#moduleList').attr("width") || $('#moduleList').css("width").replace("px",""));
//
//            var searchWidth = $("#dcmenu").width() - 200
//                - $("#quickCreate").width() - $("#globalLinksModule").width() - $("#dcmenuDotbCube").width() - $("#moduleList").attr("width");
...
//            searchWidth *= .75;
//
//            $('#dotb_spot_search').attr("width", $('#dotb_spot_search').attr("width") || $('#dotb_spot_search').css("width").replace("px",""));
//            var originalSearchWidth = parseInt($('#dotb_spot_search').attr("width"));
//            searchWidth = (searchWidth >= originalSearchWidth) ? searchWidth : originalSearchWidth;
//            $('#dotb_spot_search_div').width(searchWidth + 25);
//            $('#dotb_spot_search').width(searchWidth);
//            $('#dotb_spot_search_div').find("section ul").width(searchWidth - 120); //resize the search result text length
//        }
//
//    },
//    resizeMenu: function () {
//        //Bug#52433: Prevent calling resizeMenu before basic theme is initialized
//        if(typeof dotb_theme_gm_current == "undefined") return;
//
...
//            - $("#quickCreate").width() - $("#globalLinksModule").width() - $("#dcmenuDotbCube").width() - $("#dcmenuSearchDiv").width();
//		var currentModuleList = $("#themeTabGroupMenu_" + dotb_theme_gm_current),
//            menuItemsWidth = DOTB.themes.menuItemsWidth || $("#moduleList").width(),
//            _ie_adjustment = 10,
...
//
//        }
//        DOTB.themes.menuItemsWidth = menuItemsWidth;
//
//
//        if(menuItemsWidth > maxMenuWidth){
//            var moreNode = $("#moduleTabMore" + dotb_theme_gm_current);
//            while(menuItemsWidth >= maxMenuWidth && menuLength-- > 0){
//                var menuNode = $("#moduleTabExtraMenu" + dotb_theme_gm_current).prev();
//
...
//                    DOTB.themes.menuItemsWidth = false;
//                }
//            }
//        }
//        else {
//
//            var insertNode = $("#moduleTabExtraMenu" + dotb_theme_gm_current),
...
//                var menuNode = $("#moduleTabMore" + dotb_theme_gm_current).children("li:first"),
...
//		$("#quickCreateUL span").tipTip({maxWidth: "auto", edgeOffset: 10, content: DOTB.language.translate('', 'LBL_QUICK_CREATE_TITLE')});
//        if( typeof($("#dcmenuDotbCube").attr("title")) != 'undefined' )
//        {
//		    $("#dcmenuDotbCube").tipTip({maxWidth: "auto", edgeOffset: 10});
//        }
//
//		$("#dotb_spot_search").tipTip({maxWidth: "auto", edgeOffset: 10});
...
//        var isVisible = Get_Cookie('dotb_theme_footer_visible');
//        if(isVisible != null && isVisible == 'false')
//        {
//            var el = $("#arrow");
//            el.toggleClass("up");
//            DOTB.themes.hideFooter(el);
...
//            $(this).toggleClass("up");
//            if ($(this).hasClass('up')) {
//                Set_Cookie('dotb_theme_footer_visible','true',3000,false, false, false);
//                DOTB.themes.showFooter(this);
//                $(this).find("i").removeClass("icon-chevron-up").addClass("icon-chevron-down");
//
//            } else {
//                Set_Cookie('dotb_theme_footer_visible','false',3000,false, false, false);
//                $(this).find("i").removeClass("icon-chevron-down").addClass("icon-chevron-up");
//                DOTB.themes.hideFooter(this);
//            }
//            $("#footer").slideToggle("fast");
//        });
//    },
...
//    	firstHit = false;
//    	$("#dotb_spot_search").keypress(function(event) {
...
//   		$("div#dotb_spot_search_results").hide();
//        $("#SpotResults").remove();
//		$('#close_spot_search').css("display","none");
//        $("#dotb_spot_search").val(DOTB.language.get('app_strings', 'LBL_SEARCH'));
//        $("#dotb_spot_search").css('color', 'grey');
//		$("#dotb_spot_search").removeClass("searching");
//		$('#dotb_spot_search_div').css("left",0);
//	  	firstHit = false;
//   	},
   	actionMenu: function() {
   	...
   	dotb_theme_gm_switch: function(groupName, groupId) {

        DOTB.themes.current_theme = (DOTB.themes.current_theme) ? DOTB.themes.current_theme : dotb_theme_gm_current;
        $('ul.sf-menu:visible li').hideSuperfishUl();
        $('#moduleTabMore'+DOTB.themes.current_theme +' li').hideSuperfishUl();
        ...
        DOTB.themes.current_theme = dotb_theme_gm_current = groupName;
...
//            current_menu.hide();
//            target_menu.show();
//            DOTB.themes.menuItemsWidth = null;
//            DOTB.themes.resizeSearch();
//            DOTB.themes.resizeMenu();
//            $(this).animate({
//                top: '+=' + dcheight

...
<head>
   ...
   <link REL="SHORTCUT ICON" HREF="include/images/dotb_icon.ico?v={$versionToken}">
  ...
  <table cellspacing="0" cellpadding="0" border="0" align="center" class="shell">
    ...
    <tr>
      ...
      <th width="200" height="30" style="text-align: right;"><a href="http://www.dotbcrm.com" target="_blank">
      	<IMG src="include/images/dotbcrm_login.png?v={$versionToken}" alt="DotbCRM" border="0"></a>
      </th>
    </tr>
    <tr>
      <td colspan="2">
...
function callSysCheck(){
            ...
            ajaxCall = function(msg_panel){
                ...
                postData = "checkInstallSystem=true&to_pdf=1&dotb_body_only=1";

...
$last_name_array = $dotb_demodata['last_name_array'];
...
$last_name_max = $last_name_count - 1;
	...
	$category->name = $last_name_array[mt_rand(0,$last_name_max)] .$dotb_demodata['category_ext_name'];
...
function create_product($category_id)
{
    ...
    $first_name_array = $dotb_demodata['first_name_array'];
    $first_name_count = count($dotb_demodata['first_name_array']);
    $company_name_array = $dotb_demodata['company_name_array'];
    ...
    $template->name = $first_name_array[mt_rand(0, $first_name_max)] . $dotb_demodata['product_ext_name'];

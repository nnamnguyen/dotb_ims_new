...
if(!empty($dotb_demodata['quotes_seed_data']['quotes'])) {
   ...
   foreach($dotb_demodata['quotes_seed_data']['quotes'] as $key=>$quote) {

		$focus = new Quote();
		$focus->assigned_user_id = $dotb_demodata['users'][array_rand($dotb_demodata['users'])]['id'];

...
///////////////////////////////////////////////////////////////////////////////
////    PREFILL $dotb_config VARS
if(empty($dotb_config['upload_dir'])) {
    $dotb_config['upload_dir'] = 'upload/';
}
if(empty($dotb_config['upload_maxsize'])) {
    $dotb_config['upload_maxsize'] = 8192000;
}
if(empty($dotb_config['upload_badext'])) {
    $dotb_config['upload_badext'] = array('php', 'php3', 'php4', 'php5', 'pl', 'cgi', 'py', 'asp', 'cfm', 'js', 'vbs', 'html', 'htm');
}
////    END PREFILL $dotb_config VARS
///////////////////////////////////////////////////////////////////////////////
...
////    PREP VARS FOR LANG PACK
    $base_upgrade_dir       = dotb_cached("upgrades");
...
if(isset($_REQUEST['languagePackAction']) && !empty($_REQUEST['languagePackAction'])) {
    switch($_REQUEST['languagePackAction']) {
        ...
        if(isset($_REQUEST['release_id']) && $_REQUEST['release_id'] != ""){
            ...
            break; // end 'validate'
        case 'commit':
            $dotb_config = commitModules(false, 'langpack');
            break;
        case 'uninstall': // leaves zip file in "uploaded" state
            $dotb_config = uninstallLanguagePack();
            break;
        case 'remove':
            removeLanguagePack();
            break;
...
<head>
   ...
   <script type="text/javascript" src="cache/javascript/dotbcrm1.min.js?v={$versionToken}"></script>
   <script type="text/javascript" src="cache/javascript/dotbcrm3.min.js?v={$versionToken}"></script>
...
{$fileMaxSize}
  <table cellspacing="0" width="100%" cellpadding="0" border="0" align="center" class="shell">
    ...
    <tr>
      ...
      <th width="200" style="text-align: right;"><a href="http://www.dotbcrm.com" target=

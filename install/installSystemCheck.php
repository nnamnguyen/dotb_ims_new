...
// cache dir
	...
	{
		$dirname = dotb_cached($c_file);
		$ok = false;
		if ((is_dir($dirname)) || @dotb_mkdir($dirname,0555)) // set permissions to restrictive - use make_writable to change in a standard way to the required permissions
		{
    ...
    <tr>
      <td align="right" colspan="2">
        ...
        <table cellspacing="0" cellpadding="0" border="0" class="stdTable">
          <tr>
            <td><input class="button" type="button" onclick="window.open('http://www.dotbcrm.com/forums/');" value="{$mod_strings['LBL_HELP']}" /></td>
            <td>

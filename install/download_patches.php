...
if(isset($_REQUEST['languagePackAction']) && !empty($_REQUEST['languagePackAction'])) {
    switch($_REQUEST['languagePackAction']) {
        ...
        if(isset($_REQUEST['release_id']) && $_REQUEST['release_id'] != ""){
            ...
            $tempFile = $pm->download('3', '3', $_REQUEST['release_id'], $dotb_config['upload_dir']);
            $perform = true;
...
<head>
   ...
   <script type="text/javascript" src="cache/include/javascript/dotbcrm3.min.js?v={$versionToken}"></script>

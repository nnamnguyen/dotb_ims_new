...
<form action="install.php" method="post" name="setConfig" id="form">
    ...
    <table cellspacing="0" cellpadding="0" border="0" align="center" class="shell">
        ...
        <tr>
            ...
            <th width="200" style="text-align: right;"><a href="http://www.dotbcrm.com" target="_blank"><IMG
                            src="{$loginImage}" alt="DotbCRM" border="0"></a>
            </th>
        </tr>
        <tr>
            <td colspan="2">
                <table width="100%" cellpadding="0" cellpadding="0" border="0" class="StyleDottedHr">
                    ...
                    {if $smarty.session.install_type && $smarty.session.install_type eq 'custom'}
                        ...
                        <th colspan="3" align="left">{$MOD.LBL_SITECFG_DOTB_UPDATES}</th>
                        </tr>
                        <tr>
                            <td></td>
                            <td><strong>{$MOD.LBL_SITECFG_DOTB_UP}</strong></td>
                    ...
                    <tr>
                        ...
                        <td>
                            {$smarty.session.setup_db_dotbsales_user}
                        </td>
                    </tr>
                    <tr>
                        <td></td>
                        ...
                        <td>
                            ...
                            <span style="display:none"
                                  id="show_db_admin_pass">{$smarty.session.setup_db_dotbsales_password}</span>
                        </td>
                    </tr>
                    <tr>
                        <td></td>

...
$mod_strings = array(
    ...
    'LBL_SYSOPTS_2'                     => 'What type of database will be used for the Dotb instance you are about to install?',
    ...
    'ERR_DB_IBM_DB2_VERSION'			=> 'Your version of DB2 (%s) is not supported by Dotb.  You will need to install a version that is compatible with the Dotb application.  Please consult the Compatibility Matrix in the Release Notes for supported DB2 Versions.',
	...
	'ERR_DB_OCI8_VERSION'				=> 'Your version of Oracle (%s) is not supported by Dotb.  You will need to install a version that is compatible with the Dotb application.  Please consult the Compatibility Matrix in the Release Notes for supported Oracle Versions.',
    ...
    'ERR_ADMIN_USER_NAME_BLANK'         => 'Provide the user name for the Dotb admin user. ',
	'ERR_ADMIN_PASS_BLANK'				=> 'Provide the password for the Dotb admin user. ',

    'ERR_CHECKSYS'                      => 'Errors have been detected during compatibility check.  In order for your DotbCRM Installation to function properly, please take the proper steps to address the issues listed below and either press the recheck button, or try installing again.',
    'ERR_CHECKSYS_CALL_TIME'            => 'Allow Call Time Pass Reference is On (this should be set to Off in php.ini)',

	'ERR_CHECKSYS_CURL'					=> 'Not found: Dotb Scheduler will run with limited functionality. The Email Archiving service will not run.',
	...
	'ERR_CHECKSYS_IIS_INVALID_VER'      => 'Your version of IIS is not supported by Dotb.  You will need to install a version that is compatible with the Dotb application.  Please consult the Compatibility Matrix in the Release Notes for supported IIS Versions. Your version is ',
	'ERR_CHECKSYS_FASTCGI'              => 'We detect that you are not using a FastCGI handler mapping for PHP. You will need to install/configure a version that is compatible with the Dotb application.  Please consult the Compatibility Matrix in the Release Notes for supported Versions. Please see <a href="http://www.iis.net/php/" target="_blank">http://www.iis.net/php/</a> for details ',
    ...
    'LBL_CHECKSYS_XML_NOT_AVAILABLE'        => 'Functions associated with XML Parser Libraries that are needed by the Dotb application were not found.  You might need to uncomment the extension in the  php.ini file, or recompile with the right binary file, depending on your version of PHP.  Please refer to your PHP Manual for more information.',
    'LBL_CHECKSYS_CSPRNG' => 'Random number generator',
    'ERR_CHECKSYS_MBSTRING'             => 'Functions associated with the Multibyte Strings PHP extension (mbstring) that are needed by the Dotb application were not found. <br/><br/>Generally, the mbstring module is not enabled by default in PHP and must be activated with --enable-mbstring when the PHP binary is built. Please refer to your PHP Manual for more information on how to enable mbstring support.',
    ...
    'ERR_CHECKSYS_ZLIB'					=> 'ZLib support not found: DotbCRM reaps enormous performance benefits with zlib compression.',
    'ERR_CHECKSYS_ZIP'					=> 'ZIP support not found: DotbCRM needs ZIP support in order to process compressed files.',
    'ERR_CHECKSYS_BCMATH'				=> 'BCMATH support not found: DotbCRM needs BCMATH support for arbitrary precision math.',
    'ERR_CHECKSYS_HTACCESS'             => 'Test for .htaccess rewrites failed. This usually means you do not have AllowOverride set up for Dotb directory.',
	...
	'ERR_DB_EXISTS_WITH_CONFIG'			=> 'Database already exists with config data.  To run an install with the chosen database, please re-run the install and choose: "Drop and recreate existing DotbCRM tables?"  To upgrade, use the Upgrade Wizard in the Admin Console.  Please read the upgrade documentation located <a href="http://www.dotbforge.org/content/downloads/" target="_new">here</a>.',
	...
	'ERR_DB_MYSQL_VERSION'				=> 'Your MySQL version (%s) is not supported by Dotb.  You will need to install a version that is compatible with the Dotb application.  Please consult the Compatibility Matrix in the Release Notes for supported MySQL versions.',
	...
	'ERR_DB_PASSWORD'					=> 'The passwords provided for the Dotb database administrator do not match.  Please re-enter the same passwords in the password fields.',
	...
	'ERR_DB_USER_EXISTS'				=> 'User name for Dotb database user already exists -- cannot create another one with the same name. Please enter a new user name.',
	'ERR_DB_USER'						=> 'Enter a user name for the Dotb database administrator.',
	'ERR_DBCONF_VALIDATION'				=> 'Please fix the following errors before proceeding:',
    'ERR_DBCONF_PASSWORD_MISMATCH'      => 'The passwords provided for the Dotb database user do not match. Please re-enter the same passwords in the password fields.',
	...
	'ERR_PASSWORD_MISMATCH'				=> 'The passwords provided for the Dotb admin user do not match.  Please re-enter the same passwords in the password fields.',
	...
	'ERR_SI_NO_CONFIG'					=> 'You did not include config_si.php in the document root, or you did not define $dotb_config_si in config.php',
	...
	'ERR_URL_BLANK'						=> 'Provide the base URL for the Dotb instance.',
	'ERR_UW_NO_UPDATE_RECORD'			=> 'Could not locate installation record of',
    'ERROR_FLAVOR_INCOMPATIBLE'         => 'The uploaded file is not compatible with this flavor (Professional, Enterprise or Ultimate edition) of Dotb: ',
    ...
    'LBL_CANCEL'                        => 'Cancel',
    'LBL_ACCEPT'                        => 'I Accept',
	'LBL_CHECKSYS_1'					=> 'In order for your DotbCRM installation to function properly, please ensure all of the system check items listed below are green. If any are red, please take the necessary steps to fix them.<BR><BR> For help on these system checks, please visit the <a href="http://www.dotbcrm.com/crm/installation" target="_blank">Dotb Wiki</a>.',
	...
	'LBL_CHECKSYS_CONFIG'				=> 'Writable DotbCRM Configuration File (config.php)',
	'LBL_CHECKSYS_CONFIG_OVERRIDE'		=> 'Writable DotbCRM Configuration File (config_override.php)',
	...
	'LBL_DBCONF_DB_DROP_CREATE_WARN'	=> 'Caution: All Dotb data will be erased<br>if this box is checked.',
	'LBL_DBCONF_DB_DROP_CREATE'			=> 'Drop and Recreate Existing Dotb tables?',
    'LBL_DBCONF_DB_DROP'                => 'Drop Tables',
    'LBL_DBCONF_DB_NAME'				=> 'Database Name',
	'LBL_DBCONF_DB_PASSWORD'			=> 'Dotb Database User Password',
	'LBL_DBCONF_DB_PASSWORD2'			=> 'Re-enter Dotb Database User Password',
	'LBL_DBCONF_DB_USER'				=> 'Dotb Database Username',
    'LBL_DBCONF_DOTB_DB_USER'          => 'Dotb Database Username',
    ...
    'LBL_DBCONFIG_MSG3'                 => 'Name of the database that will contain the data for the Dotb instance you are about to install:',
    'LBL_DBCONFIG_B_MSG1'               => 'The username and password of a database administrator who can create database tables and users and who can write to the database is necessary in order to set up the Dotb database.',
    'LBL_DBCONFIG_SECURITY'             => 'For security purposes, you can specify an exclusive database user to connect to the Dotb database.  This user must be able to write, update and retrieve data on the Dotb database that will be created for this instance.  This user can be the database administrator specified above, or you can provide new or existing database user information.',
	...
	'LBL_DISABLED_HELP_1'				=> 'For installation help, please visit the DotbCRM',
    'LBL_DISABLED_HELP_LNK'               => 'http://www.dotbcrm.com/forums/',
	'LBL_DISABLED_HELP_2'				=> 'support forums',
	'LBL_DISABLED_TITLE_2'				=> 'DotbCRM Installation has been Disabled',
	'LBL_DISABLED_TITLE'				=> 'DotbCRM Installation Disabled',
	...
	'LBL_LANG_1'						=> 'To use a language in Dotb other than the default language (US-English), you can upload and install the language pack at this time. You will be able to upload and install language packs from within the Dotb application as well.  If you would like to skip this step, click Next.',
    ...
    'LBL_LAUNCHING_SILENT_INSTALL'     => 'Installing Dotb now.  This may take up to a few minutes.',
	...
	'LBL_LICENSE_TITLE_2'				=> 'DotbCRM License',
	...
	'LBL_LOCALE_DESC'					=> 'The specified locale settings will be reflected globally within the Dotb instance.',
	...
	'LBL_PERFORM_CONFIG_PHP'			=> 'Creating Dotb configuration file',
	...
	'LBL_PERFORM_CREATE_DEFAULT'		=> 'Creating default Dotb data',
	'LBL_PERFORM_CREATE_LOCALHOST'		=> 'Creating the Database username and password for localhost...',
	'LBL_PERFORM_CREATE_RELATIONSHIPS'	=> 'Creating Dotb relationship tables',
	...
	'LBL_PERFORM_OUTRO_1'				=> 'The setup of Dotb ',
	...
	'LBL_PERFORM_TABLES'				=> 'Creating Dotb application tables, audit tables and relationship metadata',
	'LBL_PERFORM_TITLE'					=> 'Perform Setup',
	'LBL_PRINT'							=> 'Print',
	'LBL_REG_CONF_1'					=> 'Please complete the short form below to receive product announcements, training news, special offers and special event invitations from DotbCRM. We do not sell, rent, share or otherwise distribute the information collected here to third parties.',
	...
	'LBL_REG_CONF_3'					=> 'Thank you for registering. Click on the Finish button to login to DotbCRM. You will need to log in for the first time using the username "admin" and the password you entered in step 2.',
	'LBL_REG_TITLE'						=> 'Registration',
    'LBL_REG_NO_THANKS'                 => 'No Thanks',
    'LBL_REG_SKIP_THIS_STEP'            => 'Skip this Step',
	'LBL_REQUIRED'						=> '* Required field',

    'LBL_SITECFG_ADMIN_Name'            => 'Dotb Application Admin Name',
	'LBL_SITECFG_ADMIN_PASS_2'			=> 'Re-enter Dotb Admin User Password',
	'LBL_SITECFG_ADMIN_PASS_WARN'		=> 'Caution: This will override the admin password of any previous installation.',
	'LBL_SITECFG_ADMIN_PASS'			=> 'Dotb Admin User Password',
	'LBL_SITECFG_APP_ID'				=> 'Application ID',
	'LBL_SITECFG_CUSTOM_ID_DIRECTIONS'	=> 'If selected, you must provide an application ID to override the auto-generated ID. The ID ensures that sessions of one Dotb instance are not used by other instances.  If you have a cluster of Dotb installations, they all must share the same application ID.',
	'LBL_SITECFG_CUSTOM_ID'				=> 'Provide Your Own Application ID',
	'LBL_SITECFG_CUSTOM_LOG_DIRECTIONS'	=> 'If selected, you must specify a log directory to override the default directory for the Dotb log. Regardless of where the log file is located, access to it through a web browser will be restricted via an .htaccess redirect.',
	'LBL_SITECFG_CUSTOM_LOG'			=> 'Use a Custom Log Directory',
	'LBL_SITECFG_CUSTOM_SESSION_DIRECTIONS'	=> 'If selected, you must provide a secure folder for storing Dotb session information. This can be done to prevent session data from being vulnerable on shared servers.',
	'LBL_SITECFG_CUSTOM_SESSION'		=> 'Use a Custom Session Directory for Dotb',
	...
	'LBL_SITECFG_DOTB_UP_DIRECTIONS'	=> 'If selected, the system will periodically check for updated versions of the application.',
	'LBL_SITECFG_DOTB_UP'				=> 'Automatically Check For Updates?',
	'LBL_SITECFG_DOTB_UPDATES'			=> 'Dotb Updates Config',
	...
	'LBL_SITECFG_URL'					=> 'URL of Dotb Instance',
	'LBL_SITECFG_USE_DEFAULTS'			=> 'Use Defaults?',
	'LBL_SITECFG_ANONSTATS'             => 'Send Anonymous Usage Statistics?',
	'LBL_SITECFG_ANONSTATS_DIRECTIONS'  => 'If selected, Dotb will send <b>anonymous</b> statistics about your installation to DotbCRM Inc. every time your system checks for new versions. This information will help us better understand how the application is used and guide improvements to the product.',
    'LBL_SITECFG_URL_MSG'               => 'Enter the URL that will be used to access the Dotb instance after installation. The URL will also be used as a base for the URLs in the Dotb application pages. The URL should include the web server or machine name or IP address.',
    'LBL_SITECFG_SYS_NAME_MSG'          => 'Enter a name for your system.  This name will be displayed in the browser title bar when users visit the Dotb application.',
    'LBL_SITECFG_PASSWORD_MSG'          => 'After installation, you will need to use the Dotb admin user (default username = admin) to log in to the Dotb instance.  Enter a password for this administrator user. This password can be changed after the initial login.  You may also enter another admin username to use besides the default value provided.',
...
//	'LBL_NO_THANKS'						=> 'Continue to installer',
	...
	'LBL_STEP'							=> 'Step',
	'LBL_TITLE_WELCOME'					=> 'Welcome to the DotbCRM ',
	'LBL_WELCOME_1'						=> 'This installer creates the DotbCRM database tables and sets the configuration variables that you need to start. The entire process should take about ten minutes.',
    ...
    'REQUIRED_SYS_COMP_MSG' =>
                    'Before you begin, please be sure that you have the supported versions of the following system
                      ...
                      compatible system components for the Dotb version that you are installing.<br>',
    'REQUIRED_SYS_CHK' => 'Initial System Check',
    'REQUIRED_SYS_CHK_MSG' =>
                    'When you begin the installation process, a system check will be performed on the web server on which the Dotb files are located in order to
					  ...
					  <li>The following Dotb files must be writeable:<ul><li><b>/custom</li>
<li>/cache</li>
<li>/modules</li>
<li>/upload</b></li></ul></li></ul>
    ...
    'REQUIRED_INSTALLTYPE_MSG' =>
                    "After the system check is performed, you can choose either
                      ...
                      <ul>
                      <li> <b>Type of database</b> that will house the Dotb data <ul><li>Compatible database
                      ...
                      <ul><li>This may be <i>localhost</i> if the database is on your local computer or is on the same web server or machine as your Dotb files.<br><br></li></ul></li>
                      <li><b>Name of the database</b> that you would like to use to house the Dotb data</li>
                        <ul>
                          ...
                          be dropped during installation when the schema for the Dotb database is defined.</li>
                      ...
                      <li> <b>Dotb database user name and password</b>
                      </li>
                        <ul>
                    ...
                    <li> <b>Elasticsearch host and port</b>
                        ...
                        <ul>
                          <li> Elasticsearch host is the host the search engine is running on. This defaults to localhost assuming you are running the search engine on the same server as Dotb.</li>
                          <li> Elasticsearch port is the port number for Dotb to connect to the search engine. This defaults to 9200, which is elasticsearch's default. </li>
                        </ul>
                        </ul><p>

                      For the <b>Custom</b> setup, you might also need to know the following:<br>
                      <ul>
                      <li> <b>URL that will be used to access the Dotb instance</b> after it is installed.
                      This URL should include the web server or machine name or IP address.<br><br></li>
                                  ...
                                  session directory for Dotb information in order to prevent session data from
                                  being vulnerable on shared servers.<br><br></li>
                                  <li> [Optional] <b>Path to a custom log directory</b> if you wish to override the default directory for the Dotb log.<br><br></li>
                                  <li> [Optional] <b>Application ID</b> if you wish to override the auto-generated
                                  ID that ensures that sessions of one Dotb instance are not used by other instances.<br><br></li>
	...
	'LBL_WELCOME_2'						=> 'For installation documentation, please visit the <a href="http://www.dotbcrm.com/crm/installation" target="_blank">Dotb Wiki</a>.  <BR><BR> To contact a DotbCRM support engineer for installation help, please log in to the <a target="_blank" href="http://support.dotbcrm.com">DotbCRM Support Portal</a> and submit a support case.',
	'LBL_WELCOME_CHOOSE_LANGUAGE'		=> '<b>Choose your language</b>',
	'LBL_WELCOME_SETUP_WIZARD'			=> 'Setup Wizard',
	'LBL_WELCOME_TITLE_WELCOME'			=> 'Welcome to the DotbCRM ',
	'LBL_WELCOME_TITLE'					=> 'DotbCRM Setup Wizard',
	'LBL_WIZARD_TITLE'					=> 'Dotb Setup Wizard: ',
	'LBL_YES'							=> 'Yes',
    ...
    'LBL_FTS_HELP'      => 'To enable full-text searching, enter the Host and Port where the search engine is hosted. Dotb includes built-in support for the elasticsearch engine.',
	...
	'LBL_SESSION_ERR_DESCRIPTION'		=> "DotbCRM relies upon PHP sessions to store important information while connected to this web server.  Your PHP installation does not have the Session information correctly configured.
	...
	'LBL_REQUIRED_SYSTEM_NAME'=>'Provide a System Name for the Dotb instance.',

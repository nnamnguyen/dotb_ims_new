...
$mod_strings = array(
	...
	'ERR_DB_OCI8_VERSION'				=> 'Your version of Oracle is not supported by Dotb.  You will need to install a version that is compatible with the Dotb application.  Please consult the Compatibility Matrix in the Release Notes for supported Oracle Versions.',
    ...
    'ERR_ADMIN_USER_NAME_BLANK'         => 'Provide the username for the Dotb admin user.',
    ...
    'ERR_CHECKSYS_IMAP'					=> 'Not found: InboundEmail and Chiến dịch (Email) require the IMAP libraries. Neither will be functional.',
    ...
    'ERR_CHECKSYS_ZLIB'					=> 'Not Found: DotbCRM reaps enormous performance benefits with zlib compression.',
	...
	'ERR_DB_USER_EXISTS'				=> 'Username for Dotb database user already exists -- cannot create another one with the same name. Please enter a new username.',
	'ERR_DB_USER'						=> 'Enter a username for the Dotb database administrator.',
    ...
    'ERROR_FLAVOR_INCOMPATIBLE'         => 'The uploaded file is not compatible with this flavour (Professional, Enterprise or Ultimate edition) of Dotb: ',
	...
	'LBL_LICENSE_TITLE_2'				=> 'DotbCRM Licence',
...
For more detailed information, please consult the Installation Guide.                                ",
	...
	'LBL_OOTB_BOUNCE'		=> 'Run Nightly Process Bounced Chiến dịch Emails',
    'LBL_OOTB_CAMPAIGN'		=> 'Run Nightly Mass Email Chiến dịch',
    ...
    'LBL_FTS_HELP'      => 'To enable full-text searching, select the search engine type and enter the Host and Port where the search engine is hosted. Dotb includes built-in support for the elasticsearch engine.',

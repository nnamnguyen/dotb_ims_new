...
// the types/methods defined in this file are deprecated -- please see SoapDotbUsers.php, SoapPortalUsers.php, SoapStudio.php, etc.
 ...
 * @param Contact $seed_contact -- A template DotbBean.  This is a blank Contact

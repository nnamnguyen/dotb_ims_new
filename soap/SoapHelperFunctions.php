...
/**
 * Retrieve field data for a provided DotbBean.
 *
 * @param DotbBean $value -- The bean to retrieve the field information for.
 ...
 *
 * @param Mixed $seed Object representing DotbBean instance
 * @param Array $dataValues Array of fields/values to set on the DotbBean instance
...
{
    if(!$seed instanceof DotbBean || !is_array($dataValues))
    {
        return;
    }

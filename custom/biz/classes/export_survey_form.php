...
function getMultiselectHTML($question, $list_lang_detail, $siteUrl) {
    ...
    switch ($type) {
        case 'multiselectlist':
            ...
            if ($is_sort == 1) {
                ...
                foreach ($options as $ans_id => $answer) {
                    ...
                    if (isset($_REQUEST['type']) && $_REQUEST['type'] == 'word') {
                        $html .= '<div style="display:inline;"><img src="' . $siteUrl . '/custom/include/images/check1.png" height="15px" width="15px">'
            ...
            //changes done for question seperatoe in pdf by Kairvi 4-06-2019
                ...
                if ($advancetype == 'Horizontal') {
                    ...
                    foreach ($options as $ans_id => $answer) {
                        ...
                        if (!empty($ext_arr[0])) {
                            ...
                            if (DotbAutoLoader::fileExists($imgdata)) {
                                $imgPath = $imgdata;
                            } else {
                                $imgPath = '';
                            }
                        ...
                        if (isset($_REQUEST['type']) && $_REQUEST['type'] == 'word') {
                            if (empty($imgPath)) {
                                ...
                                $html .= '<div style="display:inline;">     <img src="' . $siteUrl . '/custom/include/images/check1.png" height="15px" width="15px">    <img height="20px" width="20px" src="' . $matrix_row . '">'
                                        . '     <span style="height:15px;margin-top:5px;">' . htmlspecialchars_decode($answer) . '</span>'
                                        . "</div><br/>";
                            }
                            $op++;
        ...
        case 'boolean':
            ...
            //changes done for question seperater in pdf by Kairvi 4-06-2019
            if ($question['is_question_seperator'] == 1) {
                $html .= "<hr>";
            }
            return $html;
            ...
            if ($is_sort == 1) {
                ...
                if ($advancetype == 'Horizontal') {
                    ...
                    foreach ($options as $ans_id => $answer) {
                        ...
                        if (isset($_REQUEST['type']) && $_REQUEST['type'] == 'word') {
                            if (empty($imgPath)) {
                                $html .= '<div style="display:inline;"><img src="' . $siteUrl . '/custom/include/images/radio1.png" height="15px" width="15px">'
                                        . '          <span style="height:15px;margin-top:5px;">' . htmlspecialchars_decode($answer) . '</span>'
                                        . "</div><br/>";
                            } else {
                                $html .= '<div style="display:inline;"><img src="' . $siteUrl . '/custom/include/images/radio1.png" height="15px" width="15px">     <img height="20px" width="20px" src="' . $matrix_row . '">'
                                        . '          <span style="height:15px;margin-top:5px;">' . htmlspecialchars_decode($answer) . '</span>'
                                        . "</div><br/>";
                            }
                            $op++;
        ...
        case 'textbox':
            ...
            if (isset($_REQUEST['type']) && $_REQUEST['type'] == 'word') {
                $html = "<div>";
                $html .= '<img src="' . $siteUrl . '/custom/include/images/input1.png" height="30px" width="400px">';
            } else {
                $html = "<div class='option select-list two-col' id='{$que_id}_div'>";
        ...
        case 'commentbox':
            ...
            if (isset($_REQUEST['type']) && $_REQUEST['type'] == 'word') {
                $html .= '<img src="' . $siteUrl . '/custom/include/images/comment1.png" width="500px">';
            } else {
        ...
        case 'rating':
            ...
            for ($i = 1; $i <= $starCount; $i++) {
                if (isset($_REQUEST['type']) && $_REQUEST['type'] == 'word') {
                    $html .= '<img src="' . $siteUrl . '/custom/include/images/star1.png" height="30px" width="30px">';
                } else {
        ...
        case 'contact-information':
            ...
            if (isset($_REQUEST['type']) && $_REQUEST['type'] == 'word') {
                $html .= '<img src="' . $siteUrl . '/custom/include/images/contactinfo1.png"  width="500px">';
            } else {
        ...
        case 'date-time':
            ...
            if (isset($_REQUEST['type']) && $_REQUEST['type'] == 'word') {
                $html .= '<img src="' . $siteUrl . '/custom/include/images/input1.png" height="30px" width="250px">';
            } else {
        ...
        case 'scale':
            ...
            if (isset($_REQUEST['type']) && $_REQUEST['type'] == 'word') {
//                $html .= '<img src="' . $siteUrl . '/custom/include/images/input-small.png" height="30px" width="100px">';
                $html .= '<img src="' . $siteUrl . '/custom/include/images/input-small.png">';
            } else {
...
//                $html .= '<img src="' . $siteUrl . '/custom/include/images/input-small.png" height="30px" width="100px">';
                    ...
                    // Rows Label
                        ...
                        //Display answer input (RadioButton or Checkbox)
                            ...
                            if (isset($_REQUEST['type']) && $_REQUEST['type'] == 'word') {
                                ...
                                $html .= '<img src="' . $siteUrl . '/custom/include/images/radio1.png" height="15px" width="15px"></img><br/>'
                                        . "</span>"
                                        . "</td>";
                            } else {
                                $html .= "<td class='matrix-span' style='width:" . $width . "; '>"
        ...
        case 'image':
            ...
            if ($que_title == 'uploadImage') {
                if (isset($_REQUEST['type']) && $_REQUEST['type'] == 'word') {
                    $html .= '<img src="' . $matrix_row . '" height="350px" width="500px">';
                } else {
                    $image_data = explode(',', $matrix_row);
                    $ext = explode('data:image/', $image_data[0]);
        ...
        case 'video':
            ...
            $html .= "<span> <b>Video URL:</b>{$advancetype}</span>";
            $html .= "</div>";
        ...
        case 'emojis':
            ...
            foreach ($answers as $ans) {
                foreach ($ans as $ans_id => $answer) {
                    if (isset($_REQUEST['type']) && $_REQUEST['type'] == 'word') {
                        $html .= '<div style="display:inline;"><img src="' . $siteUrl . '/custom/include/images/radio1.png" height="15px" width="15px">   <img src="' . $siteUrl . '/' . $emojisImges[$op] . '" height="20px" width="20px">'
                                . '   <span style="height:15px;margin-top:5px;">' . htmlspecialchars_decode($answer) . '</span>'
                                . "</div><br/>";
                        $op++;
                    } else {
...
foreach ($survey_details as $page_sequence => $detail) {
    ...
    foreach ($detail['page_questions'] as $que_sequence => $question) {
        //changes regarding disable question.It should not been seen in the survey form exported 09-08-2019
        if ($question['disabled_question'] == 0) {
            if ($question['que_type'] != 'doc-attachment' && $question['que_type'] != 'richtextareabox') {

                $html .= '<br/><h3 class="questions">';


                if ($question['que_type'] == 'image' || $question['que_type'] == 'video') {
                    $que_no++;
                    if (isset($_REQUEST['type']) && $_REQUEST['type'] == 'word') {
                        $html .= $que_no . ' . ' . $question['question_help_comment'];
                    } else {
                        $html .= $que_no . ' .&nbsp;' . $question['question_help_comment'];
                    }
                ...
                $html .= getMultiselectHTML($question, $list_lang_detail, $siteURL);
            }
        }
    }
    $GLOBALS['log']->fatal('This is the result : $html', print_r($html, 1));
    if (isset($_REQUEST['type']) && $_REQUEST['type'] == 'word') {
        $html .= '</html>';
        $htmlWord = $html;
    } else {

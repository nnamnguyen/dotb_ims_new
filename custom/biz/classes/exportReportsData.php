...
//Export changes for disabled question
$takeDisabledQuestion = $_REQUEST['takeDisabledQuestion'];
...
if ($currentExtShort == 'pdf') {
    ...
    if ($report_type == 'question' && $exportReport == 'normal') {
        exportQuestionNormalReportDataAsPDF($questionPDFData, $survey_id, $type, $returnData, $surveyName, '', false, '', $takeDisabledQuestion);
    } elseif ($report_type == 'question' && $exportReport == 'trend') {
        exportQuestionTrendReportDataAsPDF($questionPDFData, $survey_id, $type, $returnData, $selectedRange, $surveyName, '', false, '', $takeDisabledQuestion);
    }
    ...
    $finalExportData = getAllQuestionExportData($report_type, $survey_id, $exportReport, $exportBy, $exportAs, $type, $selectedRange, $returnData, $takeDisabledQuestion);

...
{literal}
    <script type="text/javascript">
       $("document").ready(function () {
           // On page load validate license for checking license expiry details.
            if($("#outfitters_license_key").val() != ""){
                $('#btn-outfitters-validate-license').trigger('click');
            }
        });
        ...
        function outfitters_validate_license()
        {
            ...
            if (curl_not_enabled) {
    {/literal}{if $IS_DOTB_6 == true}{literal}
    ...
    {/literal}{/if}{literal}
            ...
            if (!licKey) {
                ...
                $('#outfitters_fail_message').hide();
                $('#outfitters_insert_validation_key_message').show();
                $('#outfitters_insert_validation_key_message').html('Please insert your validation key to validate');
                return false;
            }
            $('#outfitters_licensed_users').html('');
            $('#btn-outfitters-validate-license').hide();
            $('#outfitters_insert_validation_key_message').hide();
            $('#outfitters_validation_success').hide();
            $('#outfitters_validation_fail').hide();
            ...
            $.ajax('index.php?module={/literal}{$MODULE}{literal}&action=surveyHandler&main_method=outfitters_license&to_pdf=1', {
                type: 'POST',
                dataType: 'json',
                data: {
                    method: 'validate',
                ...
                success: function (response) {
                    ...
                    if (response) {
                        if (response.validated == true) {
                             ...
                             */
                            $('#outfitters_validation_success_msg').html(response.msg);
                            $('#outfitters_validation_success').css('display', 'block');
    {/literal}
    ...
    {/literal}{/if}{literal}
        ...
        $(document).ready(function () {
            ...
            $('#outfitters_additional_license_form').submit(function () {
                return false;
            });
        });
    ...
    <style type="text/css">
        ...
        #outfitters_license_increase, #outfitters_license_passed, #outfitters_validation_fail, #outfitters_validation_success  #outfitters_insert_validation_key_message{
            padding-left: 10px;
        }
...
<form name="outfitters_license_form" id="outfitters_license_form" method="POST">
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0" class="edit view">
        ...
        <tr>
            <td width="20%" scope="row" style="">{$LICENSE.LBL_LICENSE_KEY}</td>
            <td width="30%" colspan="3" scope="row">
                ...
                <span id="outfitters_insert_validation_key_message" style="display: none;color:red;"></span>
                <span id="outfitters_validation_success" style="display: none;color:green">
                    <div id="outfitters_validation_success_msg" style="margin-bottom:10px;margin-top:10px;"></div>
            ...
            <tr>
                ...
                <td width="30%" scope="row" colspan="3">
                    ...
                    <span id="outfitters_license_increase" style="display: none">
                        ...
                        <br/>
                        <button id="btn-outfitters-increase" onclick="javascript:outfitters_increase_license({$current_users});

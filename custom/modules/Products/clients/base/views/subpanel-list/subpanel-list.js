...
({
    ...
    contextEvents: {
        ...
        'list:removeProduct:fire'  :'warnDeleteProduct'
    },
    ...
    warnDeleteProduct:function (model) {
        var self = this;
    ...
    removeProduct:function (model) {
        ...
        app.api.call("update", App.api.buildURL('remove/productProductTemplate'), {id:model.id}, {
            success: function (data) {
                app.alert.show('suscess', {
                    level: 'success',
                    messages: 'Successfull',
                    autoClose: true
                });
                app.alert.dismiss('message-id');
                seft.context.parent.trigger('subpanel:reload', {links: ['product_producttemplate_2','products']});

...
class ViewHealth_check extends DotbView {
    ...
    function display() {
        ...
        $html = '<style>.add_table img {vertical-align: bottom;}</style> <table id="health_status" border="0" cellpadding="0" cellspacing="0" width="800px">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td nowrap="nowrap" style="width: 85%; height:30px;" id="curl_status">' . $health_status['curl_status'] . '</td></tr>
                                    <tr><td></td></tr><tr><td></td></tr>
                            <tr>
                                <td scope="row" nowrap="nowrap" style="width: 10%;"><label for="name_basic" > Script Status : </label></td>
                                <td nowrap="nowrap" style="width: 85%; height:30px;" id="curl_status">' . $health_status['script_status'] . '</td></tr>
                ...
                <br/>
                <input title="Back to Administrator" class="button primary back" onclick="document.location.href=\'index.php?module=Administration&action=index\'"  name="back" value="Back to Administrator" type="button">';

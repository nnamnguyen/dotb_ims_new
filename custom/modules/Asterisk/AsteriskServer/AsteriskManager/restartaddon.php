...
echo "<h4>DotbCRM Asterisk Add-on Running Status:</h4>";
echo "-----------------------------------------------------------------------------------------------------------------";
//$s=exec('whoami');
//echo "<pre>$s</pre>";
...
if (strtoupper(substr(PHP_OS, 0, 3)) === 'WIN')
{
    ...
    if ($result=="INFO: No tasks are running which match the specified criteria.")
    {
        ...
        //echo "refresh";
        echo "<script>toastr.error('<br>Your Add-on will get restrted. <br>Refresh the page for trying to re-connect !', 'Failed to connect to AMI!');</script>";
    ...
    else
    {
        ...
        echo "<pre>Message: DotbCRM Asterisk Add-on is working.</pre>";
        echo "<br/>";
        echo "-----------------------------------------------------------------------------------------------------------------";
        echo "<h5>If DotbCRM Asterisk Add-on is not working well than restart it.</h5>";
        echo "<script>
        function myFunction() {
        ...
        alert('DotbCRM Asterisk Add-on is Restarting....');
        location.reload();
        }
        </script>";
...
else
{
    ...
    {
        echo "<pre>DotbCRM Asterisk Add-on is working...</pre>";
...
echo "<br/>";
echo "-----------------------------------------------------------------------------------------------------------------";
echo "<h4>If DotbCRM Astersik Add-on is not working still please Contact TechExtension Team.</h4>";

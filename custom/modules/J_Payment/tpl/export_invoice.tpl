...
{/literal}
{dotb_getscript file="custom/modules/J_Payment/js/export_invoicee.js"}
<div class="diaglog_invoice" title="Export Invoice" style="display:none;">
<input type="hidden" id="eid_invoice_id" value="">
    <table width="100%">
    <thead>
            <tr style="height: 50px;">
                <td colspan="5" style="float: left;"><b>{$MOD.LBL_DATE_FROM}: </b> <span class="required"> *  </span> <span class="dateTime"><input disabled name="eid_from" size="10" id="eid_from" type="text" value="{$fields.payment_date.value}">  <img border="0" src="custom/themes/default/images/jscalendar.png" alt="Enter Date" id="eid_from_trigger" align="absmiddle"></span> <b> {$MOD.LBL_PAYMENT_DATE_TO} </b> <span class="dateTime"><input disabled name="eid_to" size="10" id="eid_to" type="text" value="{$today}">  <img border="0" src="custom/themes/default/images/jscalendar.png" alt="Enter Date" id="eid_to_trigger" align="absmiddle"></span> </td>
                <td colspan="1" style="float: left;"><input style="margin-left: 30px;" type="button" id="btn_eid_load_payment" value="{$MOD.LBL_BT_LOAD_PAYMENT}"></input></td>
            </tr>
    ...
    <thead>
            <tr>
                ...
                <th width="10%" style="text-align: center;">{$MOD.LBL_NAME} </th>
                <th width="10%" style="text-align: center;">{$MOD.LBL_PAYMENT_TYPE} </th>
                <th width="10%" style="text-align: center;">{$MOD.LBL_AMOUNT_BEF_DISCOUNT} </th>
                <th width="10%" style="text-align: center;">{$MOD.LBL_TOTAL_DISCOUNT_SPONSOR} </th>
                <th width="10%" style="text-align: center;">{$MOD.LBL_TOTAL_AMOUNT} </th>
                <th width="10%" style="text-align: center;">{$MOD.LBL_STATUS} </th>
            </tr>
    </thead>
    ...
    <table width="100%">
        ...
        <tr>
            <td width="25%" align="right">{$MOD.LBL_AMOUNT_BEF_DISCOUNT}:</td>
            <td width="15%" align="right" class="eid_total_before_discount">0</td>
            <td width="25%" align="right">{$MOD.LBL_INVOICE_NO}.: <span class="required"> * </span> </td>
        ...
        <tr>
            <td width="25%" align="right">{$MOD.LBL_TOTAL_AFTER_DISCOUNT}}:</td>
            <td width="15%" align="right" class="eid_total_after_discount">0</td>
            <td width="25%" align="right">{$MOD.LBL_INVOICE_DATE}: <span class="required"> * </span> </td>

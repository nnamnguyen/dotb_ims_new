...
<div id="book_list" class="content" >
    ...
    <div class="row" style="    margin-left: 6%;">
        <div class="col-md-12"><button type="button" id="btnAddBook" class="btn btn-primary">+</button></div>
    </div>

    <div style="display: flex;margin: 10px 0px;text-align:center;">
        <div class="col-md-2 book_column">
            <b>{$MOD.LBL_BOOK_NAME}</b><span class="required">*</span>
        </div>
        <div class="col-md-1 book_column">
            <b>{$MOD.LBL_QUATITY}</b><span class="required">*</span>
        </div>
        <div class="col-md-2 book_column">
            <b>{$MOD.LBL_PRICE}</b>
        </div>
    ...
    <div class="bookItem" style="display:none;">
        ...
        <div class="col-md-2 book_column">
            <input type="button" class="book_remove" value="-" >
        </div>
    </div>

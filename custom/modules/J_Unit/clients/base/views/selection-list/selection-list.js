 ...
 * @alias DOTB.App.view.views.BaseSelectionListView
...
({
    ...
    renderColection:function () {
        var seft = this;
        var collection = [];
        var group_unit_id = this.context.get('group_unit_id');
        if(group_unit_id != undefined){
            this.collection.models.forEach(function (item) {
                if (item.get('group_unit_id') == group_unit_id && !item.get('is_primary'))

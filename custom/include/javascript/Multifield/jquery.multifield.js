        ...
        */
        ...
        multiField.prototype = {
            ...
            init: function () {
                ...
                if (this.getSectionsCount() < this.config.min + 2) { //modify by Lap Nguyen
            ...
            */
            cloneSection: function () {
                ...
                if (sectionsCount > this.config.min + 1) { // modify by Lap Nguyen
            ...
            */
            removeSection: function (section) {
                ...
                if (!beforeRemoveSection(section)) return;    //add by Lap Nguyen for before remove
                var sectionsCount = this.getSectionsCount();

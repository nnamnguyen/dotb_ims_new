...
({
    ...
    className: 'survey-response-status-wrapper',
    ...
    initDashlet: function (view) {
        ...
        this.meta.label = 'Survey Repsonse Report';
        // Call Quick Status Repsonse in Dashlet
    ...
    bindDataChange: function () {
        ...
        if (this.meta.config) {
            this.settings.on('change:saved_report_id', function (model) {
                ...
                //this.meta.label = model.get('saved_report') + ' : Repsonse Report';
                ...
                options = {
                    success: function (data) {
                        ...
                        label = $('[name="label"]');
                        if (label.length) {
                            label.val('Survey Repsonse Report');
                        }
                    }
                };
...
//        this.displayNoData(!this.chart_loaded);
    ...
    evaluateResult: function (callDataStatusReport) {
        ...
        this.chartCollection = {
            data: [],
            properties: {
                title: this.meta.saved_report + ' : Repsonse Report',
                value: 2,
                label: this.total
            }
        };
    ...
    processSurveyStatus: function (data) {
        ...
        var status2css = {
                ...
                stati = {"2": "active_for", "3": "last_submitted_date"},
                statusOptions = {"active_for": "Active For", "last_submitted_date": "Last Submitted Date"};
    ...
    loadTitle: function (options) {
        var self = this;
        var url = App.api.buildURL("bc_survey", "dashlet_survey_response_chart", "", {survey_id: self.surveyId});

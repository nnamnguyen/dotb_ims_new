({
    ...
    initialize: function (options) {
        ...
        this.context.on('button:take_survey:click', this.getListRecordsToTakeSurvey, this);//Take survey changes 03-08-2019
    },
    ...
    // get list of selected records for survey to take survey
    //Take survey changes 03-08-2019
    getListRecordsToTakeSurvey: function () {
        var self = this;
        var type = 'survey';
        var module_name = this.module;
        if (this.model.get('name') != null) {
        ...
        var module_name = self.module;
        self.create_SendSurveydiv(self.model.get('id'), module_name, 1, 'take_survey');
    },
    ...
    create_SendSurveydiv: function (record, module, sendPeopleCount, type) {
        ...
        if (!Initial_Popup_Survey_List) {
            ...
            Initial_Popup_Survey_List = app.view.createView({
                ...
                record_name: self.model.get('name'),

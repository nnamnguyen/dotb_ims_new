 ...
 * @alias DOTB.App.layout.GlobalsearchView
 * @extends View.View
 */
({
    ...
    populateModules: function() {
        ...
        this.searchModules = this.populateSearchableModules({
            ...
            acl: app.acl,
            // Unlike dotb7, today, portal doesn't use ftsEnabled but instead any visible modules that
     ...
     * (Show searchahead results for dotbcon because we don't have full results page yet)
     */

 ...
 * @alias DOTB.App.view.fields.BaseHtmleditable_tinymceField
...
({
    ...
    setViewContent: function(value){
        ...
        var styleSrc = 'styleguide/assets/css/iframe-dotb.css';
        ...
        if (this._iframeHasBody(editable)) {
            // Only add the stylesheet that is dotb-specific while making sure not to add any duplicates

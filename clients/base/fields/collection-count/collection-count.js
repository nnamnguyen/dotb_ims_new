 ...
 * @alias DOTB.App.view.fields.BaseCollectionCountField
...
({
    ...
    _setCountLabel: function(options) {
        ...
        if (fullyFetched) {
            ...
            context.text =  Handlebars.Utils.escapeExpression(app.lang.get('TPL_LIST_HEADER_COUNT_PARTIAL', this.module, {num: context.num + 1}));
        ...
        var countLabel = new Handlebars.SafeString(app.lang.get(tplKey, this.module, context));
        if(typeof this.collection.link != "undefined" && this.collection.link.name != "undefined" && parseInt(context.text) > 0)
            $('button.tablinks[data-subpanel-link="'+this.collection.link.name+'"]').find('.badge_count').text(context.text);

 ...
 * @alias DOTB.App.view.fields.BaseForecastParetoChartField
...
({
    ...
    generateD3Chart: function() {
        ...
        if (!_.isEmpty(this.paretoChart)) {
            ...
            d3dotb.select('#' + this.chartId + ' svg').remove();
        }
    ...
    getDisabledChartKeys: function() {
        var currentChartData = d3dotb.select('#' + this.chartId + ' svg').data();

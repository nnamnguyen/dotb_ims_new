 ...
 * @alias DOTB.App.view.fields.BaseFullnameField
...
({
    ...
    bindDataChange: function() {
        if (this.model) {
            // As detail templates don't contain Lumia Fields,
    ...
    _render: function() {
        ...
        // Assign label by HP
        $('#first').html(app.lang.get('LBL_FIRST_NAME', 'Leads'));
        $('#last').html(app.lang.get('LBL_LAST_NAME', 'Leads'));
        $('#example').html('E.g.');
    }
})

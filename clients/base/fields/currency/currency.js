 ...
 * @alias DOTB.App.view.fields.BaseCurrencyField
...
({
                ...
                if (model.has(this.name)) {
                    ...
                    if (val) {
                        this.model.set(
                            ...
                            // we don't want to affect other bindings like dotb logic
                    ...
                    // with other events (from DotbLogic, etc.)
    ...
    unformat: function(value) {
        ...
        // be stored in the db, this is needed just in case DotbLogic is used on this field's value

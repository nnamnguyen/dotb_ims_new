 ...
 * @alias DOTB.App.view.fields.BaseSidebartoggleField
...
({
     ...
     */
    _render: function () {
        if (typeof app.config.enable_sidepane_toggle !== "undefined"
            && typeof this.context.attributes.dataView !== "undefined"
            && typeof this.module !== "undefined"
            && typeof app.config.enable_sidepane_toggle[this.context.attributes.dataView] !== "undefined"
            && ['list', 'record'].includes(this.context.attributes.dataView)
            && app.config.enable_sidepane_toggle[this.context.attributes.dataView].includes(this.module)) {

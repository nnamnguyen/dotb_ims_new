 ...
 * @alias DOTB.App.view.fields.BaseShareactionField
...
({
    ...
    initialize: function(options) {
        ...
        if(typeof options.def != 'undefined'){
            options.def.icon = 'fa-share';
            options.def.tooltip = options.def.label;
            options.def.customButton = true;
        }
        //
    ...
    /**
     * Explicit share action to launch the dotb email client with share info
     * (used by bwc)
     */
    shareWithDotbEmailClient: function() {
        this.launchDotbEmailClient(this.emailOptions);
    },

 ...
 * @alias DOTB.App.view.fields.BaseChartField
...
({
    ...
    generateD3Chart: function() {
        ...
        var dotbChart = new loadDotbChart(id, chartData, [], config, params, _.bind(function(chart) {
    ...
    getChartParams: function(chartData) {
        ...
        var properties = !_.isUndefined(chartData.properties) && Array.isArray(chartData.properties) ?
                ...
                {};
        // These params will be overriden the DotbCharts defaults
        var params = {
                chart_type: 'multibar',

 ...
 * @alias DOTB.App.view.views.BaseFilterFilterDropdownView
 * @extends View.View
 */
({
    tagName: "span",
    ...
    getFilterList: function() {
        ...
        if (this.layout.canCreateFilter()) {
            filters.push({id: "create", text: app.lang.get(this.labelCreateNewFilter), order: 0});
        }
        ...
        this.layout.filters.collection.each(function(model) {
            ...
            // Add by HP to create a attr to order by filters
            if (model.attributes.order == null){
                order = 99;
            } else order = model.attributes.order;
        ...
        // Added by HP to sort filter by attr 'order'
    ...
    _renderDropdown: function(data) {
        ...
        //Add by Tuan Anh hide create in filter
        // data = _.rest(data);
        // End

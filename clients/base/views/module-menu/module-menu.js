 ...
 * @alias DOTB.App.view.views.BaseModuleMenuView
 * @extends View.View
 */
({
    tagName: 'span',
    ...
    initialize: function (options) {
        if (options.module !== 'Home' && typeof App.config.module_icon[options.module] != 'undefined' && typeof App.config.module_icon != 'undefined') {

            if (App.config.module_icon[options.module]['src']) {
                options.meta.srcIcon = App.config.module_icon[options.module]['src'];
                if (App.config.module_icon[options.module]['type'] == 'icon') {
                    options.meta.icon = true;
                } else {
                    options.meta.image = true;
                }
                ;
            }

 ...
 * @alias DOTB.App.view.views.BaseDashletToolbarView
 * @extends View.View
 */
({
    ...
    initialize: function(options) {
        ...
        if (typeof options.meta.toolbar.buttons != 'undefined' && options.meta.toolbar.buttons.length > 0) {
            options.meta.toolbar.buttons[0]['notCustomButton'] = true;
        }

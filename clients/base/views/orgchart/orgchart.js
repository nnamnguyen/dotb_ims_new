 ...
 * @alias DOTB.App.view.views.BaseOrgchartView
 * @extends View.View
 */
({
    events: {
    ...
    nodeRenderer: function(content, d, w, h) {
        ...
        var container = d3dotb.select('svg#' + this.cid);
    ...
    renderChart: function() {
        ...
        this.jsTree = this.$('div[data-control="org-jstree"]')
                .jstree({
                    ...
                    this.$('div[data-control="org-jstree"]').addClass('jstree-dotb');
        ...
        this.container = d3dotb.select('svg#' + this.cid);

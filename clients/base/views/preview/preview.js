({
    ...
    plugins: ['ToggleMoreLess', 'Editable', 'ErrorDecoration', 'DotbLogic'],
    ...
    initialize: function(options) {
        ...
        if (this.layout) {
            var self = this;
            this.layout.on('app:view:custom-preview', function(model) {
                self._renderPreview(model,model.collection, true, model.id);
                this.$('.modal').modal({
                    backdrop: 'static'
                });
    ...
    setEditableFields: function() {
        ...
        this.editableFields = _.reject(this.fields, function(field) {
            ...
            return field.def.readOnly || field.def.calculated ||
                //Added for DotbLogic fields since they are not supported

 ...
 * @alias DOTB.App.view.views.BaseMassupdateView
 * @extends View.View
 */
({
    events: {
    ...
    /**
     * @inheritdoc
     * Retrieves metadata from dotbTemplate and then able to override it from
    ...
    delegateListFireEvents: function() {
        ...
        this.layout.on("list:mark_as_read:fire", this.show, this);

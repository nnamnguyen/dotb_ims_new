 ...
 * @alias DOTB.App.view.views.BaseSetupCompleteWizardPageView
...
({
    ...
    initialize: function(options){
        ...
        this.events = _.extend({}, this.events, {
            ...
            "click [name=start_dotb_button]:not(.disabled)": "next"
        });
     ...
     * We need to use app router for Dotb app links on complete page.

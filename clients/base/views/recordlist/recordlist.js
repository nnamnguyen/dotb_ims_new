 ...
 * @alias DOTB.App.view.views.BaseRecordlistView
...
({
    ...
    contextEvents: {
        "list:preview:fire": "customPreview",
     ...
     * link to the Lumia record view in edit mode or BWC edit view
     *
    ...
    customPreview: function (model) {
        ...
        * */
        ...
        this.layout.trigger("app:view:custom-preview", model);
    },
})

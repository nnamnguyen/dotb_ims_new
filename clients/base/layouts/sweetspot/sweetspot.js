 ...
 * @alias DOTB.App.view.layouts.BaseSweetspotLayout
 * @extends View.Layout
 */
({
    /**
    ...
    initialize: function(options) {
        ...
        // FIXME Lumia should be modified to allow multiple top level contexts. When this happens, quick search
     ...
     * see https://github.com/dotbcrm/Mango/pull/18722#discussion_r11782561.
     *

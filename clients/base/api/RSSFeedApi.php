 ...
 */
class RSSFeedApi extends DotbApi
{
    /**
        ...
        return array(
            'getFeed' => array(
                ...
                'exceptions' => array(
                    ...
                    'DotbApiExceptionConnectorResponse',
                ),
            ),
        );
    }
    ...
    public function validateFeedUrl($url)
    {
        ...
        if (empty($parts['scheme']) || empty($parts['host'])) {
            throw new DotbApiExceptionInvalidParameter('LBL_ERR_LOADING_RSS_FEED');
        }
    ...
    public function getFeedLimit(array $args)
    {
        ...
        $max = 20;
        if (isset($dotb_config['rss_feed_max_entries'])) {
            $max = intval($dotb_config['rss_feed_max_entries']);
        }
    ...
    public function getFeedContent($url)
    {
        ...
        if (!$data) {
            throw new DotbApiExceptionConnectorResponse('LBL_ERR_LOADING_RSS_FEED');
        }

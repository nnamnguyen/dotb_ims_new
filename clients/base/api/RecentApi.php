...
class RecentApi extends DotbApi
{
     ...
     * module.
     *
     * @param DotbBean $seed Instance of current bean.
     * @param array $options Prepared options.
     * @return DotbQuery query to execute.
     */
    protected function getRecentlyViewedQueryObject(DotbBean $seed, array $options)
    {
        ...
        // FIXME: FRM-226, logic for these needs to be moved to DotbQuery

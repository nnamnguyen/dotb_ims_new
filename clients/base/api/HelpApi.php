...
class HelpApi extends DotbApi 
{
    ...
    protected $clientFiles = array(
        'cache/javascript/dotbcrm2.min.js',
    );
    
    /**
     * Used in transformations of class names, like making 
     * DotbApiExceptionRequestTooLarge into Request Too Large or request-too-large
     * 
     * @var string
     */
    ...
    protected function getExceptions()
    {
        ...
        $file = 'include/api/DotbApiException.php';
    ...
    {
        // The exception type name (class name less DotbApiException)
        $typeName = str_replace('DotbApiException', '', $class);
     ...
     * DotbApiExceptionRequestTooLarge -> dotb-api-exception-request-too-large
     * 

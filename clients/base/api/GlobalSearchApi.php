...
use Dotbcrm\Dotbcrm\SearchEngine\Capability\GlobalSearch\ResultSetInterface;
use Dotbcrm\Dotbcrm\SearchEngine\Capability\GlobalSearch\ResultInterface;
 ...
 *
 */
class GlobalSearchApi extends DotbApi
{
    /**
     * @var integer Offset
     */
    ...
    public function globalSearch(ServiceBase $api, array $args)
    {
        ...
        try {
            ...
            throw new DotbApiExceptionSearchRuntime();
        }
     ...
     * @return \Dotbcrm\Dotbcrm\SearchEngine\Capability\GlobalSearch\ResultSetInterface
     */
     ...
     * @throws \DotbApiExceptionSearchRuntime
     * @throws \DotbApiExceptionSearchUnavailable
    ...
    protected function getSearchEngine()
    {
        ...
        if (!$engine->isAvailable()) {
            throw new DotbApiExceptionSearchUnavailable();
        }

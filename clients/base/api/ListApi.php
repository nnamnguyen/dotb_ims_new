...
class ListApi extends DotbListApi {
    ...
    public function __construct() {
        $this->defaultLimit = $GLOBALS['dotb_config']['list_max_entries_per_page'];
    }
    ...
    protected function performQuery(ServiceBase $api, array $args, DotbBean $seed, $queryParts, $limit, $offset)
    {

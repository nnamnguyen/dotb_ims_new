...
$resubmit_request_success_msg = "Your request to re-submit " . ucfirst($survey->survey_type) . " response is submitted successfully. You will be sent a confirmation email once admin approves your request.";
...
$resubmit_request_fail_msg = "Your request to re-submit " . ucfirst($survey->survey_type) . " response is not submitted.";
if (!empty($list_lang_detail['resubmit_request_fail_msg'])) {
    $resubmit_request_fail_msg = $list_lang_detail['resubmit_request_fail_msg'];
}

$resubmit_request_already_sent_msg = "You have already requested to re-submit " . ucfirst($survey->survey_type) . " response!";
...
<html>
    <head>
        ...
        <link href="<?php echo $dotb_config['site_url'] . '/custom/include/css/survey_css/' . $survey->survey_theme . '.css'; ?>" rel="stylesheet">
    </head>
    <body>
        <?php
                        ...
                        <div class="navbar">
                            <div class="navbar-inner">
                                <div class="nav-collapse" style="padding:10px">
                                    ...
                                    <img src="custom/include/images/dotbcrm-color.png" alt="DotbCRM" height="26" width="150">

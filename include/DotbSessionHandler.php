...
/**
 * Session handler for Dotb
 */
class DotbSessionHandler extends SessionHandler
{
    /**
     * Session start time
     */
    ...
    {
        $this->max_session_time = DotbConfig::getInstance()->get('max_session_time');
        $this->log = LoggerManager::getLogger('DotBCRM');
    }

...
abstract class DashletGenericChart extends Dashlet
{
    ...
    public function setRefreshIcon()
    {
        ...
        if($this->isRefreshable)
            ...
            $additionalTitle .= '<a href="#" onclick="DOTB.myDotb.retrieveDashlet(\'' 
                                ...
                                . DotbThemeRegistry::current()->getImageURL('dashlet-header-refresh.png').'"/></a>';    	
    ...
    public function displayScript()
    {
		...
		return $dotbChart->getDashletScript($this->id);
    ...
    {
        if ( !($this->_configureSS instanceof Dotb_Smarty) ) {

            $this->_configureSS = new Dotb_Smarty();
        }
    ...
    {
        if ( !($this->_seedBean instanceof DotbBean) )
    ...
    /**
     * Returns the built query read to feed into DotbChart::getData()
     *
    ...
    /**
     * Returns the array of group by parameters for DotbChart::$group_by
     *
     * @return string SQL query
     */

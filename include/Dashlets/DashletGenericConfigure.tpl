...
<div>
<form action='index.php' id='configure_{$id}' method='post' onSubmit='DOTB.myDotb.setChooser(); return DOTB.dashlets.postForm("configure_{$id}", DOTB.myDotb.uncoverPage);'>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="edit view">
    ...
    <tr>
	    <td colspan='4' align='right'>
	        ...
	        {if $showClearButton}
	        <input type='submit' class='button' value='{$strings.clear}' onclick='DOTB.searchForm.clear_form(this.form,["dashletTitle","displayRows","autoRefresh"]);return false;'>
	        {/if}
	    </td>    
	</tr>
</table>

...
$moduleList[] = 'Holidays'; //Add By Lap Nguyen
...
// this list defines all of the files that contain the DotbBean class definitions from $beanList
...
$modInvisList = array('Administration', 'CustomFields', 'Connectors',
    ...
    'ContractTypes',
    'ACLFields', 'SNIP', 'ForecastDirectReports',
    'Releases','Sync',
...
$beanList['DotbFavorites'] = 'DotbFavorites';
$beanFiles['DotbFavorites'] = 'modules/DotbFavorites/DotbFavorites.php';
$modules_exempt_from_availability_check['DotbFavorites'] = 'DotbFavorites';
$modInvisList[] = 'DotbFavorites';
...
foreach(DotbAutoLoader::existing('include/modules_override.php', DotbAutoLoader::loadExtension("modules")) as $modExtFile) {
    include $modExtFile;
}

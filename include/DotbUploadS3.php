 ...
 * @api
 */
class DotbUploadS3 extends UploadStream
{
    protected $s3;
    protected $s3dir;
    protected $path;
    ...
    protected function init()
    {
        ...
        if(empty($GLOBALS['dotb_config']['aws'])
            || empty($GLOBALS['dotb_config']['aws']['aws_key'])
            || empty($GLOBALS['dotb_config']['aws']['aws_secret'])
            || empty($GLOBALS['dotb_config']['aws']['upload_bucket'])
            ) {
        ...
        $this->s3 = new Zend_Service_Amazon_S3($GLOBALS['dotb_config']['aws']['aws_key'], $GLOBALS['dotb_config']['aws']['aws_secret']);
        $this->s3->registerAsClient(self::S3_STREAM_NAME);
        $this->bucket = $GLOBALS['dotb_config']['aws']['upload_bucket'];
    }

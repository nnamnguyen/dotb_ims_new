...
class ViewList extends DotbView{
    var $type ='list';
    var $lv;
    var $searchForm;
    var $use_old_search;
    ...
    function prepareSearchForm()
    {
        ...
        if (DotbAutoLoader::existingCustom('modules/' . $this->module . '/SearchForm.html') &&
            !DotbAutoLoader::existingCustom('modules/' . $this->module . '/metadata/searchdefs.php')) {

...
class ViewFts extends DotbView
{
    ...
    public function display($return = false, $encode = false)
    {
        ...
        $limit = ( !empty($GLOBALS['dotb_config']['max_spotresults_initial']) ? $GLOBALS['dotb_config']['max_spotresults_initial'] : 10 );
        ...
        if ($moduleFilter === false) {
            $moduleFilter = DotbSearchEngineMetadataHelper::getUserEnabledFTSModules();
        }
        ...
        $template = DotbAutoLoader::existingCustomOne("include/MVC/View/tpls/{$this->templateName}");
        $rsTemplate = DotbAutoLoader::existingCustomOne("include/MVC/View/tpls/{$this->rsTemplateName}");
    ...
    {
        $filteredEnabled = DotbSearchEngineMetadataHelper::getUserEnabledFTSModules();
        ...
        $systemEnabledModules = DotbSearchEngineMetadataHelper::getSystemEnabledFTSModules();

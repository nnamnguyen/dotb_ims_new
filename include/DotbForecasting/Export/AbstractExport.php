...
abstract class DotbForecasting_Export_AbstractExport extends DotbForecasting_AbstractForecastArgs implements DotbForecasting_ForecastProcessInterface
{
        ...
        foreach ($data as $val) {
            ...
            foreach ($fields_array as $key => $label) {
                ...
                if (isset($focus->field_defs[$key])) {
                    $sfh = DotbFieldHandler::getDotbField($focus->field_defs[$key]['type']);

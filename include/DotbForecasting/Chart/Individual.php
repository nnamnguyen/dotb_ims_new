...
class DotbForecasting_Chart_Individual extends DotbForecasting_Chart_AbstractChart
{
    /**
     * Constructor
     *
    ...
    protected function generateChartJson()
    {
        ...
        $acl = new DotbACLForecastWorksheets();
        ...
        if (!empty($this->dataArray)) {
            foreach ($this->dataArray as $data) {
                ...
                if ($config['show_worksheet_best'] && $bestAccess) {
                    ...
                    $v['best'] = DotbCurrency::convertWithRate($data['best_case'], $data['base_rate']);
                }
                ...
                if ($config['show_worksheet_worst'] && $worstAccess) {
                    ...
                    $v['worst'] = DotbCurrency::convertWithRate($data['worst_case'], $data['base_rate']);
                }
    ...
    protected function getUserQuota()
    {
        ...
        return DotbCurrency::convertAmountToBase($quota['amount'], $quota['currency_id']);
    }
}

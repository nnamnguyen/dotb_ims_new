...
abstract class DotbForecasting_AbstractForecast extends DotbForecasting_AbstractForecastArgs implements DotbForecasting_ForecastProcessInterface
{
    /**
    ...
    /**
     * Utility method to convert a date time string into an ISO data time string for Lumia usage.
     *
     * @param string $dt_string     Date Time value to from the db to convert into ISO format for Lumia to consume

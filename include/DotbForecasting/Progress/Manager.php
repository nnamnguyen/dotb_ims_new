...
class DotbForecasting_Progress_Manager extends DotbForecasting_Manager
{
    /**
     * @var Opportunity
     */
    ...
    public function getManagerProgress()
    {
        ...
        foreach (array('worst_adjusted', 'likely_adjusted', 'best_adjusted') as $field) {
            $totals[$field] = DotbMath::init($totals[$field])->sub($totals['closed_amount'])->result();
        }
    ...
    public function getPipelineRevenue()
    {
        ...
        //Note: this will all change in dotb7 to the filter API

...
class ExtAPIFacebook extends ExternalAPIBase implements WebFeed {
    ...
    public function checkLogin($eapmBean = null)
    {
        ...
        if ( empty($this->eapmBean->oauth_secret) ) {
            ...
            if ( !empty($_REQUEST['session']) ) {
                ...
                $callback_url = $GLOBALS['dotb_config']['site_url'].'/index.php?module=EAPM&action=oauth&record='.$this->eapmBean->id;
                ...
                DotbApplication::redirect($loginUrl);
    ...
    public function getLatestUpdates($maxTime, $maxEntries)
    {
        ...
        foreach ( $fbMessages['data'] as $message ) {
            ...
            $fake_record['NAME'] .= '<br><div class="byLineBox"><span class="byLineLeft">'.DotbFeed::getTimeLapse($fake_record['DATE_ENTERED']).'&nbsp;</span><div class="byLineRight">&nbsp;</div></div>';

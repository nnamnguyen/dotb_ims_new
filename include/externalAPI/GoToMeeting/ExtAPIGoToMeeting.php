...
class ExtAPIGoToMeeting extends OAuthPluginBase implements WebMeeting
{
    ...
    public function oauthLogin()
    {
        ...
        if (!isset($_REQUEST['code'])) {
            $callback = $dotb_config['site_url'] . '/index.php?module=EAPM&action=oauth&record=' . $this->eapmBean->id;
            ...
            DotbApplication::redirect($this->getOauthAuthURL() . '?' . http_build_query($queryData));
        } else {
            $code = $_REQUEST['code'];

...
class DotbCurrency
{
    ...
    public static function convertWithRate( $amount, $fromRate = 1.0, $toRate = 1.0, $precision = 6 ) {
        ...
        return DotbMath::init(0, $precision)->exp('?/?*?',array($amount,$fromRate,$toRate))->result();
    }
     ...
     */
    public static function verifyCurrencyBaseRateSet(DotbBean $bean, $isUpdate = true)
    {
     ...
     * @return Currency
     */
    public static function getCurrency(DotbBean $bean)
    {

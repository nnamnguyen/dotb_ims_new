...
class DotbJobQueue
{
    ...
    public function __construct()
    {
        ...
        if(!empty($GLOBALS['dotb_config']['jobs']['max_retries'])) {
            $this->jobTries = $GLOBALS['dotb_config']['jobs']['max_retries'];
        }
        if(!empty($GLOBALS['dotb_config']['jobs']['timeout'])) {
            $this->timeout = $GLOBALS['dotb_config']['jobs']['timeout'];
        }
    }
    ...
    public function cleanup()
    {
        ...
        $ret = true;
        // bsitnikovski@dotbcrm.com bugfix #56144: Scheduler Bug

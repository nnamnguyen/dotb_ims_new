...
/**
 * DotbJobCreateRevenueLineItemNotes
 *
 * Class to run a job which will create the Revenue Line Items for all the Opportunities.
 *
 */
class DotbJobCreateRevenueLineItemNotes extends JobNotification implements RunnableSchedulerJob
{
                    ...
                    if (isset($labels[$field])) {
                        if ($field === 'currency_id') {
                            if (!isset($currencies[$value])) {
                                $currencies[$value] = DotbCurrency::getCurrencyByID($value);
                            }

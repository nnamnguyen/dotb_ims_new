...
/**
 * DotbJobUpdateOpportunities.php
 *
 ...
 */
class DotbJobUpdateOpportunities extends JobNotification implements RunnableSchedulerJob {
    ...
    /**
     * This function creates a job for to run the DotbJobUpdateOpportunities class
    ...
    public static function createJob(array $data, $returnJob = false, $job_group = null)
    {
        ...
        $job->target = "class::DotbJobUpdateOpportunities";

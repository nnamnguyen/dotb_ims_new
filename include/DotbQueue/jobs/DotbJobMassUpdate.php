 ...
 * @api
 */
class DotbJobMassUpdate implements RunnableSchedulerJob
{
    ...
    public function __construct()
    {
        ...
        if (!empty($GLOBALS['dotb_config']['mass_actions']['mass_update_chunk_size'])) {
            $this->chunkSize = $GLOBALS['dotb_config']['mass_actions']['mass_update_chunk_size'];
        }
    }
    ...
    public function createJobQueueConsumer($data, $jobType = "init")
    {
        ...
        $job->target = "class::DotbJobMassUpdate";

 ...
 *
 * @copyright  2004-2007 DotBCRM Inc.
 * @license    http://www.dotbcrm.com/crm/products/dotb-professional-eula.html  DotBCRM Professional End User License
...
class QuickSearchDefaults
{
    ...
    function getQSScripts() {
		global $dotb_version, $dotb_config, $theme;
		$qsScripts = '<script type="text/javascript">sqsWaitGif = "' . DotbThemeRegistry::current()->getImageURL('sqsWait.gif') . '";</script>
	...
	function getQSScriptsJSONAlreadyDefined() {
		global $dotb_version, $dotb_config, $theme;
		$qsScriptsJSONAlreadyDefined = '<script type="text/javascript">sqsWaitGif = "' . DotbThemeRegistry::current()->getImageURL('sqsWait.gif') . '";</script><script type="text/javascript" src="' . getJSPath('include/javascript/quicksearch.js') . '"></script>';

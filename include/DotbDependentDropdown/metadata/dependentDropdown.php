...
$dotbDependentDropdown = array(
	...
	'actions' => array(
		...
		'elements' => array(
			...
			'element0'	=> array(
				 ...
				 */
				'onchange'	=> 'DOTB.routing.handleDependentDropdown(this, \'actions\');',	// javascript onchange() call
				/*
			...
			'element1'	=> array(
				...
				'handlers'	=> array(
					 ...
					 * 
					 * See DOTB.routing.handleDependentDropdown() found in
					 * "include/DotbDependentDropdown/javascript/DotbDependentDropdown.
					...
					'move_mail'		=> array(
						...
						'values'	=> 'DOTB.routing.ui.getElementValues("move_mail");',
					...
					'reply' =>		array(
						...
						'label_pos'	=> 'left',
						'values'	=> 'DOTB.routing.ui.getElementValues("email_templates");',
					),
	...
	'criteria' => array(
		'always_merge' => array(
			...
			'onchange'	=> 'DOTB.routing.handleDependentDropdown(this, \'criteria\');',	// javascript onchange() call
			'label'		=> '&nbsp;',
			'label_pos'	=> 'left',
			'actionType'	=> 'criteria',
		),
		'elements' => array(
			'element0'	=> array(
				...
				'type'		=> 'select',
				'values'	=> 'DOTB.routing.matchDom;',	// assoc array of dropdown values, if a STRING, it will be eval'd to lazy load the values
				'selected'	=> '',			// initially selected value (key value)
			),
			'element1' => array(
				'name'		=> 'crit1',
				'id'		=> 'crit1id',
				'type'		=> 'select',
				'values'	=> 'DOTB.routing.matchTypeDom;',
				'handlers' 	=> array(
					'from_addr' => array(),
					'to_addr' => array(),
					'cc_addr' => array(),

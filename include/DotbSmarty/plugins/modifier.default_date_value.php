...
- test/test_utilities/DotbTest_UserUtilities.php
- include/workflow/action_utils.php
- include/generic/DotbWidgets/DotbWidgetFielddatetime.php
- include/generic/DotbWidgets/DotbWidgetFielddate.php
- include/generic/DeleteRelationship.php
- include/DotbSmarty/modifier.default_date_value.php
- include/DotbEmailAddress/DotbEmailAddress.php
- include/database/DBManager.php
- include/javascript/jsAlerts.php
- include/CurrencyService/CurrencyService.php
- include/MVC/View/DotbView.php
- include/MVC/DotbApplication.php
...
Updated the date DotbField to support default_value formats via using the Smarty default_date_value modifier. Also updated Studio support for the date field to display a default_value dropdown list.
Touched:
include/DotbFields/Fields/Datetime/EditView.tpl
 ...
 * @author   Collin Lee <clee at dotbcrm dot com>
...
function smarty_modifier_default_date_value($defaultValue) {
	global $timedate;
	$td = new TemplateDate();
	return $timedate->asUser(new DotbDateTime($td->dateStrings[$defaultValue]));
}

...
r42997 - 2009-01-06 13:04:49 -0800 (Tue, 06 Jan 2009) - jmertic - Create a helpInline icon, used for the help icon inside a form. Updated smarty plugin dotb_help to grab the correct icon.
...
r34454 - 2008-04-21 05:58:55 -0700 (Mon, 21 Apr 2008) - jmertic - Bug 21449: Added new help icon from jyim, and updated smarty function dotb_help to use it.
Added:
- themes/default/images/help.gif
Touched:
- include/DotbSmarty/plugins/function.dotb_help.php
...
r32202 - 2008-02-29 11:05:08 -0800 (Fri, 29 Feb 2008) - jmertic - Have dotb_help icon be the magnifying glass and the window not have a title.
...
Pushed code for help popups into smarty function dotb_help.
 ...
 *
 *
 * @author John Mertic {jmertic@dotbcrm.com}
 */

/**
 * smarty_function_dotb_help
 ...
 */
function smarty_function_dotb_help($params, &$smarty)
{
    $text = str_replace("'","\'",htmlspecialchars($params['text']));
	//append any additional parameters.
	$click  = "return DOTB.util.showHelpTips(this,'$text'";
    ...
    $helpImage = DotbThemeRegistry::current()->getImageURL('helpInline.png');
	$click .= " );" ;

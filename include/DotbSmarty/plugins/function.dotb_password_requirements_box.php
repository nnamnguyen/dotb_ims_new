...
/**
 * Smarty {smarty_function_dotb_password_box} function plugin
 *
 * Type:     function<br>
 * Name:     smarty_function_dotb_password_box<br>
 * Purpose:  display the password requirement box in the User Module
 *
 * @author Aissah Fabrice {faissah at dotbcrm.com
 * @param array
 * @param Smarty
 */
function smarty_function_dotb_password_requirements_box($params, &$smarty)
{

...
/**
 * Smarty {dotb_fetch} function plugin
 *
 * Type:     function<br>
 * Name:     dotb_fetch<br>
...
function smarty_function_dotb_fetch($params, &$smarty)
{
	if(empty($params['key']))  {
	    $smarty->trigger_error("dotb_fetch: missing 'key' parameter");
	    return;
	}    
    if(empty($params['object'])) {
	    $smarty->trigger_error("dotb_fetch: missing 'object' parameter");
	    return;        
    }

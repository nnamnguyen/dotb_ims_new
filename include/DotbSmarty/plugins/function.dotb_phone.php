...
r36563 - 2008-06-11 10:36:05 -0700 (Wed, 11 Jun 2008) - jmertic - Bug 22877: Make a new wireless detail view and have the smarty dotb_phone plugin check for being in a mobile session; if true then format the phone number as a link in the form of "tel:1234567890" per RFC 3966.
Added:
- include/DotbFields/Fields/Phone/WirelessDetailView.tpl
Touched:
- include/DotbSmarty/plugins/function.dotb_phone.php
- include/DotbWireless/css/wireless.css
...
/**
 * Smarty {dotb_translate} function plugin
 *
 * Type:     function<br>
 * Name:     dotb_translate<br>
 * Purpose:  translates a label into the users current language
 *
 * @author Majed Itani {majed at dotbcrm.com
 * @param array
 * @param Smarty
 */
function smarty_function_dotb_phone($params, &$smarty)
{
	if (!isset($params['value'])){
		$smarty->trigger_error("dotb_phone: missing 'value' parameter");
		return '';
	}

...
r57851 - 2010-08-20 12:44:11 -0700 (Fri, 20 Aug 2010) - kjing - Author: Jenny Gonsalves <jenny@dotbcrm.com>
...
r30629 - 2007-12-26 08:01:12 -0800 (Wed, 26 Dec 2007) - clee - Changed DotbFieldText.php to automatically set the smarty modifier url2html to be true for DetailViews.  Changed function.dotbvar.php to check for this modifier and render the appropriate call to the smarty modifier.
Modified:
include/DotbFields/Text/DotbFieldText.php
include/DotbSmarty/plugins/function.dotbvar.php
...
/**
 * Smarty {dotbvar} function plugin
 *
 * Type:     function<br>
 * Name:     dotbvar<br>
 * Purpose:  creates a smarty variable from the parameters
 *
 * @author Wayne Pan {wayne at dotbcrm.com}
 * @param array
 * @param Smarty
 */

function smarty_function_dotbvar($params, &$smarty)
{
	if(empty($params['key']))  {
	    $smarty->trigger_error("dotbvar: missing 'key' parameter");
	    return;
	}

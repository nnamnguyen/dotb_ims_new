...
function smarty_function_dotbvar_connector($params, &$smarty) {
      
      $displayParams = $smarty->get_template_vars('displayParams');
      if(!isset($displayParams['module'])) {
         $smarty->trigger_error("dotbvar_connector: missing 'module' parameter");
         $GLOBALS['log']->error("dotbvar_connector: missing 'module' parameter");
         return;     	
      }

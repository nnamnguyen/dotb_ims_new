...
r33741 - 2008-04-03 11:03:29 -0700 (Thu, 03 Apr 2008) - bsoufflet - Change the smarty function : dotb_currency_format
Now you can specify decimals, round, convert, currency_symbol parameters in the listview defs.

r33739 - 2008-04-03 10:58:52 -0700 (Thu, 03 Apr 2008) - bsoufflet - Change the smarty function : dotb
...
/**
 * Smarty {dotb_currency_format} function plugin
 *
 * Type:     function<br>
 * Name:     dotb_currency_format<br>
 ...
 * @param Smarty
 */
function smarty_function_dotb_currency_format($params, &$smarty) {

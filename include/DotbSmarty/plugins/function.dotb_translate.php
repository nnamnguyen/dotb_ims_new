...
r58597 - 2010-10-20 11:40:04 -0700 (Wed, 20 Oct 2010) - engsvnbuild - Author: Jenny Gonsalves <jenny@dotbcrm.com>
    Revert "Merge branch 'RC2'"

r58596 - 2010-10-20 09:50:45 -0700 (Wed, 20 Oct 2010) - engsvnbuild - Merge: a813190 e0a061b
Author: Jenny Gonsalves <jenny@dotbcrm.com>
    Merge branch 'RC2'
 ...
 * @param Smarty
 */
function smarty_function_dotb_translate($params, &$smarty)
{
	if (!isset($params['label'])){
		$smarty->trigger_error("dotb_translate: missing 'label' parameter");
		return '';
	}

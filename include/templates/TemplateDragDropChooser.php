   ...
   */
    ...
    function displayDefinitionScript() {
        ...
        <script>
           ...
           var " . $this->args['classname'] . "_dotb_grid2, " . $this->args['classname'] . "_dotb_grid1, " . $this->args['classname'] . "_dotb_grid0;
	    ...
	    $j_str .=   "
            ...
            while($count<$this->args['gridcount']+1){
                ...
                // set strings to sortable if it is DOTB_GRID_grid0
                if( $count == 0 )  {
                ...
                {$this->args['classname']}_grid$count = new YAHOO.DOTB.DragDropTable(
                ...
                $j_str .= "
                {$this->args['classname']}_dotb_grid$count = {$this->args['classname']}_grid$count;";

...
/**
 * The DotbFieldTag handles the tag field
 */
class DotbFieldTag extends DotbFieldRelatecollection
{
    public function __construct($type)
    {
        // fetching tags is implemented in apiFormatField(), so the second query is not really needed,
        // but this attribute is required to prevent the relationship table from being joined to DotbQuery
     ...
     *
     * @param DotbBean - The Bean from which the Tags need to be disassociated
     ...
     *
     * @param DotbBean - The Bean to which the Tags need to be associated
     ...
     *
     * @param DotbBean $bean The DotbBean that you are getting a value of
     * @param string $field The field to get a normal value from
     * @return Array
     */
    public function getTagValues(DotbBean $bean, $field)
    {
     ...
     *
     * @param DotbBean $bean The bean to get the values from

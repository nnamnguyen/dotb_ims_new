...
class EmailDotbFieldTeamsetCollection extends ViewDotbFieldTeamsetCollection {
    ...
    public function __construct($bean, $field_defs, $customMethod = '', $form_name = 'EditView')
    {
    	...
    	$this->tpl_path = DotbAutoLoader::existingCustomOne('include/DotbFields/Fields/Teamset/TeamsetCollectionEmailView.tpl');

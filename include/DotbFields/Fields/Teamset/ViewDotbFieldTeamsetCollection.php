...
class ViewDotbFieldTeamsetCollection extends ViewDotbFieldCollection {
     ...
     * display
     *
     * Overrides the display method from ViewDotbFieldCollection to simply invoke Smarty instance
    ...
    function setup() {
            ...
            if (file_exists($GLOBALS['beanFiles'][$class])) {
                ...
                if (!empty($this->bean->team_set_id)) {
                    ...
                    {
                        $teams = DotbFieldTeamset::getTeamsFromRequest($this->bean->{$this->value_name}['role_field'], $_POST);
                        $primary_id = DotbFieldTeamset::getPrimaryTeamidFromRequest($this->bean->{$this->value_name}['role_field'], $_POST);
                        $selectedIds = DotbFieldTeamset::getSelectedTeamIdsFromRequest(

...
/**
 * ReportsDotbFieldTeamsetCollection.php
 * This class handles rendering the team widget for the Reports module.
 * 
 */

class ReportsDotbFieldTeamsetCollection extends ViewDotbFieldTeamsetCollection {
    ...
    function init_tpl() {
        ...
        $this->tpl_path = 'include/DotbFields/Fields/Teamset/TeamsetCollectionEditView.tpl'; 

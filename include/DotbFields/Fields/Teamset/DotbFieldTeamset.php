 ...
 * the include/DotbFields/Fields/DotbFieldTeamset/Teamset.tpl file which in turn
 * calls this file.  When the plugin function is run (see include/DotbSmarty/plugins/function.dotbvar_teamset.php),
 * it will call DotbFieldTeamset's render method.  From there, the corresponding method is invoked.
 *
 ...
 *
 */
class DotbFieldTeamset extends DotbFieldBase {
	...
	//reference to the ViewDotbFieldTeamsetCollection instance
	var $view = null;
	 ...
	 * render
	 *
	 * This method is called from function.dotbvar_teamset.php and determines which view to output
    ...
    function initialize() {
		...
		$this->view = new ViewDotbFieldTeamsetCollection();
	 ...
	 * getClassicView
	 *
	 * @param $field Array of the DotbBean's field definitions
	...
	/**
	 * getDetailViewSmarty
	 * Override for the DotbFieldCollection class to set the vardef name from team_name to team_set_id
	 */
	...
	function getMassUpdateViewSmarty($parentFieldArray, $vardef, $displayParams, $tabindex, $searchView = false) {
		...
		$this->view = new MassUpdateDotbFieldTeamsetCollection();
     ...
     *
     * @overrides DotbFieldBase::runSecondaryQuery
     */

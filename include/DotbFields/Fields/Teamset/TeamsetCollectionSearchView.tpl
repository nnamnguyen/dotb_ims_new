...
<link rel="stylesheet" type="text/css" href="{dotb_getjspath file='include/javascript/yui/build/container/assets/container.css'}" />
...
<!-- BEGIN Remove and Radio -->
        ...
        <td valign='top' align="center" class="teamset-row">
            ...
            <input id="primary_{$vardef.name}_collection_0" name="primary_{$vardef.name}_collection" type="radio" class="radio" value="0" title="{dotb_translate label='LBL_TEAM_SELECT_AS_PRIM_TITLE'}" onclick="collection['{$displayParams.formName}_{$vardef.name}'].changePrimary(true);" />
            </span>
        </td>
        {if $isTBAEnabled}
            <td valign='top' align='center' class="teamset-row">
                ...
                <input id="selected_{$vardef.name}_collection_0" name="selected_{$vardef.name}_collection_0"
                       ...
                       title="{dotb_translate label='LBL_TEAM_SELECT_AS_TBSELECTED_TITLE'}"/>
                </span>
            </td>
        {/if}

...
class DotbFieldEmail extends DotbFieldBase
{
    ...
    public function apiSave(DotbBean $bean, array $params, $field, $properties)
    {
        ...
        $emailOptoutDefault = !empty($GLOBALS['dotb_config']['new_email_addresses_opted_out']);
        ...
        foreach ($params[$field] as $email ) {
            ...
            if (!DotbEmailAddress::isValidEmail($email['email_address'])) {
                throw new DotbApiExceptionInvalidParameter("{$email['email_address']} is an invalid email address");
            }
        ...
        // Here is a hack for DotbEmailAddress.php so it doesn't attempt a legacy save

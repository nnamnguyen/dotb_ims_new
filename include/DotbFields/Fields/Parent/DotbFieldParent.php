...
class DotbFieldParent extends DotbFieldRelate {
     ...
     */
    protected function formatParentField(DotbBean $bean, array &$data, $fieldName, ServiceBase $service)
    {
        if ($bean->parent_type && $bean->parent_id) {
            ...
            // make sure fetched row is populated as DotbACLStatic::beanACL() may use it

...
class DotbFieldRelate extends DotbFieldBase {
    ...
    /**
     * @see DotbFieldBase::getEditViewSmarty()
     */
    ...
    public function apiFormatField(
        ...
        if (!empty($rbean)) {
            ...
            if(!empty($rdefs) && !empty($rdefs['type'])) {
                ...
                $field = $sfh->getDotbField($rdefs['type']);
                $rdata = array();
     ...
     */
    protected function formatRelateField(DotbBean $bean, array &$data, $fieldName, $properties, ServiceBase $service)
    {

...
/**
 * This array define the default value to use for the dotbpdf settings.
 * The order is DB (user or system) -> custom dotbpdf_default -> OOB dotbpdf_default
 */
$dotbpdf_default = array(
    ...
    "K_PATH_CACHE"=> dotb_cached("vendor/tcpdf/"),
    "K_PATH_URL_CACHE"=> dotb_cached("vendor/tcpdf/"),
    ...
    "PDF_CREATOR"=>"DotBCRM",
    "PDF_AUTHOR"=>"DotBCRM",
    "PDF_HEADER_TITLE"=>"DotBCRM",
    "PDF_HEADER_STRING"=>"TCPDF for DotBCRM",

<?php
    ...
    function prepare_string($string){
     ...
     /**
     * Copy of format_number() from currency with fix for dotbpdf.
     * @return String formatted currency value
     * @see modules/Currencies/Currency.php
     */
    function format_number_dotbpdf($amount, $round = null, $decimals = null, $params = array()) {
        ...
        if(!empty($params['currency_symbol']) && $params['currency_symbol']) {
            ...
            elseif(!empty($params['type']) && $params['type'] == 'dotbpdf') {

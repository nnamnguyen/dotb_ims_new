...
class IBMDB2Manager  extends DBManager
{
	...
	protected $capabilities = array(
         ...
         * dotb will add an additional id column in the ORDER BY clause to
...
WHERE TABSCHEMA = ?
		...
		if (!$this->database) {
			...
			if($this->database  && $persistConnection){
				$_SESSION['administrator_error'] = "<b>Severe Performance Degradation: Persistent Database Connections "
					. "not working.  Please set \$dotb_config['dbconfigoption']['persistent'] to false "
	...
	* @see DBManager::convert()
	 ...
	 * For a list of the actual third party software used in this Dotb product,
	 * please visit http://support.dotbcrm.com/06_Customer_Center/11_Third_Party_Software/.
	 *

...
class MysqliManager extends MysqlManager
{
    ...
    */
    protected function setupConnectOptions(array $configOptions = null)
    {
        if (is_null($configOptions)) {
            $this->connectOptions = DotbConfig::getInstance()->get('dbconfig');
        } else {
    ...
    * Add by Lap Nguyen
    */
    public function fetchArray($sql = null, $resultType = MYSQLI_ASSOC, $dieOnError = false, $msg = '', $suppress = false, $keepResult = false) {
        $data = array();

...
abstract class MysqlManager extends DBManager
{
    ...
    */
    ...
    protected $capabilities = array(
        ...
        "order_stability" => true,    //Add by Lap Nguyen
    );
    ...
    *
    * @param  object $bean DotbBean instance
    * @return string
    */
    ...
    * Add by Lap Nguyen
    */
    public function fetchArray($sql = null, $resultType = '', $dieOnError = false, $msg = '', $suppress = false, $keepResult = false) {
        $data = array();

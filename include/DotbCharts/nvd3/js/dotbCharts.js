...
function loadDotbChart(chartId, jsonFilename, css, chartConfig, chartParams, callback) {
    ...
    var params = _.extend({
        ...
        stacked: true,
        label: '',
        reportName: DOTB.charts.translateString('LBL_DASHLET_SAVED_REPORTS_CHART'),
        module: 'Home',
        colorData: 'default',
    ...
    switch (chartConfig['chartType']) {
        ...
        case 'paretoChart':
            DOTB.charts.get(jsonFilename, params, function(data) {
                ...
                if (DOTB.charts.isDataEmpty(data)) {

                    var json = DOTB.charts.translateParetoDataToD3(data, params, chartConfig);
                    ...
                    var paretoChart = nv.models.paretoChart()
                        ...
                        .tooltipBar(function(key, x, y, e, graph) {
                            ...
                            return '<p>' + DOTB.charts.translateString('LBL_SALES_STAGE', 'Forecasts') + ': <b>' + key + '</b></p>' +
                                   '<p>' + DOTB.charts.translateString('LBL_AMOUNT', 'Forecasts') + ': <b>' + val + '</b></p>' +
                                   '<p>' + DOTB.charts.translateString('LBL_PERCENT', 'Forecasts') + ': <b>' + x + '%</b></p>';
                        })
                        .showControls(false)
                        .colorData('default')
                        .colorFill('default')
                        ...
                        .strings({
                            legend: {
                                close: DOTB.charts.translateString('LBL_CHART_LEGEND_CLOSE'),
                                open: DOTB.charts.translateString('LBL_CHART_LEGEND_OPEN'),
                                noText: DOTB.charts.translateString('LBL_CHART_UNDEFINED')
                            },
                            noData: DOTB.charts.translateString('LBL_CHART_NO_DATA')
                        });
                    ...
                    var completeCallback = function() {
                        DOTB.charts.renderChart(chartId, paretoChart, json);
                        d3.select('#' + d3ChartId)
                    ...
                    if (chartConfig['ReportModule']) {
                        ...
                        DOTB.charts.trackWindowResize(paretoChart);

                        if (chartConfig['imageExportType']) {
                            DOTB.charts.saveImageFile(chartId, paretoChart, json, jsonFilename, chartConfig['imageExportType'], completeCallback);
                        } else {
                            DOTB.charts.renderChart(chartId, paretoChart, json);
                        }
                    } else {
                    ...
                    DOTB.charts.callback(callback, paretoChart);
                }
            });
            break;
        ...
        case 'barChart':
            DOTB.charts.get(jsonFilename, params, function(data) {
                ...
                if (DOTB.charts.isDataEmpty(data)) {
                    ...
                    var json = DOTB.charts.translateDataToD3(data, params, chartConfig);

                    if (json.properties && json.properties.labels && json.properties.labels.length > 50) {
                        DOTB.charts.renderError(chartId, DOTB.charts.translateString('LBL_CANNOT_DISPLAY_CHART_MESSAGE', 'Reports'));
                        return;
                    }
                    ...
                    if (chartConfig['ReportModule']) {
                        ...
                        if (chartConfig['imageExportType']) {
                            DOTB.charts.saveImageFile(chartId, barChart, json, jsonFilename, chartConfig['imageExportType']);
                        } else {
                    ...
                    DOTB.charts.callback(callback, barChart);
                }
            });
            break;
            ...
            DOTB.charts.get(jsonFilename, params, function(data) {
                ...
                if (DOTB.charts.isDataEmpty(data)) {
                    ...
                    if (chartConfig['ReportModule']) {
                        ...
                        if (chartConfig['imageExportType']) {
                            DOTB.charts.saveImageFile(chartId, lineChart, json, jsonFilename, chartConfig['imageExportType']);
                        } else {
                    ...
                    DOTB.charts.callback(callback, lineChart);
                }
            });
            break;
            ...
            DOTB.charts.get(jsonFilename, params, function(data) {
                if (DOTB.charts.isDataEmpty(data)) {
                    ...
                    if (chartConfig['ReportModule']) {
                        ...
                        if (chartConfig['imageExportType']) {
                            DOTB.charts.saveImageFile(chartId, pieChart, json, jsonFilename, chartConfig['imageExportType']);
                        } else {
                    ...
                    DOTB.charts.callback(callback, pieChart);
                }
            });
            break;
            ...
            DOTB.charts.get(jsonFilename, params, function(data) {
                if (DOTB.charts.isDataEmpty(data)) {
                    ...
                    if (chartConfig['ReportModule']) {
                        ...
                        if (chartConfig['imageExportType']) {
                            DOTB.charts.saveImageFile(chartId, funnelChart, json, jsonFilename, chartConfig['imageExportType']);
                        } else {
                    ...
                    DOTB.charts.callback(callback, funnelChart);
                }
            });
            break;
        ...
        case 'gaugeChart':
            DOTB.charts.get(jsonFilename, params, function(data) {
                ...
                if (DOTB.charts.isDataEmpty(data)) {
                    json = DOTB.charts.translateDataToD3(data, params, chartConfig);
                    ...
                    if (chartConfig['ReportModule']) {
                        ...
                        if (chartConfig['imageExportType']) {
                            DOTB.charts.saveImageFile(chartId, gaugeChart, json, jsonFilename, chartConfig['imageExportType']);
                        } else {
                    ...
                    DOTB.charts.callback(callback, gaugeChart);
                }
            });
            break;
    }
...
function swapChart(chartId, jsonFilename, css, chartConfig) {
    $('#d3_' + chartId).empty();
    var chart = new loadDotbChart(chartId, jsonFilename, css, chartConfig);
    return chart;
}
...
(function($) {
    ...
    DOTB.charts = {
        ...
        translateDataToD3: function(json, params, chartConfig) {
            ...
            var strUndefined = DOTB.charts.translateString('LBL_CHART_UNDEFINED');

...
$app_strings = array(
    ...
    'LBL_COPYRIGHT' => 'Copyright © 2004-2018 DotBCRM Inc. All Rights Reserved.',
    'LBL_TRADEMARK' => 'DotBCRM, Dotb and the 3-D Cube are registered trademarks of DotBCRM Inc. ' .
        'All other company and product names used or appearing in this product may be trademarks of the ' .
        'respective companies with which they are associated.',
    'LBL_TRADEMARK2' => 'DotBCRM ®, Dotb Enterprise™ and Dotb™ are trademarks of DotBCRM Inc.',
    ...
    'LBL_VIEWINLINE' => 'View',
    'LBL_INFOINLINE' => 'Info',
    'LBL_POWERED_BY_DOTBCRM' => "Powered by DotBCRM",
    'LBL_PRINT' => "Print",
    'LBL_HELP' => "Help",
    'LBL_TOUR' => "Tour",
    ...
    'LBL_EMAIL_ATTACHMENTS2' => 'From Dotb Documents',
    ...
    'LBL_EMAIL_MENU_HELP_ARCHIVE' => 'Archive these email(s) to DotBCRM',
    ...
    'ERR_DISABLED_FOR_IDM_MODE' => "This option is disabled in DotBCRM for IDM mode and available in Settings.",
    ...
    'ERR_POTENTIAL_SEGFAULT' => 'A potential Apache segmentation fault was detected.  Please notify your system administrator to confirm this problem and have her/him report it to DotBCRM.',
    ...
    'EXCEPTION_MAINTENANCE' => 'DotBCRM is in maintenance mode. Only admins can login. Please contact your administrator for details.',
    ...
    'EXCEPTION_MAINTENANCE_DESC' => 'The instance of DotBCRM that is serving the API is in maintenance mode. Access to the API is restricted to administrators only.',
    ...
    'LBL_BROWSER_TITLE' => 'DotBCRM - Commercial Open Source CRM',
    ...
    // The following version of LBL_DOTB_COPYRIGHT is for Professional and Enterprise editions.

    'LBL_DOTB_COPYRIGHT_SUB' =>
        '&copy; 2004-2018 <a href="http://www.dotbcrm.com" target="_blank" class="copyRightLink">DotBCRM Inc.</a> ' .
        'All Rights Reserved.<br />DotBCRM, Dotb and the 3-D Cube are registered trademarks of DotBCRM Inc. ' .
        'All other company and product names used or appearing in this product may be trademarks of the ' .
        'respective companies with which they are associated.',
    ...
    'NTC_SUPPORT_DOTBCRM' => 'Support the DotBCRM open source project with a donation through PayPal - it\'s fast, free and secure!',
    'NTC_TIME_FORMAT' => '(24:00)',
    'NTC_WELCOME' => 'Welcome',
    'NTC_YEAR_FORMAT' => '(yyyy)',
    'LOGIN_LOGO_ERROR' => 'Please replace the DotBCRM logos.',
    'FATAL_LICENSE_ALTERED' => "Your license has been altered since the last time it was validated.",
    'ERROR_FULLY_EXPIRED' => "Your company's license for DotBCRM has expired for more than 7 days and needs to be brought up to date. Only admins may login.",
    'ERROR_LICENSE_EXPIRED' => "Your company's license for DotBCRM needs to be updated. Only admins may login.",
    'WARN_LICENSE_EXPIRED' => "Your company's license for DotBCRM will expire soon.",
    'ERROR_LICENSE_VALIDATION' => "Your company's license for DotBCRM needs to be validated. Only admins may login.",
    'WARN_LICENSE_VALIDATION' => "Your company's license for DotBCRM needs to be validated soon.",
    ...
    'LBL_LEARNING_RESOURCES_DOTB_UNIVERSITY_LINK' => 'Dotb University - Become an expert',
    ...
    'LBL_PLUGIN_WORD_DESC' => 'Automatically populate information from DotBCRM into form letters, direct mail and other Microsoft documents.',
    ...
    'LBL_PLUGINS_DESC' => 'Read about the plug-in features within the <a href="https://www.dotbcrm.com/crm/support/documentation/DotbPlugIns">Plug-ins Documentation</a>.',
    ...
    'LBL_TOUR_CALENDAR_URL_1' => 'Do you share your DotBCRM calendar with 3rd party applications, such as Microsoft Outlook or Exchange? If so, you have a new URL. This new, more secure URL includes a personal key which will prevent unauthorized publishing of your calendar.',
    ...
    'LBL_TOUR_INTRO' => '<h4>Welcome to Dotb</h4> We\'d like to walk you through some of the features.  Use the < and > arrows on the bottom of the screen to take a tour.<ul class="resource-list"><li class="resource"><a href="http://support.dotbcrm.com/02_Documentation/01_Dotb_Editions/" target="_blank"><span class="label label-module label-module-md pull-left blue"><i class="fa fa-2x fa-magic"></i></span></a><div class="resource-info"><a href="http://support.dotbcrm.com/02_Documentation/01_Dotb_Editions/" target="_blank">What\'s New</a><p class="details">Find out the key changes between releases.</p></div></li><li class="resource"><a href="http://university.dotbcrm.com/" target="_blank"><span class="label label-module label-module-md pull-left green"><i class="fa fa-2x fa-book"></i></span></a><div class="resource-info"><a href="http://university.dotbcrm.com/" target="_blank">Find out more about Dotb</a><p class="details">A robust library of eLearning, live and virtual classroom training, webinars and video tutorials.</p></div></li><li class="resource"><a href="http://support.dotbcrm.com/" target="_blank"><span class="label label-module label-module-md pull-left red"><i class="fa fa-2x fa-question-circle"></i></span></a><div class="resource-info"><a href="http://support.dotbcrm.com/" target="_blank">Get Support</a><p class="details">Need help, have a issue or want to suggest how to make Dotb better?</p></div></li></ul>',
    ...
    'ERR_HTTP_400_TEXT_LINE2' => 'Please contact your Dotb Administrator for more details.',
    ...
    'ERR_HTTP_404_TEXT_LINE2' => 'Please try again. If the error persists, please contact your Dotb Administrator.',
    ...
    'ERR_HTTP_500_TEXT_LINE2' => 'Please try again. If the error persists, please contact your Dotb Administrator.',
    ...
    'ERR_HTTP_502_TEXT_LINE2' => 'Please try again. If the error persists, please contact your Dotb Administrator.',
    ...
    'ERR_HTTP_503_TEXT_LINE2' => 'Please try again later. If the error persists, please contact your Dotb Administrator.',
    ...
    // shortcut keys help
    'LBL_SHORTCUT_KEYS_HELP_ABOUT' => 'DotBCRM enables power users to quickly perform certain tasks with keyboard shortcuts to increase productivity. The tables on the right describe available shortcuts along with the keys and the actions they perform.',
    ...
    'LBL_HELP' => 'Help',
    'NTC_VOID_RECEIPT_CONFIRMATION_FORMATTED' => 'Do you want void receipt?',
    'NTC_VOID_RECEIPT_SUCCESS' => 'Void receipt successfull!',
    'NTC_REMOVE_PRODUCT_CONFIRMATION_FORMATTED' => 'Do you want remove this?',
);
...
$app_list_strings ['documentation'] = array(
    ...
    'ENT' => '02_Dotb_Enterprise',
    'CORP' => '03_Dotb_Corporate',
    'PRO' => '04_Dotb_Professional',
);

...
class RestRequest
{
     ...
     * sample accept header: application/vnd.dotbcrm.core+json; version=11.3
     */
    const ACCEPT_HEADER_VERSION_PATTERN =
        '/^application\/vnd\.dotbcrm\.core(\+?(xml|json))?\s*\;\s*version=([^;,\s]+)/';
     ...
     * @return string
     * @throws DotbApiExceptionIncorrectVersion
     */
    ...
    public function getRawPath() {
        if ( !empty($this->request['__dotb_url']) ) {
            $rawPath = $this->request['__dotb_url'];
     ...
     * valid formats:
     * application/vnd.dotbcrm.mobile+json; version=11
     * application/vnd.dotbcrm.base; version=99            // requested format is optional
     * application/vnd.dotbcrm.base+xml; version=99
     * application/vnd.dotbcrm.base+xml; version=12.2
     *
     * invalid format:
     * application/vnd.dotbcrm.mobile+json; version=11.123   // minor version is 3 digits
     * application/vnd.dotbcrm.base; version=111           // major version is not 2-digit
     *
    ...
    {
        if (empty($version)) {
            throw new DotbApiExceptionIncorrectVersion("missing version!");
        }
        ...
        if (isset($this->request['__dotb_url'])
        ...
        $siteUrl = DotbConfig::getInstance()->get('site_url');

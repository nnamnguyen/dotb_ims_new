...
class ConnectorManager
{
    ...
    public function getUserConnectors()
    {
        ...
        $cacheFile = dotb_cached('api/metadata/connectors.php');
    ...
    public function putConnectorCache($data)
    {
        ...
        mkdir_recursive(dotb_cached($cacheDir));
        ...
        // for this file
        dotb_file_put_contents_atomic($cacheFile, $write);
    ...
    {
        $hashes = array();
        $path = dotb_cached("api/metadata/connectorHashes.php");
        @include($path);
        $hashes[$key] = $hash;

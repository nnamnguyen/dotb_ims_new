    ...
    public function __construct($focus, $module, $type = 0)
    {
 	...
 	function build(){
        ...
        if (file_exists('modules/'.$this->module.'/ListView.html')) {
 		    ...
 		    $metadataFile = DotbAutoLoader::loadWithMetafiles($this->module, 'listviewdefs');
            if($metadataFile) {
 		        require $metadataFile;
            }

			DotbACL::listFilter($this->module, $listViewDefs[ $this->module], array("owner_override" => true));

...
class ListViewSmarty extends ListViewDisplay{
	...
	function display($end = true) {
        ...
        global $app_strings, $dotb_version, $dotb_flavor, $server_unique_key, $currentModule, $app_list_strings, $dotb_config;
        ...
        $this->ss->assign('dotb_info', array("dotb_version" => $dotb_version, 
											  "dotb_flavor" => $dotb_flavor));
        ...
        // Default is true
        $displayEmptyDataMessages = !isset($dotb_config['display_empty_data_messages']) || !empty($dotb_config['display_empty_data_messages']);

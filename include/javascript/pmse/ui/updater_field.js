 ...
 * for handling variables in dotb
 * @param {String} module
 */
 ...
 * of the dotb variables, change the panel z-index to show correctly,
...
UpdaterItem.prototype._createConfigButton = function () {
    ...
    button.setAttribute('data-original-title', App.lang.get('LBL_DOTB_FIELD_SELECTOR', 'pmse_Emails_Templates'));
...
TeamUpdaterItem.prototype._getSearchFunction = function () {
    return _.debounce(function (queryObject) {
        var proxy = new DotbProxy(), term = queryObject.term,
            resultsPerPage = 5;

...
/*global AdamShape, jCore, $, AdamActivityContainerBehavior, AdamActivityResizeBehavior,
 ...
 AdamShapeMarkerCommand, AdamShapeLayerCommand, RestProxy, DOTB_URL, PMSE.Window, PMSE_DESIGNER_FORM_TRANSLATIONS,
...
var AdamActivity = function (options) {
    ...
    /**
     * Activity Type
     * Values accepted for DotBCRM Module: TASK
     * @type {String}
     */
    this.act_type = null;
    /**
     ...
     * For DotBCRM module only support: USERTASK
     * @type {String}
     */
                                ...
                                updater_field.proxy.getData({base_module: PROJECT_MODULE}, {
                                    ...
                                    error: function(dotbHttpError) {
                                        ...
                                        App.alert.show(this.proxyErrorKey, {
                                            level: 'error',
                                            messages: dotbHttpError.errorThrown + ': ' + dotbHttpError.message
                                        });
                                        w.close();
                                    }
                                });

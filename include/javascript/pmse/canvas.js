...
/*global jCore, $, HiddenField, TextareaField, TextField, ItemMatrixField,
 PROJECT_LOCKED_VARIABLES, DOTB_URL, RestProxy, ComboboxField, adamUID,
...
AdamCanvas.prototype.getContextMenu = function () {
    ...
    criteriaField = new CriteriaField({
        ...
        fieldWidth: 414,
        fieldHeight: 80,
        decimalSeparator: DOTB.App.config.defaultDecimalSeparator,
        numberGroupingSeparator: DOTB.App.config.defaultNumberGroupingSeparator,
    ...
    proxyConfirm = new DotbProxy({
        url: 'pmse_Project/CrmData/putData/' + adamUID,
        //restClient: this.canvas.project.restClient,
        uid: adamUID,
        callback: null
    });
    //proxyConfirm.restClient.setRestfulBehavior(DOTB_REST);
    //if (!DOTB_REST) {
    //    proxyConfirm.restClient.setBackupAjaxUrl(DOTB_AJAX_URL);
    //}

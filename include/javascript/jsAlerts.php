...
EOQ;
		$this->addActivities();
		if(!empty($GLOBALS['dotb_config']['enable_timeout_alerts'])){
	...
	function addActivities(){
		...
		if(isset($dotb_config['meeting_integration']) && !empty($dotb_config['meeting_integration'])) {
			if(!class_exists($dotb_config['meeting_integration'])) {
				require_once("modules/{$dotb_config['meeting_integration']}/{$dotb_config['meeting_integration']}.php");
			}
			$meetingIntegration = new $dotb_config['meeting_integration']();
		}

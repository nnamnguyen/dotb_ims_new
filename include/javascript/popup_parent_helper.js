...
{
	return JSON.stringify(window.document.popup_request_data);
}
...
function set_return_and_save_targetlist(popup_reply_data)
{
	...
	for (var the_key in name_to_value_array)
	{
		...
		else
		{
            ...
            DOTB.util.callOnChangeListers(window.document.forms[form_index].elements[get_element_index(form_index,the_key)]);
		}
	}

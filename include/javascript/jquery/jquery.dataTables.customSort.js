(function($){
    ...
    $.fn.dataTableExt.afnSortData['dom-number'] = function  ( oSettings, iColumn, jColumn )
    {
        ...
        $('td:eq('+jColumn+') span[sfuuid]', oSettings.oApi._fnGetTrNodes(oSettings) ).each( function () {
            ...
            aData.push(DOTB.App.currency.unformatAmount(sortString, DOTB.App.user.getPreference('number_grouping_separator'), DOTB.App.user.getPreference('decimal_separator'), false));
        });
        return aData;
    }
})(jQuery);

...
(function(app) {
    app.events.on("app:init", function() {
        ...
        app.utils = _.extend(app.utils, {
            ...
            /**
             * Builds a route for module in either bwc or new lumia.
             *
             ...
             * it will force lumia, if not defined, will use metadata
             ...
             * DotbEmailAddress::getPrimaryAddress().
             *
             * @param {Data.Bean} model
             * @return {string}
             */
            ...
            /**
             * Javascript equivalent to the Dotb `isTruthy` utility function.
             *
             * @param {string|boolean} value The value to test.
             * @return {boolean} `true` if the value to test is roughly
             *   equivalent to `true` (in a Dotb context).
             */

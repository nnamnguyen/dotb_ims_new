...
(function(app) {
    ...
    var Bwc = {
        ...
        /**
         * Logs into dotb in BWC mode. Allows for use of current OAuth token as
                ...
                success: function(data) {
                    ...
                    if (redirectUrl) {
                        ...
                        if (redirectUrl.indexOf('&bwcRedirect=1') > -1) {
                            //Add fix bug login by Lap Nguyen
                            redirectUrl = redirectUrl.replace(/&bwcRedirect=1/g, '');
                        }
        ...
        shareRecord: function(module, id, name) {
            ...
            if (shareField.useDotbEmailClient()) {
                shareField.shareWithDotbEmailClient();
            } else {
         ...
         * Also, reworking Smarty dotb_button function code has its own set of challenges.
         *
         * @param mailto
         * @private
         */

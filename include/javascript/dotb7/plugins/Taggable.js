...
(function (app) {
    ...
    app.events.on("app:init", function () {
        var tagTemplate = Handlebars.compile('<span class="label label-{{module}} dotb_tag"><a href="#{{buildRoute module=module id=id}}">{{name}}</a></span>'),
            tagInEditTemplate = Handlebars.compile('<span class="label label-{{module}} dotb_tag" contenteditable="false"><a>{{name}}</a></span>'),
            ...
            taggingHtml = '<span class="dotb_tagging">&nbsp;</span>',
        ...
        app.plugins.register('Taggable', ['view'], {
            ...
            onAttach: function(component, plugin) {
                ...
                $(document).on('click.' + component.cid, function(event) {
                    var $target = $(event.target),
                        ...
                        clickedOutsideTaggingSpan = !$target.hasClass('dotb_tagging');
            ...
            _onKeyup: function(event) {
                ...
                if (this._taggableEnabled) {
                    ...
                    if (selection.rangeCount > 0) {
                        ...
                        if (!$container.hasClass('dotb_tagging')) {
                            this._resetTaggable();
            ...
            _resetTaggable: function() {
                ...
                if (this._taggableEnabled) {
                    $taggingSpan = $taggable.find('.dotb_tagging');
            ...
            _insertTag: function(event) {
                var $selected = $(event.currentTarget),
                    ...
                    $tagToReplace = $taggable.find('.dotb_tagging'),
            ...
            _populateTagList: function(collection, searchTerm) {
                ...
                if (collection.length > 0) {
                    ...
                    currentSearchTerm = $.trim(this._getTaggableInput().find('.dotb_tagging').text());

...
(function (app) {
    ...
    app.events.on("app:init", function () {
        app.plugins.register('EmailClientLaunch', ['view', 'field'], {
            ...
            /**
             * If Dotb Email Client used, launch email compose drawer
             *
             * @param event
             */
            launchEmailClient: function(event) {
                ...
                if (this.useDotbEmailClient()) {
                    this.launchDotbEmailClient(this._retrieveEmailOptions($link));
                }
            },
             ...
             */
            launchDotbEmailClient: function(options) {
            ...
            /**
             * Has the user opted to use the Dotb Email Client
             *
             * @returns {boolean}
             */
            useDotbEmailClient: function() {
                var emailClientPreference = app.user.getPreference('email_client_preference');

                return (emailClientPreference && emailClientPreference.type === 'dotb' && app.acl.hasAccess('edit', 'Emails'));
            },
             ...
             * for users that use Dotb's email compose.
             *

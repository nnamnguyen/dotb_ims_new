...
DotbAutoLoader::requireWithCustom('include/tabConfig.php', true) ; // include custom/ too
...
class GroupedTabStructure
{
    ...
    * @param bool  if  we set this param true, the other group tab will be returned no matter  $dotb_config['other_group_tab_displayed'] is true or false
	 ...
	 */
    function get_tab_structure($modList = '', $patch = '', $ignoreDotbConfig=false, $labelAsKey=false)
    {

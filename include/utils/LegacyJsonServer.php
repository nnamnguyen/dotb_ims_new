...
{
    /**
     * Retrieve a simplified version of DotbBean - used in legacy/bwc code only
    ...
    public function retrieve($request_id, $params)
    {
        ...
        // to get a simplified version of the dotbbean
    ...
    {
        global $response, $dotb_config;
        $json = getJSONobj();

        // override query limits
        if ($dotb_config['list_max_entries_per_page'] < 31) {
            $dotb_config['list_max_entries_per_page'] = 31;
        }

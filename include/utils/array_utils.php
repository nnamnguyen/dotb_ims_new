 ...
 * @param array $original : original dotb_config array
 *
 * @return string : example - "\$dotb_config['a']['b']['c'][0] = 'hello';\n"
 */
 ...
 */
class DotbArray extends ArrayObject
{
    /**
     ...
     * array without instantiating a DotbArray
     *
     * NOTE: This should only used where refactoring an array into a DotbArray
     *       is unfeasible.  This operation is more expensive than a direct
     *       DotbArray as each time it creates and throws away a new instance
     *

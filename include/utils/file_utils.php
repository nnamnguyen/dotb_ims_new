...
function write_array_to_file( $the_name, $the_array, $the_file, $mode="w", $header='' )
{
    ...
    return dotb_file_put_contents_atomic($the_file, $the_string);
}
...
function write_encoded_file( $soap_result, $write_to_dir, $write_to_file="" )
{
    ...
    $fh = dotb_fopen( $write_to_file, "wb" );
 ...
 * used in DotbLogger.php
 * @param string $old_filename
 * @param string $new_filename
 */
function dotb_rename( $old_filename, $new_filename){

...
use Dotbcrm\Dotbcrm\Security\Subject\LogicHook as Subject;
...
class LogicHook{
	 ...
	 * If the bean is null, then we assume this call was not made from a DotbBean Object and
	 ...
	 * logic hook. If the bean is null, then we assume this call was not made from a DotbBean Object and
	 * therefore we do not pass it to the method call.
	 *
	 * @param array $hookArray
	 * @param string $event
...
// Remove Audit logic hook by Lap Nguyen

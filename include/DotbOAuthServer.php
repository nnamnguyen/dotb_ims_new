...
/**
 * Dotb OAuth provider implementation
 * @api
 */
class DotbOAuthServer
{
    /**
     * OAuth token
     * @var OAuthToken
    ...
    {
        return urlencode(rtrim($GLOBALS['dotb_config']['site_url'],'/')."/index.php?module=OAuthTokens&action=authorize");
    }

...
class DotbFieldExpression extends GenericExpression
{
    /**
     * @var DotbBean
     */
    ...
    function evaluate()
    {
        ...
        switch ($def['type']) {
            ...
            case 'datetimecombo':
                ...
                // bug 57900 - we might have a user-formatted timedate here converted from DotbBean::retrieve()
    ...
    protected function getLinkField($fieldName)
    {
        ...
        if (DotbBean::inOperation('delete')) {
    ...
    static function getJSEvaluate()
    {
        return <<<EOQ
			...
			return DOTB.forms.AssignmentHandler.getValue(varName);
EOQ;
    }

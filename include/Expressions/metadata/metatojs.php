...
/*	// mapping of generic type to function
	$func_map = array(
		'generic' => 'DOTB.forms.FormValidator.add',
		'alpha' => 'DOTB.forms.FormValidator.alpha',
		'numeric' => 'DOTB.forms.FormValidator.numeric',
		'alphanumeric' => 'DOTB.forms.FormValidator.alphanumeric',
		'email' => 'DOTB.forms.FormValidator.email',
		'phone' => 'DOTB.forms.FormValidator.phone',
		'date' => 'DOTB.forms.FormValidator.date',
		'time' => 'DOTB.forms.FormValidator.time',
		'binary' => 'DOTB.forms.FormValidator.binary',
		'isbefore' => 'DOTB.forms.FormValidator.isbefore',
	);*/

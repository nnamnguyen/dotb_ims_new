 ...
 *
 * DotbLogic Action to set a value to a field
 */
class SetValueAction extends AbstractAction
{
    ...
    {
        return <<<JS
		DOTB.forms.SetValueAction = function(target, valExpr) {
		...
		DOTB.util.extend(DOTB.forms.SetValueAction, DOTB.forms.AbstractAction, {
...
JS;
    ...
    {
        return "new DOTB.forms.SetValueAction('{$this->targetField}','" . addslashes($this->expression) . "')";
    }

...
class VisibilityAction extends AbstractAction
{
    ...
    static function getJavascriptClass()
    {
        return "
        var App = App || null;
        DOTB.forms.SetVisibilityAction = function(target, expr, view)
        {
            ...
            if (!DOTB.forms.SetVisibilityAction.initialized) {
                ...
                DOTB.forms.SetVisibilityAction.initialized = true;
            }
        }
         ...
         */
        DOTB.util.extend(DOTB.forms.SetVisibilityAction, DOTB.forms.AbstractAction, {
            ...
            exec: function(context) {
                ...
                try {
                    ...
                    if (DOTB.App) {
                        this.lumiaExec(context, target, hide);
                    }
                    else {
            ...
            lumiaExec : function(context, target, hide) {
                ...
                if (hide) {
                    ...
                    if (wasHidden) {
                        DOTB.forms.FlashField(target, null, this.target);
                    }
                    if (field.wasRequired === true) {
                ...
                if (row) {
                    this.checkRowLumia(row, inv_class);
                    this.checkPanelLumia(row.parentElement, inv_class, panel_class);
                }
            },
            ...
            checkRowLumia: function(el, inv_class) {
                if (!el || el.children) {
                    return;
                }
                var hide = true;
            ...
            checkPanelLumia: function(el, inv_class, panel_class) {
                if (!el || !el.children) {
                    return;
                }
    ...
    {
        return "new DOTB.forms.SetVisibilityAction('{$this->targetField}','{$this->expression}', '{$this->view}')";
    }

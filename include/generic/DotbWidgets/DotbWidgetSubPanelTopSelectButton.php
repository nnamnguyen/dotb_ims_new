...
class DotbWidgetSubPanelTopSelectButton extends DotbWidgetSubPanelTopButton
{
    ...
    public function display(array $widget_data, $additionalFormFields = array())
	{
         ...
         */
        if ( DotbWidget::isModuleHidden( $widget_data['module'] ) )
        {
            return '';
        }
		...
		$return_url = "index.php?module=$return_module&action=$return_action&subpanel=$subpanel_name&record=$return_id&dotb_body_only=1";

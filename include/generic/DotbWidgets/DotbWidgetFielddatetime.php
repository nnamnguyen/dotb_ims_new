<?php
    ...
    class DotbWidgetFieldDateTime extends DotbWidgetReportField
    {
        var $reporter;
        ...
        protected function expandDate($date, $end = false)
        {
            ...
            //Fix bug sometime Report run with Display Date - BY Lap Nguyen
            ...
            $date = $timedate->tzUser(new DotbDateTime());
         ...
         * @param DotbDateTime $begin Start DateTime object
         * @param DotbDateTime $end End DateTime object
         */

...
class DotbWidgetSubPanelTopScheduleCallButton extends DotbWidgetSubPanelTopButtonQuickCreate
{
    function &_get_form($defines, $additionalFormFields = null)
    {
        ...
        // Clicking Create from BWC subpanels for lumia should open lumia create view

<?php
    ...
    class DotbWidgetReportField extends DotbWidgetField
    {
        /**
        ...
        function displayHeaderCell($layout_def)
        {
            ...
            if(!in_array($layout_def['name'], array('description', 'account_description', 'source_description', 'status_description', 'to_addrs', 'cc_addrs', 'bcc_addrs', 'work_log', 'objective', 'resolution'))) {

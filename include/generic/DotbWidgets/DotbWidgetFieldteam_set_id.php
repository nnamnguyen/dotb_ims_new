...
class DotbWidgetFieldteam_set_id extends DotbWidgetReportField{
			...
			if(!empty($teams)){
				if(!empty($teams[0]['display_name'])){
	            	...
	            	if((! empty($_REQUEST['to_csv']))|| (! empty($_REQUEST['to_pdf']) )) {
                            ...
                            $result .= "&nbsp;<a href=\"#\" style='text-decoration:none;' id='more_feather' onclick=\"DOTB.utils.showHelpTips(this,'".$body."')\" >+</a>";
                    }

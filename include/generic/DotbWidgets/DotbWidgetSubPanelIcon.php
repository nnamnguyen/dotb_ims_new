...
class DotbWidgetSubPanelIcon extends DotbWidgetField
{
...
//add module image
		...
		$icon_img_html = DotbThemeRegistry::current()->getImage( $module . '', 'border="0"',null,null,'.gif',$app_list_strings['moduleList'][$module]);
		...
		if(!empty($layout_def['image2']) &&  !empty($layout_def['image2_ext_url_field'])){
            ...
            if ( !empty($imagePath) ) {
                $icon_img_html = DotbThemeRegistry::current()->getImage( $imagePath . '', 'border="0"',null,null,'.gif',$imagePath);
...
//if requested, add attachment icon.
		if(!empty($layout_def['image2']) && !empty($layout_def['image2_url_field'])){
			...
			$icon_img_html = DotbThemeRegistry::current()->getImage( $layout_def['image2'] . '', 'border="0"',null,null,'.gif',$layout_def['image2']);

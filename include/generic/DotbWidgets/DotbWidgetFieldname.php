<?php
    ...
    class DotbWidgetFieldName extends DotbWidgetFieldVarchar
    {
        ...
        public function displayList($layout_def)
        {
            ...
            global $dotb_config;
            if (isset ($dotb_config['enable_inline_reports_edit']) && $dotb_config['enable_inline_reports_edit'] && !empty($record)) {
                ...
                $str .= "</a>";
                if ($field_name == 'name')
                    $str .= "&nbsp;" .DotbThemeRegistry::current()->getImage("edit_inline","border='0' alt='Edit Layout' align='bottom' onClick='DOTB.reportsInlineEdit.inlineEdit(\"$div_id\",\"$value\",\"$module\",\"$record\",\"$field_name\",\"$field_type\");'");
                $str .= "</div>";
            }
            return $str;
        }
        ...
        function queryFilteris_not($layout_def)
        {
            ...
            return DotbWidgetFieldId::_get_column_select($layout_def)."<>"
            .$this->reporter->db->quoted($input_name0)."\n";
        }
        ...
        function queryFilterone_of($layout_def, $rename_columns = true)
        {
            ...
            if($rename_columns) { // this was a hack to get reports working, dotbwidgets should not be renaming $name!
                $layout_def['name'] = 'id';
                $layout_def['type'] = 'id';
            }
            $arr = array();
            ...
            return DotbWidgetFieldId::_get_column_select($layout_def)." IN (".$str.")\n";
        }
        // $rename_columns, if true then you're coming from reports
        function queryFilternot_one_of($layout_def, $rename_columns = true)
        {
            ...
            return DotbWidgetFieldId::_get_column_select($layout_def)." NOT IN (".$str.")\n";
        }
        ...
        public function queryGroupBy($layout_def)
        {
            if($layout_def['name'] == 'full_name') {
                ...
                $group_by =  DotbWidgetFieldId::_get_column_select($layout_def)."\n";
            } else {

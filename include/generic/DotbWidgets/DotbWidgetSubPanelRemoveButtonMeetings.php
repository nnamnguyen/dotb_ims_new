...
class DotbWidgetSubPanelRemoveButtonMeetings extends DotbWidgetField
{
    ...
    public function displayList($layout_def)
	{
		...
		$return_url = "index.php?module=$return_module&action=$return_action&subpanel=$subpanel&record=$return_id&dotb_body_only=1";

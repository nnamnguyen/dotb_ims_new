...
class DotbSystemInfo
{
    ...
    private function __construct()
    {
        ...
        $this->dotbConfig = $GLOBALS['dotb_config'];
        $this->settings = $this->getSettings();
    }

    /**
     * @return DotbSystemInfo
     */
    ...
    {
        $info = $this->getAppInfo();
        if(version_compare($info['dotb_version'], '7.2', '>')) {
    ...
    public function getEnvInfo()
    {
        ...
        $info['db_type'] = $this->dotbConfig['dbconfig']['db_type'];
    ...
    {
        $info = array();
        $dotb_db_version = $dotb_version = $dotb_flavor = '';
        require 'dotb_version.php';
        $info['dotb_db_version'] = $dotb_db_version;
        $info['dotb_version'] = $dotb_version;
        $info['dotb_flavor'] = $dotb_flavor;
        $info['auth_level'] = 0;
        return $info;
    }
    ...
    {
        return array('application_key' => $this->dotbConfig['unique_key']);
    }
    ...
    protected function getExcludeSystemUsersWhere($alias = 'users')
    {
        ...
        return ' ' . $aliasQuery . 'deleted = 0 AND ' . $aliasQuery . 'user_name NOT IN(\'DotbCRMSupport\', \'DotbCRMUpgradeUser\')';
    }

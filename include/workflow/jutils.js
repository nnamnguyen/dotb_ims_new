...
function confirm_selected_radio(radioObj) {
	var msg = DOTB.language.get('WorkFlow', 'LBL_SELECT_OPTION');
...
function confirm_value_present(target_field, message){
	var select_msg = DOTB.language.get('WorkFlow', 'LBL_SELECT_VALUE');
...
function check_specific_type(type){
	if(type=='rel_user' || type=='rel_user_custom'){
		var msg = DOTB.language.get('WorkFlow', 'LBL_SELECT_MODULE');
...
{
	var lbl_show = DOTB.language.get('WorkFlow', 'LBL_SHOW');
	var lbl_hide = DOTB.language.get('WorkFlow', 'LBL_HIDE');
	var show_img = "<img src='index.php?entryPoint=getImage&themeName="+DOTB.themes.theme_name+"&imageName=advanced_search.gif' width='8' height='8' alt='" + lbl_show + "' border='0'>";
	var hide_img = "<img src='index.php?entryPoint=getImage&themeName="+DOTB.themes.theme_name+"&imageName=basic_search.gif' width='8' height='8' alt='" + lbl_hide + "' border='0'>";
...
function safety_rel_filters(){
	var msg = DOTB.language.get('WorkFlow', 'LBL_SELECT_FILTER');

...
use Dotbcrm\Dotbcrm\Security\Subject\Workflow;
...
function process_workflow_actions(DotbBean $focus, array $action_array)
{
 ...
 * @param DotbBean $focus The primary bean
...
function clean_save_data($target_module, $action_array){
	global $app_list_strings;
		if (empty($app_list_strings)) {
			global $dotb_config;
			$app_list_strings = return_app_list_strings_language($dotb_config['default_language']);
		}

 ...
 * @deprecated
 */
class DotbSearchEngineMetadataHelper
{
    /**
    ...
    {
        $cachedResults = dotb_cache_retrieve(self::ENABLE_MODULE_CACHE_KEY);
        ...
        dotb_cache_put(self::ENABLE_MODULE_CACHE_KEY, $results, 0);
        return $results;
    ...
    public static function retrieveFtsEnabledFieldsPerModule($module)
    {
        ...
        $cacheResults = dotb_cache_retrieve($cacheKey);
    ...
    public static function clearCache()
    {
        ...
        foreach ($list as $modules) {
            foreach ($modules as $module) {
                ...
                dotb_cache_clear($cacheKey);
            }
        }

        // clear master list of enabled modules
        dotb_cache_clear(self::ENABLE_MODULE_CACHE_KEY);
    }
}

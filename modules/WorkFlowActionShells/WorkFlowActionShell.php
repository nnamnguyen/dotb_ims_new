...
class WorkFlowActionShell extends DotbBean {
	// Stored fields
	var $id;
	var $deleted;
	var $date_entered;
	...
	//Grab event
		...
		if(	$this->action_module == "Meetings" ||
			...
			$recipient_icon =  DotbThemeRegistry::current()->getImage('Users','align="absmiddle" border="0"',null,null,'.gif',$app_strings['LNK_REMOVE']);

...
class ProductTemplateTreeApi extends DotbApi
{
    ...
    public function getTemplateTree(ServiceBase $api, array $args)
    {
        ...
        $tree = [];
        $records = [];
        $max_num = $this->getDotbConfig()->get('list_max_entries_per_page', 20);
        $offset = -1;
        $total = 0;
        $max_limit = $this->getDotbConfig()->get('max_list_limit');
    ...
    /**
     * gets an instance of dotbconfig
     *
     * @return DotbConfig
     */

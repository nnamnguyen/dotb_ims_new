...
<tr valign='top'>
	...
	<td scope='row' align='left' width='10%'>
		{dotb_translate label='LBL_ORDER_BY_COLUMNS' module='SavedSearch'}
	...
	<td scope='row' width='10%'>
		{dotb_translate label='LBL_DIRECTION' module='SavedSearch'}
	</td>
	<td width='23%'>
...
<script>
	DOTB.savedViews.columnsMeta = {$columnsMeta};

...
DurationDependency.prototype.get_duration_text = function(){
	...
	d = format_part(d,DOTB.language.get('app_strings', (d > 1)?'LBL_DURATION_DAYS':'LBL_DURATION_DAY'));
	h = format_part(h,DOTB.language.get('app_strings', (h > 1)?'LBL_DURATION_HOURS':'LBL_DURATION_HOUR'));
	m = format_part(m,DOTB.language.get('app_strings', (m > 1)?'LBL_DURATION_MINUTES':'LBL_DURATION_MINUTE'));	

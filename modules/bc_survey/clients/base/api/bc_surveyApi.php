...
class bc_surveyApi extends ModuleApi {
    ...
    public function registerApiRest() {
        return array(
            ...
            'checkSMSTemplateForSurvey' => array(
                'reqType' => 'GET',
                'path' => array('bc_survey', 'checkSMSTemplateForSurvey'),
                'pathVars' => array('module', '', '', ''),
                'method' => 'checkSMSTemplateForSurvey',
                'shortHelp' => 'Check SMS Template Exist For Survey',
                'longHelp' => '',
            ),
            ...
            'disable_question' => array(
                'reqType' => 'GET',
                'path' => array('bc_survey', 'disable_question'),
                'pathVars' => array('', ''),
                'method' => 'disable_question',
                'shortHelp' => 'Disable Question from Survey',
                'longHelp' => '',
            ),
            'enable_question' => array(
                'reqType' => 'GET',
                'path' => array('bc_survey', 'enable_question'),
                'pathVars' => array('', ''),
                'method' => 'enable_question',
                'shortHelp' => 'UnDisable Question from Survey',
                'longHelp' => '',
            ),
            'dashlet_survey_question_chart' => array(
                'reqType' => 'POST',
                'path' => array('bc_survey', 'dashlet_survey_question_chart'),
                'pathVars' => array('', ''),
                'method' => 'dashlet_survey_question_chart',
                'shortHelp' => 'Survey question wise chart for Dashlet',
                'longHelp' => '',
            ),
            'survey_question_list' => array(
                'reqType' => 'GET',
                'path' => array('bc_survey', 'survey_question_list'),
                'pathVars' => array('', ''),
                'method' => 'survey_question_list',
                'shortHelp' => 'Get selected surveys questions for Chart settings for Dashlet',
                'longHelp' => '',
            ),
            'dashlet_survey_status_chart' => array(
                'reqType' => 'POST',
                'path' => array('bc_survey', 'dashlet_survey_status_chart'),
                'pathVars' => array('', ''),
                'method' => 'dashlet_survey_status_chart',
                'shortHelp' => 'Survey Status chart for Dashlet',
                'longHelp' => '',
            ),
            'dashlet_survey_send_status_chart' => array(
                'reqType' => 'POST',
                'path' => array('bc_survey', 'dashlet_survey_send_status_chart'),
                'pathVars' => array('', ''),
                'method' => 'dashlet_survey_send_status_chart',
                'shortHelp' => 'Survey Send Status chart for Dashlet',
                'longHelp' => '',
            ),
            'dashlet_survey_response_chart' => array(
                'reqType' => 'POST',
                'path' => array('bc_survey', 'dashlet_survey_response_chart'),
                'pathVars' => array('', ''),
                'method' => 'dashlet_survey_response_chart',
                'shortHelp' => 'Survey Response chart for Dashlet',
                'longHelp' => '',
            ),
            //Survey Comparison report
            'get_comparison_report_survey_name' => array(
                'reqType' => 'POST',
                'path' => array('bc_survey', 'get_comparison_report_survey_name'),
                'pathVars' => array('', ''),
                'method' => 'get_comparison_report_survey_name',
                'shortHelp' => 'Get Comparison report Survey names',
                'longHelp' => '',
            ),
            //Compared Survey Question list report
            'get_comparison_report_question_name' => array(
                'reqType' => 'POST',
                'path' => array('bc_survey', 'get_comparison_report_question_name'),
                'pathVars' => array('', ''),
                'method' => 'get_comparison_report_question_name',
                'shortHelp' => 'Get Comparison Survey Question names',
                'longHelp' => '',
            ),
            //List of Comparison Report Generated
            'list_comparison_report' => array(
                'reqType' => 'POST',
                'path' => array('bc_survey', 'list_comparison_report'),
                'pathVars' => array('', ''),
                'method' => 'list_comparison_report',
                'shortHelp' => 'List of Comparison Report Created',
                'longHelp' => '',
            ),
            //Add Created Comparison Report in db
            'create_comparison_report' => array(
                'reqType' => 'POST',
                'path' => array('bc_survey', 'create_comparison_report'),
                'pathVars' => array('', ''),
                'method' => 'create_comparison_report',
                'shortHelp' => 'List of Comparison Report Created',
                'longHelp' => '',
            ),
            //Add Created crosstab Report in db
            'create_crosstab_report' => array(
                'reqType' => 'POST',
                'path' => array('bc_survey', 'create_crosstab_report'),
                'pathVars' => array('', ''),
                'method' => 'create_crosstab_report',
                'shortHelp' => 'List of Crosstab Report Created',
                'longHelp' => '',
            ),
            //Deleted Comparison Report in db
            'delete_comparison_report' => array(
                'reqType' => 'POST',
                'path' => array('bc_survey', 'delete_comparison_report'),
                'pathVars' => array('', ''),
                'method' => 'delete_comparison_report',
                'shortHelp' => 'Delete Comparison Report',
                'longHelp' => '',
            ),
            //Edit Comparison Report in db
            'edit_comparison_report' => array(
                'reqType' => 'POST',
                'path' => array('bc_survey', 'edit_comparison_report'),
                'pathVars' => array('', ''),
                'method' => 'edit_comparison_report',
                'shortHelp' => 'Edit Comparison Report',
                'longHelp' => '',
            ),
            //Load Comparison Report chart
            'loadComparisonReportChart' => array(
                'reqType' => 'POST',
                'path' => array('bc_survey', 'loadComparisonReportChart'),
                'pathVars' => array('', ''),
                'method' => 'loadComparisonReportChart',
                'shortHelp' => 'Load Comparison Report chart',
                'longHelp' => '',
            ),
            //Get Search Comparison Report
            'getSearchComparisonResult' => array(
                'reqType' => 'POST',
                'path' => array('bc_survey', 'getSearchComparisonResult'),
                'pathVars' => array('', ''),
                'method' => 'getSearchComparisonResult',
                'shortHelp' => 'Get Search Comparison Report',
                'longHelp' => '',
            ),
            //Get Crosstab Report Question Name
            'get_crosstab_report_question_name' => array(
                'reqType' => 'POST',
                'path' => array('bc_survey', 'get_crosstab_report_question_name'),
                'pathVars' => array('', ''),
                'method' => 'get_crosstab_report_question_name',
                'shortHelp' => 'Get Crosstab Report Question Name',
                'longHelp' => '',
            ),
            //List of Crosstab Report Created
            'list_crosstab_report' => array(
                'reqType' => 'POST',
                'path' => array('bc_survey', 'list_crosstab_report'),
                'pathVars' => array('', ''),
                'method' => 'list_crosstab_report',
                'shortHelp' => 'List of Crosstab Report Created',
                'longHelp' => '',
            ),
            //Crosstab Report Chart List
            'openCrosstabChartOptionsModel' => array(
                'reqType' => 'POST',
                'path' => array('bc_survey', 'openCrosstabChartOptionsModel'),
                'pathVars' => array('', ''),
                'method' => 'openCrosstabChartOptionsModel',
                'shortHelp' => 'Crosstab Report Chart List',
                'longHelp' => '',
            ),
            //Delete Cross Tab Report
            'delete_crosstab_report' => array(
                'reqType' => 'POST',
                'path' => array('bc_survey', 'delete_crosstab_report'),
                'pathVars' => array('', ''),
                'method' => 'delete_crosstab_report',
                'shortHelp' => 'Delete Crosstab Report',
                'longHelp' => '',
            ),
            //Load CrossTab Report chart From List
            'loadCrosstabReportChart' => array(
                'reqType' => 'POST',
                'path' => array('bc_survey', 'loadCrosstabReportChart'),
                'pathVars' => array('', ''),
                'method' => 'loadCrosstabReportChart',
                'shortHelp' => 'Load CrossTab Report chart From List',
                'longHelp' => '',
            ),
            //Get Search Crosstab Report
            'getSearchCrosstabResult' => array(
                'reqType' => 'POST',
                'path' => array('bc_survey', 'getSearchCrosstabResult'),
                'pathVars' => array('', ''),
                'method' => 'getSearchCrosstabResult',
                'shortHelp' => 'Get Search Crosstab Report',
                'longHelp' => '',
            ),
            //Save Survey SMS setting 
            'save_surveysms_setting' => array(
                'reqType' => 'GET',
                'path' => array('bc_survey', 'save_surveysms_setting'),
                'pathVars' => array('', ''),
                'method' => 'save_surveysms_setting',
                'shortHelp' => 'Survey Custom SMS setting',
                'longHelp' => '',
            ),
            //Save Survey SMS setting 
            'immediateSendSurveyFromSMS' => array(
                'reqType' => 'GET',
                'path' => array('bc_survey', 'immediateSendSurveyFromSMS'),
                'pathVars' => array('', ''),
                'method' => 'immediateSendSurveyFromSMS',
                'shortHelp' => 'Immediate Send Survey By SMS',
                'longHelp' => '',
            ),
            //Save Survey SMS setting 
            'SendSurveyFromSMS' => array(
                'reqType' => 'GET',
                'path' => array('bc_survey', 'SendSurveyFromSMS'),
                'pathVars' => array('', ''),
                'method' => 'SendSurveyFromSMS',
                'shortHelp' => 'Send Survey By SMS',
                'longHelp' => '',
            ),
            //Save Survey SMS setting 
            'getFromAndToNumber' => array(
                'reqType' => 'GET',
                'path' => array('bc_survey', 'getFromAndToNumber'),
                'pathVars' => array('', ''),
                'method' => 'getFromAndToNumber',
                'shortHelp' => 'Get FRom and To number to send SMS',
                'longHelp' => '',
            ),
            //Genrate QR code for survey
            'generate_qrcode_survey_submit_id' => array(
                'reqType' => 'GET',
                'path' => array('bc_survey', 'generate_qrcode_survey_submit_id'),
                'pathVars' => array('', ''),
                'method' => 'generate_qrcode_survey_submit_id',
                'shortHelp' => 'Generate QR code of web link',
                'longHelp' => '',
            ),
            //Generate QR link for list view download
            'generate_qr_code_link_list_view_download' => array(
                'reqType' => 'GET',
                'path' => array('bc_survey', 'generate_qr_code_link_list_view_download'),
                'pathVars' => array('', ''),
                'method' => 'generate_qr_code_link_list_view_download',
                'shortHelp' => 'Generate QR link for email template',
                'longHelp' => '',
            ),
            //To find if script is need to be run or not for notification in report
            'getScriptNotificationRun' => array(
                'reqType' => 'GET',
                'path' => array('bc_survey', 'getScriptNotificationRun'),
                'pathVars' => array('', ''),
                'method' => 'getScriptNotificationRun',
                'shortHelp' => 'Generate QR link for email template',
                'longHelp' => '',
            ),
        );
    ...
    function makeQuestionWiseExportContent($api, $args) {
        ...
        $takeDisabledQuestion = $args['takeDisabledQuestion'];
        //changes regarding for disabled question in export table structure
...
// Global Filter :: End
        ...
        if ($exportReport == 'normal') {
            ...
            $retunrChartData = exportQuestionTrendReportDataAsPDF($questionPDFData, $survey_id, $survey_type, $returnData, $selectedRangeVal, $surveyName, $qID, $fromIndividualQuestion, $exportAS, $takeDisabledQuestion);
        }
    ...
    function get_export_report($api, $args) {
        ...
        $takeDisabledQuestion = $args['takeDisabledQuestion'];
        $selectedRangeVal = json_decode(html_entity_decode($args['selectedRangeVal']), true);
        //changes regarding disable questions in report export  12-08-2019
        $takeDisabledQuestion = $args['takeDisabledQuestion'];
        $GF_saved_question_logic = array();
// Global Filter :: Start
        $gf_filter_by = isset($gffilterData['gf_filter_by']) ? $gffilterData['gf_filter_by'] : '';
...
// Global Filter :: End
        ...
        if ($exportReport == 'normal') {
            $retunrChartData = getQuestionWiseExportReportData($survey_id, $survey_type, $total_submitted, $accesible_submissions, '', false, $takeDisabledQuestion);
        } else {
            $retunrChartData = getQuestionWiseTrendExportReportData($survey_id, $survey_type, $accesible_submissions, $selectedRangeVal, '', false, $takeDisabledQuestion);
        }
        return $retunrChartData;
    }
    ...
    public function get_report($api, $args) {
        require_once 'custom/include/utilsfunction.php';
        $survey_id = $args['survey_id'];
        global $db, $current_user, $app_list_strings, $dotb_config;
        ...
        } else if (isset($args['status_type']) && $args['status_type'] == 'manual') {
            //Take survey changes 03-08-2019
            $status_type = 'manual';
            $submissionTypeArray = array('Manual');
        } else if (isset($args['status_type']) && $args['status_type'] == 'sms') {
            //submission by sms changes 03-08-2019
            $status_type = 'sms';
            $submissionTypeArray = array('SMS');
        } else if (isset($args['status_type']) && $args['status_type'] == 'whatsapp') {
            //submission by whatsapp changes 03-08-2019
            $status_type = 'whatsapp';
            $submissionTypeArray = array('WhatsApp');
        } else {
            $status_type = 'combined';
            //Take survey changes 03-08-2019
            $submissionTypeArray = array('Email', 'Open Ended', 'Manual', 'SMS', 'WhatsApp');
        }
        ...
        $survey = getReportData($type, $survey_id, '', '', '', '', '', '', $status_type, '', '', $page, $gf_filter_by, $accesible_submissionsAll);
        $details = array();
        $que_details = array();
        $name = array();
        $rating = "";
        ...
        if ($type == 'question') {
            $trendsQuestionReportDataArray = getTrendQuestionWiseSubmissionData($survey_id, $status_type, $GF_QueLogic_Passed_Submissions, true);
        ...
        $page = isset($args['page']) ? $args['page'] : 1;
        if ($type == 'status') {
            $status_response = array('name' => htmlspecialchars($oSurvey->name), 'status_report_detail' => $survey, 'survey_start_date' => $survey_start_date, 'survey_end_date' => $survey_end_date);
        }
        ...
        if ($type == 'question') {
            ...
            foreach ($orderedSurvey as $que_id => $question_name) {
                ...
                if ($oQuestion->question_type != 'section-header') {
                    ...
                    if ($oQuestion->question_type != 'image' && $oQuestion->question_type != 'video' && $oQuestion->question_type != 'additional-text') {
                        ...
                        $details['page_title'][$page_seq] = htmlspecialchars($question_name[3]);
                        $details[$que_id]['page_id'] = $page_seq;
                        $details[$que_id]['name'] = htmlspecialchars($question_name[0]);
                        ...
                        //changes for the disabled question details in Report
                        $details[$que_id]['disabled_question'] = $oQuestion->disabled_question;
                        ...
                        foreach ($answer_objects as $answer_object) {
                            if ($oQuestion->is_image_option) {
                                ...
                                $details[$que_id]['answers'][$answer_object->answer_sequence]['ans_name'] = htmlspecialchars($answer_object->answer_name);
                        ...
                        if (in_array($oQuestion->question_type, array('commentbox', 'textbox', 'contact-information', 'rating', 'date-time', 'scale', 'matrix', 'doc-attachment'))) {
                            ...
                            if ($oQuestion->question_type == 'contact-information') {
                                ...
                                if (!in_array($res_value_question[$oQuestion->id]['question_title'], $scale_answers)) {
                                    ...
                                    foreach ($res_value_question[$oQuestion->id]['answers'] as $anskey => $ansvalue) {
                                        // Role Compatibility :: START
                                        if ($ansvalue['answer_name'] != '' && $ansvalue['answer_name'] != 'N/A') {
            ...
            $status_response = array(
                'survey_name' => htmlspecialchars($oSurvey->name),
                'total_submitted_que' => $total_send_survey,
                        ...
                        if ($qid != 'page_title') {
                            ...
                            foreach ($survey_detail['answers'] as $ansSeq => $answers) {
                                ...
                                if ($survey_detail['que_type'] == 'scale') {
                                    ...
                                    if (isset($chart_display_data[$qid])) {
                                        // set scale question ids for chrt display
                                        array_push($scale_chart_ids, $qid); // set scale question ids for chrt display
                                    }
                                    $multi_data = array();
                                    $multi_data[] = array('Task', 'Percentage', array('role' => 'style'));
            ...
            $list_max_entries_per_page = !empty($dotb_config['list_max_entries_per_page']) ? $dotb_config['list_max_entries_per_page'] : 20;
            $status_response = array('Individual_ReportData' => $name, 'survey_id' => $survey_id, 'page' => $page, 'survey_name' => htmlspecialchars($oSurvey->name), 'max_records' => $list_max_entries_per_page);
        }
    ...
    public function save_survey($api, $args) {
        ...
        foreach ($page_data as $pg_index => $page_data) {
            ...
            foreach ($page_data->questions as $que_index => $que_data) {
                ...
                // Survey Question Piping Configuration
                $oSurveyQue->piping_sequence = $que_data->piping_sequence;

                // find piped question id from piping seq added in que title
                $fullstring = $oSurveyQue->name;
                ...
                for ($i = 0; $i < $occu; $i++) {
                    ...
                    $fullstring = str_replace('{{Q' . trim($current_piping_seq) . '}}', ' ', $fullstring);
                }

                $oSurveyQue->qpiping_que_ids = $piping_seq;

                $oSurveyQue->save();

                $piping_question_array[$oSurveyQue->piping_sequence] = $oSurveyQue->id;
                ...
                if (isset($que_data->answers)) {
                    foreach ($que_data->answers as $ans_index => $answer) {
                        ...
                        $oSurveyAns->piping_selection_type_values = $answer->pipe_key; // fix for piping for multiselect questions
                        if (isset($answer->weight)) {
        ...
        if ((isset($args['type']) && $args['type'] != "SurveyTemplate") || !isset($args['type'])) {
            ...
            //generate unique key for open survey
            if (empty($obSurvey->survey_submit_unique_id)) {
                ...
                $unique_key = implode($uid);
            } else {
                $unique_key = $obSurvey->survey_submit_unique_id;
            }


            $db->query("UPDATE bc_survey SET image = '{$file_contents}', background_image_lb = '{$survey_background_image_file_contents}', survey_theme = '{$survey_theme}',base_score = {$base_score},default_survey_language = '{$dotb_config['default_language']}',survey_type='{$survey_type}', survey_submit_unique_id= '{$unique_key}' WHERE id = '{$record_id}' ");
        }
        return $record_id;
    }
    ...
    public function get_survey($api, $args) {
        ...
        if ((isset($args['type']) && $args['type'] != 'SurveyTemplate' || !isset($args['type']))) {
            foreach ($oSurvey->bc_survey_pages_bc_survey->getBeans() as $pages) {
                unset($questions);
                if ($editFlag == 1) {
                    $pages->name = htmlspecialchars($pages->name);
                }
                ...
                foreach ($pages->bc_survey_pages_bc_survey_questions->getBeans() as $survey_questions) {
                    if ($editFlag == 1) {
                        $survey_questions->description = htmlspecialchars($survey_questions->description);
                        $survey_questions->name = htmlspecialchars($survey_questions->name);
                        $survey_questions->question_help_comment = htmlspecialchars($survey_questions->question_help_comment);
                        $survey_questions->display_boolean_label = htmlspecialchars($survey_questions->display_boolean_label);
                        $survey_questions->description = htmlspecialchars($survey_questions->description);
                    }
                    ...
                    $questions[$survey_questions->question_sequence]['piping_sequence'] = $survey_questions->piping_sequence;
                    ...
                    //disabled Question changes 7-08-2019
                    $questions[$survey_questions->question_sequence]['disabled_question'] = ($survey_questions->disabled_question == 1) ? 'Yes' : 'No';
                    ...
                    foreach ($survey_questions->bc_survey_answers_bc_survey_questions->getBeans() as $survey_answers) {
                        if ($editFlag == 1) {
                            $survey_answers->answer_name = htmlspecialchars($survey_answers->answer_name);
                        }
                        if ($survey_answers->answer_type != 'other') {
                            ...
                            $questions[$survey_questions->question_sequence]['answers'][$survey_answers->answer_sequence][$survey_answers->id]['pipe_key'] = $survey_answers->piping_selection_type_values;
                            ;
                        } else {
                        ...
                        //Changes Regarding Detail view for making Detail view same as Edit View 1-7-2019 By kairvi
                        if ($survey_answers->logic_action == "show_hide_question") {
                            $AllQuestionName = "";
                            $new_question_id = explode(',', $survey_answers->logic_target);
                            foreach ($new_question_id as $number => $que_id) {
                                $selQuestionName = "SELECT * FROM  bc_survey_questions WHERE id = '$que_id' ";
                                $result = $db->query($selQuestionName);
                                $QuestionName = $db->fetchByAssoc($result);
                                if (empty($AllQuestionName)) {
                                    $AllQuestionName = 'Question : ' . $QuestionName['name'];
                                } else {
                                    $AllQuestionName = $AllQuestionName . '<br/>Question : ' . $QuestionName['name'];
                                }
                            }
                            $questions[$survey_questions->question_sequence]['skip_logic'][$survey_answers->id]['logic_target_name'] = $AllQuestionName;
                        } else if ($survey_answers->logic_action == "redirect_to_page") {
                            $selPageName = "SELECT * FROM  bc_survey_pages WHERE id = '$survey_answers->logic_target' ";
                            $result = $db->query($selPageName);
                            $PageName = $db->fetchByAssoc($result);
                            $questions[$survey_questions->question_sequence]['skip_logic'][$survey_answers->id]['logic_target_name'] = $PageName['name'];
                        } else if ($survey_answers->logic_action == "eop") {
                            $questions[$survey_questions->question_sequence]['skip_logic'][$survey_answers->id]['logic_target_name'] = "";
                        } else if ($survey_answers->logic_action == "redirect_to_url") {
                            $questions[$survey_questions->question_sequence]['skip_logic'][$survey_answers->id]['logic_target_name'] = "";
                        } else {
                            $questions[$survey_questions->question_sequence]['skip_logic'][$survey_answers->id]['logic_target_name'] = "";
                        }
    ...
    public function save_edited_survey($api, array $args) {
        ...
        //survey page data
        $page_data = isset($aedited_survey_data->pages) ? $aedited_survey_data->pages : array();
        $que_ids_saved = array();
        $piping_question_array = array();
        $page_seq = 0;
        foreach ($page_data as $pg_index => $page_data) {
            ...
            foreach ($page_data->questions as $que_index => $que_data) {
                ...
                // set disabled_question or not
                if (isset($que_data->disabled_question)) {
                    if ($que_data->disabled_question == "1") {
                        $oSurveyQue->disabled_question = 1;
                    } else {
                        $oSurveyQue->disabled_question = 0;
                    }
                }
                // store advance options
                if ($que_data->que_type == 'richtextareabox') {
...
//            $db->query("UPDATE bc_survey SET image = '{$file_contents}', background_image_lb = '{$survey_background_image_file_contents}' , survey_theme = '{$survey_theme}',base_score = {$base_score} WHERE id = '{$record_id}' ");
                ...
                if ($oPage->page_sequence == $page) {
                    ...
                    foreach ($queList as $oQuestion) {
                        if ($oQuestion->question_type != 'section-header' && $oQuestion->question_type != 'richtextareabox') {
                            ...
                            // Replace Answer Piping Text with Actual answer submitted :: START
                            $que_title = (!empty($list_lang_detail[$oQuestion->id . '_que_title'])) ? $list_lang_detail[$oQuestion->id . '_que_title'] : $oQuestion->name;
                            $que_type = $oQuestion->question_type;
                            $QorAText = $que_title;
                            $que_title = ReplaceQAPipingText($que_type, $QorAText, $survey_id, $submission_id);
                            // Replace Answer Piping Text with Actual answer submitted :: END
                            $resultArray['pages'][$oPage->id][$oQuestion->id]['question_title'] = $que_title;
                            ...
                            //changes regarding disable question in survey 09-08-2019
                            $resultArray['pages'][$oPage->id][$oQuestion->id]['disabled_question'] = $oQuestion->disabled_question;
                            ...
                            if ($oQuestion->question_type == 'radio-button' || $oQuestion->question_type == 'check-box' || $oQuestion->question_type == 'multiselectlist' || $oQuestion->question_type == 'dropdownlist' || $oQuestion->question_type == 'boolean') {
                                ...
                                foreach ($ansList as $oAnswer) {
                                    ...
                                    if (in_array($oAnswer->id, $submitedAndIds) && $oAnswer->answer_type != 'other') {
                                        ...
                                        // Replace Answer Piping Text with Actual answer submitted :: START
                                        $que_type = $oQuestion->question_type;
                                        $QorAText = $oAnswer->answer_name;
                                        $oAnswer->answer_name = ReplaceQAPipingText($que_type, $QorAText, $survey_id, $submission_id);
                                        // Replace Answer Piping Text with Actual answer submitted :: END
                            ...
                            // get answers of other than multi select question type
                                ...
                                // Replace Answer Piping Text with Actual answer submitted :: START
                                $que_type = $oQuestion->question_type;
                                $QorAText = $submitted_ans_name;
                                $submitted_ans_name = ReplaceQAPipingText($que_type, $QorAText, $survey_id, $submission_id);
                                // Replace Answer Piping Text with Actual answer submitted :: END
                                // submitted answer
        ...
        foreach ($orderedSurvey['pages'] as $page_id => $page_detail) {
            ...
            foreach ($page_detail as $que_id => $que_detail) {
                ...
                if ($que_detail['question_type'] != 'image' && $que_detail['question_type'] != 'video' && $que_detail['question_type'] != 'additional-text' && $que_detail['question_type'] != 'richtextareabox') {
                    ...
                    //changes regarding disable piping in survey 09-08-2019
                    $row_data[$que_detail['page_seq']]['disabled_question'] = $resultArray['disabled_question'];
                    ...
                    if ($resultArray['status'] == 'Pending') {
                        ...
                        if ($resultArray['status'] == 'Submitted') {
                            ...
                            // Other type of Question
                                ...
                                if ($que_detail['question_type'] == 'radio-button' || $que_detail['question_type'] == 'check-box' || $que_detail['question_type'] == 'multiselectlist' || $que_detail['question_type'] == 'dropdownlist' || $que_detail['question_type'] == 'boolean') {
                                    ...
                                    foreach ($que_detail['answers'] as $ans_id => $ans_detail) {
                                        if ($que_detail['question_type'] != 'netpromoterscore') {
                        ...
                        $detail_array[$que_detail['page_seq']][$que_detail['question_id']][$que_detail['question_title']]['disabled_question'] = $que_detail['disabled_question'];
    ...
    public function getSearchResult($api, $args) {
        require_once 'custom/include/utilsfunction.php';
        global $app_list_strings, $dotb_config;
    ...
    public function approveRequest($api, $args) {
        ...
        $uid = $oSubmission->email_survey_sumission_unique_id;
        //get submission
        $query = new DotbQuery();
        $query->from(BeanFactory::getBean('bc_survey_submission'));
        ...
        if ($surveyObj->survey_status == 'Active') {
            ...
            $survey_url = $dotb_config['site_url'] . '/survey_submission.php?survey_id=';
            $dotb_survey_Url = $survey_url; //create survey submission url
            $encoded_param = base64_encode($uid);
            $dotb_survey_Url = str_replace('survey_id=', 'q=', $dotb_survey_Url);
            $surveyURL = $dotb_survey_Url . $encoded_param;
...
//change in the survey URL
                    $new_url = $host . '?q=' . $encoded_data;
//                    $encoded_data = base64_encode($pure_data);
//                    $new_url = $dotb_config['site_url'] . '/survey_submission.php?q=' . $encoded_data;
                    ...
                    $image_src = "{$dotb_config['site_url']}/index.php?entryPoint=checkEmailOpened&submission_id={$submission_id_each}";
    ...
    /**
     * Function : checkSMSTemplateForSurvey
     *    check sms template exist or not for the selected survey
     * 
     * @return string - $smsTempID 
     */
    function checkSMSTemplateForSurvey($api, $args) {
        require_once 'custom/include/utilsfunction.php';
        $smsTempID = '';
        if (!empty($args['survey_ID'])) {
            $smsTempID = getSMSTemplateBySurveyID($args['survey_ID']);
        }
        return $smsTempID;
    }
    ...
    function SendSurveyEmail($api, $args) {
        ...
        //Take survey changes 03-08-2019
        $isTakeSurvey = !empty($args['isTakeSurvey']) ? $args['isTakeSurvey'] : 0;

        $dataArray = sendSurveyEmailsModuleRecords($records, $module_name, $survey_id, $schedule_on_date, $schedule_on_time, false, '', '', $origin_module, $origin_module_id, false, $isTakeSurvey);
        ...
        $contentPopUP = createContentForMailStatusPopup($customersSummary, $survey_id, $module_name, $total_seleted_records, false, '', '', '', $surveySingularModule, 'Email');
    ...
    function SendImmediateEmail($api, $args) {
        ...
        if ($dataArray['is_send'] == 'scheduled') {
            ...
            $emailSubject = htmlspecialchars_decode($mailSubject, ENT_QUOTES);
            $survey_url = $dotb_config['site_url'] . '/survey_submission.php?survey_id=' . $args['id_survey'] . '&ctype=' . $args['module_name'] . '&cid=' . $args['records'] . '&sub_id=' . $dataArray['submission_id'];
            $to_Email = $focus->email1;
            ...
            if (strpos($template_data['body_html'], 'src=') >= 1) {
                $survey_url_qr = explode('"', substr($template_data['body_html'], strpos($template_data['body_html'], 'src=')));
            }
            ...
            if (strpos($template_data['body_html'], 'src=') >= 1) {
                ...
                $template_data['body_html'] = str_replace($survey_url_qr[1], $qr_url, $template_data['body_html']);
            }
            ...
            $to_Email = $focus->email1;
            //$image_src = "{$dotb_config['site_url']}/check_email_opened.jpg/{$rec_module_detail['submission_id']}";
            $image_src = "{$dotb_config['site_url']}/index.php?entryPoint=checkEmailOpened&submission_id={$dataArray['submission_id']}";
            $image_url = "<img src='{$image_src}'>";
            $emailBody .= $image_url;
            $emailBody .= '<br/><span style="font-size:0.8em">To remove yourself from this email list  <a href="' . $opt_out_url . '" target="_blank">click here</a></span>';
        ...
        $contentPopUP = createContentForMailStatusPopup($customersSummary, $survey_id, $module_name, $total_selected, $isSendNow, $record_name, $isSendSuccess, $isDetailView, $surveySingularModule, "Email");
        $returnDataArray['mailStatus'] = $is_processed;
        $returnDataArray['contentPopUP'] = $contentPopUP;
        $returnDataArray = json_encode($returnDataArray);
        return $returnDataArray;
    ...
    public function openSummaryDetailView($api, $args) {
        ...
        $offset = 0;
        $limit = (!empty($currentRecordCount)) ? $dotb_config['list_max_entries_per_page'] + (int) $currentRecordCount : $dotb_config['list_max_entries_per_page'];
        $show_more = false;
        if (trim($type) == 'pending_res') {
            ...
            if (!empty($args['opted_out_record'])) {
                if ($args['send_sms_type'] == "sms") {
                    $opted_data = json_decode($args['opted_out_record'], true);
                    $opted_out_record = $opted_data;
                } else {
...
//                $opted_out_record[$module_name] = explode(',', $args['opted_out_record']);
            ...
            foreach ($opted_out_record as $survey_mod => $survey_mod_ids) {
                if ($args['send_sms_type'] != "sms") {
                    ...
                    $sms = 1;
                    $optOutEmailDetails[$index]['count'] = $count;
                    $optOutEmailDetails[$index]['record_name'] = $survey_mod_ids['record_name'];
                    $optOutEmailDetails[$index]['email'] = $survey_mod_ids['mobile_number'];
                    $count++;
                    $index++;
                }
            }
...
//            $restrict_edit = "1";
            $restrict_edit = "0";
            //edit survey when submission count is greater than "0" 5th August 2019
            $submissionCount_edit = "1";
        } else {
            // if total submission is 0 then set flag to 0 for allow editing survey
            $restrict_edit = "0";
            $submissionCount_edit = "0";
        }

        // Check dotb version 7.7 or less
        if (version_compare($dotb_version, '7.7', '>')) {
            $dotbLatest = "1";
        } else {
            $dotbLatest = "0";
        }
    ...
    public function getSurveyURL($api, $args) {
        ...
        $dotb_survey_Url = $dotb_config['site_url'] . $survey_url_for_email; //create survey submission url
        ...
        $surveyURL = $dotb_survey_Url . $encoded_param . '&submitted_by=sender';
        return $surveyURL;
    }
    ...
    public function delete_transaction($api, $args) {
        ...
        $submission->load_relationship('bc_survey_submission_bc_survey');
        $submission->bc_survey_submission_bc_survey->delete($submission->id, $surveyID);
        // delete submission
    ...
    public function get_survey_language($api, $args) {
        ...
        $result['default_crm_language'] = $dotb_config['default_language'];
    ...
    public function get_survey_detail_to_translate_lang($api, $args) {
        ...
        if ($record_id != 'SurveyTemplate') {
            ...
            $all_survey_details['survey_title'] = htmlspecialchars($oSurvey->name);
            $all_survey_details['survey_description'] = htmlspecialchars($oSurvey->description);
        ...
        foreach ($oSurvey->bc_survey_pages_bc_survey->getBeans() as $pages) {
            unset($questions);
            $survey_details[$pages->page_sequence]['page_title'] = htmlspecialchars($pages->name);
            $survey_details[$pages->page_sequence]['page_number'] = $pages->page_number;
            $survey_details[$pages->page_sequence]['page_id'] = $pages->id;
            $pages->load_relationship('bc_survey_pages_bc_survey_questions');
            foreach ($pages->bc_survey_pages_bc_survey_questions->getBeans() as $survey_questions) {
                $questions[$survey_questions->question_sequence]['que_id'] = $survey_questions->id;
                $questions[$survey_questions->question_sequence]['que_title'] = htmlspecialchars($survey_questions->name);
                $questions[$survey_questions->question_sequence]['que_type'] = $survey_questions->question_type;
                $questions[$survey_questions->question_sequence]['question_help_comment'] = htmlspecialchars($survey_questions->question_help_comment);
                //advance options
                $questions[$survey_questions->question_sequence]['advance_type'] = (isset($survey_questions->advance_type)) ? $survey_questions->advance_type : '';
                $questions[$survey_questions->question_sequence]['enable_otherOption'] = (isset($survey_questions->enable_otherOption) && $survey_questions->enable_otherOption == 1 ) ? 'Yes' : 'No';
                $questions[$survey_questions->question_sequence]['matrix_row'] = (isset($survey_questions->matrix_row)) ? base64_decode($survey_questions->matrix_row) : '';
                $questions[$survey_questions->question_sequence]['matrix_col'] = (isset($survey_questions->matrix_col)) ? base64_decode($survey_questions->matrix_col) : '';
                $questions[$survey_questions->question_sequence]['description'] = (isset($survey_questions->description)) ? htmlspecialchars($survey_questions->description) : '';
                ...
                if ($survey_questions->question_type != 'boolean') {
                    foreach ($survey_questions->bc_survey_answers_bc_survey_questions->getBeans() as $survey_answers) {
                        ...
                        $questions[$survey_questions->question_sequence]['answers'][$survey_answers->answer_sequence][$survey_answers->id]['option'] = htmlspecialchars($survey_answers->answer_name);
                        $questions[$survey_questions->question_sequence]['answers'][$survey_answers->answer_sequence][$survey_answers->id]['answer_type'] = $survey_answers->answer_type;
                    }
                    if (isset($questions[$survey_questions->question_sequence]['answers']) && is_array($questions[$survey_questions->question_sequence]['answers']))
                        ksort($questions[$survey_questions->question_sequence]['answers']);
    ...
    public function save_language_translation($api, $args) {
        ...
        if ($oSurveyLang->survey_lang != $dotb_config['default_language']) {
    ...
    function generate_unique_survey_submit_id($api, $args) {
        ...
        if (empty($oSurvey->survey_submit_unique_id)) {
            ...
            $survey_sharable_link = $dotb_config['site_url'] . '/survey_submission.php?q=' . $oSurvey->survey_submit_unique_id;
    ...
    public function generateIndividualHistory($api, $args) {
        ...
        if (!empty($answer_Submitted)) {
            ...
            $resultQue = $db->query("SELECT name,maxsize,matrix_row,matrix_col,is_image_option,disabled_question FROM bc_survey_questions WHERE id='$que_id' ");
            $que_detail = $db->fetchByAssoc($resultQue);

            // Replace Answer Piping Text with Actual answer submitted :: START
            $que_type = $answer_Submitted[0]['question_type'];
            $QorAText = $que_detail['name'];
            $que_detail['name'] = ReplaceQAPipingText($que_type, $QorAText, $survey_id, $submission_id);
            // Replace Answer Piping Text with Actual answer submitted :: END
                ...
                if (in_array($subDetail['question_type'], $multiChoiceQueType)) {
                    ...
                    if (!empty($subDetail['submitted_answer']) && $subDetail['submitted_answer'] != 'selection_default_value_dropdown') {
                        foreach ($answersList as $k => $answer_id) {
                            ...
                            // Replace Answer Piping Text with Actual answer submitted :: START
                            $que_type = $subDetail['question_type'];
                            $QorAText = $oAnswer->answer_name;
                            $oAnswer->answer_name = ReplaceQAPipingText($que_type, $QorAText, $survey_id, $submission_id);
                            // Replace Answer Piping Text with Actual answer submitted :: END
                ...
                // EMOJIS
                    ...
                    if (!empty($subDetail['submitted_answer'])) {
                        foreach ($answersList as $k => $answer_id) {
                            ...
                            // Replace Answer Piping Text with Actual answer submitted :: START
                            $que_type = $subDetail['question_type'];
                            $QorAText = $oAnswer->name;
                            $oAnswer->name = ReplaceQAPipingText($que_type, $QorAText, $survey_id, $submission_id);
                            // Replace Answer Piping Text with Actual answer submitted :: END
            ...
            $html = '<div class="answerHistoryDetail" style="padding: 10px 3%; max-height: 375px; overflow: auto;">';
            // Retrieve Question Title
            $resultQue = $db->query("SELECT name,maxsize,matrix_row,matrix_col,is_image_option,disabled_question,question_type FROM bc_survey_questions WHERE id='$que_id' ");
            $que_detail = $db->fetchByAssoc($resultQue);

            // Replace Answer Piping Text with Actual answer submitted :: START
            $que_type = $que_detail['question_type'];
            $QorAText = $que_detail['name'];
            $que_detail['name'] = ReplaceQAPipingText($que_type, $QorAText, $survey_id, $submission_id);
            // Replace Answer Piping Text with Actual answer submitted :: END

            $html .= "  <div class='que-rwo'> <p class='que'><b>Question</b>" . $que_detail['name'] . '</p>';
            $html .= '<div class="row subDateRow"><span class="span8"> <span class="btn  answerHistory" style="margin-left:0px;"><i class="fa fa-clock-o"></i></span>  This question has been disabled and there is no answer for this question.</span></div>';
            $html .= "  </div>";
            $html .= "  </div>";
    ...
    /**
     * Description :: This function is used to retrieve Survey Question Wise chart data for Dashboard
     * 
     * @return array '$result'
     */
    public function dashlet_survey_question_chart($api, $args) {
        $result = array();
        $survey_id = $args['survey_id'];
        $module_name = $args['module_name'];
        $record_id = $args['record_id'];
        $que_id = $args['que_id'];
        $show_all_transactions = $args['show_all_transactions'];

        if (!empty($que_id)) {
            $oQuestion = BeanFactory::getBean('bc_survey_questions', $que_id);

            $result['reportData'] = array();
            $result['reportData']['label'] = 'Survey Question : ' . $oQuestion->name;
            $result['reportData']['id'] = $survey_id;

            $result['reportData']['summary_columns'] = array(
                array
                    (
                    'name' => 'name',
                    'label' => 'Answer'
            ...
            $result['chartData'] = array();

            $result['chartData']['color'] = array(
                0 => '#8c2b2b',
                1 => '#468c2b',
                2 => '#2b5d8c',
                3 => ' #cd5200',
            ...
            $result['chartData'] = getSurveyQuestionChartData($survey_id, $que_id, $module_name, $record_id, $show_all_transactions);
            ...
            $result['chartData']['properties'] = array(
                array(
                    ...
                    'thousands' => '',
                    'base_module' => '',
                    'label' => 'Survey Submission Report : Question wise',
                    'allow_drillthru' => 1,
                    'groupName' => 'Name',
                    'groupType' => 'string',
                    'xDataType' => 'ordinal',
    ...
    /**
     * Description :: This function is used to retrieve Survey Question List for configuration of chart data for Dashboard
     * 
     * @return array '$result' : 'que_id : que_name pair
     */
    public function survey_question_list($api, $args) {
        $result = array('' => '');
        $survey_id = $args['survey_id'];
        $allowed_question_types = array('check-box', 'radio-button', 'multiselectlist', 'dropdownlist', 'boolean', 'netpromoterscore', 'emojis', 'rating', 'scale', 'matrix');
        // Retrieve survey
        $oSurvey = BeanFactory::getBean('bc_survey', $survey_id);
        // retrieve survey questions
        $oQuestions = $oSurvey->get_linked_beans('bc_survey_bc_survey_questions', 'bc_survey_questions', ' question_sequence ASC ');
        foreach ($oQuestions as $oQue) {
            // Get allowed question type's Survey Question title
            if (in_array($oQue->question_type, $allowed_question_types)) {
                $result[$oQue->id] = $oQue->name;
            }
        }
        return $result;
    }
    ...
    /*
     * Description : This function is used to retrieve Survey Status Report for Dashlet
     */

    public function dashlet_survey_status_chart($api, $args) {
        $survey_id = $args['survey_id'];
        ...
        $query->where()->equals('bc_survey.id', $survey_id);
        $query->where()->notEquals('bc_survey.survey_type', NULL);
        $result_total_send_survey = $query->execute();

        foreach ($result_total_send_survey as $totalSend) {

            // Check role compatibility of a Submissions
            $oAclFocus = array();
        ...
        $survey_status_response = getReportData('status', $survey_id, '', '', '', '', '', '', '', '', '', '', '', $accesible_submissions);

        // If there is no response then set all values as Default 0
        if (!is_array($survey_status_response)) {
            $survey_status_response['Submitted'] = 0;
            $survey_status_response['email_not_opened'] = 0;
            $survey_status_response['Pending'] = 0;
        }
        $StatusChartData = array();
        $StatusChartData['data'] = array(
            array(
                "key" => "Submitted",
                "label" => "Submitted",
                "value" => $survey_status_response['Submitted'],
                "color" => "#17dbc7"
            ), array(
                "key" => "Not Viewed",
                "label" => "Not Viewed",
                "value" => $survey_status_response['email_not_opened'],
                "color" => "#0679c8"
            ), array(
                "key" => "Viewed",
                "label" => "Viewed",
                "value" => $survey_status_response['Pending'],
                "color" => "#e61718"
        ));

        $result['chart'] = $StatusChartData;
        $result['total'] = $survey_status_response['Submitted'];
        return json_encode($result);
    }

    /*
     * Description : This function is used to retrieve Survey Send Status Report for Dashlet
     */

    public function dashlet_survey_send_status_chart($api, $args) {
        global $db;
        $accesible_submissions = array();
        $result = array();
        ...
        // select fields
        $query->select->fieldRaw("COUNT(survey_send_status)", "count");
        $query->select->fieldRaw("survey_send_status", "survey_send_status");

        $query->where()->equals('bc_survey.deleted', 0);
        $query->where()->equals('bc_survey.survey_type', "survey");
        $query->groupBy("survey_send_status");
        $result_total_send_survey_status = $query->execute();
        $total_send_survey_status = array();
        foreach ($result_total_send_survey_status as $num => $totalSendstatus) {
            if (sizeof($result_total_send_survey_status) == 2) {
                if ($totalSendstatus['survey_send_status'] == "active") {
                    $total_send_survey_status[0]['survey_send_status'] = 'active';
                    $total_send_survey_status[0]['count'] = $totalSendstatus['count'];
                } else if ($totalSendstatus['survey_send_status'] == "inactive") {
                    $total_send_survey_status[1]['survey_send_status'] = 'inactive';
                    $total_send_survey_status[1]['count'] = $totalSendstatus['count'];
                }
            } else if (sizeof($result_total_send_survey_status) == 1) {
                if ($totalSendstatus['survey_send_status'] == "active") {
                    $total_send_survey_status[0]['survey_send_status'] = 'active';
                    $total_send_survey_status[0]['coutn'] = $totalSendstatus['count'];
                    $total_send_survey_status[1]['survey_send_status'] = 'inactive';
                    $total_send_survey_status[1]['count'] = 0;
                } else if ($totalSendstatus['survey_send_status'] == "inactive") {
                    $total_send_survey_status[0]['survey_send_status'] = 'active';
                    $total_send_survey_status[0]['count'] = 0;
                    $total_send_survey_status[1]['survey_send_status'] = 'inactive';
                    $total_send_survey_status[1]['count'] = $totalSendstatus['count'];
                }
            } else if (sizeof($result_total_send_survey_status) == 0) {
                $total_send_survey_status[0]['survey_send_status'] = 'active';
                $total_send_survey_status[0]['count'] = 0;
                $total_send_survey_status[1]['survey_send_status'] = 'inactive';
                $total_send_survey_status[1]['count'] = 0;
        ...
        $queryPublishedSurvey = "SELECT
              id,name
            FROM
              bc_survey
            WHERE
        survey_send_status = 'active' and deleted = 0 and survey_type = 'survey' ORDER BY bc_survey.date_modified  DESC ";
        $PublishedSurveyData = $db->query($queryPublishedSurvey);
        $PublishedSurveyarray = array();
        while ($PublishedSurvey = $db->fetchByAssoc($PublishedSurveyData)) {
            $PublishedSurveyarray[] = $PublishedSurvey;
        }
        $queryUnpublishedSurvey = "SELECT
              id,name
            FROM
              bc_survey
            WHERE
        survey_send_status = 'inactive' and deleted = 0 and survey_type = 'survey' ORDER BY bc_survey.date_modified  DESC ";
        $UnpublishedSurveyData = $db->query($queryUnpublishedSurvey);
        $UnpublishedSurveyarray = array();
        while ($UnpublishedSurvey = $db->fetchByAssoc($UnpublishedSurveyData)) {
            $UnpublishedSurveyarray[] = $UnpublishedSurvey;
        }
        // If there is no response then set all values as Default 0
        if (!is_array($result_total_send_survey_status)) {
            $survey_send_status_response['Published'] = 0;
            $survey_send_status_response['Unpublished'] = 0;
        }
        $StatusChartData = array();
        $StatusChartData['data'] = array(
            array(
                "key" => "Published",
                "label" => "Published",
                "value" => $total_send_survey_status[0]['count'],
                "color" => "#008000"
            ), array(
                "key" => "Unpublished",
                "label" => "Unpublished",
                "value" => $total_send_survey_status[1]['count'],
                "color" => "#E5A117"
        ));
        $survey_Total = $total_send_survey_status[0]['count'] + $total_send_survey_status[1]['count'];
        $result['chart'] = $StatusChartData;
        $result['total'] = $survey_Total;
        $result['publishedSurveyList'] = $PublishedSurveyarray;
        $result['unpublishedSurveyList'] = $UnpublishedSurveyarray;
        return json_encode($result);
    }

    /*
     * Description : This function is used to retrieve Survey Response Report for Dashlet
     */

    public function dashlet_survey_response_chart($api, $args) {
        $survey_id = $args['survey_id'];
        $accesible_submissions = array();
        $result = array();
        ...
        $survey_status_response = getSurveyResponseChartData($survey_id, $accesible_submissions);
        // If there is no response then set all values as Default 0
        if (!is_array($survey_status_response)) {
            $survey_status_response['Submitted'] = 0;
            $survey_status_response['email_not_opened'] = 0;
        ...
        $StatusChartData = array();
        //for active for days changes
        $activeFor = (int) $survey_status_response['activeFor'] + 1;
        if ($activeFor == 1) {
            $activeForDay = "1 Day";
        } else if ($activeFor > 1) {
            $activeForDay = $activeFor . " Days";
        }
        $StatusChartData['data'] = array(
            array(
                "key" => "Total Response",
                "label" => "Total Responses",
                "value" => (int) $survey_status_response['totalResponse'],
                "color" => "#30a7bc"
            ), array(
                "key" => "Today Response Count",
                "label" => "Today's Responses",
                "value" => (int) $survey_status_response['todayResponseCount'],
                "color" => "#0679c8"
            ), array(
                "key" => "Active For",
                "label" => "Active For",
                ...
                "key" => "Last Submitted Date",
                "label" => "Last Submitted Date",
                "value" => $survey_status_response['lastSubmittedDate'],
                "color" => "#e61718"
        ));

        $result['chart'] = $StatusChartData;
        $result['total'] = (int) $survey_status_response['totalResponse'];
        return json_encode($result);
    }

    /**
     * Function : get compare Report survey names
     *   Retrieve all surveys for compare report
     * 
     * @return array - $data
     */
    public function get_comparison_report_survey_name($api, $args) {
        require_once 'custom/include/utilsfunction.php';
        $survey_id = $args['survey_id'];
        $comparison_report_id = $args['comparison_report_id'];
        global $db, $current_user, $app_list_strings, $dotb_config;
        //current survey details
        $currentSurveyQuery = "SELECT name,survey_type FROM bc_survey WHERE deleted = 0 AND id='{$survey_id}'";
        $currentSurveyDetails = $db->query($currentSurveyQuery);
        $currentSurveyData = $db->fetchByAssoc($currentSurveyDetails);
        $currentSurveyId = $survey_id;
        $currentSurveyName = htmlspecialchars($currentSurveyData['name']);
        $currentSurveyType = $currentSurveyData['survey_type'];
        $currentSurvey = array();
        $currentSurvey[$currentSurveyId] = $currentSurveyName;
        $totalSurveyList = array();

        //current survey question list
        $currentSurveyQuestionQuery = "SELECT
                            bc_survey_questions.id,
                            bc_survey_questions.name,
                            bc_survey_questions.question_type
                          FROM
                            bc_survey_questions
                          LEFT JOIN
                          ...
                          WHERE
                            bc_survey_bc_survey_questions_c.bc_survey_bc_survey_questionsbc_survey_ida = '{$survey_id}' AND bc_survey_questions.question_type IN ('check-box','radio-button','boolean','dropdownlist','multiselectlist','netpromoterscore','emojis','rating')";
        $currentSurveyQuestionDetails = $db->query($currentSurveyQuestionQuery);
        while ($currentSurveyQuestionData = $db->fetchByAssoc($currentSurveyQuestionDetails)) {
            $currentSurveyQuestionList[$currentSurveyQuestionData['id']] = array(
                "question_name" => htmlspecialchars($currentSurveyQuestionData['name']),
                "question_type" => $currentSurveyQuestionData['question_type']
            );
        }
        $totalSurveyList = array();
        //compared surveys details for dropdown
        $totalSurveyQuery = "SELECT
                        id,name
                      FROM
                        bc_survey
                      WHERE
                        deleted = 0 AND id != '{$survey_id}' 
                        and survey_type = '{$currentSurveyType}'";
        $totalSurveyDetails = $db->query($totalSurveyQuery);
        while ($totalSurveyData = $db->fetchByAssoc($totalSurveyDetails)) {
            $totalSurveyList[$totalSurveyData['id']] = htmlspecialchars($totalSurveyData['name']);
        }

        if ($comparison_report_id != "") {
            //add compared survey details
            $editComparisonReportQuery = "SELECT
                           *
                          FROM
                            bc_survey_comparison_crosstab_report
                          WHERE
                            current_survey_id = '{$survey_id}' AND deleted = 0 AND id='{$comparison_report_id}'";
            $editComparisonReportDetails = $db->query($editComparisonReportQuery);
            $editComparisonReportData = $db->fetchByAssoc($editComparisonReportDetails);
        } else {
            $editComparisonReportData = "";
        }
        return array('currentSurveyDetails' => $currentSurvey, 'comparedSurveyDetails' => $totalSurveyList, 'currentSurveyQuestionList' => $currentSurveyQuestionList, 'editComparisonReport' => $editComparisonReportData);
    }

    /**
     * Function : get compared survey question names
     *   Retrieve selected question type from compared survey for compare report
     * 
     * @return array - $data
     */
    public function get_comparison_report_question_name($api, $args) {
        require_once 'custom/include/utilsfunction.php';
        $compare_survey_id = $args['compare_survey_id'];
        $current_survey_questionId = $args['current_survey_questionId'];
        $current_survey_questionType = $args['current_survey_questionType'];
        $comparison_reportId = $args['comparison_reportId'];
        global $db, $current_user, $app_list_strings, $dotb_config;
        if ($current_survey_questionType == 'rating') {
            //currentSurvey max size for question type rating
            $currentSurveyMaxSizeQuery = "SELECT maxsize FROM bc_survey_questions WHERE id = '{$current_survey_questionId}'";
            $currentSurveyMaxSizeDetails = $db->query($currentSurveyMaxSizeQuery);
            $currentSurveyMaxSizeData = $db->fetchByAssoc($currentSurveyMaxSizeDetails);
            $currentSurveyMaxSize = $currentSurveyMaxSizeData['maxsize'];
        } else {
            $optionCountQ = "SELECT
                      ...
                      FROM
                        bc_survey_answers
                      LEFT JOIN
                        bc_survey_answers_bc_survey_questions_c ON bc_survey_answers_bc_survey_questions_c.bc_survey_answers_bc_survey_questionsbc_survey_answers_idb = bc_survey_answers.id AND bc_survey_answers.deleted = 0 AND bc_survey_answers_bc_survey_questions_c.deleted = 0
                      WHERE
                        bc_survey_answers_bc_survey_questions_c.bc_survey_answers_bc_survey_questionsbc_survey_questions_ida = '{$current_survey_questionId}'";
            $optionCountDetails = $db->query($optionCountQ);
            $optionCountData = $db->fetchByAssoc($optionCountDetails);
            $currentOptionCount = $optionCountData['optionCount'];
        }

        //compared survey details
        $comparedSurveyQuery = "SELECT name,survey_type FROM bc_survey WHERE deleted = 0 AND id='{$compare_survey_id}'";
        $comparedSurveyDetails = $db->query($comparedSurveyQuery);
        $comparedSurveyData = $db->fetchByAssoc($comparedSurveyDetails);
        $comparedSurveyId = $compare_survey_id;
        $comparedSurveyName = $comparedSurveyData['name'];
        $comparedSurveyType = $comparedSurveyData['survey_type'];
        $comparedSurvey = array();
        $comparedSurvey[$comparedSurveyId] = $comparedSurveyName;
        $totalSurveyList = array();

        //compared survey question list
        $comparedSurveyQuestionQuery = "SELECT
                            bc_survey_questions.id,
                            bc_survey_questions.name,
                            bc_survey_questions.question_type
                          FROM
                          ...
                          LEFT JOIN
                            bc_survey_bc_survey_questions_c ON bc_survey_bc_survey_questions_c.bc_survey_bc_survey_questionsbc_survey_questions_idb = bc_survey_questions.id AND bc_survey_questions.deleted = 0 AND bc_survey_bc_survey_questions_c.deleted = 0
                          WHERE
                            bc_survey_bc_survey_questions_c.bc_survey_bc_survey_questionsbc_survey_ida = '{$comparedSurveyId}' AND bc_survey_questions.question_type = '{$current_survey_questionType}' ";
        if ($current_survey_questionType == 'rating') {
            $comparedSurveyQuestionQuery .= " AND  bc_survey_questions.maxsize = {$currentSurveyMaxSize}";
        }
        $comparedSurveyQuestionDetails = $db->query($comparedSurveyQuestionQuery);
        while ($comparedSurveyQuestionData = $db->fetchByAssoc($comparedSurveyQuestionDetails)) {
            $compareAnsCountQ = "SELECT
                    count(*) as count
                    FROM
                      bc_survey_answers
                    LEFT JOIN
                      bc_survey_answers_bc_survey_questions_c ON bc_survey_answers_bc_survey_questions_c.bc_survey_answers_bc_survey_questionsbc_survey_answers_idb = bc_survey_answers.id AND bc_survey_answers.deleted = 0 AND bc_survey_answers_bc_survey_questions_c.deleted = 0
                    WHERE
                      bc_survey_answers_bc_survey_questions_c.bc_survey_answers_bc_survey_questionsbc_survey_questions_ida = '{$comparedSurveyQuestionData['id']}'";
            $compareAnsCountDetails = $db->query($compareAnsCountQ);
            $compareAnsCountData = $db->fetchByAssoc($compareAnsCountDetails);
            $compareAnsCount = $compareAnsCountData['count'];
            if ($current_survey_questionType != 'rating') {
                if ($currentOptionCount == $compareAnsCount) {
                    $comparedSurveyQuestionList[$comparedSurveyQuestionData['id']] = array(
                        "question_name" => htmlspecialchars($comparedSurveyQuestionData['name']),
                        "question_type" => $comparedSurveyQuestionData['question_type']
                    );
                }
            } else {
                $comparedSurveyQuestionList[$comparedSurveyQuestionData['id']] = array(
        ...
        return array('comparedSurveyDetails' => $comparedSurvey, 'comparedSurveyQuestionList' => $comparedSurveyQuestionList, 'editComparisonReport' => $editComparisonReportData);
    }

    /**
     * Function : List of Comparison Report Generated
     *   list of the comparison for that particular survey
     * 
     * @return array - $data
     */
    public function list_comparison_report($api, $args) {
        require_once 'custom/include/utilsfunction.php';
        $survey_id = $args['survey_id'];
        global $db, $current_user, $app_list_strings, $dotb_config;
        $comparisonReportList = array();
        $firstChartDataFlag = 0;

        //check for submission of survey
        $subCoutnQ = "SELECT
            COUNT(submission.id) AS idCount
          FROM
            bc_survey_submission AS submission
          INNER JOIN
            bc_survey_submission_bc_survey_c AS relation ON relation.bc_survey_submission_bc_surveybc_survey_submission_idb = submission.id
          WHERE
            relation.bc_survey_submission_bc_surveybc_survey_ida = '{$survey_id}' AND submission.deleted = 0";
        $subCoutnDetails = $db->query($subCoutnQ);
        $subCoutnData = $db->fetchByAssoc($subCoutnDetails);
        $subCount = $subCoutnData['idCount'];

        //compared survey question list
        $comparisonReportQuery = "SELECT
                           *
                          FROM
                            bc_survey_comparison_crosstab_report
                          WHERE
                            current_survey_id = '{$survey_id}' AND deleted = 0 AND report_type = 'comparison_report' ORDER BY bc_survey_comparison_crosstab_report.date_entered  DESC";
        $comparisonReportDetails = $db->query($comparisonReportQuery);
        while ($comparisonReportData = $db->fetchByAssoc($comparisonReportDetails)) {
            $comparedSurveyQuestionList[$comparisonReportData['id']] = $comparisonReportData;
            $comparedSurveyQuestionList[$comparisonReportData['id']]['current_survey_name'] = $comparisonReportData['current_survey_name'];
            $comparedSurveyQuestionList[$comparisonReportData['id']]['compared_survey_name'] = $comparisonReportData['compared_survey_name'];
            $comparedSurveyQuestionList[$comparisonReportData['id']]['current_question_name_or_x_axis_question_name'] = $comparisonReportData['current_question_name_or_x_axis_question_name'];
            $comparedSurveyQuestionList[$comparisonReportData['id']]['compared_question_name_or_y_axis_question_name'] = $comparisonReportData['compared_question_name_or_y_axis_question_name'];
            $comparedSurveyQuestionList[$comparisonReportData['id']]['date_entered'] = TimeDate::getInstance()->to_display_date_time($comparisonReportData['date_entered']);
            if ($firstChartDataFlag == 0) {
                $firstChartDataFlag = 1;
                $firstChartData = comparisonChartData($comparisonReportData);
                $firstChartData['title'] = htmlspecialchars($comparisonReportData['name']);
                $firstChartData['id'] = $comparisonReportData['id'];
                $firstChartData['current_survey'] = $comparisonReportData['current_survey_name'];
                $firstChartData['compare_survey'] = $comparisonReportData['compared_survey_name'];
                $firstChartData['current_question'] = $comparisonReportData['current_question_name_or_x_axis_question_name'];
                $firstChartData['compare_question'] = $comparisonReportData['compared_question_name_or_y_axis_question_name'];
            }
        }
        $list_max_entries_per_page = !empty($dotb_config['list_max_entries_per_page']) ? $dotb_config['list_max_entries_per_page'] : 20;
        return array('comparisonReportDetails' => $comparedSurveyQuestionList, 'compareChart_details' => $firstChartData, 'max_record' => $list_max_entries_per_page, 'subCount' => $subCount);
    }

    /**
     * Function : Add Created Comparison Report in db
     *   Add created comparison report data in database
     * 
     * @return array - $data
     */
    public function create_comparison_report($api, $args) {
        require_once 'custom/include/utilsfunction.php';
        global $db, $current_user, $app_list_strings, $dotb_config;
        $comparison_reportId = $args['comparison_reportId'];
        if ($comparison_reportId == "") {
            ...
            $id = $comparison_reportId;
        }
        $editComparisonReport = 0;
        $name = $args['name'];
        $date_entered = date("Y-m-d h:i:s");
        $date_modified = date("Y-m-d h:i:s");
        $modified_user_id = $current_user->id;
        $created_by = $current_user->id;
        $current_survey_id = $args['current_survey_id'];
        $compared_survey_id = $args['compared_survey_id'];
        $current_survey_name = $args['current_survey_name'];
        $compared_survey_name = $args['compared_survey_name'];
        $current_question_id_or_x_axis_question_id = explode('_', $args['current_question_id_or_x_axis_question_id']);
        $compared_question_id_or_y_axis_question_id = $args['compared_question_id_or_y_axis_question_id'];
        $current_question_name_or_x_axis_question_name = $args['current_question_id_or_x_axis_question_name'];
        $compared_question_name_or_y_axis_question_name = $args['compared_question_id_or_y_axis_question_name'];
        $report_type = $args['report_type'];
        $addComparisonReport = array();
        if ($comparison_reportId == "") {
            $editComparisonReport = 0;
            //add compared survey details
            $db->query("INSERT
            INTO
              bc_survey_comparison_crosstab_report(
                ...
                compared_survey_id,
                current_survey_name,
                compared_survey_name,
                current_question_id_or_x_axis_question_id,
                compared_question_id_or_y_axis_question_id,
                current_question_name_or_x_axis_question_name,
                compared_question_name_or_y_axis_question_name,
                report_type
              )
            VALUES(
              '{$id}',
              ...
              '{$current_survey_name}',
              '{$compared_survey_name}',
              '{$current_question_id_or_x_axis_question_id['0']}',
              '{$compared_question_id_or_y_axis_question_id}',
              '{$current_question_name_or_x_axis_question_name}',
              '{$compared_question_name_or_y_axis_question_name}',
              '{$report_type}'
            ...
            $editComparisonReport = 1;
            //edit compared survey details
            $db->query("UPDATE
                bc_survey_comparison_crosstab_report
              SET
                name = '{$name}',
                ...
                compared_survey_id = '{$compared_survey_id}',
                current_survey_name = '{$current_survey_name}',
                compared_survey_name = '{$compared_survey_name}',
                current_question_id_or_x_axis_question_id = '{$current_question_id_or_x_axis_question_id['0']}',
                compared_question_id_or_y_axis_question_id = '{$compared_question_id_or_y_axis_question_id}',
                current_question_name_or_x_axis_question_name = '{$current_question_name_or_x_axis_question_name}',
                compared_question_name_or_y_axis_question_name = '{$compared_question_name_or_y_axis_question_name}'
                WHERE 
                id = '{$id}'
  ");
        }
        //compared survey question list
        $comparisonTotalQuery = "SELECT
                           COUNT(*) as TotalCount
                          FROM
                            bc_survey_comparison_crosstab_report
                          WHERE
                            current_survey_id = '{$current_survey_id}' AND deleted = 0 AND report_type='{$report_type}'";
        $comparisonTotalDetails = $db->query($comparisonTotalQuery);
        $comparisonTotalData = $db->fetchByAssoc($comparisonTotalDetails);
        $newComparisonReport = array(
            'id' => $id,
            'name' => $name,
            'date_entered' => TimeDate::getInstance()->to_display_date_time($date_entered),
            'date_modified' => $date_modified,
            'modified_user_id' => $modified_user_id,
        ...
        $firstCompareReport[$id] = $newComparisonReport;
        $compareChart_details = comparisonChartData($newComparisonReport);
        $compareChart_details['title'] = $newComparisonReport['name'];
        $compareChart_details['id'] = $newComparisonReport['id'];
        $list_max_entries_per_page = !empty($dotb_config['list_max_entries_per_page']) ? $dotb_config['list_max_entries_per_page'] : 20;
        return array('comparisonReportDetails' => $newComparisonReport, 'compareChart_details' => $compareChart_details, 'comparisonTotalData' => $comparisonTotalData, 'firstCompareReport' => $firstCompareReport, 'editComparisonReport' => $editComparisonReport, 'max_record' => $list_max_entries_per_page);
    }

    /**
     * Function : Delete Comparison Report in db
     *   Delete comparison report data in database
     * 
     * @return array - $data
     */
    public function delete_comparison_report($api, $args) {
        require_once 'custom/include/utilsfunction.php';
        global $db, $current_user, $app_list_strings, $dotb_config;
        $comparison_reportId = $args['comparison_report_id'];
        $survey_id = $args['survey_id'];
        //add compared survey details
        $db->query("UPDATE bc_survey_comparison_crosstab_report SET deleted = 1 WHERE id = '{$comparison_reportId}' AND report_type = 'comparison_report'");
        $firstchart = $this->list_comparison_report('', $args);
        $compareChart_details = $firstchart['compareChart_details'];
        $list_max_entries_per_page = !empty($dotb_config['list_max_entries_per_page']) ? $dotb_config['list_max_entries_per_page'] : 20;
        return array('comparison_reportId' => $comparison_reportId, 'compareChart_details' => $compareChart_details, 'max_record' => $list_max_entries_per_page);
    }

    /**
     * Function : Edit Comparison Report in db
     *   Edit comparison report data in database
     * 
     * @return array - $data
     */
    public function edit_comparison_report($api, $args) {
        require_once 'custom/include/utilsfunction.php';
        global $db, $current_user, $app_list_strings, $dotb_config;
        $comparison_reportId = $args['comparison_report_id'];
        $survey_id = $args['survey_id'];

        return array('editComparisonReport' => $editComparison);
    }
     ...
     * @return array - $data
     */
    public function loadComparisonReportChart($api, $args) {
        require_once 'custom/include/utilsfunction.php';
        global $db, $current_user, $app_list_strings, $dotb_config;
        $comparison_reportId = $args['comparison_report_id'];
        $survey_id = $args['survey_id'];
        ...
        $comparisonReportQuery = "SELECT
                          ...
                          FROM
                            bc_survey_comparison_crosstab_report
                          WHERE
                            current_survey_id = '{$survey_id}' AND deleted = 0 AND id='{$comparison_reportId}'";
        $comparisonReportDetails = $db->query($comparisonReportQuery);
        $comparisonFirstData = $db->fetchByAssoc($comparisonReportDetails);
        $loadComparisonReport = comparisonChartData($comparisonFirstData);
        $loadComparisonReport['title'] = $comparisonFirstData['name'];
        $loadComparisonReport['id'] = $comparisonFirstData['id'];
        $loadComparisonReport['current_question'] = $comparisonFirstData['current_question_name_or_x_axis_question_name'];
        $loadComparisonReport['compared_question'] = $comparisonFirstData['compared_question_name_or_y_axis_question_name'];
        $loadComparisonReport['current_survey'] = $comparisonFirstData['current_survey_name'];
        $loadComparisonReport['compare_survey'] = $comparisonFirstData['compared_survey_name'];
        return array('compareChart_details' => $loadComparisonReport);
    }

    /**
     * Function : getSearchComparisonResult
     *    get search result for comparison report
     * 
     * @return array - $reponse 
     */
    public function getSearchComparisonResult($api, $args) {
        require_once 'custom/include/utilsfunction.php';
        global $app_list_strings, $dotb_config;
        $getRequestData = $args['newData'];
        $dataArray = json_decode(html_entity_decode($getRequestData));
        $postDataArray = array(
            ...
            'report_type' => $dataArray->report_type,
            'page' => $dataArray->page,
            'sort_by' => $dataArray->sort_by,
            'sort_order' => $dataArray->sort_order,
            'searchby' => $dataArray->searchby,
        );
        $survey_id = $postDataArray['survey_id'];
        $report_type = $postDataArray['report_type'];
        $page = $postDataArray['page'];
        $sort_by = $postDataArray['sort_by'];
        $sort_order = $postDataArray['sort_order'];
        $searchby = $postDataArray['searchby'];

        $records = getComparisonSearchData($survey_id, $report_type, $page, $sort_by, $sort_order, $searchby);
        if (count($records['searchData']) > 0) {
            //set pagination
            $pagination = new pagination($records['searchData'], (isset($page) ? $page : 1), 10);
            $pagination->setShowFirstAndLast(true);
            $IndividualReportData = $pagination->getResults();
            $post_data = array();
            if (count($IndividualReportData) != 0) {
            ...
            $list_max_entries_per_page = !empty($dotb_config['list_max_entries_per_page']) ? $dotb_config['list_max_entries_per_page'] : 20;
            return array('records' => $records['searchData'], 'Individual_Report_pageNumbers' => $Individual_Report_pageNumbers, 'ComparisonReportData' => $records['searchData'], 'max_records' => $list_max_entries_per_page, 'compareChart_details' => $records['comparisonchartDetails']);
        }
    }

    /**
     * Function : get_crosstab_report_question_name
     *    get crosstab report question name
     * 
     * @return array - $reponse 
     */
    public function get_crosstab_report_question_name($api, $args) {
        require_once 'custom/include/utilsfunction.php';
        global $db, $app_list_strings, $dotb_config;

        $survey_id = $args['survey_id'];
        $crosstab_report_id = $args['crosstab_report_id'];
        //current survey question list
        $crosstabQuestionName = array();
        $currentSurveyQuestionQuery = "SELECT
                            bc_survey_questions.id,
                            bc_survey_questions.name,
                            bc_survey_questions.question_type
        ...
        $currentSurveyQuestionDetails = $db->query($currentSurveyQuestionQuery);
        while ($currentSurveyQuestionData = $db->fetchByAssoc($currentSurveyQuestionDetails)) {
            $crosstabQuestionName[$currentSurveyQuestionData['id']] = array(
                "question_name" => htmlspecialchars($currentSurveyQuestionData['name']),
                "question_type" => $currentSurveyQuestionData['question_type']
            );
        }

        if ($crosstab_report_id != "") {
            //add compared survey details
            $editCrosstabReportQuery = "SELECT
                           *
                          FROM
                            bc_survey_comparison_crosstab_report
                          WHERE
                            current_survey_id = '{$survey_id}' AND deleted = 0 AND id='{$crosstab_report_id}'";
            $editCrosstabReportDetails = $db->query($editCrosstabReportQuery);
            $editCrosstabReport = $db->fetchByAssoc($editCrosstabReportDetails);
        } else {
            $editCrosstabReport = "";
        }
        return array('crosstabQuestionName' => $crosstabQuestionName, 'editCrosstabReport' => $editCrosstabReport);
    }

    /**
     * Function : List of Crosstab Report Generated
     *   list of the comparison for that particular survey
     * 
     * @return array - $data
     */
    public function list_crosstab_report($api, $args) {
        require_once 'custom/include/utilsfunction.php';
        $survey_id = $args['survey_id'];
        global $db, $dotb_config;
        $crosstabReportList = array();
        $firstChartDataFlag = 0;
        ...
        //compared survey question list
        $crosstabReportQuery = "SELECT
                           *
                          FROM
                            bc_survey_comparison_crosstab_report
                          WHERE
                            current_survey_id = '{$survey_id}' AND deleted = 0 AND report_type = 'crosstab_report' ORDER BY bc_survey_comparison_crosstab_report.date_entered  DESC";
        $crosstabReportDetails = $db->query($crosstabReportQuery);
        while ($crosstabReportData = $db->fetchByAssoc($crosstabReportDetails)) {
            $crosstabSurveyQuestionList[$crosstabReportData['id']] = $crosstabReportData;
            $crosstabSurveyQuestionList[$crosstabReportData['id']]['current_survey_name'] = $crosstabReportData['current_survey_name'];
            $crosstabSurveyQuestionList[$crosstabReportData['id']]['compared_survey_name'] = $crosstabReportData['compared_survey_name'];
            $crosstabSurveyQuestionList[$crosstabReportData['id']]['current_question_name_or_x_axis_question_name'] = $crosstabReportData['current_question_name_or_x_axis_question_name'];
            $crosstabSurveyQuestionList[$crosstabReportData['id']]['compared_question_name_or_y_axis_question_name'] = $crosstabReportData['compared_question_name_or_y_axis_question_name'];
            $crosstabSurveyQuestionList[$crosstabReportData['id']]['date_entered'] = TimeDate::getInstance()->to_display_date_time($crosstabReportData['date_entered']);
            if ($firstChartDataFlag == 0) {
                $firstChartDataFlag = 1;
                $firstChartData = crosstabChartData($crosstabReportData);
                $firstChartData['title'] = htmlspecialchars($crosstabReportData['name']);
                $firstChartData['id'] = $crosstabReportData['id'];
                $firstChartData['current_survey'] = $crosstabReportData['current_survey_name'];
                $firstChartData['compare_survey'] = $crosstabReportData['compared_survey_name'];
                $firstChartData['current_question'] = $crosstabReportData['current_question_name_or_x_axis_question_name'];
                $firstChartData['compare_question'] = $crosstabReportData['compared_question_name_or_y_axis_question_name'];
            }
        }
        $list_max_entries_per_page = !empty($dotb_config['list_max_entries_per_page']) ? $dotb_config['list_max_entries_per_page'] : 20;
        return array('crosstabReportDetails' => $crosstabSurveyQuestionList, 'crosstabChart_details' => $firstChartData, 'max_record' => $list_max_entries_per_page, 'subCount' => $subCount);
    }
     ...
     * @return array - $data
     */
    public function create_crosstab_report($api, $args) {
        require_once 'custom/include/utilsfunction.php';
        global $db, $current_user, $app_list_strings, $dotb_config;
        $crosstab_reportId = $args['crosstab_reportId'];
        if ($crosstab_reportId == "") {
            $id = create_guid();
        } else {
            $id = $crosstab_reportId;
        }
        $surveyNameQuery = "SELECT name from bc_survey WHERE id='{$args['current_survey_id']}'";
        $surveyNameDetails = $db->query($surveyNameQuery);
        $surveyNameData = $db->fetchByAssoc($surveyNameDetails);
        $surveyName = htmlspecialchars($surveyNameData['name']);

        $editCrosstabReport = 0;
        $name = $args['name'];
        $date_entered = date("Y-m-d h:i:s");
        $date_modified = date("Y-m-d h:i:s");
        $modified_user_id = $current_user->id;
        $created_by = $current_user->id;
        $current_survey_id = $args['current_survey_id'];
        $compared_survey_id = $args['current_survey_id'];
        $current_survey_name = $surveyName;
        $compared_survey_name = $surveyName;
        $current_question_id_or_x_axis_question_id = explode('_', $args['current_question_id_or_x_axis_question_id']);
        $compared_question_id_or_y_axis_question_id = explode('_', $args['compared_question_id_or_y_axis_question_id']);
        $current_question_name_or_x_axis_question_name = $args['current_question_id_or_x_axis_question_name'];
        $compared_question_name_or_y_axis_question_name = $args['compared_question_id_or_y_axis_question_name'];
        $report_type = $args['report_type'];
        $addComparisonReport = array();
        if ($crosstab_reportId == "") {
            ...
            VALUES(
              ...
              '{$compared_survey_name}',
              '{$current_question_id_or_x_axis_question_id['0']}',
              '{$compared_question_id_or_y_axis_question_id['0']}',
              '{$current_question_name_or_x_axis_question_name}',
              '{$compared_question_name_or_y_axis_question_name}',
              '{$report_type}'
            )");
        } else {
            $editCrosstabReport = 1;
            //edit compared survey details
            $db->query("UPDATE
                bc_survey_comparison_crosstab_report
              SET
                ...
                compared_survey_name = '{$compared_survey_name}',
                current_question_id_or_x_axis_question_id = '{$current_question_id_or_x_axis_question_id['0']}',
                compared_question_id_or_y_axis_question_id = '{$compared_question_id_or_y_axis_question_id['0']}',
                current_question_name_or_x_axis_question_name = '{$current_question_name_or_x_axis_question_name}',
                compared_question_name_or_y_axis_question_name = '{$compared_question_name_or_y_axis_question_name}'
                WHERE 
                id = '{$id}'
  ");
        ...
        //crosstab survey question list
        $crosstabTotalQuery = "SELECT
                           COUNT(*) as TotalCount
                          FROM
                            bc_survey_comparison_crosstab_report
                          WHERE
                            current_survey_id = '{$current_survey_id}' AND deleted = 0 AND report_type='{$report_type}'";
        $crosstabTotalDetails = $db->query($crosstabTotalQuery);
        $crosstabTotalData = $db->fetchByAssoc($crosstabTotalDetails);
        $newCrosstabReport = array(
            'id' => $id,
            'name' => $name,
            'date_entered' => TimeDate::getInstance()->to_display_date_time($date_entered),
            'date_modified' => $date_modified,
        ...
        $firstCrosstabReport[$id] = $newCrosstabReport;
        $crosstabChart_details = crosstabChartData($newCrosstabReport);
        $crosstabChart_details['title'] = $newCrosstabReport['name'];
        $crosstabChart_details['id'] = $newCrosstabReport['id'];
        $crosstabChart_details['current_question'] = $newCrosstabReport['current_question_name_or_x_axis_question_name'];

        $list_max_entries_per_page = !empty($dotb_config['list_max_entries_per_page']) ? $dotb_config['list_max_entries_per_page'] : 20;
        return array('crosstabReportDetails' => $newCrosstabReport, 'crosstabChart_details' => $crosstabChart_details, 'crosstabTotalData' => $crosstabTotalData, 'firstCrosstabReport' => $firstCrosstabReport, 'editCrosstabReport' => $editCrosstabReport, 'max_record' => $list_max_entries_per_page);
    }

    function openCrosstabChartOptionsModel($api, $args) {
        $chartArrayOnQType = array(
            'crosstab' => array(
                'groupcolumnchart' => array('title' => 'Group Column Chart', 'src' => 'custom/include/images/groupcolumnchart.png'),
                'stackedcolumnchart' => array('title' => 'Stacked Column Chart', 'src' => 'custom/include/images/stackedcolumnchart.png'),
        ...
        $htmlContent = "<div class='bottom' id='switchChartModel' style='border: solid 2px grey;min-width: 200px !important;'>
                            <div style='float: right;top: -13px;position: relative;left: 21px;'><img style='cursor: pointer;' id='closeCrosstabChartModel' width='30px' src='custom/include/images/close.png' /></div>
                            <div style=''><h4>Chart Type</h4></div>
                            <div><br/></div>
                            <div id='different_charts' style='margin-top:-12px;margin-left:8px;'>";
        foreach ($chartArrayOnQType['crosstab'] as $chartType => $qContent) {
            $title = $qContent['title'];
            $src = $qContent['src'];
            $htmlContent .= "<div title='{$title}' style='cursor: pointer;display:inline;font-size: 14px;margin-right: 10px;' class='crosstabChangeChart' id='crosstab_{$chartType}'>";
            $htmlContent .= "<img src='{$src}' style='margin-left: 5px;height: 16px;width: 16px;'>";
            $htmlContent .= " </div>";
        }
        $htmlContent .= "</div><div style='margin-top: 10px;border-bottom: 2px solid #dddddd;'></div>";
    ...
    /**
     * Function : Delete Crosstab Report in db
     *   Delete crosstab report data in database
     * 
     * @return array - $data
     */
    public function delete_crosstab_report($api, $args) {
        require_once 'custom/include/utilsfunction.php';
        global $db;
        $crosstab_reportId = $args['crosstab_report_id'];
        $survey_id = $args['survey_id'];
        //add compared survey details
        $db->query("UPDATE bc_survey_comparison_crosstab_report SET deleted = 1 WHERE id = '{$crosstab_reportId}' AND report_type = 'crosstab_report'");
        $firstchart = $this->list_crosstab_report('', $args);
        $crosstabChart_details = $firstchart['crosstabChart_details'];
        $list_max_entries_per_page = !empty($dotb_config['list_max_entries_per_page']) ? $dotb_config['list_max_entries_per_page'] : 20;

        return array('crosstab_reportId' => $crosstab_reportId, 'crosstabChart_details' => $crosstabChart_details, 'max_record' => $list_max_entries_per_page);
    }

    /**
     * Function : loadCrosstabReportChart
     *   Load Crosstab report Chaty
     * 
     * @return array - $data
     */
    public function loadCrosstabReportChart($api, $args) {
        require_once 'custom/include/utilsfunction.php';
        global $db, $current_user, $app_list_strings, $dotb_config;
        $crosstab_reportId = $args['crosstab_report_id'];
        $survey_id = $args['survey_id'];
        ...
        $crosstabReportQuery = "SELECT
                          ...
                          FROM
                            bc_survey_comparison_crosstab_report
                          WHERE
                            current_survey_id = '{$survey_id}' AND deleted = 0 AND id='{$crosstab_reportId }'";
        $crosstabReportDetails = $db->query($crosstabReportQuery);
        $crosstabFirstData = $db->fetchByAssoc($crosstabReportDetails);
        $loadCrosstabReport = crosstabChartData($crosstabFirstData);
        $loadCrosstabReport['title'] = $crosstabFirstData['name'];
        $loadCrosstabReport['id'] = $crosstabFirstData['id'];
        $loadCrosstabReport['current_question'] = $crosstabFirstData['current_question_name_or_x_axis_question_name'];

        return array('crosstabChart_details' => $loadCrosstabReport);
    }

    /**
     * Function : getSearchCrosstabResult
     *    get search result for comparison report
     * 
     * @return array - $reponse 
     */
    public function getSearchCrosstabResult($api, $args) {
        require_once 'custom/include/utilsfunction.php';
        global $app_list_strings, $dotb_config;
        $getRequestData = $args['newData'];
        $dataArray = json_decode(html_entity_decode($getRequestData));
        ...
        $records = getCrosstabSearchData($survey_id, $report_type, $page, $sort_by, $sort_order, $searchby);
        if (count($records) > 0) {
            //set pagination
            $pagination = new pagination($records, (isset($page) ? $page : 1), 10);
            $pagination->setShowFirstAndLast(true);
            ...
            $list_max_entries_per_page = !empty($dotb_config['list_max_entries_per_page']) ? $dotb_config['list_max_entries_per_page'] : 20;
            return array('records' => $records, 'Individual_Report_pageNumbers' => $Individual_Report_pageNumbers, 'CrosstabReportData' => $records, 'max_record' => $list_max_entries_per_page);
        }
    }

    /**
     * Function : save_surveysms_setting
     * Save Survey SMS setting to send survey link through SMS
     * 
     * @return array - $reponse 
     */
    public function save_surveysms_setting($api, $args) {
        require_once('modules/Administration/Administration.php');
        $administrationObj = new Administration();
     ...
     * @return array - $reponse 
     */
    public function immediateSendSurveyFromSMS($api, $args) {
        global $db, $dotb_config;
        $records = $args['selected_data_id'];
        ...
        switch ($module_name) {
            case "Accounts":
                $db_module_name = 'accounts';
                break;
            case "Contacts":
                $db_module_name = 'contacts';
                break;
            case "Leads":
                $db_module_name = 'leads';
                break;
            case "Prospects":
                $db_module_name = 'prospects';
                break;
        }

        $fieldValues = array();
        $toNumberFields = implode(',', $args['toNumberField']);
        $toNumberFieldData = $args['toNumberData'];
        $selectQuery = "SELECT id," . $toNumberFields . " FROM " . $db_module_name . " WHERE id IN ('{$records}') ";
        $fieldDetails = $db->query($selectQuery);
        while ($fieldDataAll = $db->fetchByAssoc($fieldDetails)) {
            $fieldData[$fieldDataAll['id']] = $fieldDataAll;
        }
        $dataArray = sendSurveyEmailsModuleRecords($records, $module_name, $survey_id, '', '', true, '', '', $module_name, $records, false, 0, $sendBy, $fieldData, $toNumberFieldData);
        ...
        if ($dataArray['is_send'] == 'scheduled') {
            ...
            //retrieve record name of given module
            $focus->retrieve($records);
            $record_name = $focus->name;

            /* Do same for sms template module */
            $smstemplateObj = new bc_survey_sms_template();
            $smstemplateObj->retrieve($template_id);
            //retrieve survey title
            $oSurvey = new bc_survey();
            $oSurvey->retrieve($args['survey_id']);
            $survey_title = $oSurvey->name;
            ...
            $survey_sms['fields'] = json_encode($dataArray['mobile_numberlist']);
            $survey_sms['record_id'] = $records;
            $survey_sms['survey_title'] = $survey_title;

            if (!empty($survey_sms_sid) && !empty($survey_sms_token) && !empty($survey_sms_fromPhoneNumber)) {
                if ($sendBy == "sms") {
                    $sendSMS = sendSMS($survey_sms);
                } else if ($sendBy == "whatsapp") {
                    $sendSMS = sendWhatsApp($survey_sms, $dataArray["submission_id"], $survey_url);
                }
            }
...
//            $sendMail = CustomSendEmail($to_Email, $emailSubject, $emailBody, $args['records'], $args['module_name'], '');
            ...
            if (trim($sendSMS['success']) == 'send') {
                ...
                $survey_submission->save();
                if ($sendBy == "whatsapp") {
                    $send_number = json_decode($survey_submission->to_be_sms_send_field, true);
                }
                $isSendSuccess = 'send';
        ...
        $customersSummary['unsubscribeCustomers'] = isset($dataArray['unsubscribeCustomers']) ? $dataArray['unsubscribeCustomers'] : '';
        $total_selected = !isset($args['total_selected']) ? $args['total_selected'] : 1;
        if ($sendBy == "whatsapp" && $sendSMS['success'] == 'send') {
            foreach ($dataArray['mobile_numberlist'] as $field => $number) {
                if (!in_array($number, $send_number)) {
                    if ($dataArray['sms_optOut'] == "") {
                        $dataArray['sms_optOut']['records'][$records]['mobile_number'] = $toNumberFieldData[$field] . ": " . $number;
                    } else {
                        $dataArray['sms_optOut']['records'][$records]['mobile_number'] = $dataArray['sms_optOut']['records'][$records]['mobile_number'] . ',' . $toNumberFieldData[$field] . ': ' . $number;
                    }
                }
            }
            $dataArray['sms_optOutCount'] = count($dataArray['sms_optOut']['records']);
        }
        $customersSummary['sms_optOut'] = isset($dataArray['sms_optOut']) ? $dataArray['sms_optOut'] : '';
        $customersSummary['sms_optOutCount'] = isset($dataArray['sms_optOutCount']) ? $dataArray['sms_optOutCount'] : '';
        $contentPopUP = createContentForMailStatusPopup($customersSummary, $survey_id, $module_name, $total_selected, $isSendNow, $record_name, $isSendSuccess, $isDetailView, $surveySingularModule, $sendBy);
        $returnDataArray['contentPopUP'] = $contentPopUP;
        $returnDataArray = json_encode($returnDataArray);
        return $returnDataArray;
    }
    ...
    /**
     * Function : SendSurveyFromSMS
     * Send Survey SMS from list view
     * 
     * @return array - $reponse 
     */
    public function SendSurveyFromSMS($api, $args) {
        global $db;
        require_once 'custom/include/utilsfunction.php';
        $customersSummary = array();
        $returnDataArray = array();
        ...
        $toNumberFields = implode(',', $args['toNumberField']);
        $toNumberFieldData = $args['toNumberData'];
        $recoed_id = explode(',', $records);
        $record_id = "'" . implode("','", $recoed_id) . "'";
        $selectQuery = "SELECT id," . $toNumberFields . " FROM " . $db_module_name . " WHERE id IN ({$record_id}) ";
        $fieldDetails = $db->query($selectQuery);
        while ($fieldDataAll = $db->fetchByAssoc($fieldDetails)) {
            $fieldData[$fieldDataAll['id']] = $fieldDataAll;
        }
        $dataArray = sendSurveyEmailsModuleRecords($records, $module_name, $survey_id, '', '', false, '', '', $module_name, $records, false, 0, $sendBy, $fieldData, $toNumberFieldData);
        $is_processed = $dataArray['is_send'];
        $customersSummary['MailSentSuccessfullyFirstTime'] = isset($dataArray['MailSentSuccessfullyFirstTime']) ? $dataArray['MailSentSuccessfullyFirstTime'] : '';
        $customersSummary['ResponseSubmitted'] = isset($dataArray['ResponseSubmitted']) ? $dataArray['ResponseSubmitted'] : '';
        $customersSummary['ResponseNotSubmitted'] = isset($dataArray['ResponseNotSubmitted']) ? $dataArray['ResponseNotSubmitted'] : '';
        ...
        $customersSummary['sms_optOut'] = isset($dataArray['sms_optOut']) ? $dataArray['sms_optOut'] : '';
        $customersSummary['sms_optOutCount'] = isset($dataArray['sms_optOutCount']) ? $dataArray['sms_optOutCount'] : '';
        $contentPopUP = createContentForMailStatusPopup($customersSummary, $survey_id, $module_name, $total_seleted_records, false, '', '', '', $surveySingularModule, $sendBy);
        $returnDataArray['mailStatus'] = $is_processed;
        $returnDataArray['contentPopUP'] = $contentPopUP;
        $returnDataArray = json_encode($returnDataArray);
        return $returnDataArray;
    ...
    /**
     * Function : getFromAndToNumber
     * get from number from sms setting
     * 
     * @return array - $reponse 
     */
    public function getFromAndToNumber($api, $args) {
        global $db;
        $sendBy = $args['sendBy'];
        $custom_Sms_Settings = new Administration();
        $custom_Sms_Settings->retrieveSettings('SurveySms');
        $survey_sms_sid = $custom_Sms_Settings->settings['SurveySms_survey_sms_sid'];
        $survey_sms_token = $custom_Sms_Settings->settings['SurveySms_survey_sms_token'];
        $survey_sms_fromDetails = $custom_Sms_Settings->settings['SurveySms_survey_sms_fromdetails'];
        if ($sendBy == "sms") {
            $survey_sms_fromdetails = $survey_sms_fromDetails["sms"];
            $key = "sms";
        } else if ($sendBy == "whatsapp") {
            $survey_sms_fromdetails = $survey_sms_fromDetails["whatsapp"];
            $key = "wp";
        }
        $phnNumber = "";
        foreach ($survey_sms_fromdetails as $sms_key => $smsValues) {
            if (trim($smsValues[$key . 'FromPhoneNumber']) != "") {
                $phnNumber .= "<option value='" . trim($smsValues[$key . 'FromPhoneNumber']) . "'>" . trim($smsValues[$key . 'FromPhoneNumber']) . "</option>";
            }
            if ($smsValues['defaultNumber'] == "default") {
                $survey_sms_fromName = trim($smsValues[$key . 'FromName']);
                $survey_sms_fromPhoneNumber = trim($smsValues[$key . 'FromPhoneNumber']);
            }
        }
        ...
        $fields = '';
        foreach ($fieldList as $fieldType => $fieldValue) {
            if ($fieldValue['type'] == "phone") {
                $fieldName = "";
                if ($fieldType == "phone_fax") {
                    $fieldName = "Fax";
                } else if ($fieldType == "phone_office" || $fieldType == "phone_work") {
                    $fieldName = "Office Phone";
                    $other_sel = "selected";
                } else if ($fieldType == "phone_alternate") {
                    $fieldName = "Alternate Phone";
                } else if ($fieldType == "phone_home") {
                    if ($moduleName == "Leads") {
                        $fieldName = "Home Phone";
                    } else {
                        $fieldName = "Home";
                    }
                } else if ($fieldType == "phone_mobile") {
                    $fieldName = "Mobile";
                    $sel = "selected";
                } else if ($fieldType == "phone_other") {
                    $fieldName = "Other";
                } else if ($fieldType == "assistant_phone") {
                    $fieldName = "Assistant Phone";
                }
                if ($fieldType == "phone_mobile") {
                    $fields .= "<option value='" . $fieldType . "' name='" . $fieldName . "' selected='{$sel}'>" . $fieldName . "</option>";
                } else if (($fieldType == "phone_office" || $fieldType == "phone_work") && $sel == "") {
                    $fields .= "<option value='" . $fieldType . "' name='" . $fieldName . "' selected='{$other_sel}'>" . $fieldName . "</option>";
                } else {
                    $fields .= "<option value='" . $fieldType . "' name='" . $fieldName . "'>" . $fieldName . "</option>";
                }
            }
        }
        $survey_sms = array();
        ...
        $survey_sms['survey_sms_fromName'] = $survey_sms_fromName;
        $survey_sms['survey_sms_fromPhoneNumber'] = $survey_sms_fromPhoneNumber;
        $survey_sms['fromPhnNoList'] = $phnNumber;
        $survey_sms['toPhnFields'] = $fields;
        return $survey_sms;
    }

    /**
     * Function : generate_qrcode_survey_submit_id
     * generate QR code link on open link in detail view
     * 
     * @return array - $reponse 
     */
    function generate_qrcode_survey_submit_id($api, $args) {
        global $dotb_config;

        $survey_id = $args['survey_id'];
        $oSurvey = BeanFactory::getBean('bc_survey', $survey_id);
        require_once 'custom/biz/classes/qrGenerator.php';
        $survey_sharable_link = $dotb_config['site_url'] . '/survey_submission.php?q=' . $oSurvey->survey_submit_unique_id;
        $ex1 = new QRGenerator($survey_sharable_link);
        $image = $ex1->generate();
        // sharable survey link
        if (empty($oSurvey->survey_submit_unique_id)) {
            return false;
    ...
    /**
     * Function : generate_qr_code_link_list_view_download
     * generate QR code link for survey list view download QR code
     * 
     * @return array - $reponse 
     */
    function generate_qr_code_link_list_view_download($api, $args) {
        $surveyUrlPart = $args['surveyUrlPart'];
        $qr_link = genrateQRCode($surveyUrlPart);
        return $qr_link;
    }
     ...
     * @return array - $reponse 
     */
    function getScriptNotificationRun($api, $args) {
        ...
        return array("scriptOneMigration" => $ScriptOneMigration, "scriptTwoMigration" => $ScriptTwoMigration);
    }

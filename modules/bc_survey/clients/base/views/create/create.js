...
//            self.$el.parents('.main-pane').find('[data-name="allow_redundant_answers"]').show();
        ...
        async.waterfall([
            ...
            if (error && error.status == 412 && !error.request.metadataRetry) {
                ...
                if (error_status.length == 0) {
                    ...
                    app.alert.show('loading_detail_view', {level: 'process', title: 'Please wait while survey is being saved.', autoclose: false});
    ...
    saveAndClose: function () {
        ...
        self.$el.parents('.main-pane').find('.thumbnail').each(function () {
            ...
            self.$el.parents('.main-pane').find(data_page).each(function () {
                    ...
                    else if (typeof que_class == "object" && typeof que_sec_class == "object" && que_class.length == que_sec_class.length)
                    {
                        ...
                        $.each(que_sec_class, function () {
                            if (!$(this).find('#section_title').val())
                            {
                                ...
                                $(this).find('#section_title').parent().addClass('error-custom').find('.fa-exclamation-circle').parent().attr('style', 'margin-left:-25px; position:relative; z-index:500'); // show error message icon on current input field
                            } else {
                                $(this).find('#section_title').css('border', 'margin-top:0; width:95%;');
                                $(this).find('#section_title').parent().removeClass('error-custom').find('.fa-exclamation-circle').parent().attr('style', 'display:none;'); // show error message icon on current input field
                            }
                        });
                    } else {
                                ...
                                self.$el.parents('.main-pane').find(data_page).find('#' + que_section).each(function () {
                                    ...
                                    if (questionTypeValue == "richtextareabox") {
                                        ...
                                        if (richTextContent) {
                                            ...
                                            self.$el.parents('.main-pane').find('[name="question_' + que_section + '"]').parent().removeClass('error-custom').find('.fa-exclamation-circle').parent().attr('style', 'display:none;'); // error icon and red style to input
                                        ...
                                        if (typeof question != "undefined" && question.trim() != '') {
                                            ...
                                            if (question.length < 255) {
                                                ...
                                                $('[name="question_' + que_section + '"]').parent().addClass('error-custom').find('.fa-exclamation-circle').parent().attr('style', 'margin-left:-25px; position:relative; z-index:500'); // error icon and red style to input
                                    ...
                                    if (typeof question != "undefined" && question.trim() != '') {
                                        ...
                                        self.$el.parents('.main-pane').find('[name="question_' + que_section + '"]').parent().removeClass('error-custom').find('.fa-exclamation-circle').parent().attr('style', 'display:none;');
                                        self.$el.parents('.main-pane').find('[name="question_' + que_section + '"]').parents('.question').find('.general').css('color', '#747474');
                                        ...
                                        self.$el.parents('.main-pane').find('[name="question_' + que_section + '"]').parents('.question').find('.general').css('color', 'red');
                                        ...
                                        self.$el.parents('.main-pane').find('[name="question_' + que_section + '"]').parent().addClass('error-custom').find('.fa-exclamation-circle').parent().attr('style', 'margin-left:-25px; position:relative; z-index:500'); // error icon and red style to input
                                    ...
                                    if (question_type == 'radio-button' || question_type == 'check-box') {
                                        ...
                                        if (((question_type == 'radio-button') || (question_type == 'check-box')) && typeof show_option_text != 'undefined') {
                                    ...
                                    if (question_type == 'image') {
                                        if (self.$el.parents('.main-pane').find('[name=uploadImageType_' + que_section + ']:checked').prop('class') != null && self.$el.parents('.main-pane').find('[name=uploadImageType_' + que_section + ']:checked').prop('class').includes("uploadsImage")) {
                                            ...
                                            if (((image && image.trim()) || uploadedImage != '')) {
                                                if (uploadedImage) {
                                                    ...
                                                    self.$el.parents('.main-pane').find('[name="uploadType_' + que_section + '"]').parent().addClass('error-custom').find('.fa-exclamation-circle').parent().attr('style', 'margin-left:-25px; position:relative; z-index:500'); // error icon and red style to input 
                                                    self.$el.parents('.main-pane').find('[name="uploadType_' + que_section + '"]').parents('.question').find('.general').css('color', 'red');
                                                }
                                        ...
                                        if ((self.$el.parents('.main-pane').find('[name=helptips_' + que_section + ']').val()).trim() == '') {
                                        ...
                                        if (start != null && end != null && step != null && step <= allowed_step_value) {
                                            ...
                                            if (self.$el.parents('.main-pane').find('[name="step_' + que_section + '"]').parent().find('.error-step-msg').length == 0) {
                                                if (allowed_step_value == 1) {
                                                    self.$el.parents('.main-pane').find('[name="step_' + que_section + '"]').parent().append('<div class="error-step-msg" style="color:red;font-size:11px;">You need to have step value set to 1.</div>');
                                                } else {
                                            ...
                                            if (allowed_step_value == 1) {
                                                self.$el.parents('.main-pane').find('[name="step_' + que_section + '"]').parent().find('.error-step-msg').html('You need to have step value set to 1.');
                                            } else {
                                    ...
                                    if ($('#' + que_section).find('.piping_sequence').length != 0 && $('#' + que_section).find('.piping_sequence').val()) {
                                        ...
                                        var piping_sequence = question_seq;
                                    }
                                        ...
                                        if (old_question_type)
                                        {
                                            ...
                                            self.$el.parents('.main-pane').find('#' + opid).find($('[name="option_' + survey_question_detail['que_type'] + '"]')).each(function () {
                                                ...
                                                if (survey_question_detail['que_type'] != "emojis") {
                                                    if ($(this).parents('.general_options').find('.enableScore').find('input').prop('checked') == true) {
                                                        if ($(this).parents('.options').find('.score_weight').val())
                                                        {
                                                            var weight = $(this).parents('.options').find('.score_weight').val();
                                                            if (parseInt(weight) < 0) {
                                                                $(this).parent().find('.score_weight').addClass('error-custom');
                                                                $(this).parents('.question').find('.general').css('color', 'red');
                                                                $(this).parent().find('.score_weight').attr('style', 'border:1px solid red;margin-left: 4px; max-width: 7%; margin-top: 5px;');
                                                                error_flag = 1;
                                                            } else {
                                                                $(this).parent().find('.score_weight').removeClass('error-custom');
                                                                $(this).parents('.question').find('.general').css('color', '#747474');
                                                                $(this).parent().find('.score_weight').attr('style', 'margin-left: 4px; max-width: 7%; margin-top: 5px;');
                                                ...
                                                if (survey_question_detail['que_type'] == "radio-button" || survey_question_detail['que_type'] == "check-box") {
                                                    if (this.value.trim() != '') {
                                                        ...
                                                        if (pipe_keyid == "") {
                                                            answer_detail[op_count]['pipe_key'] = $(this.parentElement).find($('[name="piping_values_' + survey_question_detail['que_type'] + '"]')).val();
                                                        } else {
                                                            answer_detail[op_count]['pipe_key'] = self.$el.parents('.main-pane').find('#' + pipe_keyid).find($('[name="piping_values_' + survey_question_detail['que_type'] + '"]')).val();
                                                        }
                ...
                if (typeof page_title != "undefined" && page_title.trim() != "") {
                    ...
                    self.$el.parents('.main-pane').find('#' + page_id).find('#txt_page_title').parent().removeClass('error-placeholder');//hide placeholder color if answer value is given ::kairvi
                    ...
                    self.$el.parents('.main-pane').find('#' + page_id).find('#txt_page_title').parent().addClass('error-custom').find('.fa-exclamation-circle').parent().attr('style', 'margin-left:-25px; position:relative; z-index:500'); // show error message icon on current input field
                    self.$el.parents('.main-pane').find('#' + page_id).find('#txt_page_title').parent().find('input').val("");//show placeholder if black value is given ::kairvi
                    self.$el.parents('.main-pane').find('#' + page_id).find('#txt_page_title').parent().addClass('error-placeholder');//show placeholder if black value is given ::kairvi
        ...
        else if (is_require_missing)
        {
            ...
            App.alert.show('msg', {
                level: 'error',
                messages: 'Mandatory fields for module are not included in the survey. Please add mandatory fields from the selected sync module. Missing Mandatory Fields are :' + module_required_fields,
                autoClose: false
            });
        } else {
            //if error then enable save & cancel button
            ...
            this.initiateSave(_.bind(function () {
                ...
                if (isCreateFromSendSurvey == true || isCreateFromSendSurveyNew == true) {
                    // When survey is created from Send Survey Popup at that time show message for how to send survey and close drawer
                    App.alert.show('msg', {
                        level: 'success',
                        messages: 'You can send newly created survey by first clicking on Send Survey button and then click on Select Existing Survey button.',
                        autoClose: true,

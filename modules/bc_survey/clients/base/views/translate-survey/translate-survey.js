({
            ...
            App.api.call('GET', url, {}, {
                success: function (data) {
                    ...
                    if (self.allow_copy) {
                        ...
                        $('.matrix_required_msg').val('This question requires one answer per row.');
                        $('.sel_limit_msg').val('You must select atleast $min option(s).');
                        $('.limit_msg').val('Please enter value between $min-$max.');
                        $('.limit_min_msg').val('Value can not be less than $min.');
                        $('.limit_max_msg').val('Value can not be more than $max.');
                        ...
                        $('.resubmit_request_success_msg').val('Your request to re-submit ' + self.survey_type + '  response is submitted successfully. You will be sent a confirmation email once admin approves your request.');
                        $('.resubmit_request_fail_msg').val('Your request to re-submit ' + self.survey_type + '  response is not submitted.');
                        $('.resubmit_request_already_sent_msg').val('You have already requested to re-submit ' + self.survey_type + '  response !');
                    ...
                    // If already translated then prefill from language file
                        ...
                        var matrix_required_msg = (survey_lang_data['matrix_required_msg']) ? survey_lang_data['matrix_required_msg'] : 'This question requires one answer per row.';
                        $('.matrix_required_msg').val(matrix_required_msg);
                        var sel_limit_msg = (survey_lang_data['sel_limit_msg']) ? survey_lang_data['sel_limit_msg'] : 'You must select atleast $min option(s).';
                        ...
                        var limit_min_msg = (survey_lang_data['limit_min_msg']) ? survey_lang_data['limit_min_msg'] : 'Value can not be less than $min.';
                        $('.limit_min_msg').val(limit_min_msg);
                        var limit_max_msg = (survey_lang_data['limit_max_msg']) ? survey_lang_data['limit_max_msg'] : 'Value can not be more than $max.';
                        ...
                        var resubmit_request_success_msg = (survey_lang_data['resubmit_request_success_msg']) ? survey_lang_data['resubmit_request_success_msg'] : 'Your request to re-submit ' + self.survey_type + '  response is submitted successfully. You will be sent a confirmation email once admin approves your request.';
                        $('.resubmit_request_success_msg').val(resubmit_request_success_msg);
                        var resubmit_request_fail_msg = (survey_lang_data['resubmit_request_fail_msg']) ? survey_lang_data['resubmit_request_fail_msg'] : 'Your request to re-submit ' + self.survey_type + '  response is not submitted.';
                        $('.resubmit_request_fail_msg').val(resubmit_request_fail_msg);
                        var resubmit_request_already_sent_msg = (survey_lang_data['resubmit_request_already_sent_msg']) ? survey_lang_data['resubmit_request_already_sent_msg'] : 'You have already requested to re-submit ' + self.survey_type + '  response !';
    ...
    remove_lang_clicked: function (el) {
        ...
        app.alert.show('remove_lang', {
            level: 'confirmation',
            messages: "Are you sure to remove this language?",
            onConfirm: function () {
                // call api to save record via php

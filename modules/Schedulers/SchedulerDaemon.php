...
class SchedulerDaemon extends DotbBean
{
	// schema columns
	var $id;
	var $deleted;
	...
	var $job_id;
	var $execute_time;
	// replicated DotbBean attributes
	var $db;
	// object attributes
	...
	function checkPendingJobs() {
		...
		while($a = $this->db->fetchByAssoc($r)) {
			...
			$job->fire($dotb_config['site_url'].'/index.php?entryPoint=schedulers&type=job&job_id='.$paramJob.'&record='.$a['id']);
			$count++;
		}

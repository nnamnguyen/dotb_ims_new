...
class Scheduler extends DotbBean {
	// table columns
	var $id;
	var $deleted;
	var $date_entered;
...
//					$error = '<em>'.$mod_strings['LBL_NO_PHP_CLI'].'</em>';
    ...
    public function getDefaultSystemSchedulers()
    {
        ...
        $scheduler->job = 'class::DotbJobCreateNextTimePeriod';
        $scheduler->date_time_start = create_date(2012, 1, 1) . ' ' . create_time(0, 0, 1);
        $scheduler->date_time_end = create_date(2030, 12, 31) . ' ' . create_time(23, 59, 59);
        ...
        $scheduler->job = 'class::DotbJobRemoveTmpFiles';
        $scheduler->date_time_start = create_date(2005, 1, 1) . ' ' . create_time(0, 0, 1);
        $scheduler->date_time_end = create_date(2030, 12, 31) . ' ' . create_time(23, 59, 59);
        ...
        $scheduler->job = 'class::DotbJobRemoveDiagnosticFiles';
        $scheduler->date_time_start = create_date(2005, 1, 1) . ' ' . create_time(0, 0, 1);
        $scheduler->date_time_end = create_date(2030, 12, 31) . ' ' . create_time(23, 59, 59);
        ...
        $scheduler->job = 'class::DotbJobRemovePdfFiles';
        $scheduler->date_time_start = create_date(2005, 1, 1) . ' ' . create_time(0, 0, 1);
        $scheduler->date_time_end = create_date(2030, 12, 31) . ' ' . create_time(23, 59, 59);
        $scheduler->job_interval = '0::4::*::*::*';
        $scheduler->status = 'Active';
        ...
        $scheduler->job                = 'class::DotbJobKBContentUpdateArticles';
        $scheduler->date_time_start    = create_date(2005, 1, 1) . ' ' . create_time(0, 0, 1);
        $scheduler->date_time_end      = create_date(2030, 12, 31) . ' ' . create_time(23, 59, 59);
        $scheduler->job_interval       = '0::5::*::*::*';
        $scheduler->status             = 'Active';
	...
	///////////////////////////////////////////////////////////////////////////
	////	STANDARD DOTBBEAN OVERRIDES
	/**
	 * function overrides the one in DotbBean.php
	 */
	...
	////	END STANDARD DOTBBEAN OVERRIDES
	///////////////////////////////////////////////////////////////////////////

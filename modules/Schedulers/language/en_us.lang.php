...
$mod_strings=array (
  ...
  'LBL_CRON_LINUX_DESC' => 'Note: In order to run Dotb Schedulers, add the following line to the crontab file: ',
  'LBL_CRON_WINDOWS_DESC' => 'Note: In order to run the Dotb schedulers, create a batch file to run using Windows Scheduled Tasks. The batch file should include the following commands: ',
  ...
  'LBL_MODULE_NAME' => 'Dotb Scheduler',
  'LBL_MODULE_NAME_SINGULAR' => 'Dotb Scheduler',
  ...
  'LBL_NO_PHP_CLI' => 'If your host does not have the PHP binary available, you can use wget or curl to launch your Jobs.<br>for wget: <b>*&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;wget --quiet --non-verbose http://localhost/dotbvn/dotbmoon/cron.php > /dev/null 2>&1</b><br>for curl: <b>*&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;*&nbsp;&nbsp;&nbsp;&nbsp;curl --silent http://localhost/dotbvn/dotbmoon/cron.php > /dev/null 2>&1',
  ...
  'LBL_OPS_BACKUPS_FETCH_EXPORTS' => 'Retrieve updated backup listing from DotBCRM',

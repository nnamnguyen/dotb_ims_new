...
/*DOTB.forms.AssignmentHandler.registerFields({
form:"EditView",
fields:['industry', 'employees', 'name', 'phone_office', 'phone_fax']
});*/
//Register an entire form at once
DOTB.forms.AssignmentHandler.registerForm("EditView");
if (!Ext.isIE) console.log("name = " + DOTB.forms.AssignmentHandler.getValue('name'));
//Values of the form can now be used in expressions
if (!Ext.isIE) console.log("Length of $name = " + new DOTB.forms.evalVariableExpression('strlen($name)').evaluate());
//Create a new Dependency
var typeDep = new DOTB.forms.Dependency(
new DOTB.forms.Trigger(['name', 'employees'], 'true'),
new DOTB.forms.SetValueAction('phone_office', 'add($employees, strlen($name))')
);
//Set value of a field directly (will trigger any Dependencies)
DOTB.forms.AssignmentHandler.assign('employees', 100);
var types = [];
types[""] = "";
types["one"] = "A";
types["two"] = "B";
types["three"] = "C";
DOTB.forms.AssignmentHandler.assign('account_type', types);
DOTB.forms.AssignmentHandler.assign('industry', ["", "Shipping", "Faxing", "Retail"]);
var aFaxesDep = new DOTB.forms.Dependency(
new DOTB.forms.Trigger(['account_type'], 'contains($account_type, "one")'),
[new DOTB.forms.Action('industry', '"Faxing"'), new DOTB.forms.ReadOnlyAction('phone_fax', 'true')],
new DOTB.forms.ReadOnlyAction('phone_fax', 'false')
);
...
{dotb_csrf_form_token}
	...
	<script src="{dotb_getjspath file='modules/Accounts/Account.js'}">
	</script>
																										...
																										<p>
																											<div id="LBL_ADDRESS_INFORMATION">
																												<table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
																													...
																													<tr>
																														<td valign="top" width='37.5%' class='tabEditViewDF' NOWRAP>
																															<script type="text/javascript" src="{dotb_getjspath file='include/DotbFields/Fields/Address/DotbFieldAddress.js'}">
																															</script>
 ...
 Email:
																																			...
																																			<td valign="top" width='37.5%' class='tabEditViewDF' colspan='3' NOWRAP>
																																				<script type="text/javascript" src="{dotb_getjspath file='include/DotbEmailAddress/DotbEmailAddress.js'}">
																																				</script>
																																				<script type="text/javascript">
																																					var module = 'Accounts';
																																				</script>

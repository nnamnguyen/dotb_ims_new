...
$button .= "LANGUAGE=javascript onclick='window.open(\"index.php?module=WorkFlowTriggerShells&action=CreateStep1&dotb_body_only=true&form=ComponentView&workflow_id=$focus->id&frame_type=$frame_type\",\"new\",\"width=400,height=500,resizable=1,scrollbars=1\");'>";
$button .= "</form>\n";

require_once('include/DotbSmarty/plugins/function.dotb_action_menu.php');
$action_buttons = smarty_function_dotb_action_menu(array(

...
echo '<tr>
			...
			<tr align="center">
				...
				<td>
					...
					<input type="button" class="button" value="'.$app_strings['LBL_EMAIL_CANCEL'].'" onclick="DOTB.inboundEmail.listDlg.hide()">
				</td>
			</tr>
			<tr>
				<td>&nbsp;
...
<script type="text/javascript">
    DOTB.inboundEmail.listDlg.setHeader("'.$title.'");
    function setMailbox(box) {
        ...
        DOTB.inboundEmail.listDlg.hide();
     }
	function switchMsg() {

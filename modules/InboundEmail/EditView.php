...
$teamSetField = new EmailDotbFieldTeamsetCollection($focus, $focus->field_defs, "get_non_private_teams_array");
...
foreach ($javascript->dotbbean->field_defs as $field => $value) {
...
foreach ($tipsStrings as $string)
{
    ...
    {
        $tips[$string] = smarty_function_dotb_help(array(

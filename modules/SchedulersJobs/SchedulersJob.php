...
use Dotbcrm\Dotbcrm\Security\Subject\CronJob;
...
class SchedulersJob extends Basic
{
	...
	public function __construct()
	{
        ...
        if(!empty($GLOBALS['dotb_config']['jobs']['min_retry_interval'])) {
            $this->min_interval = $GLOBALS['dotb_config']['jobs']['min_retry_interval'];
        }
	}

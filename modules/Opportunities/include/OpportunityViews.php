...
class OpportunityViews
{
    ...
    {
        /* @var $gridDefParser LumiaGridLayoutMetaDataParser */
     ...
     *
     * @param LumiaGridLayoutMetaDataParser $parser
     * @param array $fieldMap
     */
    protected function _processRecordParser(LumiaGridLayoutMetaDataParser $parser, array $fieldMap) {
        // no matter what we are going to add everything to the first panel at the end, LumiaGridLayoutMetaDataParser
    ...
    {
        /* @var $listDefsParser LumiaListLayoutMetaDataParser */
        $listDefsParser = ParserFactory::getParser(MB_LUMIAPOPUPVIEW, 'Opportunities', null, null, 'base');
    ...
    {
        /* @var $listDefsParser LumiaListLayoutMetaDataParser */
        $listDefsParser = ParserFactory::getParser(MB_LUMIADUPECHECKVIEW, 'Opportunities', null, null, 'base');
        $this->processList($fieldMap, $listDefsParser->_paneldefs, $listDefsParser);
    }
    ...
    {
        if (!($listParser instanceof LumiaListLayoutMetaDataParser)) {

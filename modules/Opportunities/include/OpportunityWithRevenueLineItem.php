...
class OpportunityWithRevenueLineItem extends OpportunitySetup
{
    ...
    protected function fixOpportunityModule()
    {
        ...
        DotbAutoLoader::ensureDir($this->moduleExtFolder . '/Vardefs');
...
EOL;
        ...
        dotb_file_put_contents($this->moduleExtFolder . '/Vardefs/' . $this->dupeCheckExtFile, $file_contents);

        DotbAutoLoader::ensureDir($this->moduleExtFolder . '/Dependencies');
...
EOL;
    ...
    {
        // lets make sure the dir is there
        DotbAutoLoader::ensureDir($this->rliModuleExtFolder . '/Vardefs');
...
EOL;
        ...
        dotb_file_put_contents($this->rliModuleExtFolder . '/Vardefs/' . $this->rliModuleExtVardefFile, $file_contents);
        ...
        DotbAutoLoader::ensureDir($this->appExtFolder . '/Include');
...
EOL;
        ...
        dotb_file_put_contents($this->appExtFolder . '/Include/' . $this->rliModuleExtFile, $file_contents);
    ...
    public function doDataConvert()
    {
        ...
        // fix the reports
        DotbAutoLoader::load('modules/Opportunities/include/OpportunityReports.php');
    ...
    protected function createRevenueLineItemJob(array $data, $job_group)
    {
        ...
        $job->target = "class::DotbJobCreateRevenueLineItems";
    ...
    public static function processOpportunityIds(array $data)
    {
        ...
        $ftsSearch = \Dotbcrm\Dotbcrm\SearchEngine\SearchEngine::getInstance();
        ...
        $ftsSearch->setForceAsyncIndex(
            DotbConfig::getInstance()->get('search_engine.force_async_index', false)
        );

...
abstract class OpportunitySetup
{
    ...
    protected function processFields()
    {
        ...
        DotbAutoLoader::load('modules/DynamicFields/FieldCases.php');
        DotbAutoLoader::load('modules/ModuleBuilder/parsers/StandardField.php');
    ...
    public function doMetadataConvert()
    {
        ...
        DotbBean::clearLoadedDef('RevenueLineItem');
        ...
        register_shutdown_function(array('DotbAutoLoader', 'buildCache'));
    }
    ...
    {
        DotbAutoLoader::load('modules/Administration/QuickRepairAndRebuild.php');
    ...
    {
        /* @var $filterDefParser LumiaFilterLayoutMetaDataParser */
    ...
    {
        DotbAutoLoader::load('modules/Opportunities/include/OpportunityViews.php');
    ...
    protected function resetForecastData($forecast_by)
    {
        ...
        DotbAutoLoader::load('modules/Forecasts/include/ForecastReset.php');
    ...
    protected function setRevenueLineItemModuleTab($show = true)
    {
        ...
        dotb_cache_clear('admin_settings_cache');
    }

    protected function setRevenueLineItemTab($show)
    {
        DotbAutoLoader::load('modules/MySettings/TabController.php');
    ...
    protected function setRevenueLineItemInParentRelateDropDown($add = true)
    {
        ...
        DotbAutoLoader::load('modules/ModuleBuilder/parsers/ParserFactory.php');
        /**
    ...
    {
        DotbAutoLoader::load('modules/Administration/views/view.configureshortcutbar.php');
    ...
    protected function toggleRevenueLineItemsLinkInWorkFlows($show = false)
    {
        ...
        foreach($rli_links as $name => $link) {
            if ($rli_bean->load_relationship($name) && $rli_bean->$name instanceof Link2) {
                ...
                DotbAutoLoader::ensureDir($folder . '/Vardefs');
...
EOL;
                    ...
                    dotb_file_put_contents($folder . '/Vardefs/' . $file, $file_contents);
                } else {

...
class Opportunity extends DotbBean
{
    ...
    public function __construct()
    {
        ...
        if (empty($dotb_config['require_accounts'])) {
		...
		if ( !empty($idequals) ) {
            ...
            while ($row = $this->db->fetchByAssoc($result)) {
                $query = sprintf(
                    ...
                    $this->db->quoted(DotbCurrency::convertAmountToBase($row['amount'], $currency->id)),
    ...
    public function get_list_view_data()
    {
        ...
        global $locale, $current_language, $current_user, $mod_strings, $app_list_strings, $dotb_config;
    ...
    public function save($check_notify = false)
    {
        ...
        // verify that base_rate is set to the correct amount, moved in from DotbBean
        ...
        if (isset($this->field_defs['currency_id']) && isset($this->field_defs['base_rate'])) {
            DotbCurrency::verifyCurrencyBaseRateSet($this);
        }

        DotbAutoLoader::requireWithCustom('modules/Opportunities/SaveOverload.php');
        perform_save($this);
    ...
    public function save_relationship_changes($is_update, $exclude = array())
    {
        ...
        //this rel_fields_before_value is populated by dotbbean during the retrieve call.

...
({
    ...
    cancelClicked: function() {
        /**
         * todo: this is a sad way to work around some problems with dotblogic and revertAttributes
         * but it makes things work now. Probability listens for Sales Stage to change and then by
         * DotbLogic, it updates probability when sales_stage changes. When the user clicks cancel,

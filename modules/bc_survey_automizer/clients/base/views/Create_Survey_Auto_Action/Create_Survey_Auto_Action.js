        ...
        App.api.call('GET', url, {}, {
            success: function (data) {
                if (data.length != 0) {
                    ...
                    $('.survey_selection').parent().html('Survey not found. <a onclick="javascript:DOTB.App.router.navigate(\'bc_survey/create\', {trigger: true});"> click here</a> to create new one.');
                }
            }
        });
                            ...
                            App.api.call('create', url, {}, {
                                success: function (result) {
                                    if (result) {
                                        App.alert.show('msg', {
                                            level: 'success',
                                            messages: 'Survey Automation action saved successfully.',
                                            autoClose: true
                                        });
                                        self._disposeView();

...
class EmailMan extends DotbBean{
	var $id;
	var $deleted;
	var $date_created;
	var $date_modified;
     ...
     * @param string from_address_name The from address eg markeing <marketing@dotb.net>
     * @return
     */
    ...
    */
	...
	function sendEmail($mail,$save_emails=1,$testmode=false){
		...
		$mod_strings = return_module_language( $dotb_config['default_language'], 'EmailMan');
		...
		if (!isset($this->tracking_url)) {
		    ...
		    if (isset($admin->settings['massemailer_tracking_entities_location_type']) and $admin->settings['massemailer_tracking_entities_location_type']=='2'  and isset($admin->settings['massemailer_tracking_entities_location']) ) {
				...
				$this->tracking_url=$dotb_config['site_url'];
		    }
		}
        ...
        if ((!isset($module->email_opt_out)
            ...
            try {
                ...
                $macro_nv['dotb_to_email_address'] = $module->email1;

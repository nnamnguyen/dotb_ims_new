...
<table width="100%" border="1" cellspacing="0" cellpadding="0" class="edit view">
		...
		<tr class="{$OUTBOUND_TYPE_CLASS}">
			...
			<td width="30%">
				<select id="mail_sendtype" name="mail_sendtype" onChange="notify_setrequired(document.ConfigureSettings); DOTB.user.showHideGmailDefaultLink(this);" tabindex="1">{$mail_sendtype_options}</select>
			</td>
			<td scope="row">&nbsp;</td>
			<td >&nbsp;</td>
		</tr>
			     ...
			     <div id="smtp_settings">
					<table width="100%" cellpadding="0" cellspacing="0">
                       ...
                       <tr id="smtp_auth2">
                            ...
                            <a href="javascript:void(0)" id='mail_smtppass_link' onClick="DOTB.util.setEmailPasswordEdit('mail_smtppass')" style="display: none">{$APP.LBL_CHANGE_PASSWORD}</a>
                            </td>
                            <td width="20%">&nbsp;</td>
                            <td width="30%">&nbsp;</td>
                       </tr>
				 		<tr id="mail_allow_user">
				 		     <td width="20%" scope="row">
                                    ...
                                    <img border="0" class="inlineHelpTip" onclick="return DOTB.util.showHelpTips(this,'{$MOD.LBL_ALLOW_DEFAULT_SELECTION_HELP|escape}','','','dialogHelpPopup')" src="index.php?entryPoint=getImage&themeName={$THEME}&imageName=helpInline.gif">
							</td>
				 		    <td width="30%">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="edit view">
    ...
    <tr>
    	<td width="20%" scope="row" valign='top'>
    	   {$MOD.LBL_NOTIFY_ON}:&nbsp;
            <img border="0" class="inlineHelpTip" onclick="return DOTB.util.showHelpTips(this,'{$MOD.LBL_NOTIFICATION_ON_DESC|escape}','','','dialogHelpPopup')" src="index.php?entryPoint=getImage&themeName={$THEME}&imageName=helpInline.gif">
    	</td>
     ...
     <tr>
         <td scope="row" width="20%">
             ...
             <img border="0" class="inlineHelpTip"
                  onclick="return DOTB.util.showHelpTips(this,'{$MOD.LBL_FROM_ADDRESS_HELP|escape}','','','dialogHelpPopup')"
         ...
         <td width="20%" scope="row" valign='top'>
             ...
             <img border="0" class="inlineHelpTip"
                  onclick="return DOTB.util.showHelpTips(this,'{$MOD.LBL_EMAIL_OPT_OUT_DEFAULT_TOOLTIP|escape}','','','dialogHelpPopup')"
                  src="index.php?entryPoint=getImage&themeName={$THEME}&imageName=helpInline.gif">
         </td>
         <td width="30%" valign='top'>
...
if(window.addEventListener){
    window.addEventListener("load", function() { DOTB.util.setEmailPasswordDisplay('mail_smtppass', {/literal}{$mail_haspass}{literal}); }, false);
}else{
    window.attachEvent("onload", function() { DOTB.util.setEmailPasswordDisplay('mail_smtppass', {/literal}{$mail_haspass}{literal}); });
}

...
*}
<link type="text/css" href="{dotb_getjspath file='modules/ProcessMaker/css/jcore.libraries.css'}" rel="stylesheet" />
...
<script type="text/javascript" src="{dotb_getjspath file='cache/include/javascript/pmse.jcore.js'}"></script>

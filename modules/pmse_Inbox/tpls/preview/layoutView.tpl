            ...
            {assign var="field" value=$col.name}
                <div class='le_field' id='{$idCount}'>
                    ...
                    {if isset($field_defs.$field.calculated) && $field_defs.$field.calculated}
                        {dotb_getimage name="DotbLogic/icon_calculated" ext=".png" alt=$mod_strings.LBL_CALCULATED other_attributes='class="right_icon" '}
                    {/if}
                    {if isset($field_defs.$field.dependency) && $field_defs.$field.dependency}
                        {dotb_getimage name="DotbLogic/icon_dependent" alt=$mod_strings.LBL_DEPENDANT ext=".png" other_attributes='class="right_icon" '}
                    {/if}

...
*}
<link type="text/css" href="{dotb_getjspath file='modules/ProcessMaker/css/jcore.adam-ui.css'}" rel="stylesheet" />
<link type="text/css" href="{dotb_getjspath file='modules/ProcessMaker/css/jcore.adam.css'}" rel="stylesheet" />
    ...
    <table width="100%" cellspacing="0" cellpadding="0" border="0" class="dcQuickEdit">
        <tbody><tr>
            <td class="buttons">
                ...
                <div class="action_buttons">
                    ...
                    {foreachelse}
                        ...
                        <input type="button" id="CANCEL_HEADER" value="Cancel" name="button" onclick="DOTB.ajaxUI.loadContent('index.php?action=index&amp;module=Home&amp;record='); return false;" class="button" accesskey="l" title="Cancel [Alt+Shift+l]">
                    {/foreach}
                    <div class="clear"></div>
                </div>
            </td>
            <td align="right">
                ...
                {dotb_translate label='LBL_PMSE_MESSAGE_REQUIREDFIELDS' module=$moduleName}
            </td>
        </tr>
        </tbody>
    </table>

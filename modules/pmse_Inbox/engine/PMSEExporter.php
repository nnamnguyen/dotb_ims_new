...
class PMSEExporter
{
    ...
    {
        global $dotb_flavor, $dotb_version, $dotb_config;
        $toolName = 'ProcessAuthor';
        $toolVersion = '2.0';
        $metadataObject = array();
        $metadataObject['DotbCRMFlavor'] = $dotb_flavor;
        $metadataObject['DotbCRMVersion'] = $dotb_version;
        $metadataObject['DotbCRMHost'] = $dotb_config['host_name'];
        $metadataObject['DotbCRMUrl'] = $dotb_config['site_url'];

...
class PMSEReceiveMessageEvent extends PMSEIntermediateEvent
{
     ...
     * @param DotbBean|null $bean The trigger bean, if passed
     * @return DotbBean The proper bean, if there is one
     */
    protected function getProcessBean(array $flowData, DotbBean $bean = null)
    {
        if ($bean === null || $bean->id === $flowData['cas_dotb_object_id']) {
            return BeanFactory::getBean($flowData['cas_dotb_module'], $flowData['cas_dotb_object_id']);
        }

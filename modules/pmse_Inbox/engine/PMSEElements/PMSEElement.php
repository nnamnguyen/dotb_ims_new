...
class PMSEElement implements PMSERunnable
{
    ...
    /**
     * The bean handler manages operations related to the Dotb Beans
     *
    ...
    /**
     * The db handler is an abstraction of the global dotb $db
    ...
    /**
     *
     * @return DotbQuery $dotbQueryObject
     * @codeCoverageIgnore
     */
    ...
    public function getNextShapeElements($flowData)
    {
        ...
        $dotbQueryObject->from($flowBean, array('alias' => 'f'));
        $dotbQueryObject->joinTable(
            'pmse_bpmn_event',
            array(
                'joinType' => 'LEFT',
                'alias' => 'e',
        ...
        $queryResult = $dotbQueryObject->execute();
        return $queryResult;
    }
}

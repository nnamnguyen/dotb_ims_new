    ...
    public function run($flowData, $bean = null, $externalAction = '', $arguments = array())
    {
        if (empty($externalAction)) {
            ...
            if (!is_array($eventCriteria)) {
                ...
                $moduleName = $flowData['cas_dotb_module'];
                $object_id = $flowData['cas_dotb_object_id'];
                ...
                if ($dueDate instanceof DotbDateTime) {
                    $date = $dueDate;
                } else {
                    ...
                    if (!($date instanceof DotbDateTime)) {
                        throw ProcessManager\Factory::getException(
                            'DateTime',
                            "TimerEvent: Cannot convert '{$dueDate}' to DotbDateTime.",
                            1
                        );
                    }
                }

...
class PMSEExpressionEvaluator
{
    ...
    public function executeAddSubstractCurrency($value1, $operator, $value2) {
        ...
        if ($value1->expField == $value2->expField) {
            ...
            $resCurrency = DotbCurrency::getUserLocaleCurrency();
            $resCurrency = $resCurrency->id;
            $num1 = DotbCurrency::convertAmount($value1->expValue, $value1->expField, $resCurrency);
            $num2 = DotbCurrency::convertAmount($value2->expValue, $value2->expField, $resCurrency);
        }

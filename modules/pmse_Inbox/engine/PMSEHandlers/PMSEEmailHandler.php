...
class PMSEEmailHandler
{
     ...
     * @param DotbBean $bean The target bean
     * @param string $module The related module name
     * @return DotbBean
     * @deprecated Will be removed in a future release
     */
    protected function getProperBean(DotbBean $bean, $module)
    {
        global $beanList;
    ...
    public function getCurrentCSO($bean)
    {
        $userBean = $this->retrieveBean("Users", $bean->cso_id);
        return $userBean;
    }
    ...
    public function addEmailToQueue($id)
    {
        ...
        $job->target = "class::DotbJobSendAWFEmail";
    ...
    protected function getBeansForEmailContentSave($flowData)
    {
        ...
        $targetBean = BeanFactory::getBean($flowData['cas_dotb_module'], $flowData['cas_dotb_object_id']);
     ...
     *
     * @param DotbBean $eventDefinitionBean Bean containing the event definition
     * @param DotbBean $targetBean Target module bean
     ...
     *
     * @param DotbBean $templateBean Email template bean
     * @param DotbBean $targetBean Target module bean
     * @return array
     */

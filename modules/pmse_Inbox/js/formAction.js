...
var w, hp;
// This var should be used locally to point to global App variable in lumia and BWC views
var _App;
if(App){
    _App = App;
}
...
function onSubmit(e) {
    ...
    if (RECLAIMCASE){
        ...
        restClient.setRestfulBehavior(DOTB_REST);
        if (!DOTB_REST) {
            restClient.setBackupAjaxUrl(DOTB_AJAX_URL);
        }
        restClient.getCall({
            url: DOTB_URL + '/rest/v10/CrmData/validateReclaimCase',
            id: '',

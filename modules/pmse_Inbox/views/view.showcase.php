...
class pmse_InboxViewShowCase extends DotbView
{
    public $type = 'list';
    ...
    public function display()
    {
        ...
        $fields = array_merge(
            ...
            array(
                ...
                'bpmFlow.cas_dotb_module','bpmFlow.cas_dotb_object_id',
                'bpmFlow.cas_dotb_action','bpmFlow.cas_adhoc_type',
...
FLIST;
                ...
                $beanTemplate = $this->displayDataForm($caseData['cas_dotb_module'], $caseData['cas_dotb_object_id'],
                ...
                $smarty->assign('DOTB_URL', $dotb_config['site_url']);
                $smarty->assign('DOTB_AJAX_URL',
                    $dotb_config['site_url'] . "/index.php?module=pmse_Inbox&action=ajaxapi");
                $apiSupported = 'false';
                $smarty->assign('DOTB_REST', $apiSupported);
            ...
            default:
                global $dotb_config;
                $smarty->assign('siteUrl', $dotb_config['site_url']);
    ...
    protected function setupOriginalEditView () {
        ...
        if (isset($this->bean) && isset($this->th->ss)) {
            ...
            //Set the view to use an Empty Dotbview to prevent the display of any data. We only want to populate
    ...
    {
        global $mod_strings, $dotb_config, $app_strings, $app_list_strings, $theme, $current_user;
        ...
        $this->th->ss->assign('config', $dotb_config);
        ...
        $this->th->ss->assign('DOTB_VERSION', $dotb_version);
        ...
        //for DotbFieldImage, we must set form enctype to "multipart/form-data"
    ...
    public function showTitle($showTitle = false)
    {
        ...
        if (is_null($this->viewObject)) {
            $this->viewObject = (!empty($GLOBALS['current_view'])) ? $GLOBALS['current_view'] : new DotbView();
        }

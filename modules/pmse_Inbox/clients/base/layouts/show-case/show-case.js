 ...
 * @alias DOTB.App.view.layouts.Basepmse_InboxShowCaseLayout
 * @extends View.Layout
 */
({
        ...
        app.api.call('read', pmseInboxUrl, {}, {
            success: function (data) {
                ...
                options.endpoint = function(method, model, opts, callbacks) {
                    var casModule = data.case.flow.cas_dotb_module;
                    var casModuleId = data.case.flow.cas_dotb_object_id;
    ...
    loadChildLayout: function(data, loadDataParams) {
        ...
        this.recordModule = data.case.flow.cas_dotb_module;
    ...
    caseClaim: function () {
        ...
        value.moduleName = this.case.flow.cas_dotb_module;
        value.beanId = this.case.flow.cas_dotb_object_id;
            ...
            app.alert.show('confirm_save_process', {
                ...
                onConfirm: _.bind(function () {
                    ...
                    data = _.extend(data, {
                        ...
                        moduleName: this.case.flow.cas_dotb_module,
                        beanId: this.case.flow.cas_dotb_object_id,

...
class Product extends DotbBean
{
     ...
     * @deprecated
     *
     * This is only used by BWC Modules, not lumia modules
     *
     ...
     *
     * This was replace by DotbLogic in the vardefs
     *
     * @deprecated
     */
    ...
    public function convertToRevenueLineItem()
    {
        ...
        if ($this->discount_select == 1) {
            ...
            $rli->discount_amount = DotbMath::init()->
    ...
    protected function getPriceFormula($formula, $refresh = false)
    {
        if (!isset($GLOBALS['price_formulas']) || $refresh) {
             DotbAutoLoader::load('modules/ProductTemplates/Formulas.php');
        ...
        DotbAutoLoader::load($GLOBALS['price_formulas'][$formula]);
        return new $formula;
    }

...
$dictionary['Product'] = array(
    ...
    'fields' => array(
        ...
        'subtotal' => array(
            ...
            'formula' => '
                 ifElse(and(isNumeric($quantity), isNumeric($list_price)),
                   ifElse(equal($quantity, 0), "0", currencyMultiply($list_price, $quantity))
                 , "")',
            'calculated' => true,
            'enforced' => true,
        ),
...
//                )',
            'formula' => '
                ifElse(and(isNumeric(toString($quantity)), isNumeric(toString($list_price))),
                    currencySubtract(
                        currencyMultiply(
                            $list_price,
                            $quantity
...
//                        )',
            'formula' => 'ifElse(isNumeric(toString($discount_amount)), $discount_amount, 0)',
            'calculated' => true,
            'enforced' => true,
            'related_fields' => array(
                'currency_id',
            ...
            'filter_template' => array(
                array(
                    '$and' => array(
                        ...
                        array('product_template_relationship_id' => array('$equals' => '$product_template_relationship_id')),

...
class ImportFieldSanitize
{
    ...
    /**
     * Checks the DotbField defintion for an available santization method.
     *
     * @param  $value  string
     * @param  $vardef array
        ...
        )
    {
        ...
        if ( !empty($value) && !DotbEmailAddress::isValidEmail($value) ) {
            return false;
        }
    ...
    {
        return $this->sfh->getDotbField(ucfirst($type));
    }

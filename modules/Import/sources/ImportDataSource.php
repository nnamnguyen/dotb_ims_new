...
abstract class ImportDataSource implements Iterator
{
    ...
    {
        $fp = dotb_fopen(ImportCacheFiles::getErrorFileName(),'a');
    ...
    {
        $fp = dotb_fopen(ImportCacheFiles::getStatusFileName(),'a');
    ...
    {
        $fp = dotb_fopen(ImportCacheFiles::getDuplicateFileName(),'a');
        ...
        $fdp = dotb_fopen(ImportCacheFiles::getDuplicateFileDisplayName(),'a');
    ...
    public function writeErrorRecord($errorMessage = '')
    {
        ...
        $fp = dotb_fopen(ImportCacheFiles::getErrorRecordsFileName(),'a');
        $fpNoErrors = dotb_fopen(ImportCacheFiles::getErrorRecordsWithoutErrorFileName(),'a');

...
class ImportViewLast extends ImportView
{
    ...
    {
        global $mod_strings, $app_strings, $current_user, $dotb_config, $current_language;
        ...
        $createdCount = 0;
        $updatedCount = 0;
        $fp = dotb_fopen(ImportCacheFiles::getStatusFileName(), 'r');
...
EOJAVASCRIPT;
    ...
    {
        global $app_strings, $dotb_version, $dotb_config, $current_user;
        ...
        return <<<EOHTML
<script type="text/javascript" src="include/SubPanel/SubPanelTiles.js?s={$dotb_version}&c={$dotb_config['js_custom_version']}"></script>

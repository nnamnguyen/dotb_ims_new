...
class ImportViewConfirm extends ImportView
{
 	...
 	public function display()
    {
        ...
        if ( !$importFile->fileExists() ) {
         ...
         $maxLineCount = isset($dotb_config['import_max_records_total_limit'] ) ? $dotb_config['import_max_records_total_limit'] : 5000;
    ...
    {
        global $locale, $current_user, $dotb_config;
...
eoq;
    ...
    private function setDateTimeProperties( $field_map = array() )
    {
        ...
        $timeOptions = get_select_options_with_id($dotb_config['time_formats'], $defaultTimeOption);
        $dateOptions = get_select_options_with_id($dotb_config['date_formats'], $defaultDateOption);
...
YAHOO.util.Event.onDOMReady(function(){
    ...
    function setMappingProperties(el)
    {
       ...
       {
           if( !confirm(DOTB.language.get('Import','LBL_CONFIRM_MAP_OVERRIDE')) )
           {

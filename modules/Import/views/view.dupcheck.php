...
class ImportViewDupcheck extends ImportView
{
    ...
    protected function _getJS()
    {
        ...
        $splitter = new ImportFileSplitter($uploadFileName, $dotb_config['import_max_records_per_file']);
...
ProcessImport = new function()
{
     ...
     */
    this.recordThreshold   = {$dotb_config['import_max_records_per_file']};
    ...
    this.submit = function()
    {
        ...
        YAHOO.util.Connect.asyncRequest('POST', 'index.php',
            {
                success: function(o) {
                        ...
                        if ( ProcessImport.fileCount >= ProcessImport.fileTotal ) {
                        	YAHOO.DOTB.MessageBox.updateProgress(1,'{$mod_strings['LBL_IMPORT_COMPLETED']}');
                        	DOTB.util.hrefURL(locationStr);
                        }
                        else {
                ...
                failure: function(o) {
                	YAHOO.DOTB.MessageBox.minWidth = 500;
        ...
        YAHOO.DOTB.MessageBox.updateProgress( move,
...
//begin dragdrop code
	...
	DOTB.enabledDupesTable = new YAHOO.DOTB.DragDropTable(
		"enabled_div",
	...
	DOTB.disabledDupesTable = new YAHOO.DOTB.DragDropTable(
		"disabled_div",
	...
	DOTB.enabledDupesTable.disableEmptyRows = true;
    DOTB.disabledDupesTable.disableEmptyRows = true;
    DOTB.enabledDupesTable.addRow({module: "", label: ""});
    DOTB.disabledDupesTable.addRow({module: "", label: ""});
	DOTB.enabledDupesTable.render();
	DOTB.disabledDupesTable.render();


	DOTB.saveConfigureDupes = function()
	{
		var enabledTable = DOTB.enabledDupesTable;
		var dupeVal = [];
        ...
        var disabledTable = DOTB.disabledDupesTable;
		var dupeVal = [];
...
document.getElementById('goback').onclick = function(){
    ...
    document.getElementById('importstepdup').to_pdf.value = '0';
        var success = function(data) {
			...
			DOTB.util.evalScript(response['html']);

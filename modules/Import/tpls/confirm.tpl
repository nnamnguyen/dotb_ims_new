        ...
        <tr>
            <td align="left" colspan="4" style="background: transparent;">
                <input title="{$MOD.LBL_SHOW_ADVANCED_OPTIONS}"  id="toggleImportOptions" class="button" type="button"
                       name="button" value="  {$MOD.LBL_SHOW_ADVANCED_OPTIONS}  "> {dotb_help text=$MOD.LBL_IMPORT_FILE_SETTINGS_HELP}
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td>
                            <slot>
                                ...
                                {dotb_help text=$MOD.LBL_FIELD_DELIMETED_HELP}
                            </slot>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            {dotb_help text=$MOD.LBL_ENCLOSURE_HELP}
                            </slot>
                        </td>
                        <td scope="col">
                        ...
                        <td>
                            <input class="checkBox" value='on' type="checkbox" name="has_header" id="has_header" {$HAS_HEADER_CHECKED}> {dotb_help text=$MOD.LBL_HEADER_ROW_OPTION_HELP}
                        </td>
                    </tr>
                    <tr>

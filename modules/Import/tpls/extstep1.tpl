...
<tr>
    <td style="text-align: left;" scope="col">
        ...
        {dotb_help text=$MOD.LBL_EXTERNAL_FIELD_TOOLTIP}
    </td>
    <td style="text-align: left;" scope="col">
        <b>{$MOD.LBL_DATABASE_FIELD}</b>&nbsp;
        {dotb_help text=$MOD.LBL_DATABASE_FIELD_HELP}
    </td>
    <td style="text-align: left;" scope="col" id="default_column_header" width="10%">
        ...
        {dotb_help text=$MOD.LBL_EXTERNAL_DEFAULT_TOOPLTIP}</span>
...
ProcessESImport = new function()
{
    ...
    this.submit = function()
    {
        ...
        YAHOO.util.Connect.asyncRequest('POST', 'index.php',
            {
                success: function(o) {
                    ...
                    {
                        YAHOO.DOTB.MessageBox.updateProgress(1,'{/literal}{$MOD.LBL_IMPORT_COMPLETED}{literal}');
        ...
        YAHOO.DOTB.MessageBox.updateProgress( move,displayMessg);
    }

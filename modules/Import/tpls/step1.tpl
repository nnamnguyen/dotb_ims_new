        ...
        <tr>
            <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <td valign="top" width='100%' scope="row">
                            ...
                            <tr id="ext_source_csv">
                                <td colspan="3" scope="row">
                                  ...
                                  &nbsp;<label for="source">{$MOD.LBL_CSV}</label>&nbsp;</span>{dotb_help text=$MOD.LBL_DELIMITER_COMMA_HELP}
                                </td>
                            </tr>
                            <tr id="ext_source_tr">
                  ...
                  &nbsp;<label for="source">{$MOD.LBL_EXTERNAL_SOURCE}</label>&nbsp;</span>{dotb_help text=$MOD.LBL_EXTERNAL_SOURCE_HELP}
                                </td>
                            </tr>

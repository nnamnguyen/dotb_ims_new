...
<tr>
    ...
    <th style="text-align: left;" scope="col">
        ...
        {dotb_help text=$MOD.LBL_HEADER_ROW_HELP}
    </th>
    {/if}
    <th style="text-align: left;" scope="col">
    ...
    <th style="text-align: left;" scope="col">
        <b>{$MOD.LBL_ROW} 1</b>&nbsp;
        {dotb_help text=$MOD.LBL_ROW_HELP}
    </th>
    {if $HAS_HEADER != 'on'}
    ...
    <th scope='col' style="text-align: left;" scope="rcol" id="default_column_header" width="10%">
        ...
        {dotb_help text=$MOD.LBL_DEFAULT_VALUE_HELP}</span>
...
<tr>
    <td align="left" colspan="4">
        <input title="{$MOD.LBL_ADD_ROW}"  id="addrow" class="button" type="button"
            name="button" value="  {$MOD.LBL_ADD_ROW}  "> {dotb_help text=$MOD.LBL_ADD_FIELD_HELP}
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </td>
</tr>
</table>

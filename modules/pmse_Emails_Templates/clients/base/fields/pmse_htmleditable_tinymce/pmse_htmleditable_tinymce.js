...
({
    ...
    addCustomButtons: function (editor) {
        editor.addButton('dotbfieldbutton', {
            title: app.lang.get('LBL_DOTB_FIELD_SELECTOR', 'pmse_Emails_Templates'),
            class: 'mce_selectfield',
            icon: 'fullpage',

            onclick: _.bind(this._showVariablesBook, this)
        });
        editor.addButton('dotblinkbutton', {
            title: app.lang.get('LBL_DOTB_LINK_SELECTOR', 'pmse_Emails_Templates'),
            class: 'mce_selectfield',
     ...
     * by the backend to replace the variable with the correct Dotb link
     *
     * @private
     */

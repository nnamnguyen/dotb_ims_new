...
class SubPanelViewTeams {
	...
	function ProcessSubPanelListView($xTemplatePath, &$mod_strings, $action, $curModule = "") {
		...
		$ListView->xTemplateAssign("EDIT_INLINE_PNG",  DotbThemeRegistry::current()->getImage('edit_inline.png','align="absmiddle" border="0"',null,null,'.gif',$app_strings['LNK_EDIT']));
		$ListView->xTemplateAssign("DELETE_INLINE_PNG",  DotbThemeRegistry::current()->getImage('delete_inline.png','align="absmiddle" border="0"',null,null,'.gif',$app_strings['LNK_REMOVE']));

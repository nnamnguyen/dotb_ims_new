...
class TeamNotice extends DotbBean {
	// Stored fields
	var $id;
	var $deleted;
	var $date_entered;
	...
	function get_list_view_data(){
      ...
      if(count($teams) > 1) {
      	 $temp_array['TEAM_NAME'] .= "<span id='div_{$this->id}_teams'>
					    ...
					    ".DotbThemeRegistry::current()->getImage('MoreDetail', "style='padding: 0px 0px 0px 0px' border='0'", 8, 7, ".png", $mod_strings['LBL_MORE_DETAIL'])."
						</a>
						</span>";
      }
      return $temp_array;

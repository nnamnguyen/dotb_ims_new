...
<tr>
    ...
    <td valign='top' class='dataField'>
    	...
    	{dotb_getimage name="jscalendar" ext=".gif" alt=$LBL_ENTER_DATE other_attributes='align="absmiddle" id="date_start_trigger" '}
    </td>
</tr>
<tr>
    ...
    <td valign='top' class='dataField'>
    	...
    	{dotb_getimage name="jscalendar" ext=".gif" alt=$LBL_ENTER_DATE other_attributes='align="absmiddle" id="date_end_trigger" '}
    </td>
</tr>

...
global $app_list_strings, $current_language, $dotb_config, $currentModule, $action, $current_user, $theme, $timedate;
...
$dateFileNameSafe	= str_replace($seps, "_", $dates);
$cache_file_name = dotb_cached("xml/").$current_user->getUserPrivGuid()."_".$theme."_my_pipeline_".$dateFileNameSafe[0]."_".$dateFileNameSafe[1].".xml";

$GLOBALS['log']->debug("cache file name is: $cache_file_name");


$tools='<div align="right"><a href="index.php?module='.$currentModule.'&action='. $action .'&mypbss_refresh=true" class="tabFormAdvLink">'.DotbThemeRegistry::current()->getImage('refresh','border="0" align="absmiddle"',null,null,'.gif',$mod_strings['LBL_REFRESH']).'&nbsp;'.$current_module_strings['LBL_REFRESH'].'</a>&nbsp;&nbsp;<a href="javascript: toggleDisplay(\'my_pipeline_edit\');" class="tabFormAdvLink">'.DotbThemeRegistry::current()->getImage('edit','border="0" align="absmiddle"',null,null,'.gif',$mod_strings['LBL_EDIT']).'&nbsp;'. $current_module_strings['LBL_EDIT'].'</a></div>';
...
<tr>
	...
	<td valign='top' >
		<input onblur="parseDate(this, '<?php echo $cal_dateformat ?>');" class="text" name="mypbss_date_start"
			   size='12' maxlength='10' id='date_start'
			   value='<?php echo htmlspecialchars($date_start, ENT_QUOTES, 'UTF-8'); ?>'>
<?php
echo DotbThemeRegistry::current()->getImage(
    'jscalendar',
...
<tr>
	...
	<td valign='top' >
		<input onblur="parseDate(this, '<?php echo $cal_dateformat ?>');" class="text" name="mypbss_date_end" size='12'
			   maxlength='10' id='date_end' value='<?php echo htmlspecialchars($date_end, ENT_QUOTES, 'UTF-8'); ?>'>
<?php
echo DotbThemeRegistry::current()->getImage(
    'jscalendar',

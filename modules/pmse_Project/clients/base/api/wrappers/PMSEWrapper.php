...
//        $orderBy = $this->processOrderBy($orderBy);
     ...
     * @return string
     */
    protected function getDeleteQuery(\DotbBean $bean)
    {
        $return = '';
     ...
     * @return string
     */
    protected function buildConditionFromKeys(\DotbBean $bean, array $keys)
    {
        // Default the return
        $condition = '';
     ...
     * @return array
     */
    protected function getPrimaryKeysArray(\DotbBean $bean)
    {

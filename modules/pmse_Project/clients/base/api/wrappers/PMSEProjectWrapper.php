...
//            $this->diagram->fetched_row['data'] = $retrievedData;
            ...
            $dotbApiException = new DotbApiException('Invalid Process Definiton', 500);
            PMSELogger::getInstance()->alert($dotbApiException->getMessage());
            throw $dotbApiException;
        }
        return $diagramData;
    }
    ...
    protected function deleteImproperFlows(array $entityData, array $element)
    {
        ...
        if (!empty($dotb_config['pmse_settings_default']['delete_improper_flows'])) {
            // Grab the flow bean

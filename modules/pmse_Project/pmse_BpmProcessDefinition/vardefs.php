...
DotbAutoLoader::load('modules/pmse_Project/pmse_BpmProcessDefinition/LockedFieldsRelatedModulesUtilities.php');
...
$dictionary['pmse_BpmProcessDefinition'] = array(
    ...
    'fields' => array(
        ...
        'pro_locked_variables' => array(
            ...
            'vname' => 'array of locked variables, these variables are not able to be modified by DotbCrm Forms',
            'type' => 'text',
            'massupdate' => false,
            'no_default' => false,
            'comments' => '',

...
$dictionary['Email'] = array(
    ...
    'acls' => array(
        'DotbACLEmails' => true,
        'DotbACLDraftEmails' => true,
        'DotbACLArchivedEmails' => true,
    ),
    'full_text_search' => true,
    'activity_enabled' => true,
    'comment' => 'Contains a record of emails sent to and from the Dotb application',
    'fields' => array(
        'id' => array(
            'name' => 'id',
            'vname' => 'LBL_ID',
        ...
        'parent_type' => array(
            ...
            'options' => 'parent_type_display',
            'reportable' => false,
            'comment' => 'Identifier of Dotb module to which this email is associated',
        ),
        'parent_id' => array(
            'name' => 'parent_id',
            'vname' => 'LBL_PARENT_ID',
            ...
            'group' => 'parent_name',
            'reportable' => false,
            'comment' => 'ID of Dotb object referenced by parent_type',
        ),
        ...
        'outbound_email_id' => array(
            ...
            'comment' => 'The configuration used to send an email, only used for emails sent using DotBCRM',
            'type' => 'enum',
            'dbType' => 'id',
            'required' => false,

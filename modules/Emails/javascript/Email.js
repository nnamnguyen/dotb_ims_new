...
var uploadIndex = 0;
var select_image = DOTB.language.get('app_strings', 'LBL_ONLY_IMAGE_ATTACHMENT');
var lbl_remove = DOTB.language.get('app_strings', 'LBL_REMOVE');
var lbl_email_attachments_file = DOTB.language.get('app_strings', 'LBL_EMAIL_ATTACHMENTS_FILE');
var lbl_email_attachments_document = DOTB.language.get('app_strings', 'LBL_EMAIL_ATTACHMENTS_DOCUMENT');
var lbl_email_attachments_embeded = DOTB.language.get('app_strings', 'LBL_EMAIL_ATTACHMENTS_EMBEDED');
...
function setDocument(target, documentId, documentName, docRevId) {
	if(window.opener.DOTB.email2) {
		var idx = window.opener.DOTB.email2.composeLayout.currentInstanceId;
		window.opener.DOTB.email2.composeLayout.setDocument(idx, target, documentId, documentName, docRevId);
	} else {
...
function multiFiles( list_target){
	...
	this.addListRow = function( element ){
        ...
        new_row_attach_file.value ='/index.php?entryPoint=getImage&themeName='+DOTB.themes.theme_name+'&imageName=company_logo.png';
        new_row_attach_file.disabled ='true';

        var imgElement = document.createElement("img");
        imgElement.setAttribute("src", "index.php?entryPoint=getImage&themeName="+DOTB.themes.theme_name+"&imageName=Accounts.gif");
        ...
        new_row_button_embed.setAttribute("src", "index.php?entryPoint=getImage&themeName="+DOTB.themes.theme_name+"&imageName=attachment.gif");
        ...
        new_row_button_embed.onclick = function() {
            ...
            if (DOTB.util.validateFileExt(fileName, allowedTypes)) {
                cid = 'cid:' + fileName;
...
function docUpload() {
	...
	var dotbDoc = document.createElement('input');
    dotbDoc.setAttribute('type', 'label');
    dotbDoc.setAttribute('disabled', 'true');
    dotbDoc.setAttribute('font', 'bold');
    dotbDoc.setAttribute('value',"Dotb Document");
   ...
   var DotbDoc = document.createElement("img");
   DotbDoc.setAttribute("src", "index.php?entryPoint=getImage&themeName="+DOTB.themes.theme_name+"&imageName=dotb_document.png");
   DotbDoc.setAttribute("align","absmiddle");
   DotbDoc.setAttribute("alt",lbl_email_attachments_document);
   DotbDoc.setAttribute("border","0");
   DotbDoc.setAttribute("height","16");
   DotbDoc.setAttribute("width","16");


    //elm.appendChild(eah);
    elm.appendChild(DotbDoc);
...
if(typeof DotbClass == "object") {
	DotbClass.inherit("EmailJsonObj","DotbClass");
}
...
function quick_create_overlib(id, theme, el) {
		...
		.html('<a style=\'width: 150px\' class=\'menuItem\' onmouseover=\'hiliteItem(this,"yes");\' onmouseout=\'unhiliteItem(this);\' href=\'index.php?module=Cases&action=EditView&inbound_email_id=' + id + '\'>' +
            "<img border='0' src='index.php?entryPoint=getImage&themeName="+DOTB.themes.theme_name+"&imageName=Cases.gif' style='margin-right:5px'>" + DOTB.language.get('Emails', 'LBL_LIST_CASE') + '</a>' +
            "<a style='width: 150px' class='menuItem' onmouseover='hiliteItem(this,\"yes\");' onmouseout='unhiliteItem(this);' href='index.php?module=Leads&action=EditView&inbound_email_id=" + id + "'>" +
                    "<img border='0' src='index.php?entryPoint=getImage&themeName="+DOTB.themes.theme_name+"&imageName=Leads.gif' style='margin-right:5px'>"
                    + DOTB.language.get('Emails', 'LBL_LIST_LEAD') + "</a>" +
             "<a style='width: 150px' class='menuItem' onmouseover='hiliteItem(this,\"yes\");' onmouseout='unhiliteItem(this);' href='index.php?module=Contacts&action=EditView&inbound_email_id=" + id + "'>" +
                    "<img border='0' src='index.php?entryPoint=getImage&themeName="+DOTB.themes.theme_name+"&imageName=Contacts.gif' style='margin-right:5px'>"
                    + DOTB.language.get('Emails', 'LBL_LIST_CONTACT') + "</a>" +
             "<a style='width: 150px' class='menuItem' onmouseover='hiliteItem(this,\"yes\");' onmouseout='unhiliteItem(this);' href='index.php?module=Bugs&action=EditView&inbound_email_id=" + id + "'>"+
                    "<img border='0' src='index.php?entryPoint=getImage&themeName="+DOTB.themes.theme_name+"&imageName=Bugs.gif' style='margin-right:5px'>"
                    + DOTB.language.get('Emails', 'LBL_LIST_BUG') + "</a>" +
             "<a style='width: 150px' class='menuItem' onmouseover='hiliteItem(this,\"yes\");' onmouseout='unhiliteItem(this);' href='index.php?module=Tasks&action=EditView&inbound_email_id=" + id + "'>" +
                    "<img border='0' src='index.php?entryPoint=getImage&themeName="+DOTB.themes.theme_name+"&imageName=Tasks.gif' style='margin-right:5px'>"
                   + DOTB.language.get('Emails', 'LBL_LIST_TASK') + "</a>"
                   )
		.dialog({
			autoOpen: false,
			title:  DOTB.language.get('Emails', 'LBL_QUICK_CREATE'),
			width: 150,
			position: {
				    my: 'right top',
				    at: 'left top',

 ...
 * @alias DOTB.App.view.fields.BaseEmailsHtmleditable_tinymceField
...
({
    ...
    /**
     * Suppress calling the lumia _render method in detail view
     *
     * @inheritdoc
     */
    _render: function() {
    ...
    /**
     * Replicate the lumia render logic for detail view except for
     ...
     * @inheritdoc
     *
     * Adds buttons for uploading a local file and selecting a Dotb Document
    ...
    addCustomButtons: function(editor) {
        ...
        if (app.acl.hasAccess('create', 'Notes')) {
            ...
            if (app.acl.hasAccess('view', 'Documents')) {
                attachmentButtons.push({
                    text: app.lang.get('LBL_ATTACH_DOTB_DOC', this.module),
                    onclick: _.bind(function(event) {
            ...
            editor.addButton('dotbattachment', {
                type: 'menubutton',
        ...
        editor.addButton('dotbsignature', {
            type: 'menubutton',

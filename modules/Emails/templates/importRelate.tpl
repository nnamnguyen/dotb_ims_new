...
<script type="text/javascript">addToValidate("{$formName}", "team_id", "relate", true, "{dotb_translate label="LBL_TEAM_ID"}");</script>
<script type="text/javascript">addToValidate("{$formName}", "team_name", "relate", true, "{dotb_translate label="LBL_TEAM"}");</script>
{dotb_translate label="LBL_TEAMS"}:
...
{if $showAssignedTo}
<td scope="row" nowrap="nowrap" valign="top" width="12%">
<script type="text/javascript">addToValidate("{$formName}", "assigned_user_id", "relate", false, "{dotb_translate label="LBL_ASSIGNED_TO_ID"}");</script>
<script type="text/javascript">addToValidate("{$formName}", "assigned_user_name", "relate", false, "{dotb_translate label="LBL_ASSIGNED_TO"}");</script>
{dotb_translate label="LBL_ASSIGNED_TO"}:
</td>
<td nowrap="nowrap" width="37%">
...
<tr>
<td scope="row" nowrap="nowrap" valign="top" width="12%">
{dotb_translate label="LBL_EMAIL_RELATE"}:
</td>
...
{dotb_translate label="LBL_DELETE_FROM_SERVER"}:
</td>
<td nowrap="nowrap" width="37%">

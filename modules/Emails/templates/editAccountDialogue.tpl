...
{dotb_csrf_form_token}
			...
			<table border="0" cellspacing="0" cellpadding="0" class="edit view">
				<tr>
				    ...
				    <td style="vertical-align:bottom;"><a href="javascript:void(0);" id="prefill_gmail_defaults_link" onclick="javascript:DOTB.email2.accounts.fillInboundGmailDefaults();">{$app_strings.LBL_EMAIL_ACCOUNTS_GMAIL_DEFAULTS}</a>&nbsp;</td>
				</tr>
			    <tr>
			    ...
			    <tr>
					...
					<td valign="top" >
						<input id='email_user' name='email_user' size='30' maxlength='100' type="text" onclick="DOTB.email2.accounts.ieAccountError(DOTB.email2.accounts.normalStyle);">
					</td>
			    </tr>
			    ...
			    <tr>
					...
					<td valign="top" >
						<input id='email_password' name='email_password' size='30' maxlength='100' type="password" onclick="DOTB.email2.accounts.ieAccountError(DOTB.email2.accounts.normalStyle);">
						<a href="javascript:void(0)" id='email_password_link' onClick="DOTB.util.setEmailPasswordEdit('email_password')" style="display: none">{$app_strings.LBL_CHANGE_PASSWORD}</a>
					</td>
			    </tr>
			     ...
			     <tr>
                    ...
                    <td valign="top" >
                        <input id='server_url' name='server_url' size='30' maxlength='100' type="text" onclick="DOTB.email2.accounts.ieAccountError(DOTB.email2.accounts.normalStyle);">
                    </td>
                </tr>
			    <tr>
					<td valign="top" scope="row" NOWRAP>
					...
					<td valign="top" >
						<select name='protocol' id="protocol" onchange="DOTB.email2.accounts.setPortDefault(); DOTB.email2.accounts.ieAccountError(DOTB.email2.accounts.normalStyle);">{$PROTOCOL}</select>
					</td>
				</tr>
				<tr>
					<td valign="top" scope="row" NOWRAP>
                        ...
                        <div id="rollover">
                            <a href="#" class="rollover">{dotb_getimage alt=$mod_strings.LBL_HELP name="helpInline" ext=".gif" other_attributes='border="0" '}<span>{$ie_mod_strings.LBL_SSL_DESC}</span></a>
                        </div>
					</td>
					<td valign="top"  width="15%">
					   <div class="maybe">
						   <input name='ssl' id='ssl' {$CERT} value='1' type='checkbox' {$SSL} onClick="DOTB.email2.accounts.setPortDefault();">
					   </div>
					</td>
				</tr>
				<tr>
					...
					<td valign="top" >
						<input name='port' id='port' size='10' onclick="DOTB.email2.accounts.ieAccountError(DOTB.email2.accounts.normalStyle);">
					</td>
				</tr>
			     <tr id="mailboxdiv" style="dispay:'none';">
                    ...
                    <td valign="top" >
                        <input id='mailbox' value="" name='mailbox' size='30' maxlength='500' type="text" onclick="DOTB.email2.accounts.ieAccountError(DOTB.email2.accounts.normalStyle);" />
					<input type="button" id="subscribeFolderButton" name="subscribeFolderButton" class="button" onclick='this.form.searchField.value="";DOTB.email2.accounts.getFoldersListForInboundAccountForEmail2();' value="{$app_strings.LBL_EMAIL_SELECT}" />
                    </td>
                </tr>
			     <tr id="trashFolderdiv" style="dispay:'none';">
                    ...
                    <td valign="top" >
                        <input id='trashFolder' value="" name='trashFolder' size='30' maxlength='100' type="text" onclick="DOTB.email2.accounts.ieAccountError(DOTB.email2.accounts.normalStyle);" />
					<input type="button" id="trashFolderButton" name="trashFolderButton" class="button" onclick='this.form.searchField.value="trash";DOTB.email2.accounts.getFoldersListForInboundAccountForEmail2();' value="{$app_strings.LBL_EMAIL_SELECT}" />
                    </td>
                </tr>
			     <tr id="sentFolderdiv" style="dispay:'none';">
                    ...
                    <td valign="top" >
                        <input id='sentFolder' value="" name='sentFolder' size='30' maxlength='100' type="text" onclick="DOTB.email2.accounts.ieAccountError(DOTB.email2.accounts.normalStyle);" />
					<input type="button" id="sentFolderButton" name="sentFolderButton" class="button" onclick='this.form.searchField.value="sent";DOTB.email2.accounts.getFoldersListForInboundAccountForEmail2();' value="{$app_strings.LBL_EMAIL_SELECT}" />
                    </td>
                </tr>
			    <tr>
				...
				<input title="{$ie_mod_strings.LBL_TEST_BUTTON_TITLE}"
							type='button'
							class="button"
							onClick='DOTB.email2.accounts.testSettings();'
			...
			<tr>
				...
				<td >
					<select name='outbound_email' id='outbound_email' onchange="DOTB.email2.accounts.checkOutBoundSelection()"></select>
				</td>
			</tr>
			...
			<tr  style="padding-bottom: 25px;padding-top:15px;">
					...
					<input title="{$ie_mod_strings.LBL_EMAIL_SAVE}"
							...
							class="button"
							onClick='DOTB.email2.accounts.saveIeAccount();'
					   ...
					   <input title="{$app_strings.LBL_EMAIL_SETTINGS_ADD_ACCOUNT}"
                        type='button'
                        class="button"
                        onClick='DOTB.email2.accounts.clearInboundAccountEditScreen();SE.accounts.setPortDefault();'

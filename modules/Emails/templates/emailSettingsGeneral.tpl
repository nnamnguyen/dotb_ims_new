...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="view">
	...
	<tr>
		...
		<td scope="row" width="20%">
			<a href="javascript:parent.DOTB.App.router.navigate('#UserSignatures', {$smarty.ldelim}trigger: true{$smarty.rdelim})">{$mod_strings.LNK_EMAIL_SIGNATURE_LIST}</a>
		</td>
		<td>
			&nbsp;
		</td>
...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="view">
	...
	<tr>
		<td NOWRAP scope="row" width="20%">
			...
			<div id="rollover">
                            <a href="#" class="rollover">{dotb_getimage alt=$mod_strings.LBL_HELP name="helpInline" ext=".gif" other_attributes='border="0" '}<span>{$app_strings.LBL_EMAIL_SETTINGS_REQUIRE_REFRESH}</span></a>
            </div>
		</td>
		<td NOWRAP >

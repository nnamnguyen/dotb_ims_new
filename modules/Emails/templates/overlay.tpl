...
*}
<div id="DOTB.email2.e2overlay" style="visibility:hidden; position:absolute; top:0px; background-color:#fff;">
...
{dotb_csrf_form_token}
				...
				<input type="button" onclick="DOTB.email2.composeLayout.uploadAttachment();" class="button" value="{$app_strings.LBL_EMAIL_ATTACH_FILE_TO_EMAIL}" />
			</form>
		</div>
	</div>
</div>

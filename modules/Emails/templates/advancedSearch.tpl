...
<table cellpadding="4" cellspacing="0" border="0" id='advancedSearchTable'>
	...
	<tr class="toggleClass yui-hidden">
		<td class="advancedSearchTD" style="padding-bottom: 2px">
			...
			{dotb_getimage name="jscalendar" ext=".gif" alt=$app_strings.LBL_ENTER_DATE other_attributes='align="absmiddle" id="searchDateFrom_trigger" '}
		</td>
	</tr>
	...
	<tr class="toggleClass yui-hidden">
		<td class="advancedSearchTD">
			...
			{dotb_getimage name="jscalendar" ext=".gif" alt=$app_strings.LBL_ENTER_DATE other_attributes='align="absmiddle" id="searchDateTo_trigger" '}		
		</td>
	</tr>

    <tr class="toggleClass yui-hidden">
        <td class="advancedSearchTD">
        {dotb_translate label="LBL_ASSIGNED_TO"}: <br/>
        ...
        <a href="javascript:void(0);">
            <img src="{dotb_getimagepath file='select.gif'}" align="absmiddle" border="0" alt=$mod_strings.LBL_EMAIL_SELECTOR onclick='open_popup("Users", 600, 400, "", true, false, {literal}{"call_back_function":"set_return","form_name":"advancedSearchForm","field_to_name_array":{"id":"assigned_user_id","name":"assigned_user_name"}}{/literal}, "single", true);'>
        </a>
        </td>
    </tr>
      <tr class="toggleClass yui-hidden">
    ...
    <tr class="toggleClass yui-hidden">
        ...
        <a href="javascript:void(0);"><img src="{dotb_getimagepath file='select.gif'}" align="absmiddle" border="0" alt=$mod_strings.LBL_EMAIL_SELECTOR onclick="DOTB.email2.composeLayout.callopenpopupForEmail2('_search',{ldelim}'form_name':'advancedSearchForm'{rdelim} );">
         </a>
        </td>
    </tr>
     <tr class="toggleClass yui-hidden">
	...
	<tr>
		<td NOWRAP>
			<br />&nbsp;<br />
			<input type="button" id="advancedSearchButton" class="button" onclick="DOTB.email2.search.searchAdvanced()" value="   {$app_strings.LBL_SEARCH_BUTTON_LABEL}   ">&nbsp;
			<input type="button" class="button" onclick="DOTB.email2.search.searchClearAdvanced()" value="   {$app_strings.LBL_CLEAR_BUTTON_LABEL}   ">
		</td>
	</tr>
</table>
</form>

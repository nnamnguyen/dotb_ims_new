...
<script type="text/javascript" src="include/javascript/dotb_3.js?v={VERSION_MARK}"></script>
<script type="text/javascript" src="cache/javascript/dotbcrm3.min.js?v={VERSION_MARK}"></script>
<script type="text/javascript" src="include/DotbFields/Teamset/Teamset.js?v={VERSION_MARK}"></script>
{$languageStrings}
<script type="text/javascript" src="cache/javascript/dotbcrm3.min.js??v={VERSION_MARK}"></script>
<script type="text/javascript" src="cache/javascript/dotbcrm1.min.js??v={VERSION_MARK}"></script>
...
{literal}
	...
	function checkTeamSetData() {
        if (!DOTB.collection.prototype.validateTemSet('EditView', 'team_name')) {
        	alert({/literal}'{$app_strings.ERR_NO_PRIMARY_TEAM_SPECIFIED}'{literal});
        	return false;
        } // if
        var teamIdsArray = DOTB.collection.prototype.getTeamIdsfromUI('EditView', 'team_name');
		var primaryTeamId = DOTB.collection.prototype.getPrimaryTeamidsFromUI('EditView', 'team_name');

...
class KBContentsApiHelper extends DotbBeanApiHelper {
    ...
    public function populateFromApi(DotbBean $bean, array $submittedData, array $options = array())
    {
        ...
        if (!$this->checkStatus($bean)) {
            throw new DotbApiExceptionInvalidParameter('Invalid status field value');
        }

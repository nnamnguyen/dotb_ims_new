...
//                                    html += "<span data-action='answerHistory'><span class='btn btn-info pull-right answerHistory' data-submission_id = '" + sub_id + "' data-que_id='" + ques_id + "' onclick='getAnswerHistory(this)' style='margin-right: 3px;' title='Answer History'><i class='fa fa-history'></i></span></span></p>";
                                    if (answers['disabled_question'] == 1) {
                                        ...
                                        html += "<span data-action='answerHistory'><span class='btn btn-info pull-right answerHistory' data-submission_id = '" + sub_id + "' data-que_id='" + ques_id + "' onclick='getAnswerHistory(this)' style='margin-right: 3px;' title='Answer History'><i><img src='custom/include/images/History.png'  height='21px' width='21px'></i></span></span></p>";
                                    }
                                }
...
//
        ...
        App.api.call('GET', url, {}, {
            success: function (result) {
                ...
                if (result == "true" || model.attributes.status == 'Pending') {
                    ...
                    app.alert.show('info', {
                        level: 'info',
                        messages: 'You can\'t attend this survey as survey is already submitted.',
                        autoClose: true
                    });
                }
            }
    ...
    resendSurvey: function (model) {
        ...
        app.alert.show('send_confirm', {
            level: 'confirmation',
            title: 'Notice',
            messages: "Are you sure to resend survey?",
            onConfirm: function () {

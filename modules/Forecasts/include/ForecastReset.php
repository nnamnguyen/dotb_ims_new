...
class ForecastReset
{
    ...
    {
        DotbAutoLoader::load('modules/Forecasts/ForecastsDefaults.php');
    ...
    public function updateConfigWorksheetColumnsMetadata($forecast_by, $refresh = true)
    {
        if ($forecast_by === 'RevenueLineItems') {
            ...
            dotb_file_put_contents($this->module_ext_path . DIRECTORY_SEPARATOR . $this->columns_ext_file, $contents);
        } else {

 ...
 */
class Forecast extends DotbBean
{
    ...
    function fill_in_additional_list_fields()
    {
        if ( isset($this->best_case) && !empty($this->best_case) ) {
            $this->best_case = DotbCurrency::convertAmountFromBase($this->best_case, $this->currency_id);
        }
        if ( isset($this->worst_case) && !empty($this->worst_case) ) {
            $this->worst_case = DotbCurrency::convertAmountFromBase($this->worst_case, $this->currency_id);
        }
        if ( isset($this->likely_case) && !empty($this->likely_case) ) {
            $this->likely_case = DotbCurrency::convertAmountFromBase($this->likely_case, $this->currency_id);
        }
	}
    ...
    public function save($check_notify = false)
    {
        ...
        if(empty($this->currency_id)) {
            ...
            $currency = DotbCurrency::getCurrencyByID($this->currency_id);
        }

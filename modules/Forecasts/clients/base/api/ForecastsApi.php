...
class ForecastsApi extends ModuleApi
{
    ...
    public function forecastsInitialization(ServiceBase $api, array $args)
    {
        ...
        if(!DotbACL::checkAccess('Forecasts', 'access')) {
    ...
    protected function getTimeperiodFilterClass(array $args)
    {
        ...
        $file = 'include/DotbForecasting/Filter/TimePeriodFilter.php';
        $klass = 'DotbForecasting_Filter_TimePeriodFilter';
    ...
    public function getReportees(ServiceBase $api, array $args)
    {
        ...
        // base file and class name
        $file = 'include/DotbForecasting/ReportingUsers.php';
        $klass = 'DotbForecasting_ReportingUsers';
    ...
    {
        if(!DotbACL::checkAccess('Quotas', 'access')) {
            throw new DotbApiExceptionNotAuthorized();
        }

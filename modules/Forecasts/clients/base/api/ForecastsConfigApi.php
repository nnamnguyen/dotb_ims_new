...
class ForecastsConfigApi extends ConfigModuleApi
{
    ...
    public function forecastsConfigSave(ServiceBase $api, array $args)
    {
        ...
        if ($upgraded || empty($prior_forecasts_settings['is_setup'])) {
            if ($args['forecast_by'] === 'Opportunities') {
                ...
                DotbJobUpdateOpportunities::updateOpportunitiesForForecasting();
            } else {
                DotbAutoLoader::load('include/DotbQueue/jobs/DotbJobUpdateRevenueLineItems.php');
                DotbJobUpdateRevenueLineItems::scheduleRevenueLineItemUpdateJobs();
            }
        }
    ...
    public function getOpportunityConfigObject($forecast_by)
    {
        ...
        if ($forecast_by === 'RevenueLineItems') {
            ...
            DotbAutoLoader::load('modules/Opportunities/include/OpportunityWithOutRevenueLineItem.php');

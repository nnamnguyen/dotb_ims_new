...
$(document).ready(function() {
    ...
    var saveConfiguration = function(isTBAEnabled, enabledModulesList) {
            ...
            var queryString = DOTB.util.paramsToUrl({
                    module: 'Teams',
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    ajaxStatus.flashStatus(DOTB.language.get('app_strings', 'LBL_DONE_BUTTON_LABEL'));
                ...
                error: function() {
                    ...
                    ajaxStatus.showStatus(DOTB.language.get('app_strings', 'ERR_GENERIC_SERVER_ERROR'));
                }
            });
        };
    var initState = {
     ...
     * see dotbcrm/include/javascript/dotb7/plugins/Editable.js
     */
        ...
        if ((initState.isTBAEnabled && $('input#tba_set_enabled').attr('checked') !== 'checked') ||
            ...
            app.alert.show('submit_tba_confirmation', {
                ...
                messages: app.user.get('type') == 'admin'
                    ? DOTB.language.get('Teams', 'LBL_TBA_CONFIGURATION_WARNING')
                    : DOTB.language.get('Teams', 'LBL_TBA_CONFIGURATION_WARNING_NO_ADMIN')
                ,
                onConfirm: function() {

<?php 
global $dotb_flavor,$dotb_config;
 ...
 $dotb_version = $dotb_config['dotb_version'];
 if($dotb_flavor == 'ENT' && version_compare($dotb_version, '7.8', '>')){
      $GLOBALS["dictionary"]["bc_survey_answers"]['acls']['DotbACLLockedFields'] =  true;
 }
...
class ACLRole extends DotbBean{
    ...
    // bug 16790 - missing get_summary_text method led Tracker to display DotbBean's "base implementation"
...
{
        $user_roles = dotb_cache_retrieve("RoleMembershipNames_".$user_id);
        ...
        if(!$user_roles){
            ...
            dotb_cache_put("RoleMembershipNames_".$user_id, $user_roles);
        }

...
class DotbSNIP
{
    ...
    const DEFAULT_URL = 'https://ease.dotbcrm.com/';
     ...
     * @return DotbSNIP SNIP client instance
     */
    ...
    */
    ...
    public function callRest($name, $params = array(), $json = false, &$connectionfailed=false)
    {
        ...
        $url .= $name;
        $params["dotbkey"] = $this->config['unique_key'];
    ...
    */
    ...
    {
        $user = BeanFactory::newBean('Users');
        // if dotb_config['snip']['assign_ignore_email'] is set, assign everything to one user
        // which will be specified below
        if(empty($GLOBALS['dotb_config']['snip']['assign_ignore_email'])) {
    ...
    public function importEmail($email)
    {
        ...
        //Can't use dotb_bean field definition to determine which fields to import.
    ...
    {
    	if(!DotbAutoLoader::existing('custom/modules/SNIP/createdefs.php')) {
    		return false;
    	}
    	$createdef = array();
    ...
    * @param DotbBean $email Email object

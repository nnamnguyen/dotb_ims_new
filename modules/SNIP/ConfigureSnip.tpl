...
{dotb_csrf_form_token}
			...
			<table border="0" cellpadding="0" cellspacing="1" width="100%">
				<tr width="50%">
					<td scope="row">
						{$MOD.LBL_SNIP_STATUS}:&nbsp;{dotb_help text=$MOD.LBL_SNIP_MOUSEOVER_STATUS}
					</td>
					<td>
...
{dotb_csrf_form_token}
					...
					<td scope="row" style='width:180px;background-color:white'>
						<div style='width:auto;margin-top:-5px;height:20px;padding:5px 5px 7px 5px;background-color:#EEEEEE'>
							{$MOD.LBL_SNIP_DOTB_URL}:&nbsp;{dotb_help text=$MOD.LBL_SNIP_MOUSEOVER_INSTANCE_URL}
						</div>
					</td>
					<td>
						{$DOTB_URL}
				...
				<tr>
					...
					<td scope="row" style='width:100px'>
						{$MOD.LBL_SNIP_EMAIL}:&nbsp;{dotb_help text=$MOD.LBL_SNIP_MOUSEOVER_EMAIL}
					</td>
					<td>
						{$SNIP_EMAIL}
					</td>
			...
			<div style='margin-left:4px;margin-top:4px;margin-bottom:7px'> <a href='http://www.dotbcrm.com/crm/case-tracker/submit.html?lsd=supportportal&tmpl=' target='_blank'>{$MOD.LBL_SNIP_SUPPORT}</a></div>
			{/if}

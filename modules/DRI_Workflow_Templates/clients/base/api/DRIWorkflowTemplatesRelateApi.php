 ...
 */
class DRIWorkflowTemplatesRelateApi extends RelateApi
{
    /**
     * @return array
     */
    public function registerApiRest() {
        return array(
            'filterRelatedRecords' => array(
                'reqType' => 'GET',
                'path' => array('DRI_Workflow_Templates', '?', 'link', 'dri_subworkflow_templates', 'filter'),
            ...
            'listRelatedRecords' => array(
                'reqType' => 'GET',
                'path' => array('DRI_Workflow_Templates', '?', 'link', 'dri_subworkflow_templates'),
                'pathVars' => array('module', 'record', '', 'link_name'),
                'jsonParams' => array('filter'),
                'method' => 'filterRelated',

...
{dotb_csrf_form_token}
				...
				<input type="hidden" name="dotb_body_only" id="dotb_body_only" value="1">
	...
	<tr>
        ...
        <td>
            ...
            {dotb_getimage name="jscalendar" ext=".gif" alt="$USER_DATEFORMAT" other_attributes="align='absmiddle' id='date_start_trigger' onclick='parseDate(document.getElementById(\'date_start\'), \'$CALENDAR_DATEFORMAT\');' "}&nbsp;</td>
        </td>
	</tr>
	<tr>
        ...
        <td>
            ...
            {dotb_getimage name="jscalendar" ext=".gif" alt="$USER_DATEFORMAT" other_attributes="align='absmiddle' id='date_finish_trigger' onclick='parseDate(document.getElementById(\'date_finish\'), \'$CALENDAR_DATEFORMAT\');' "}&nbsp;
        </td>
    </tr>
	<tr>

...
//    if(DCMenu){
//        DCMenu.qe_refresh = 'DOTB.ajaxUI.loadContent("index.php?module=Project&action=ProjectTemplatesListView&ignore='+new Date().getTime()+'");';
//    }
    {/literal}
</script>

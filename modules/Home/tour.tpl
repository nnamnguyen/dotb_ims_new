	...
	<div class="modal-body" {if $view_calendar_url}style="overflow: auto;"{/if}>
        <div style="float: left;">
            <div style="float: left; width: 300px;">
				...
				<p>{$APP.LBL_TOUR_VISIT} <a href="javascript:void window.open('http://support.dotbcrm.com/02_Documentation/01_Dotb_Editions/{$appList.documentation.$dotbFlavor}')">{$APP.LNK_TOUR_DOCUMENTATION}</a>.</p>
            ...
            <div class="well" style="float: left; width: 220px; margin-left: 20px;"><img src="{dotb_getjspath file='themes/default/images/pt-screen0-thumb.png'}" width="220" id="thumbnail_0" class="thumb"></div>
        </div>
        </div>
        <div class="clear"></div>
...
<div id="tourEnd" style="display: none;">
	...
	<div class="modal-body">
		<div style="float: left;">
			...
			<p>
			{$APP.LBL_TOUR_REFERENCE_1} <a href="javascript:void window.open('http://support.dotbcrm.com/02_Documentation/01_Dotb_Editions/{$appList.documentation.$dotbFlavor}')">{$APP.LNK_TOUR_DOCUMENTATION}</a> {$APP.LBL_TOUR_REFERENCE_2}
<br>
				<i class="fa fa-arrow-right fa-lg" style="float: right; position: relative; right: -33px; top: -30px;"></i>
			</p>
			</div>
			<div style="float: left">
				<img src="{dotb_getjspath file='themes/default/images/pt-profile-link.png'}" width="152" height="221">
			</div>
		</div>
	</div>
    <div class="clear"></div>

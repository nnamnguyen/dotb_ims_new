...
class JotPadDashlet extends Dashlet {
    ...
    {
        $ss = new Dotb_Smarty();
        $ss->assign('savedText', DotbCleaner::cleanHtml($this->savedText));
    ...
    function saveOptions($req) {
        global $dotb_config, $timedate, $current_user, $theme;
        $options = array();
    ...
    function saveText() {
    	...
    	if(isset($_REQUEST['savedText'])) {
            ...
            $optionsArray['savedText']=DotbCleaner::cleanHtml(nl2br($optionsArray['savedText']));

...
class QuickSearchQuery
{
            ...
            foreach ($args['field_list'] as $field) {
                ...
                if ((isset($results[$i]->field_defs[$field]['type'])
                    ...
                    if(empty($app_list_strings)) {
                        ...
                        else $current_language = $dotb_config['default_language'];
    ...
    protected function prepareArguments($args)
    {
        ...
        if (isset($args['limit']) && $dotb_config['list_max_entries_per_page'] < ($args['limit'] + 1)) {
            $dotb_config['list_max_entries_per_page'] = ($args['limit'] + 1);
        }

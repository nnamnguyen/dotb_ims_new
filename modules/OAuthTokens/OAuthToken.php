 ...
 * OAuth token
 */
class OAuthToken extends DotbBean
{
    ...
    static public function cleanup()
	{
        ...
        $db->query("DELETE FROM oauth_tokens WHERE tstate IN (".self::INVALID.",".self::REQUEST.") AND token_ts < ".(time()-$dotbConfig->get('oauth_token_life',60*60*24)));
        // delete expired access tokens
        $db->query("DELETE FROM oauth_tokens WHERE tstate = ".self::ACCESS." AND expire_ts <> -1 AND expire_ts < ".(time()-$dotbConfig->get('oauth_token_expiry',0)));

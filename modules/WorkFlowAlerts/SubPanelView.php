...
$button .= "LANGUAGE=javascript onclick='window.open(\"index.php?module=WorkFlowAlerts&action=CreateStep1&dotb_body_only=true&form=ComponentView&parent_id=$focus->id&base_module=$workflow_object->base_module\",\"new\",\"width=400,height=500,resizable=1,scrollbars=1\");'";
$button .= ">\n";
$button .= "</form>\n";

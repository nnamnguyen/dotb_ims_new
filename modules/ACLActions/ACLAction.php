 ...
 * @api
 */
class ACLAction  extends DotbBean
{
    ...
    */
    static function addActions($category, $type='module'){
        ...
        if(isset($ACLActions[$type])){
            ...
            dotb_die("FAILED TO ADD: $category - TYPE $type NOT DEFINED IN modules/ACLActions/actiondefs.php");
        }
    }
    ...
    */
    public static function removeActions($category, $type='module'){
        ...
        if(isset($ACLActions[$type])){
            ...
            dotb_die("FAILED TO REMOVE: - CATEGORY : $category - TYPE $type NOT DEFINED IN modules/ACLActions/actiondefs.php");
        }
    }

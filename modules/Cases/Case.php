...
class aCase extends Basic
{
     ...
     *
     * @see DotbBean::save_relationship_changes()
     */
    ...
    function get_list_view_data()
    {
        ...
        $temp_array['SET_COMPLETE'] =  "<a href='index.php?return_module=Home&return_action=index&action=EditView&module=Cases&record=$this->id&status=Closed'>".DotbThemeRegistry::current()->getImage("close_inline", "title=".translate('LBL_LIST_CLOSE', 'Cases')." border='0'", null, null, '.gif', translate('LBL_LIST_CLOSE', 'Cases'))."</a>";
    ...
    */
    ...
    {
        global $dotb_config;
        return (isset($dotb_config['inbound_email_case_subject_macro']) && !empty($dotb_config['inbound_email_case_subject_macro'])) ?
            $dotb_config['inbound_email_case_subject_macro'] : $this->emailSubjectMacro;
    }
}

 ...
 * used by other files in this nodule. It should extend the DotbBean which implements
 * all the basic database operations. Any custom behaviors can be implemented here by
 * implementing functions available in the DotbBean.
 ********************************************************************************/
...
class CampaignTracker extends DotbBean {
    ...
    */
    ...
    /* variable $table_name is used by DotbBean and methods in this file to constructs queries
    * set this variables value to the table associated with this bean.
    */
    var $table_name = 'campaign_trkrs';

    /*This  variable overrides the object_name variable in DotbBean, wher it has a value of null.*/
    ...
    */
    ...
    function fill_in_additional_detail_fields() {
        ...
        if (isset($admin->settings['massemailer_tracking_entities_location_type']) and $admin->settings['massemailer_tracking_entities_location_type']=='2'  and isset($admin->settings['massemailer_tracking_entities_location']) ) {
            ...
            $this->message_url=$dotb_config['site_url'];
        }
        if ($this->is_optout == 1) {

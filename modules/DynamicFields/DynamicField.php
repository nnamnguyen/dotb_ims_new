...
class DynamicField {
    ...
    */
    function getFieldWidget($module, $fieldName) {
        ...
        if (empty($module) || empty($fieldName)){
            dotb_die("Unable to load widget for '$module' : '$fieldName'");
        }
    ...
    */
    ...
    /**
     * Process the save action for dotb bean custom fields
     *
    ...
    protected function writeVardefExtension($bean_name, $field, $def_override)
    {
        ...
        $file_loc = "$this->base_path/dotbfield_{$field->name}.php";

...
class TemplateDatetimecombo extends TemplateRange 
{
	...
	var $dateStrings = array(
        ...
        'two weeks'=> '+2 weeks',
        'next month'=> '+1 month',
        'first day of next month'=> 'first day of next month', // must handle this non-GNU date string in DotbBean->populateDefaultValues; if we don't this will evaluate to 1969...

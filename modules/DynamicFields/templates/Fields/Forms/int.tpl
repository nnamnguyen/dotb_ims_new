...
<tr>
	...
	{if $hideLevel < 5}
		...
		{if isset($field_range_value)}
            <script>addToValidateRange('popup_form', 'default', 'int', false, '{dotb_translate module="DynamicFields" label="COLUMN_TITLE_DEFAULT_VALUE"}',{$field_range_value.min},{$field_range_value.max});</script>
        {else}
            <script>addToValidate('popup_form', 'default', 'int', false,'{dotb_translate module="DynamicFields" label="COLUMN_TITLE_DEFAULT_VALUE"}' );</script>
        {/if}
	{else}
...
<tr>
	<td class='mbLBL'>{dotb_translate module="DynamicFields" label="COLUMN_TITLE_MIN_VALUE"}:</td>
	<td>
	{if $hideLevel < 5}
		<input type='text' name='min' id='int_min' value='{$vardef.validation.min}'>
		{if isset($field_range_value)}
            <script>addToValidateRange('popup_form', 'min', 'int', false, '{dotb_translate module="DynamicFields" label="COLUMN_TITLE_MIN_VALUE"}',{$field_range_value.min},{$field_range_value.max});</script>
        {else}
            <script>addToValidate('popup_form', 'min', 'int', false,'{dotb_translate module="DynamicFields" label="COLUMN_TITLE_MIN_VALUE"}' );</script>
        {/if}
	{else}
...
<tr>
	<td class='mbLBL'>{dotb_translate module="DynamicFields" label="COLUMN_TITLE_MAX_VALUE"}:</td>
	<td>
	{if $hideLevel < 5}
		<input type='text' name='max' id='int_max' value='{$vardef.validation.max}'>
		{if isset($field_range_value)}
            <script>addToValidateRange('popup_form', 'max', 'int', false, '{dotb_translate module="DynamicFields" label="COLUMN_TITLE_MAX_VALUE"}',{$field_range_value.min},{$field_range_value.max});</script>
        {else}
            <script>addToValidate('popup_form', 'max', 'int', false,'{dotb_translate module="DynamicFields" label="COLUMN_TITLE_MAX_VALUE"}' );</script>
        {/if}
	{else}
...
<tr>
	...
	{if $hideLevel < 5}
		...
		<script>addToValidate('popup_form', 'len', 'int', false,'{dotb_translate module="DynamicFields" label="COLUMN_TITLE_MAX_SIZE"}' );</script>
	{else}
...
<tr id="autoinc_start_wrap" {if empty($vardef.auto_increment) }style="display:none" {/if}>
    <td class='mbLBL'>{dotb_translate module="DynamicFields" label="COLUMN_TITLE_AUTOINC_NEXT"}:</td>
    <td>
        ...
        <script>addToValidateMoreThan('popup_form', 'autoinc_next', 'int', false,'{dotb_translate module="DynamicFields" label="COLUMN_TITLE_AUTOINC_NEXT"}', {$vardef.autoinc_next|default:1});</script>
        <input type='hidden' name='autoinc_val_changed' id='autoinc_val_changed' value='false'>
    </td>
</tr>
{/if}
<tr>
    <td class='mbLBL'>{dotb_translate module="DynamicFields" label="COLUMN_DISABLE_NUMBER_FORMAT"}:</td>
    <td>

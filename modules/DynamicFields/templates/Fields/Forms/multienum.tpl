...
<tr>
	<td nowrap="nowrap">{dotb_translate module="DynamicFields" label="LBL_DROP_DOWN_LIST"}:</td>
	<td>
	{if $hideLevel < 5}
...
<tr>
	<td nowrap="nowrap">{dotb_translate module="DynamicFields" label="COLUMN_TITLE_DEFAULT_VALUE"}:</td>
	<td>
	{if $hideLevel < 5}
...
<tr>
	<td nowrap="nowrap">{dotb_translate module="DynamicFields" label="COLUMN_TITLE_DISPLAYED_ITEM_COUNT"}:</td>
	<td>
	{if $hideLevel < 5}
		<input type='text' name='ext2' id='ext2' value='{$cf.ext2|default:5}'>
		<script>addToValidate('popup_form', 'ext2', 'int', false,'{dotb_translate module="DynamicFields" label="COLUMN_TITLE_DISPLAYED_ITEM_COUNT"}' );</script>
	{else}
...
<tr>
	<td nowrap="nowrap">{dotb_translate module="DynamicFields" label="COLUMN_TITLE_MASS_UPDATE"}:</td>
	<td>
	{if $hideLevel < 5}

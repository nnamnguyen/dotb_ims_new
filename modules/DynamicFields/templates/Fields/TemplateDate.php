...
function __construct() {
	...
	$this->dateStrings = array(
            ...
            $app_strings['LBL_FIRST_DAY_OF_NEXT_MONTH']=> 'first day of next month', // must handle this non-GNU date string in DotbBean->populateDefaultValues; if we don't this will evaluate to 1969...

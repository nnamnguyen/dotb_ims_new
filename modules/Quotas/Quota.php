...
class Quota extends DotbBean
{
    ...
    public function save($check_notify = false)
    {
        if (empty($this->currency_id)) {
            ...
            $currency = DotbCurrency::getUserLocaleCurrency();
    ...
    public function set_notification_body($xtpl, $quota)
    {
        ...
        $xtpl->assign("QUOTA_URL", $dotb_config['site_url'] . '/index.php?module=Quotas&action=index&timeperiod_id=' . $quota->timeperiod_id);
    ...
    public function getRollupQuota($timeperiod_id, $user_id = null, $should_rollup = false)
    {
        ...
        $row['formatted_amount'] = DotbCurrency::formatAmountUserLocale($row['amount'], $row['currency_id']);

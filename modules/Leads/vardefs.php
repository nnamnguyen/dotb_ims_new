...
$dictionary['Lead'] = array(
    ...
    'fields' => array(
        'address_state_2' => array(
            'name' => 'address_state_2',
            'vname' => 'LBL_ADDRESS_STATE_2',
            'type' => 'enum',
            'options'=>'address_state_2_options'
        ),
        ...
        'address_city_2' => array(
            'name' => 'address_city_2',
            'vname' => 'LBL_ADDRESS_CITY_2',
            'type' => 'enum',
            'options'=>'address_city_2_options'
        ),
        ...
        'status' => array(
            ...
            'merge_filter' => 'enabled',
            //Fixme PAT-2241 will remove this when DotbLogic is supported in preview
            'previewEdit' => false,
        ),

 ...
 *
 * This is the DotbView subclass to handle displaying the list of duplicate Leads found when attempting to create
 * a new Lead.  This class is called from the LeadFormBase class handleSave function.
 */
class ViewShowDuplicates extends DotbView
{
    ...
    function display()
    {
        ...
        if(!isset($_SESSION['SHOW_DUPLICATES']))
        {
            ...
            dotb_die("Unauthorized access to this area.");
        }

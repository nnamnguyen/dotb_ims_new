...
function template_groups_chooser(&$args) {
	...
	$uparraow_big = DotbThemeRegistry::current()->getImage('uparrow_big','border="0" style="margin-bottom: 1px;"'
,null,null,'.gif',$mod_strings['LBL_SORT']);
	$downarrow_big = DotbThemeRegistry::current()->getImage('downarrow_big','border="0" style="margin-top: 1px;" ',null,null,'.gif',$mod_strings['LBL_SORT']);
	$leftarrow_big = DotbThemeRegistry::current()->getImage('leftarrow_big','border="0" style="margin-right: 1px;"'
,null,null,'.gif',$mod_strings['LBL_SORT']);
	$rightarrow_big = DotbThemeRegistry::current()->getImage('rightarrow_big','border="0" style="margin-left: 1px;"',null,null,'.gif',$mod_strings['LBL_SORT']);

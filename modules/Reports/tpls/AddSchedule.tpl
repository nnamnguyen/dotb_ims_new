...
<script type="text/javascript" src='{dotb_getjspath file="$CACHE_DIR/javascript/dotbcrm2.min.js"}'></script>
<script type="text/javascript" src='{dotb_getjspath file="include/javascript/dotb_3.js"}'></script>
<script type="text/javascript" src='{dotb_getjspath file="$CACHE_DIR/javascript/dotbcrm3.min.js"}'></script>
<script type="text/javascript" src='{dotb_getjspath file="$CACHE_DIR/javascript/dotbcrm1.min.js"}'></script>

...
class ReportsViewBuildreportmoduletree extends DotbView
{
    /**
    ...
    public function display()
    {
        ...
        foreach($linked_fields as $linked_field)
        {
			...
			foreach(DotbAutoLoader::existing("custom/modules/".$_REQUEST['report_module']."/Ext/Language/".$lang.".lang.ext.php") as $file) {
			    require $file;
			}//end 47834
    ...
    protected function _populateNodeItem($bean_name,$link_module,$linked_field)
    {
        ...
        $node['href'] = "javascript:DOTB.reports.populateFieldGrid('". $link_module . "','".$linked_field['relationship']."','".$bean_name."','".str_replace(array('&#039;', '&#39;'), "\'", $linked_field['label'])."');";
        $node['leaf'] = false;

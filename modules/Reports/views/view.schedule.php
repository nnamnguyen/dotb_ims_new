...
class ViewSchedule extends DotbView
{
    function display ()
    {
        ...
        $smarty->assign('STYLESHEET',DotbThemeRegistry::current()->getCSS());
        ...
        $cache_dir = !empty($GLOBALS['dotb_config']['cache_dir']) ? rtrim($GLOBALS['dotb_config']['cache_dir'], '/\\') : 'cache';
        ...
        $smarty->assign('JS_LANGUAGE_VERSION',  $GLOBALS['dotb_config']['js_lang_version']);

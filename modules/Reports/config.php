...
$local_mod_strings = return_module_language($dotb_config['default_language'], 'Reports');
...
function getAllowedReportModules(&$local_modListHeader, $skipCache = false) {
	...
	foreach(DotbAutoLoader::existingCustom('modules/Reports/metadata/reportmodulesdefs.php') as $file) {
	    include $file;
	}

	...
	<td>
		...
		<tr>
			...
			if ($control_type == '4corner') { ?>
				...
				<a onclick="javascript:right_to_left();"><?php echo DotbThemeRegistry::current()->getImage('leftarrow', 'border="0" ', null, null, ".gif", $mod_strings['LBL_LEFT']); ?></a>
				</td>
				<td rowspan=2 valign=middle>
				<a onclick="javascript:left_to_right();"><?php echo DotbThemeRegistry::current()->getImage("rightarrow", "", null, null, ".gif", $mod_strings['LBL_RIGHT']); ?></a>
				</tr>
				<tr>
				<td>
				<a onclick="javascript:down('display_columns');"><?php echo DotbThemeRegistry::current()->getImage("downarrow", "", null, null, ".gif", $mod_strings['LBL_DOWN']); ?></a></td>
				</tr>
				</table> 
			<?php } else if ($control_type == 'side') { ?>
				...
				<a onclick="javascript:up('display_columns');"><?php echo DotbThemeRegistry::current()->getImage("uparrow", "border='0'", null, null, ".gif", $mod_strings['LBL_UP']); ?></a>
				</td></tr> 
				<tr> <td align=left colspan=2>
				<a onclick="javascript:down('display_columns');"><?php echo DotbThemeRegistry::current()->getImage("downarrow", "", null, null, ".gif", $mod_strings['LBL_DOWN']); ?></a>
				</td> </tr> 
				...
				<td>
				<a onclick="javascript:left_to_right();"><?php echo DotbThemeRegistry::current()->getImage("rightarrow", 'border="0"', null, null, ".gif", $mod_strings['LBL_RIGHT']); ?></a>
				</td>
				</tr>
				</table> 
			<?php } ?>
...
var visible_fields = ["<?php echo DotbCleaner::cleanHtml(implode('","',$table_columns), false);?>"];
var hidden_fields = ["<?php echo DotbCleaner::cleanHtml(implode('","',$hidden_columns), false);?>"];
...
?>
<input name="<?php echo $field['name'];?>" type="text" length="<?php echo $field['len']; ?>" value="<?php echo DotbCleaner::cleanHtml($val, false); ?>">
<?php
}

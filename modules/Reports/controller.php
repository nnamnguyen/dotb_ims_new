...
class ReportsController extends DotbController
{	
	/** 
	 * @see DotbController::setup($module = '')
	 */
	...
	{
		$view = new ReportsDotbFieldTeamsetCollection(true);
		$view->setup();
		$view->process();
		$view->init_tpl();
		echo $view->display();

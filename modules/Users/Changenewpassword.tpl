...
<script type='text/javascript' src='{/literal}{dotb_getjspath file="modules/Users/PasswordRequirementBox.js"}{literal}'></script>
<style type="text/css">
<!--

@import url({dotb_getjspath file='modules/Users/PasswordRequirementBox.css'});
.body 
{ 
    font-size: 12px;
}
...
<img src="{$dotb_md}" alt="Dotb" width="340" height="25" /></td>
</tr>
<tr>
<td align="center">

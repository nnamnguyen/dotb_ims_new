...
<div id="email_options">
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
        ...
        <tr id="email_options_link_type" style='display:{$HIDE_FOR_GROUP_AND_PORTAL}'>
            <td scope="row" width="17%">
                {$MOD.LBL_EMAIL_LINK_TYPE}:&nbsp;{dotb_help text=$MOD.LBL_EMAIL_LINK_TYPE_HELP WIDTH=450}
            </td>
            <td>
                <select id="email_link_type"
                        name="email_link_type" {if $DISABLE_DOTB_CLIENT} data-dotbclientdisabled="true"{/if}
                        tabindex='410'>
                    {$EMAIL_LINK_TYPE}
                </select>
            </td>
        ...
        {if !$HIDE_IF_CAN_USE_DEFAULT_OUTBOUND}
            <tr id="mail_smtpserver_tr">
                ...
                <td width="30%">
                    <slot>{$mail_smtpdisplay}<input id='mail_smtpserver' name='mail_smtpserver' type="hidden"
                                                    value='{$mail_smtpserver}'/></slot>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
            {if !empty($mail_smtpauth_req) }
                <tr id="mail_smtpuser_tr">
                    <td width="20%" scope="row" nowrap="nowrap"><span
                                id="mail_smtpuser_label">{$MOD.LBL_MAIL_SMTPUSER}</span></td>
                    <td width="30%">
                        <slot><input type="text" id="mail_smtpuser" name="mail_smtpuser" size="25" maxlength="64"
                                     value="{$mail_smtpuser}" tabindex='1'></slot>
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
                <tr id="mail_smtppass_tr">
                    <td width="20%" scope="row" nowrap="nowrap"><span
                                id="mail_smtppass_label">{$MOD.LBL_MAIL_SMTPPASS}</span></td>
                    <td width="30%">
                        <slot>
                            <input type="password" id="mail_smtppass" name="mail_smtppass" size="25" maxlength="64"
                                   value="{$mail_smtppass}" tabindex='1'>
                            <a href="javascript:void(0)" id='mail_smtppass_link'
                               onClick="DOTB.util.setEmailPasswordEdit('mail_smtppass')"
                               style="display: none">{$APP.LBL_CHANGE_PASSWORD}</a>
                        </slot>
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
            ...
            <tr id="test_outbound_settings_tr">
                <td width="17%" scope="row"><input type="button" class="button"
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="edit view">
                <tr>
                            ...
                            <tr>
                                ...
                                <td class='dataField'>
                                    <input name='confirm_new_password' id='confirm_pwd' style='' type='password'
                                           tabindex='2' {$DISABLED} onkeyup="password_confirmation();">
                                </td>
                                <td width='40%'>
                                    ...
                                    {*<span id="ext-gen63" class="x-panel-header-text">
                                       Requirements
                                       <span id="Filter.1_help" onclick="return DOTB.util.showHelpTips(this,help());">
                    ...
                    <td width='60%' style="vertical-align:middle;">
                        {if !$IS_PORTALONLY}
                            {dotb_password_requirements_box width='300px' class='x-sqs-list' style='background-color:white; padding:5px !important;'}
                        {/if}
                    </td>
                </tr>
            </table>
        ...
        <div id="themepicker" style="display:{$HIDE_FOR_GROUP_AND_PORTAL}">
            <table class="edit view" border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td width="33%">
                        <img id="themePreview" src="{dotb_getimagepath file='themePreview.png'}" border="1"/>
                    </td>
                    <td width="17%">&nbsp;</td>
                    <td width="33%">&nbsp;</td>
                </tr>
...
<div>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
            ...
            <tr>
                <td scope="row" valign="top">
                    <slot>{$MOD.LBL_EXPORT_DELIMITER}:</slot>&nbsp;{dotb_help text=$MOD.LBL_EXPORT_DELIMITER_DESC }
                </td>
                <td>
                ...
                <td scope="row" width="17%">
                    ...
                    </slot>&nbsp;{dotb_help text=$MOD.LBL_RECEIVE_NOTIFICATIONS_TEXT}
                </td>
                <td width="33%">
            ...
            <tr>
                <td scope="row" valign="top">
                    <slot>{$MOD.LBL_EXPORT_CHARSET}:</slot>&nbsp;{dotb_help text=$MOD.LBL_EXPORT_CHARSET_DESC }</td>
                <td>
                    <slot><select tabindex='12' name="default_export_charset">{$EXPORT_CHARSET}</select></slot>
                </td>
                <td scope="row" valign="top">
                    <slot>{$MOD.LBL_REMINDER}:</slot>&nbsp;{dotb_help text=$MOD.LBL_REMINDER_TEXT }
                </td>
            ...
            <tr>
                <td scope="row" valign="top">
                    <slot>{$MOD.LBL_USE_REAL_NAMES}:</slot>&nbsp;{dotb_help text=$MOD.LBL_USE_REAL_NAMES_DESC }</td>
                <td>
            ...
            <tr>
                {if !empty($SHOW_TEAM_SELECTION)}
                    <td width="20%" scope="row">
                        <slot>{$MOD.LBL_DEFAULT_TEAM}:</slot>&nbsp;{dotb_help text=$MOD.LBL_DEFAULT_TEAM_TEXT }</td>
                    <td>
                        <slot>{$DEFAULT_TEAM_OPTIONS}</slot>
                    </td>
                {/if}
                <td scope="row"></td>
                <td></td>
            ...
            <tr>
                ...
                <td scope="row" nowrap>
                    ...
                    </slot>&nbsp;{dotb_help text=$smarty.capture.SMARTY_LBL_EXTERNAL_AUTH_ONLY}</td>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
            ...
            <tr>
                <td width="17%" scope="row">
                    <slot>{$MOD.LBL_DATE_FORMAT}:</slot>&nbsp;{dotb_help text=$MOD.LBL_DATE_FORMAT_TEXT }</td>
                <td width="33%">
                ...
                <!-- BEGIN: currency -->
                <td width="17%" scope="row">
                    <slot>{$MOD.LBL_CURRENCY}:</slot>&nbsp;{dotb_help text=$MOD.LBL_CURRENCY_TEXT }</td>
                <td>
                    <slot>
            ...
            <tr>
                <td scope="row">
                    <slot>{$MOD.LBL_TIME_FORMAT}:</slot>&nbsp;{dotb_help text=$MOD.LBL_TIME_FORMAT_TEXT }</td>
                <td>
                ...
                <td>
                    <slot>
                        <select disabled id='sigDigits' onchange='setSigDigits(this.value);'
            ...
            <tr>
                <td scope="row">
                    <slot>{$MOD.LBL_TIMEZONE}:</slot>&nbsp;{dotb_help text=$MOD.LBL_TIMEZONE_TEXT }</td>
                <td>
            ...
            <tr>
                ...
                <td width="17%" scope="row">
                    ...
                    </slot>&nbsp;{dotb_help text=$MOD.LBL_NUMBER_GROUPING_SEP_TEXT }</td>
                <td>
                    <slot>
                        <input disabled tabindex='14' name='num_grp_sep' id='default_number_grouping_seperator'
            ...
            <tr>
                <td scope="row" valign="top">{$MOD.LBL_LOCALE_DEFAULT_NAME_FORMAT}
                    :&nbsp;{dotb_help text=$smarty.capture.SMARTY_LOCALE_NAME_FORMAT_DESC }</td>
                <td valign="top">
                ...
                <td width="17%" scope="row">
                    <slot>{$MOD.LBL_DECIMAL_SEP}:</slot>&nbsp;{dotb_help text=$MOD.LBL_DECIMAL_SEP_TEXT }</td>
                <td>
                    <slot>
                        <input disabled tabindex='14' name='dec_sep' id='default_decimal_seperator'
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
                <tr>
                    <th width="100%" align="left" colspan="4">
                        <h4>
                            <slot>{$MOD.LBL_PDF_SETTINGS}</slot>
                        </h4>
                    </th>
                </tr>
                <tr>
                    <td width="17%" scope="row">
                        <slot>{$MOD.LBL_PDF_FONT_NAME_MAIN}:
                        </slot>&nbsp;{dotb_help text=$MOD.LBL_PDF_FONT_NAME_MAIN_TEXT}</td>
                    <td width="33%">
                        <slot><select name='dotbpdf_pdf_font_name_main' tabindex='16'>{$PDF_FONT_NAME_MAIN}</select>
                        </slot>
                    </td>
                    <td colspan="2">
                        <slot>&nbsp;</slot>
                ...
                <tr>
                    <td width="17%" scope="row">
                        <slot>{$MOD.LBL_PDF_FONT_SIZE_MAIN}:</slot>
                    </td>
                    <td width="33%">
                        <slot><input type="text" name="dotbpdf_pdf_font_size_main" value="{$PDF_FONT_SIZE_MAIN}"
                                     size="5" maxlength="5" tabindex='16'/></slot>
                    </td>
                    <td colspan="2">
                        <slot>{$MOD.LBL_PDF_FONT_SIZE_MAIN_TEXT}&nbsp;</slot>
                    </td>
                </tr>
                <tr>
                    <td width="17%" scope="row">
                        <slot>{$MOD.LBL_PDF_FONT_NAME_DATA}:
                        </slot>&nbsp;{dotb_help text=$MOD.LBL_PDF_FONT_NAME_DATA_TEXT}</td>
                    <td width="33%">
                        <slot><select name='dotbpdf_pdf_font_name_data' tabindex='16'>{$PDF_FONT_NAME_DATA}</select>
                        </slot>
                    </td>
                    <td colspan="2">
                        <slot>&nbsp;</slot>
                ...
                <tr>
                    <td width="17%" scope="row">
                        <slot>{$MOD.LBL_PDF_FONT_SIZE_DATA}:</slot>
                    </td>
                    <td width="33%">
                        <slot><input type="text" name="dotbpdf_pdf_font_size_data" value="{$PDF_FONT_SIZE_DATA}"
                                     size="5" maxlength="5" tabindex='16'/></slot>
                    </td>
                    <td colspan="2">
                        <slot>{$MOD.LBL_PDF_FONT_SIZE_DATA_TEXT}&nbsp;</slot>
                    </td>
                </tr>
            </table>
        {/if}
    ...
    <div id="calendar_options" style="display:{$HIDE_FOR_GROUP_AND_PORTAL}">
        <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
            ...
            <tr>
                <td width="17%" scope="row">
                    <slot>{$MOD.LBL_PUBLISH_KEY}:</slot>&nbsp;{dotb_help text=$MOD.LBL_CHOOSE_A_KEY}</td>
                <td width="20%">
                    <slot><input id='calendar_publish_key' name='calendar_publish_key' tabindex='17' size='25'
                                 maxlength='25' type="text" value="{$CALENDAR_PUBLISH_KEY}"></slot>
                </td>
                <td width="63%">
                    <slot>&nbsp;</slot>
                </td>
            ...
            <tr>
                <td width="15%" scope="row">
                    <slot>{$MOD.LBL_ICAL_PUB_URL|strip_semicolon}: {dotb_help text=$MOD.LBL_ICAL_PUB_URL_HELP}</slot>
                </td>
            ...
            <tr>
                <td width="17%" scope="row">
                    <slot>{$MOD.LBL_FDOW}:</slot>&nbsp;{dotb_help text=$MOD.LBL_FDOW_TEXT}</td>
                <td>
                    <slot>
                        <select tabindex='14'
...
{if $ID}
    <div id="eapm_area" style='display:{$HIDE_FOR_GROUP_AND_PORTAL};'>
        <div style="text-align:center; width: 100%">{dotb_image name="loading"}</div>
    </div>
{/if}
</div>
    ...
    $(document).ready(function () {
        ...
        if (window.addEventListener) {
            window.addEventListener("load", function () {
                DOTB.util.setEmailPasswordDisplay('mail_smtppass', {/literal}{$mail_haspass}{literal});
            }, false);
        } else {
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" class="actionsContainer footer">
    <tr>
        <td>
            {dotb_action_menu id="userEditActions" class="clickMenu fancymenu" buttons=$ACTION_BUTTON_FOOTER flat=true}
        </td>

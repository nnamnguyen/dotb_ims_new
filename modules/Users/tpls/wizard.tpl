...
<script type="text/javascript" src="{dotb_getjspath file='modules/Emails/javascript/vars.js'}"></script>
<script type="text/javascript" src="{dotb_getjspath file='cache/javascript/dotbcrm14.min.js'}"></script>
<script type="text/javascript" src="{dotb_getjspath file='modules/Users/User.js'}"></script>
...
<div id="welcome" class="screen">
        ...
        <td>
            ...
            <tr>
               ...
               <p> {$MOD.LBL_WIZARD_WELCOME_NOSMTP}</p>
				...
				<div class="userWizWelcome"><img src='include/images/dotb_wizard_welcome.jpg' border='0' alt='{$MOD.LBL_WIZARD_WELCOME_TAB}' width='765px' height='325px'></div>
                </td>
            </tr>
            </table>
            </div>
    ...
    <div class="nav-buttons">
        <input title="{$MOD.LBL_WIZARD_NEXT_BUTTON}"
            ...
            onclick="DotbWizard.changeScreen('personalinfo',false);" id="next_tab_personalinfo" />
    </div>
</div>
...
<div id="personalinfo" class="screen">
    ...
    <div class="nav-buttons">
        ...
        <input title="{$MOD.LBL_WIZARD_BACK_BUTTON}"
            ...
            onclick="DotbWizard.changeScreen('welcome',true);" id="previous_tab_welcome" />&nbsp;
        {/if}
        <input title="{$MOD.LBL_WIZARD_NEXT_BUTTON}"
            class="button primary" type="button" name="next_tab1" value="  {$MOD.LBL_WIZARD_NEXT_BUTTON}  "
            onclick="DotbWizard.changeScreen('locale',false);" id="next_tab_locale" />
    </div>
</div>
...
<div id="locale" class="screen">
        ...
        <tr>
            <td>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td scope="row" nowrap="nowrap"><slot>{$MOD.LBL_TIMEZONE}:</slot>&nbsp;{dotb_help text=$MOD.LBL_TIMEZONE_TEXT }</td>
                    ...
                    <tr>
                        <td width="17%" scope="row" nowrap="nowrap"><slot>{$MOD.LBL_DATE_FORMAT}:</slot>&nbsp;{dotb_help text=$MOD.LBL_DATE_FORMAT_TEXT }</td>
                        <td width="33%"><slot><select tabindex='14' name='dateformat'>{$DATEOPTIONS}</select></slot></td>
                        <td scope="row" nowrap="nowrap"><slot>{$MOD.LBL_TIME_FORMAT}:</slot>&nbsp;{dotb_help text=$MOD.LBL_TIME_FORMAT_TEXT }</td>
                    ...
                    <tr>
                        <td width="17%" scope="row" nowrap="nowrap"><slot>{$MOD.LBL_CURRENCY}:</slot>&nbsp;{dotb_help text=$MOD.LBL_CURRENCY_TEXT }</td>
                            <td ><slot>
                    ...
                    <tr>
                        <td width="17%" scope="row" nowrap="nowrap"><slot>{$MOD.LBL_DECIMAL_SEP}:</slot>&nbsp;{dotb_help text=$MOD.LBL_DECIMAL_SEP_TEXT }</td>
                        <td ><slot>
                            <input tabindex='14' name='dec_sep' id='default_decimal_seperator'
                                type='text' maxlength='1' size='1' value='{$DEC_SEP}'
                                onkeydown='setSigDigits();' onkeyup='setSigDigits();'>
                        </slot></td>
                        <td width="17%" scope="row" nowrap="nowrap"><slot>{$MOD.LBL_NUMBER_GROUPING_SEP}:</slot>&nbsp;{dotb_help text=$MOD.LBL_NUMBER_GROUPING_SEP_TEXT }</td>
                    ...
                    <tr>
                        ...
                        <td nowrap="nowrap" scope="row" valign="top">{$MOD.LBL_LOCALE_DEFAULT_NAME_FORMAT}:&nbsp;{dotb_help text=$smarty.capture.SMARTY_LOCALE_NAME_FORMAT_DESC }</td>
    ...
    <div class="nav-buttons">
        <input title="{$MOD.LBL_WIZARD_BACK_BUTTON}"
            class="button" type="button" name="next_tab1" value="  {$MOD.LBL_WIZARD_BACK_BUTTON}  "
            onclick="DotbWizard.changeScreen('personalinfo',true);" id="previous_tab_personalinfo" />&nbsp;
        <input title="{$MOD.LBL_WIZARD_NEXT_BUTTON}"
            class="button primary" type="button" name="next_tab1" value="  {$MOD.LBL_WIZARD_NEXT_BUTTON}  "
            {if !$HIDE_IF_CAN_USE_DEFAULT_OUTBOUND}
            onclick="DotbWizard.changeScreen('smtp',false);" id="next_tab_smtp" />
            {else}
            onclick="DotbWizard.changeScreen('finish',false);" id="next_tab_finish" />
            {/if}
    </div>
</div>
{if !$HIDE_IF_CAN_USE_DEFAULT_OUTBOUND}
<div id="smtp" class="screen">
    ...
    <div class="nav-buttons">
        <input title="{$MOD.LBL_WIZARD_BACK_BUTTON}"
            class="button" type="button" name="next_tab1" value="  {$MOD.LBL_WIZARD_BACK_BUTTON}  "
            onclick="DotbWizard.changeScreen('locale',true);" id="previous_tab_locale" />&nbsp;
        <input title="{$MOD.LBL_WIZARD_NEXT_BUTTON}"
            class="button primary" type="button" name="next_tab1" value="  {$MOD.LBL_WIZARD_NEXT_BUTTON}  "
            onclick="DotbWizard.changeScreen('finish',false);" id="next_tab_finish" />
    </div>
...
<div id="finish" class="screen">
            ...
            <td>
                ...
                <tr>
                    <td scope="row">
                        ...
                        {if $IS_ADMIN}
                        <tr><td><img src="{dotb_getjspath file='include/images/start.png'}" style="margin-right: 5px;"></td><td><a onclick='document.UserWizard.whatnext.value="finish";document.UserWizard.submit()' href="#" ><b> {$MOD.LBL_WIZARD_FINISH2}  </b></a><br> {$MOD.LBL_WIZARD_FINISH2DESC}</td></tr>
                        <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                        <tr><td><img src="{dotb_getjspath file='include/images/import.png'}" style="margin-right: 5px;"></td><td><a onclick='document.UserWizard.whatnext.value="import";document.UserWizard.submit()' href="#" ><b> {$MOD.LBL_WIZARD_FINISH3} </b></a><br> {$MOD.LBL_WIZARD_FINISH4}</td></tr>
                        <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                        <tr><td><img src="{dotb_getjspath file='include/images/create_users.png'}" style="margin-right: 5px;"></td><td><a onclick='document.UserWizard.whatnext.value="users";document.UserWizard.submit()' href="#"  ><b> {$MOD.LBL_WIZARD_FINISH5} </b></a><br>{$MOD.LBL_WIZARD_FINISH6}</td></tr>
                        <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                        <tr><td><img src="{dotb_getjspath file='include/images/settings.png'}" style="margin-right: 5px;"></td><td><a  onclick='document.UserWizard.whatnext.value="settings";document.UserWizard.submit()' href="#" ><b> {$MOD.LBL_WIZARD_FINISH7} </b></a><br>{$MOD.LBL_WIZARD_FINISH8}</td></tr>
                        <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                        <tr><td><img src="{dotb_getjspath file='include/images/configure.png'}" style="margin-right: 5px;"></td><td><a onclick='document.UserWizard.whatnext.value="studio";document.UserWizard.submit()' href="#"  ><b> {$MOD.LBL_WIZARD_FINISH9} </b></a><br>{$MOD.LBL_WIZARD_FINISH10}</td></tr>
                        <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                        <tr><td><img src="{dotb_getjspath file='include/images/university.png'}" style="margin-right: 5px;"></td><td><a href="http://www.dotbcrm.com/university" target="_blank"><b> {$MOD.LBL_WIZARD_FINISH11} </b></a></b><br>{$MOD.LBL_WIZARD_FINISH12}</td></tr>
                        <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                        {else}
                            <tr><td><img src="{dotb_getjspath file='include/images/university2.png'}" style="margin-right: 5px;"></td><td><a href="http://www.dotbcrm.com/university" target="_blank"><b> {$MOD.LBL_WIZARD_FINISH11} </b></a></b><br>{$MOD.LBL_WIZARD_FINISH12}</td></tr>
                            <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                            <tr><td><img src="{dotb_getjspath file='include/images/docs.png'}" style="margin-right: 5px;"></td><td><a href="http://docs.dotbcrm.com/" target="_blank"><b> {$MOD.LBL_WIZARD_FINISH14} </b></a></b><br>{$MOD.LBL_WIZARD_FINISH15}</td></tr>
                            <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                            <tr><td><img src="{dotb_getjspath file='include/images/kb.png'}" style="margin-right: 5px;"></td><td><a href="http://kb.dotbcrm.com/" target="_blank"><b> {$MOD.LBL_WIZARD_FINISH16} </b></a></b><br>{$MOD.LBL_WIZARD_FINISH17}</td></tr>
                            <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                            <tr><td><img src="{dotb_getjspath file='include/images/forums.png'}" style="margin-right: 5px;"></td><td><a href="http://www.dotbcrm.com/forums" target="_blank"><b> {$MOD.LBL_WIZARD_FINISH18} </b></a></b><br>{$MOD.LBL_WIZARD_FINISH19}</td></tr>
                            <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                        {/if}
                        </table>
                    </td>
    ...
    <div class="nav-buttons">
        <input title="{$MOD.LBL_WIZARD_BACK_BUTTON}"
            class="button" type="button" name="next_tab1" value="  {$MOD.LBL_WIZARD_BACK_BUTTON}  "
            {if !$HIDE_IF_CAN_USE_DEFAULT_OUTBOUND}
            onclick="DotbWizard.changeScreen('smtp',true);" id="previous_tab_smtp" />&nbsp;
            {else}
            onclick="DotbWizard.changeScreen('locale',true);" id="previous_tab_locale" />&nbsp;
            {/if}
...
var DotbWizard = new function()
{
    ...
    this.handleKeyStroke = function(e)
    {
        ...
        switch(key) {
        case 13:
            primaryButton = YAHOO.util.Selector.query('input.primary',DotbWizard.currentScreen,true);
            primaryButton.click();
            break;
        }
    }
        ...
        if ( !skipCheck ) {
            ...
            case 'locale':
                if (document.getElementById("default_number_grouping_seperator").value == document.getElementById("default_decimal_seperator").value) {
	            	alert(DOTB.language.get('app_strings','ERR_DECIMAL_SEP_EQ_THOUSANDS_SEP'));
		            isError = true
                }
                break
            }
...
{/literal}
{if $SKIP_WELCOME}
DotbWizard.changeScreen('personalinfo');
{else}
DotbWizard.changeScreen('welcome');
{/if}
{literal}
document.onkeypress = DotbWizard.handleKeyStroke;
...
function sendTestEmail()
{
	...
	YAHOO.util.Connect.asyncRequest("POST", "index.php?action=testOutboundEmail&module=EmailMan&to_pdf=true&dotb_body_only=true", callbackOutboundTest, postDataString);
}

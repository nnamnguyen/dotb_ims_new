...
<link rel="stylesheet" type="text/css" href="{dotb_getjspath file='modules/Users/PasswordRequirementBox.css'}">
<script type="text/javascript" src="{dotb_getjspath file='cache/javascript/dotbcrm12.min.js'}"></script>
<script type='text/javascript' src='{dotb_getjspath file='include/SubPanel/SubPanelTiles.js'}'></script>
...
<script type='text/javascript' src='{dotb_getjspath file='modules/Users/UserEditView.js'}'></script>
<script type='text/javascript' src='{dotb_getjspath file='modules/Users/PasswordRequirementBox.js'}'></script>
{$ERROR_STRING}
...
DOTB.EmailAddressWidget.prototype.forceSubmit = function() { document.getElementById('Save').click();}
...
{literal}
    ...
    EditView_tabs.getTab(eapmTabIndex).set('dataSrc','index.php?dotb_body_only=1&module=Users&subpanel=eapm&action=SubPanelViewer&inline=1&record={/literal}{$ID}{literal}&layout_def_key=UserEAPM&inline=1&ajaxSubpanel=true');
...
{literal}
    EditView_tabs.addTab( new YAHOO.widget.Tab({
        ...
        content: '<div style="text-align:center; width: 100%">{/literal}{dotb_image name="loading"}{literal}</div>',
        cacheData: true
    }));
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" class="actionsContainer">
    <tr>
        <td>
            {dotb_action_menu id="userEditActions" class="clickMenu fancymenu" buttons=$ACTION_BUTTON_HEADER flat=true}
        </td>

...
var LBL_LOGIN_SUBMIT = '{dotb_translate module="Users" label="LBL_LOGIN_SUBMIT"}';
var LBL_REQUEST_SUBMIT = '{dotb_translate module="Users" label="LBL_REQUEST_SUBMIT"}';
var LBL_SHOWOPTIONS = '{dotb_translate module="Users" label="LBL_SHOWOPTIONS"}';
var LBL_HIDEOPTIONS = '{dotb_translate module="Users" label="LBL_HIDEOPTIONS"}';
</script>
	...
	<tr>
		...
		<div class="loginBoxShadow" style="width: 460px;">
			...
			<table cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
				<tr>
					<td align="left"><b>{dotb_translate module="Users" label="LBL_LOGIN_WELCOME_TO"}</b><br>
					    {$LOGIN_IMAGE}
					</td>
				</tr>
				<tr>
...
{dotb_csrf_form_token}
						    	...
						    	<td scope="row" colspan="2">
						    	    <span class="error" id="browser_warning" style="display:none">
						    	        {dotb_translate label="LBL_ALERT_BROWSER_NOT_SUPPORTED"}
						    	    </span>
						    	    <span class="error" id="ie_compatibility_mode_warning" style="display:none">
						    	        {dotb_translate label="WARN_BROWSER_IE_COMPATIBILITY_MODE_WARNING"}
						    	    </span>
						    	</td>
                                ...
                                {if !empty($SELECT_LANGUAGE)}
                                    <tr>
                                        <td scope="row">{dotb_translate module="Users" label="LBL_LANGUAGE"}:</td>
                                        <td><select style='width: 152px' name='login_language' onchange="switchLanguage(this.value)">{$SELECT_LANGUAGE}</select></td>
                                    </tr>
                                {/if}
									<tr>
										<td scope="row" width="30%"><label for="user_name">{dotb_translate module="Users" label="LBL_USER_NAME"}:</label></td>
										<td width="70%"><input type="text" size='35' tabindex="1" id="user_name" name="user_name" value="{$LOGIN_USER_NAME|escape:'html':'UTF-8'}" /></td>
									</tr>
									<tr>
										<td scope="row"><label for="user_password">{dotb_translate module="Users" label="LBL_PASSWORD"}:</label></td>
										<td width="30%"><input type="password" size='26' tabindex="2" id="user_password" name="user_password" value='{$LOGIN_PASSWORD}' /></td>
									</tr>

									<tr>
										<td>&nbsp;</td>
										<td><input title="{dotb_translate module="Users" label="LBL_LOGIN_BUTTON_TITLE"}"  class="button primary" class="button primary" type="submit" tabindex="3" id="login_button" name="Login" value="{dotb_translate module="Users" label="LBL_LOGIN_BUTTON_LABEL"}"><br>&nbsp;</td>
									</tr>
								</table>
							</form>
								...
								<table cellpadding="0" cellspacing="2" border="0" align="center" width="100%">
									<tr>
										...
										<div  style="cursor: hand; cursor: pointer; display:{$DISPLAY_FORGOT_PASSWORD_FEATURE};" onclick='toggleDisplay("forgot_password_dialog");'>
											<a href='javascript:void(0)'><IMG src="{dotb_getimagepath file='advanced_search.gif'}" border="0" alt="Hide Options" id="forgot_password_dialog_options">{dotb_translate module="Users" label="LBL_LOGIN_FORGOT_PASSWORD"}</a>
										</div>
											<div id="forgot_password_dialog" style="display:none" >
												...
												<table cellpadding="0" cellspacing="2" border="0" align="center" width="100%" >
													...
													<tr>
														<td scope="row" width="30%"><label for="fp_user_name">{dotb_translate module="Users" label="LBL_USER_NAME"}:</label></td>
														<td width="70%"><input type="text" size='26' id="fp_user_name" name="fp_user_name" value="{$LOGIN_USER_NAME|escape:'html':'UTF-8'}" /></td>
													</tr>
													<tr>
											            <td scope="row" width="30%"><label for="fp_user_mail">{dotb_translate module="Users" label="LBL_EMAIL"}:</label></td>
													...
													<tr>
														...
														<td width="70%"><input title="Email Temp Password" class="button" type="button" style="display:inline" onclick="validateAndSubmit(); return document.getElementById('cant_login').value == ''" id="generate_pwd_button" name="fp_login" value="{dotb_translate module="Users" label="LBL_LOGIN_SUBMIT"}"></td>
													</tr>
												</table>
											</div>
										</td>

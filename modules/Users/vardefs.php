    ...
    $dictionary['User'] = array(
        ...
        'fields' => array(
            ...
            array (
                ...
                'bean_name' => 'Team',
                'source' => 'non-db',
                'vname' => 'LBL_MANAGER_USER_TEAM',
            ),


            //Custom Fields full_name by Lap Nguyen
            'full_user_name' =>
            array (
                'required' => false,
                'name' => 'full_user_name',
            ...
            //Token Apps
            'portal_app_token' => array(
                'name' => 'portal_app_token',
                'vname' => 'LBL_PORTAL_APP_TOKEN',
                'type' => 'text',
                'comment' => '',
            ),
            'id' => array(
            ...
            /**
             * dotb_login will force the user to use dotb authentication
             * regardless of what authentication the system is configured to use
             */
            'dotb_login' => array(
                'name' => 'dotb_login',
                'vname' => 'LBL_DOTB_LOGIN',
                'type' => 'bool',
                'default' => '1',
                'reportable' => false,
                'massupdate' => false,
        ...
        'relationships' => array (
            ...
            'manager_user_rel' => array(
                'lhs_module' => 'Users',
                'lhs_table' => 'users',
                'lhs_key' => 'id',
                'rhs_module' => 'Teams',
                'rhs_table' => 'teams',
                'rhs_key' => 'manager_user_id',
                'relationship_type' => 'one-to-many'
            ),
        ),

        'acls' => array('DotbACLUsers' => true, 'DotbACLStatic' => true),
    );

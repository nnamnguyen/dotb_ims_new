...
If you are not setting up Inbound Email, please clear all fields in that section.',
  ...
  'LBL_PLEASE_INPUT_USER_VERIFY_KEY' => 'Please input Username and Verify key!',
...
<tr><td><!--not_in_theme!--><img src=include/images/university.png style="margin-right: 5px;"></td><td><a href="http://www.dotbcrm.com/university" target="_blank"><b>Dotb University</b></a><br>End-user and System Administrator Training and Resources</td></tr>
<tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
<tr><td><!--not_in_theme!--><img src=include/images/docs.png style="margin-right: 5px;"></td><td><a href="http://docs.dotbcrm.com/" target="_blank"><b>Documentation</b></a><br>Product Guides and Release Notes</td></tr>
<tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
<tr><td><!--not_in_theme!--><img src=include/images/kb.png style="margin-right: 5px;"></td><td><a href="http://kb.dotbcrm.com/" target="_blank"><b>Knowledge Base</b></a><br>Tips from DotBCRM Support for performing common tasks and processes in Dotb</td></tr>
<tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
<tr><td><!--not_in_theme!--><img src=include/images/forums.png style="margin-right: 5px;"></td><td><a href="http://www.dotbcrm.com/forums" target="_blank"><b>Forums</b></a><br>Forums dedicated to the Dotb Community to discuss topics of interest with each other and with DotBCRM Developers</td></tr>
</table>',
  ...
  'LBL_WIZARD_FINISH11' => 'Visit Dotb University ',
  ...
  'LBL_WIZARD_PERSONALINFO_DESC' => 'Provide information about yourself. The information you provide about yourself will be visible to other Dotb users.<br />Fields marked with <span class="required">*</span> are required.',

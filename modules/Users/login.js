...
function toggleDisplay(id){
	...
	if(this.document.getElementById(id).style.display=='none'){
        ...
        document.getElementById(id+"_options").src = 'index.php?entryPoint=getImage&themeName='+DOTB.themes.theme_name+'&imageName=basic_search.gif';
	...
	document.getElementById(id+"_options").src = 'index.php?entryPoint=getImage&themeName='+DOTB.themes.theme_name+'&imageName=advanced_search.gif';	
...
function generatepwd(){
	...
	document.getElementById('wait_pwd_generation').innerHTML = '<img src="themes/default/images/img_loading.gif?v='+DOTB.VERSION_MARK+'" >';
var callback;
       callback = {
			success: function(o){
...
$(function(){
    ...
    if (DOTB.isIECompatibilityMode()){
        $("#ie_compatibility_mode_warning").show();
    }
    else if (!DOTB.isSupportedBrowser()){

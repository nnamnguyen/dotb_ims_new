...
if (isset($_GET['option'])) {
    ...
    switch($_GET['option']) {
        ...
        case "macro":
            ...
            $del_btn = $e->delete_button_attributes($GLOBALS['dotb_version']);
    ...
    if (empty($sms->params['sms_instance_id']) or empty($sms->params['domain_name'])) {
        ...
        <form method="post" name="WebToLeadForm" id="WebToLeadForm">
            <table width="100%" border="0" cellspacing="1" cellpadding="0"  class="edit view">
                <tbody>
                    <tr>
                        <td width='12%'><span dotb="slot">First Name: </span><span class="required">*</span></td>
                        <td ><span dotb="slot"><input size="30" type="text" name="first_name" id="first_name" /></span></td>
                    </tr>
                    <tr>
                        <td><span dotb="slot">Last Name: </span><span class="required">*</span></td>
                        <td ><span dotb="slot"><input size="30" type="text" name="last_name" id="last_name" /></span></td>
                    </tr>
                    <tr>
                        <td><span dotb="slot">Title: </span></td>
                        <td ><span dotb="slot"><input size="30" type="text" name="title" id="title" /></span></td>
                    </tr>
                    <tr>
                        <td><span dotb="slot">Company
                            Name: </span><span class="required">*</span></td>
                        <td ><span dotb="slot"><input size="30" type="text" name="account_name" id="account_name" /></span></td>
                    </tr>
                    <tr>
                        <td><span dotb="slot">Country: </span><span class="required">*</span></td>
                        <td ><span dotb="slot"><select onchange="document.getElementById('primary_address_country').value = this.options[this.selectedIndex].firstChild.nodeValue" name="primary_address_country_list" id="primary_address_country_list">
                                    <?php
                    ...
                    <tr>
                        <td><span dotb="slot">Mobile Phone: </span><span class="required">*</span></td>
                        <td ><span dotb="slot"><input size="30" type="text" name="phone_work" id="phone_work" /></span></td>
                    </tr>
                    <tr>
                        <td><span dotb="slot">Email: </span><span class="required">*</span></td>
                        <td ><span dotb="slot"><input size="30" type="text" name="email1" id="email1" /></span></td>
                    </tr>
                    <tr>
                        <td><span dotb="slot">Remark: </span></td>
                        <td ><span dotb="slot"><textarea rows="8" cols="50" name="description" id="description"></textarea></span></td>
                    </tr>
                </tbody>
            </table>
            ...
            <input type="hidden" value="<?php echo $dotb_version; ?>" name="version" id="version">
            <input type="hidden" value="<?php echo $dotb_flavor; ?>" name="edition" id="edition">
        </form>
        ...
        <script type='text/javascript'>
            ...
            function form_submit() {
                ...
                var url = 'https://apps.theopensource.com.sg/dotbcrm/WebToLeadCaptureJoomla.php';
                    ...
                    success: function(dat) { //on success getting result
                        $.ajax({
                            ...
                            success: function(dat1) { //on success getting result
                                $.get("./index.php?module=Administration&action=smsProvider&dotb_body_only=1", { param:dat1.url, option:'create_sms_config' }, function() {        // create sms_config

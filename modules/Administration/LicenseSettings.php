...
if (!is_admin($current_user)) dotb_die("Unauthorized access to administration.");
    ...
    if (isset($GLOBALS['dotb_config']['hide_admin_licensing']) && $GLOBALS['dotb_config']['hide_admin_licensing']) {
        dotb_die(translate('LBL_LICENSE_UNAUTHORIZED_ACCESS', 'Administration'));
...
//
//
//	$content = check_now(get_dotbbeat(), true);
//	header("Content-Disposition: attachment; filename=dotbkey.lic");
...
$manualValidation3Url = '<a href="https://updates.dotbcrm.com/license/" target="_blank">https://updates.dotbcrm.com/license/</a>';

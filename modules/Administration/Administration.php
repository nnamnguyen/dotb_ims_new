...
class Administration extends DotbBean {
    var $settings;
    ...
    function retrieveSettings($category = false, $clean=false) {
        ...
        $settings_cache = dotb_cache_retrieve('admin_settings_cache');
        ...
        dotb_cache_put('admin_settings_cache',$this->settings);
        return $this;
    }
    ...
    public function getConfigForModule($module, $platform = 'base', $clean = false) {
        ...
        if($clean){
            ...
            $moduleConfig = dotb_cache_retrieve($cache_key);
        ...
        if(!empty($moduleConfig)) {
            dotb_cache_put($cache_key, $moduleConfig);
        }

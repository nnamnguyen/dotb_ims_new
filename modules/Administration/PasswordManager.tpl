    ...
    <tr>
        <td colspan='4'>
            <a class="tabFormAdvLink"
               href="javascript:toggleDisplay_2('regex_config_display')">{dotb_getimage alt=$mod_strings.LBL_ADVANCED_SEARCH name="advanced_search" ext=".gif" other_attributes='border="0" id="regex_config_display_img" '}
            ...
            <table id='regex_config_display' style='display:none;' cellspacing="0" cellpadding="0" width="100%">
                <tr>
                    <td width='25%' scope="row">
                        {$MOD.LBL_PASSWORD_REGEX}: {dotb_help text=$MOD.LBL_REGEX_HELP_TEXT WIDTH=500}
                    </td>
                    <td width='25%'>
                    ...
                    <td width='25%' scope="row">
                        {$MOD.LBL_PASSWORD_REGEX_COMMENT}: {dotb_help text=$MOD.LBL_REGEX_DESC_HELP_TEXT WIDTH=500}
                    </td>
                    <td width='25%'>
...
<table id="sysGeneratedId" name="sysGeneratedName" width="100%" border="0" cellspacing="1" cellpadding="0"
    ...
    <tr>
        <td scope="row" width='25%'>
            ...
            :&nbsp{dotb_help text=$MOD.LBL_PASSWORD_SYST_GENERATED_PWD_HELP WIDTH=400}
        </td>
        <td>
...
<table id="userResetPassId" name="userResetPassName" width="100%" border="0" cellspacing="1" cellpadding="0"
    ...
    <tr>
        ...
        <td width="25%" scope="row">{$MOD.LBL_PASSWORD_FORGOT_FEATURE}
            :&nbsp{dotb_help text=$MOD.LBL_PASSWORD_FORGOT_FEATURE_HELP WIDTH=400}</td>
        <td scope="row" width="25%">
    ...
    <tr>
        <td width="25%" scope="row">{$MOD.LBL_PASSWORD_LINK_EXPIRATION}
            :&nbsp{dotb_help text=$MOD.LBL_PASSWORD_LINK_EXPIRATION_HELP WIDTH=400}</td>
        <td colspan="3">
    ...
    <tr>
        ...
        <td width="25%" scope="row">{$MOD.ENABLE_CAPTCHA}
            :&nbsp{dotb_help text=$MOD.LBL_CAPTCHA_HELP_TEXT WIDTH=400}</td>
    ...
    {/if}
    <td width="25%" scope="row">{$MOD.ENABLE_HONEYPOT}:&nbsp{dotb_help text=$MOD.LBL_HONEYPOT_HELP_TEXT WIDTH=400}</td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td width="25%" scope="row" valign='middle'>
                        {$MOD.LBL_LDAP_ENABLE}{dotb_help text=$MOD.LBL_LDAP_HELP_TXT}
                    </td>
                        ...
                        <table cellspacing='0' cellpadding='1' id='ldap_display' style='display:{$ldap_display}'
                            ...
                            <tr>
                                <td width='25%' scope="row" valign='top'
                                    nowrap>{$MOD.LBL_LDAP_SERVER_HOSTNAME} {dotb_help text=$MOD.LBL_LDAP_SERVER_HOSTNAME_DESC}</td>{$settings.proxy_host}
                                <td width='25%' align="left" valign='top'><input name="ldap_hostname" size='25'
                                                                                 type="text"
                                                                                 value="{$settings.ldap_hostname}"></td>
                                <td width='25%' scope="row" valign='top'
                                    nowrap>{$MOD.LBL_LDAP_SERVER_PORT} {dotb_help text=$MOD.LBL_LDAP_SERVER_PORT_DESC}</td>{$settings.proxy_port}
                                ...
                                <td colspan='3'>
																<span id='ldap_group'
																	...
																	<table width='100%'>
                                                                        <tr>
                                                                            <td width='25%' scope="row" valign='top'
                                                                                nowrap>{$MOD.LBL_LDAP_GROUP_DN} {dotb_help text=$MOD.LBL_LDAP_GROUP_DN_DESC}</td>
                                                                            ...
                                                                            <td width='25%' scope="row" valign='top'
                                                                                nowrap>{$MOD.LBL_LDAP_GROUP_NAME} {dotb_help text=$MOD.LBL_LDAP_GROUP_NAME_DESC}</td>
                                                                            <td width='25%' align="left" valign='top'>
                                                                        ...
                                                                        <tr>
                                                                            <td scope="row" valign='top'
                                                                                nowrap>{$MOD.LBL_LDAP_GROUP_USER_ATTR} {dotb_help text=$MOD.LBL_LDAP_GROUP_USER_ATTR_DESC}</td>
                                                                            ...
                                                                            <td scope="row" valign='top'
                                                                                nowrap>{$MOD.LBL_LDAP_GROUP_ATTR} {dotb_help text=$MOD.LBL_LDAP_GROUP_ATTR_DESC}</td>
                                                                            <td align="left" valign='top'><input
                                                                        ...
                                                                        <tr>
                                                                            <td scope="row" valign='top'
                                                                                nowrap>{$MOD.LBL_LDAP_GROUP_ATTR_REQ_DN} {dotb_help text=$MOD.LBL_LDAP_GROUP_ATTR_REQ_DN_DESC}</td>
                                                                            <td align="left" valign='top'>
                            ...
                            <tr>
                                <td scope="row" valign='top'
                                    nowrap>{$MOD.LBL_LDAP_AUTHENTICATION} {dotb_help text=$MOD.LBL_LDAP_AUTHENTICATION_DESC}</td>
                                <td align="left" valign='top'>
                                ...
                                <td colspan='3'>
															<span id='ldap_authentication'
																...
																<table width='100%'>
                                                                    <tr>
                                                                        <td width='25%' scope="row" valign='top'
                                                                            nowrap>{$MOD.LBL_LDAP_ADMIN_USER} {dotb_help text=$MOD.LBL_LDAP_ADMIN_USER_DESC}</td>
                            ...
                            <tr>
                                <td scope="row" valign='top'
                                    nowrap>{$MOD.LBL_LDAP_AUTO_CREATE_USERS} {dotb_help text=$MOD.LBL_LDAP_AUTO_CREATE_USERS_DESC}</td>
                            ...
                            <tr>
                                <td scope="row" valign='middle'
                                    nowrap>{$MOD.LBL_LDAP_ENC_KEY} {dotb_help text=$LDAP_ENC_KEY_DESC}</td>
    ...
    <tr>
        <td>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td width="25%" scope="row" valign='middle'>
                        {$MOD.LBL_SAML_ENABLE}{dotb_help text=$MOD.LBL_SAML_HELP_TXT}
                    </td>
                    <td valign='middle'>
                ...
                <tr>
                    <td colspan='4'>
                        <table cellspacing='0' cellpadding='1' id='saml_display' style='display:{$saml_display}'
                            ...
                            <tr>
                                <td scope="row" valign='middle'
                                    nowrap>{$MOD.LBL_SAML_LOGIN_URL} {dotb_help text=$MOD.LBL_SAML_LOGIN_URL_DESC}<span class="required">*</span></td>
                            ...
                            <tr>
                                <td scope="row" valign='middle'
                                    nowrap>{$MOD.LBL_SAML_LOGOUT_URL} {dotb_help text=$MOD.LBL_SAML_LOGOUT_URL_DESC}</td>
                            ...
                            <tr>
                                <td scope="row" valign='middle'
                                    ...
                                    {dotb_help text=$MOD.LBL_SAML_IDP_ENTITY_ID_DESC}
                            ...
                            <tr>
                                <td scope="row" valign="middle"
                                    ...
                                    {dotb_help text=$MOD.LBL_SAML_SP_ENTITY_ID_DESC}
                                </td>
                                <td align="left" valign="middle">
                            ...
                            <tr>
                                <td width='25%' scope="row" valign='top'
                                    nowrap>{$MOD.LBL_SAML_CERT} {dotb_help text=$MOD.LBL_SAML_CERT_DESC}<span class="required">*</span></td>
                            ...
                            <tr>
                                ...
                                <td width='25%' scope="row" valign='top' nowrap>
                                    {$MOD.LBL_SAML_PROVISION_USER} {dotb_help text=$MOD.LBL_SAML_PROVISION_USER_DESC}
                                </td>
                                <td width='25%' align="left" valign='top'>
                            ...
                            <tr>
                                <td width='25%' scope="row" valign='top'
                                    nowrap>{$MOD.LBL_SAML_SAME_WINDOW} {dotb_help text=$MOD.LBL_SAML_SAME_WINDOW_DESC}</td>
                        ...
                        <table cellspacing="0" cellpadding="1" id="saml_advanced" style="display:{$saml_display}" width="100%">
                            <tr>
                                <td scope="row" valign="middle" nowrap>
                                    {$MOD.LBL_SAML_REQUEST_SIGNING_PKEY} {dotb_help text=$MOD.LBL_SAML_REQUEST_SIGNING_PKEY_DESC}
                                </td>
                                <td align="left" valign="middle">
                            ...
                            <tr>
                                <td scope="row" valign="middle" nowrap>
                                    {$MOD.LBL_SAML_REQUEST_SIGNING_CERT} {dotb_help text=$MOD.LBL_SAML_REQUEST_SIGNING_CERT_DESC}
                                </td>
                                <td align="left" valign="middle">
                            ...
                            <tr>
                                <td scope="row" valign="middle" nowrap>
                                    {$MOD.LBL_SAML_REQUEST_SIGNING_METHOD} {dotb_help text=$MOD.LBL_SAML_REQUEST_SIGNING_METHOD_DESC}
                                </td>
                                <td align="left" valign="middle">
                            ...
                            <tr>
                                <td scope="row" valign="middle" nowrap>
                                    {$MOD.LBL_SAML_SIGN_AUTHN} {dotb_help text=$MOD.LBL_SAML_SIGN_AUTHN_DESC}
                                </td>
                                <td align="left" valign="middle">
                            ...
                            <tr>
                                <td scope="row" valign="middle" nowrap>
                                    {$MOD.LBL_SAML_SIGN_LOGOUT_REQUEST} {dotb_help text=$MOD.LBL_SAML_SIGN_LOGOUT_REQUEST_DESC}
                                </td>
                                <td align="left" valign="middle">
                            ...
                            <tr>
                                <td scope="row" valign="middle" nowrap>
                                    {$MOD.LBL_SAML_SIGN_LOGOUT_RESPONSE} {dotb_help text=$MOD.LBL_SAML_SIGN_LOGOUT_RESPONSE_DESC}
                                </td>
                                <td align="left" valign="middle">
...
function testregex(customregex) {
    try {
        ...
        alert(DOTB.language.get("Administration", "ERR_INCORRECT_REGEX"));
...
function toggleDisplay_2(id) {
    ...
    if (this.document.getElementById(id).style.display == 'none') {
        ...
        this.document.getElementById("regex_config_display_img").src = '{/literal}{dotb_getimagepath file="basic_search.gif"}{literal}';
    } else {
        this.document.getElementById(id).style.display = 'none'
        this.document.getElementById(id + "_lbl").innerHTML = '{/literal}{$MOD.LBL_SHOW_ADVANCED_OPTIONS}{literal}';
        this.document.getElementById("regex_config_display_img").src = '{/literal}{dotb_getimagepath file="advanced_search.gif"}{literal}';
    }
}

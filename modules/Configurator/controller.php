...
class ConfiguratorController extends DotbController
{
    /**
     * List of allowed $dotb_config keys to be changed
    ...
    function action_saveadminwizard()
    {
        ...
        DotbApplication::redirect('index.php?module=Users&action=Wizard&skipwelcome=1');
    }
    ...
    public function action_saveconfig()
    {
        ...
        if (!DotbConfig::getInstance()->get('logger_visible', true)) {
        ...
        if (file_exists($cachedfile = dotb_cached('modules/Contacts/EditView.tpl'))) {
            unlink($cachedfile);
        }

        echo '<script type="text/javascript">';
        echo 'parent && parent.DOTB && parent.DOTB.App && parent.DOTB.App.sync();';

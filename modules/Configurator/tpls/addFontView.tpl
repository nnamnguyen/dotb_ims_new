...
<br>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="edit view">
        <tr>
            <td  scope="row">{$MOD.LBL_PDF_METRIC_FILE}: <span class="required">*</span>{dotb_help text=$MOD.LBL_PDF_METRIC_FILE_INFO} </td>
            <td>
        ...
        <tr>
            <td  scope="row">{$MOD.LBL_PDF_FONT_FILE}: <span class="required">*</span>{dotb_help text=$MOD.LBL_PDF_FONT_FILE_INFO} </td>
            <td>
        ...
        <tr>
            <td  scope="row">{$MOD.LBL_FONT_LIST_EMBEDDED}: <span class="required">*</span>{dotb_help text=$MOD.LBL_FONT_LIST_EMBEDDED_INFO} </td>
            <td>
        ...
        <tr id="cidInfo" style="display:none">
            <td  scope="row">{$MOD.LBL_FONT_LIST_CIDINFO}: <span class="required">*</span>{dotb_help text=$MOD.LBL_FONT_LIST_CIDINFO_INFO} </td>
            <td>
        ...
        <tr>
            <td  scope="row">{$MOD.LBL_PDF_ENCODING_TABLE}: <span class="required">*</span>{dotb_help text=$MOD.LBL_PDF_ENCODING_TABLE_INFO} </td>
            <td>
        ...
        <tr>
            <td  scope="row">{$MOD.LBL_FONT_LIST_STYLE}: <span class="required">*</span>{dotb_help text=$MOD.LBL_FONT_LIST_STYLE_INFO} </td>
            <td>

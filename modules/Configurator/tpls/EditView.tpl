...
<tr>
	...
	<tr>
		<td  scope="row">{$MOD.LIST_ENTRIES_PER_LISTVIEW}: {dotb_help text=$list_entries_per_listview_help}</td>
		<td  >
		...
		<td  scope="row">{$MOD.LIST_ENTRIES_PER_SUBPANEL}: {dotb_help text=$list_entries_per_subpanel_help}</td>
		<td  >
	...
	<tr>
		...
		<td scope="row">{$MOD.LBL_MODULE_FAVICON} &nbsp;{dotb_help text=$MOD.LBL_MODULE_FAVICON_HELP} </td>
	...
	<tr>
        ...
        <td  scope="row" nowrap>{$MOD.LBL_USE_REAL_NAMES}: &nbsp;{dotb_help text=$MOD.LBL_USE_REAL_NAMES_DESC}</td>
    ...
    <tr>
        ...
        {$MOD.CURRENT_LOGO}&nbsp;{dotb_help text=$MOD.CURRENT_LOGO_HELP}
        </td>
        <td width="35%">
        ...
        <td  scope="row"> {$MOD.SHOW_DOWNLOADS_TAB}: &nbsp;{dotb_help text=$MOD.SHOW_DOWNLOADS_TAB_HELP} </td>
    ...
    <tr>
        <td  scope="row" width='12%' nowrap>
            {$MOD.NEW_LOGO}&nbsp;{dotb_help text=$MOD.NEW_LOGO_HELP_NO_SPACE}
        </td>
        <td  width='35%'>
    ...
    <tr>
        <td scope="row">{$MOD.LBL_LEAD_CONV_OPTION}:&nbsp;{dotb_help text=$MOD.LEAD_CONV_OPT_HELP}</td>
        <td><select name="lead_conv_activity_opt">{$lead_conv_activities}</select></td>
        <td scope="row">{$MOD.COLLAPSE_SUBPANELS}: &nbsp;{dotb_help text=$MOD.LBL_COLLAPSE_SUBPANELS_DESC}</td>
        <td>
    ...
    <tr>
        <td  scope="row" nowrap>{$MOD.LBL_ENABLE_ACTION_MENU}: &nbsp;{dotb_help text=$MOD.LBL_ENABLE_ACTION_MENU_DESC}</td>
    ...
    {/if}
        ...
        <td  scope="row">{$MOD.LOCK_SUBPANELS}: &nbsp;{dotb_help text=$MOD.LBL_LOCK_SUBPANELS_DESC}</td>
        <td  >
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
	...
	<tr>
	<td width="25%" scope="row" valign='middle'>{$MOD.LBL_PROXY_ON}&nbsp{dotb_help text=$MOD.LBL_PROXY_ON_DESC}</td>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
	...
	<tr>
	<td width="25%" scope="row" valign='middle'>{$MOD.LBL_SKYPEOUT_ON}&nbsp{dotb_help text=$MOD.LBL_SKYPEOUT_ON_DESC WIDTH=400}</td>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
    ...
    <tr>
        <td width="25%" scope="row" valign='middle'>{$MOD.LBL_TWEETTOCASE_ON}&nbsp{dotb_help text=$MOD.LBL_TWEETTOCASE_ON_DESC WIDTH=400}</td>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
    ...
    <tr>
        <td width="25%" scope="row" valign='middle'>{$MOD.LBL_PREVIEW_EDIT}&nbsp{dotb_help text=$MOD.LBL_PREVIEW_EDIT_HELP WIDTH=400}</td>
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
		...
		<tr>
			<td width="25%" scope="row" valign='middle'>{$MOD.LBL_ACTIVITY_STREAMS_SETTINGS_EDIT}&nbsp{dotb_help text=$MOD.LBL_ACTIVITY_STREAMS_SETTINGS_EDIT_HELP WIDTH=400}</td>
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
	...
	<tr>
		<td  scope="row">{$MOD.SESSION_TIMEOUT}:&nbsp;{dotb_help text=$MOD.LBL_SESSION_TIMEOUT_TOOLTIP}</td>
		<td  >
	...
	<tr>
		<td scope="row">{$MOD.LBL_VCAL_PERIOD} {dotb_help text=$MOD.vCAL_HELP}</td>
		<td >
			<input type='text' size='4' name='vcal_time' value='{$config.vcal_time}'>
		</td>
        <td scope="row">{$MOD.LBL_IMPORT_MAX_RECORDS} {dotb_help text=$MOD.LBL_IMPORT_MAX_RECORDS_HELP}</td>
		<td >
 ...
 function uploadCheck(quotes){
    ...
    var callback = {
        upload:function(r) {
            ...
            bad_image = DOTB.language.get('Configurator',(forQuotes == 'quotes')?'LBL_ALERT_TYPE_JPEG':'LBL_ALERT_TYPE_IMAGE');

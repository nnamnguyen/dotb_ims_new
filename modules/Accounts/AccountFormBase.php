...
EOQ;
if(DotbACL::checkField('Accounts', 'name', 'edit', array("owner_override" => true))) {
	$form .= "$lbl_account_name&nbsp;<span class='required'>$lbl_required_symbol</span><br><input name='name' type='text' value=''><br>";
}
if(DotbACL::checkField('Accounts', 'phone_office', 'edit', array("owner_override" => true))) {
	$form .= "$lbl_phone<br><input name='phone_office' type='text' value=''><br>";
}
if(DotbACL::checkField('Accounts', 'website', 'edit', array("owner_override" => true))) {
...
$javascript->setDotbBean(BeanFactory::newBean('Accounts'));

...
class Audit extends DotbBean
{
     ...
     * @param  type DotbBean $bean
     * @return array
     */
    public function getAuditLog(DotbBean $bean)
    {
        global $timedate;
        ...
        while ($row = $stmt->fetch()) {
            if (!DotbACL::checkField($bean->module_dir, $row['field_name'], 'access', $aclCheckContext)) {
                continue;
            }

...
class Subscription extends Basic
{
     ...
     * @param  DotbBean $record
     * @param  string    $type   Return type for data
     * @param Array $params
     *        disable_row_level_security
     * @return mixed
     */
    public static function getSubscribedUsers(DotbBean $record, $type = 'array', $params = array())
    {
     ...
     */
    public static function checkSubscription(User $user, DotbBean $record, $params = array())
    {
        $query = self::getQueryObject($params);
     ...
     * @param  User  $user
     * @param  array $records An array of associative arrays (not DotbBeans).
     * @param Array $params
     *        disable_row_level_security
     ...
     */
    public static function getSubscription(User $user, DotbBean $record, $params = array())
    {
     ...
     */
    public static function subscribeUserToRecord(User $user, DotbBean $record, $params = array())
    {
     ...
     * @return bool
     */
    public static function unsubscribeUserFromRecord(User $user, DotbBean $record)
    {
     ...
     * @param  array     $params
     */
    public static function processSubscriptions(DotbBean $bean, Activity $act, array $args, $params = array())
    {
        ...
        if (count($userPartials) < 5) {
            ...
            $job->target           = "class::DotbJobAddActivitySubscriptions";

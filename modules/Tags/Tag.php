...
class Tag extends Basic
{
    ...
    /**
     * Retrieve the list of related tags from the database, given the DotbBean id.
    ...
    /**
     * Retrieve the list of related tags from the database, given a DotbBean.
     * @param Dotbbean $bean
     * @return array
     */
    public function getTagIdsByBean(DotbBean $bean)
    {

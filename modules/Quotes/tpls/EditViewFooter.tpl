...
<script type="text/javascript" src="{dotb_getjspath file='modules/Quotes/quotes.js'}"></script>
<script type="text/javascript" src="{dotb_getjspath file='modules/Quotes/EditView.js'}"></script>
<script type="text/javascript">
{literal}

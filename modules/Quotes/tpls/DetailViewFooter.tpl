...
<tr>
    ...
    {foreach from=$bundle_list key=key item=line_item}
        {if $line_item->object_name == "Product"}
			...
			<td valign="top" style="text-align: right;">{dotb_currency_format var=$COST_PRICE currency_id=$CURRENCY_ID}</td>
			<td valign="top" style="text-align: right;">{dotb_currency_format var=$LIST_PRICE currency_id=$CURRENCY_ID}</td>
			<td valign="top" style="text-align: right;">{dotb_currency_format var=$DISCOUNT_PRICE currency_id=$CURRENCY_ID}</td>
            {if $product_bundle->deal_tot!= "0.00" && $product_bundle->deal_tot!= ""}
            <td valign="top" style="text-align: right;">
			{if $line_item->discount_amount != "0.00" && $product_bundle->deal_tot!= ""}
			     {if $line_item->discount_select}
			         {dotb_number_format var=$DISCOUNT_AMOUNT}%
			     {else}
			         {dotb_currency_format var=$DISCOUNT_AMOUNT currency_id=$CURRENCY_ID}
			     {/if}
			{/if}
            </td>
            {/if}
    ...
    {/foreach}
		...
		<tr>
			...
			<td NOWRAP style="text-align: right;">{dotb_currency_format var=$product_bundle->subtotal currency_id=$CURRENCY_ID}</td>
        </tr><tr>
            {if $product_bundle->deal_tot!= "0.00" && $product_bundle->deal_tot!= ""}
            <td NOWRAP>&nbsp;</td>
            <td NOWRAP>&nbsp;</td>
            ...
            <td NOWRAP style="text-align: right;">{dotb_currency_format var=$product_bundle->deal_tot currency_id=$CURRENCY_ID}</td>
		</tr><tr>
		    <td NOWRAP>&nbsp;</td>
            <td NOWRAP>&nbsp;</td>
            <td style="text-align: right;">&nbsp;</td>
            ...
            <td NOWRAP style="text-align: right;">{dotb_currency_format var=$product_bundle->new_sub currency_id=$CURRENCY_ID}</td>
        </tr><tr>
            {/if}
			<td NOWRAP>&nbsp;</td>
			<td NOWRAP>&nbsp;</td>
			...
			<td NOWRAP style="text-align: right;">{dotb_currency_format var=$product_bundle->tax currency_id=$CURRENCY_ID}</td>
		</tr><tr>
			<td NOWRAP>&nbsp;</td>
			<td NOWRAP>&nbsp;</td>
			<td style="text-align: right;">&nbsp;</td>
			...
			<td NOWRAP style="text-align: right;">{dotb_currency_format var=$product_bundle->shipping currency_id=$CURRENCY_ID}</td>
        </tr><tr>
			<td NOWRAP>&nbsp;</td>
			...
			<td NOWRAP style="text-align: right;">{dotb_currency_format var=$product_bundle->total currency_id=$CURRENCY_ID}</td>
	    </tr>
	...
	<tr>
			...
			<td>{$CURRENCY}</td>
			<td NOWRAP style="text-align: right;">{$MOD.LBL_SUBTOTAL}</td>
			<td NOWRAP style="text-align: right;">{dotb_currency_format var=$bean->subtotal currency_id=$CURRENCY_ID}</td>
		</tr><tr>
			{if abs($bean->deal_tot) > 0.01}
            ...
            {/if}
            <td NOWRAP style="text-align: right;">{$MOD.LBL_DISCOUNT_TOTAL}</td>
            <td NOWRAP style="text-align: right;">{dotb_currency_format var=$bean->deal_tot currency_id=$CURRENCY_ID}</td>
		</tr><tr>
		<td colspan='4' NOWRAP>&nbsp;</td>
        {if abs($bean->deal_tot) > 0.01}
            <td>&nbsp;</td>
            {/if}
            <td NOWRAP style="text-align: right;">{$MOD.LBL_NEW_SUB}</td>
            <td NOWRAP style="text-align: right;">{dotb_currency_format var=$bean->new_sub currency_id=$CURRENCY_ID}</td>
        </tr><tr>
        {/if}
			<td NOWRAP>&nbsp;</td>
			<td NOWRAP>&nbsp;</td>
			...
			<td>{dotb_number_format precision=2 var=$bean->taxrate_value} {$APP.LBL_PERCENTAGE_SYMBOL}</td>
			{/if}
			<td NOWRAP style="text-align: right;">{$MOD.LBL_TAX}</td>
			<td NOWRAP style="text-align: right;">{dotb_currency_format var=$bean->tax currency_id=$CURRENCY_ID}</td>
		</tr><tr>
			<td NOWRAP>&nbsp;</td>
			<td NOWRAP>&nbsp;</td>
            {if abs($bean->deal_tot) > 0.01}
			...
			<td NOWRAP style="text-align: right;">{$MOD.LBL_SHIPPING}</td>
			<td NOWRAP style="text-align: right;">{dotb_currency_format var=$bean->shipping currency_id=$CURRENCY_ID}</td>
		</tr><tr>
			<td colspan='4' NOWRAP>&nbsp;</td>
            {if abs($bean->deal_tot) > 0.01}
            <td>&nbsp;</td>
            {/if}
			<td NOWRAP style="text-align: right;">{$MOD.LBL_TOTAL}</td>
			<td NOWRAP style="text-align: right;">{dotb_currency_format var=$bean->total currency_id=$CURRENCY_ID}</td>
	</tr>
	{* END: grand_total *}
    {/if}
</table>

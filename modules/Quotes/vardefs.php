...
//            'formula' => 'rollupCurrencySum($product_bundles, "deal_tot")',
            'formula' => 'currencyAdd(
                    ifElse(isNumeric($order_discount_amount), $order_discount_amount, "0"),
                ifElse(isNumeric($order_sponsor_amount), $order_sponsor_amount, "0"),
                 ifElse(isNumeric($order_loyalty_amount), $order_loyalty_amount, "0")
                )',
            'calculated' => true,
            'enforced' => true,
        ),
        'deal_tot_discount_percentage' => array(
            ...
            'type' => 'float',
            'len' => '26,2',
            'formula' => 'ifElse(not(equal($subtotal_usdollar, 0)), mul(divide($deal_tot_usdollar, $new_sub_usdollar),100), 0)',
            'default' => '0',
            'calculated' => true,
            'enforced' => true,
        ),
        ...
        'total' => array(
            ...
            'formula' => 'subtract(
                ...
                ifElse(isNumeric($use_free_balance), $use_free_balance, "0"),
                ifElse(isNumeric($order_discount_amount), $order_discount_amount, "0"),
                ifElse(isNumeric($order_sponsor_amount), $order_sponsor_amount, "0"),
                 ifElse(isNumeric($order_loyalty_amount), $order_loyalty_amount, "0")
            )',
        ...
        'billing_contact_name' => array(
            ...
            'dependency' => 'equal($parent_type, "Contacts")',
        ),

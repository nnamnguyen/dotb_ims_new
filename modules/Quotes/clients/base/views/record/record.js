 ...
 * @alias DOTB.App.view.views.BaseQuotesRecordView
...
({
    ...
    duplicateClicked: function() {
        ...
        _.each(bundles.models, function(bundle) {
            ...
            // remove any id or dotblogic entries from the bundle data
    ...
    /**
     * Override the cancel clicked function to retrigger dotblogic.
     *
     * @inheritdoc
     */
    ...
    editClicked: function () {
        if(this.model.attributes.paid_amount >0){
            app.alert.show('message-id', {
                level: 'info',
                messages: app.lang.get('LBL_MESSAGE_EDIT_QUOTE','Quotes'),
                autoClose: true
            });
        }
        else {

 ...
 * @alias DOTB.App.view.views.QuotesProductCatalogView
 * @extends View.View
 */
({
    ...
    _createPhaser: function() {
        ...
        treeState = {
            ...
            /**
             * After preload is done, create runs and lets us let the Dotb.App know our tree is ready
             */
            create: function() {

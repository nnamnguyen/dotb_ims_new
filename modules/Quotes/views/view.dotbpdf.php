...
class QuotesViewDotbpdf extends ViewDotbpdf{
    ...
    function display(){
        ...
        if (isset($_REQUEST['email_action']) && $_REQUEST['email_action']=="EmailLayout") {
            ...
            $fileName = $this->dotbpdfBean->fileName;
            $bean = $this->dotbpdfBean->bean;

            $tmp = $this->dotbpdfBean->Output('','S');
        ...
        $this->dotbpdfBean->Output($this->dotbpdfBean->fileName,'D');
        dotb_cleanup(true);
    }

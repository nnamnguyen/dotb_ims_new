...
class QuotesApiHelper extends DotbBeanApiHelper
{
    /**
     * This function sets up shipping and billing address for new Quote.
     *
     * @param DotbBean|Quote $quote The current DotbBean that is being worked with
     ...
     */
    public function populateFromApi(DotbBean $quote, array $submittedData, array $options = array())
    {
     ...
     * @param String $fromId
     * @param DotbBean|Quote $quote
     */
    protected function setAddressFromBean($fromModule, $fromId, DotbBean $quote)
    {
     ...
     * @param DotbBean $fromBean The DotbBean we are looking at for a value

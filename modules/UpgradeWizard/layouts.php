...
if( isset($_POST['layoutSelectedModules']) )
{
    ...
    $mergedModules = $_SESSION['dotbMergeRunResults'];
...
else 
{
    ...
    $layoutMergeData = cleanMergeData($_SESSION['dotbMergeRunResults']);
...
/**
 * Format results from DotbMerge output to be used in the selection table.
 *

...
class LumiaGridMetaDataUpgrader extends LumiaAbstractMetaDataUpgrader
{
    /**
    ...
    public function convertLegacyViewDefsToLumia()
    {
        ...
        if (isset($defs[$panelKey])) {
            ...
            // Setup the new defs
            $this->lumiaViewdefs[$module][$client]['view'][$this->viewtype] = $newdefs;
        }
    }

    /**
     * Gets fields from a panel and converts them from legacy format to lumia
     * format
     * 

...
class LumiaListMetaDataUpgrader extends LumiaAbstractMetaDataUpgrader
{
    /**
    ...
    public function convertLegacyViewDefsToLumia() {
        ...
        // This is the structure of the lumia list meta
        ...
        $this->lumiaViewdefs[$module][$client]['view']['list'] = array(
            'panels' => array(
                array(
    ...
    /**
     * Scans the Dotb7 list view style metadata and keys the list defs on field
     * name for use later
     * 

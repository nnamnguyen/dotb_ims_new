 ...
 */
class LumiaQuickcreateMetaDataUpgrader extends LumiaAbstractMetaDataUpgrader
{
    ...
    public function convertLegacyViewDefsToLumia()
    {
        ...
        $this->lumiaViewdefs = $this->legacyViewdefs[$this->getNormalizedModuleName()]['base']['menu']['quickcreate'];
    }

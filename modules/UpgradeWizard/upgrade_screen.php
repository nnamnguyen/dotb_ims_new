...
<html>
<head>
<title>DotbCRM Upgrader</title>
<meta name="viewport" content="initial-scale=1.0">
<meta name="viewport" content="user-scalable=no, width=device-width">
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
<link rel="stylesheet" href="styleguide/assets/css/upgrade.css?v=<?php echo time();?>"/>
<script src='include/javascript/jquery/jquery-min.js'></script>
<script type="text/javascript" src="<?php echo getJSPath('cache/javascript/dotbcrm1.min.js'); ?>"></script>
...
<div class="upgrade">
    ...
    <div class="modal" data-step="1">
        <div class="modal-header modal-header-upgrade row-fluid">
            ...
            <div class="upgrade-title span8">
                <h3>Dotb Upgrader: Upload</h3>
                <span>Upload the upgrade package</span>
            </div>
            <div class="progress-section span4 pull-right">
                <span><img src="themes/default/images/company_logo.png" alt="DotBCRM" class="logo"></span>
        ...
        <div class="modal-body record">
            <div id="unpack" class="row-fluid ">
                ...
                <p>Please provide the upgrade package files. <a target="_blank" href="http://support.dotbcrm.com/03_Training/06_Upgrade_Training/" target="_blank">Learn more...</a></p>
                <form id="uploadForm">
    ...
    <div class="modal" data-step="3">
        <div class="modal-header modal-header-upgrade row-fluid">
            ...
            <div class="upgrade-title span8">
                <h3 id="upgradeTitle">Dotb Upgrader: Upload</h3>

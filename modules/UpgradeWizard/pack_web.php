...
function packUpgradeWizardWeb($zip, $manifest, $installdefs, $params) {
    ...
    $files = array(
        ...
        'include/DotbSystemInfo/DotbSystemInfo.php',
        'include/DotbHeartbeat/DotbHeartbeatClient.php',
        'include/DotbHttpClient.php',
    );
    ...
    $manifest = array_merge($manifest, array(
        'author' => 'DotBCRM, Inc.',
        'description' => 'DotBCRM Upgrader '.$params['version'],
        'icon' => '',
        'is_uninstallable' => 'true',
        'name' => 'DotBCRM Upgrader '.$params['version'],
        'published_date' => date("Y-m-d H:i:s"),
        'type' => 'module',
        'version' => $params['version'],
        'acceptable_dotb_versions' => $params['from']
    ));
...
if (empty($argv[1])) {
    die("Use $argv[0] name.zip [dotbVersion [buildNumber [from]]]");
}

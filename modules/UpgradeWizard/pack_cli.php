...
function packUpgradeWizardCli($phar, $params, $files = array())
{
    ...
    $files = array_merge(
        array(
            ...
            'include/DotbSystemInfo/DotbSystemInfo.php' => 'DotbSystemInfo.php',
            'include/DotbHeartbeat/DotbHeartbeatClient.php' => 'DotbHeartbeatClient.php',
        ),
        $files
    );
...
if (empty($argv[1])) {
    die("Use $argv[0] name (no zip or phar extension) [dotbVersion [buildNumber]]\n");
}

...
/**
 * DotbMerge wraps around all the merge functionality of Dotb given a module name and the path to an unzipped patch
 *
 */
class DotbMerge {
    ...
    public function __construct($new_path='', $original_path='', $custom_path='custom', $includeFromNew = false)
    {
        ...
        $mergeFiles = array(
            'modules/UpgradeWizard/DotbMerge/MergeUtils.php',
            'modules/UpgradeWizard/DotbMerge/EditViewMerge.php',
            'modules/UpgradeWizard/DotbMerge/DetailViewMerge.php',
            'modules/UpgradeWizard/DotbMerge/ListViewMerge.php',
            'modules/UpgradeWizard/DotbMerge/SearchMerge.php',
            'modules/UpgradeWizard/DotbMerge/QuickCreateMerge.php'
        );
				...
				if(substr($e , 0, 1) != '.') {
					if(is_dir("{$searchDirectory}/{$e}/metadata")){
					    ...
					    if( is_array($merge) )
					    {
					        ...
					        {
					            $this->log("DotbMerge is skipping $e module as filter array passed in but module not specified for merge.");
					            continue;
					        }
					    }
					    else

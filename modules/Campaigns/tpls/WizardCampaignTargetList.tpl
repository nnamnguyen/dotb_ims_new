...
*}
	...
	<tr>
	<td scope='row'><span dotb='slot26'>{dotb_help text=$MOD.LBL_SUBSCRIPTION_TARGET_WIZARD_DESC }
	{$MOD.LBL_SUBSCRIPTION_LIST_NAME}</span dotb='slot'>
	</td>
	...
	<td  colspan='2'><span dotb='slot26b'>
	...
	<tr>
	<td scope='row'><span dotb='slot27'>{dotb_help text=$MOD.LBL_UNSUBSCRIPTION_TARGET_WIZARD_DESC }
	{$MOD.LBL_UNSUBSCRIPTION_LIST_NAME}</span dotb='slot'>
	</td>
	...
	<td colspan='2'><span dotb='slot27b'>
	...
	<tr>
	<td scope='row'>
	<span dotb='slot28'>{dotb_help text=$MOD.LBL_TEST_TARGET_WIZARD_DESC }
	{$MOD.LBL_TEST_LIST_NAME}</span dotb='slot'>
	</td>
	...
	<td   colspan='2'><span dotb='slot28b'>

    ...
    'templateMeta' => array(
        'form'       => array(
            ...
            array(
                ...
                'DUPLICATE',
                'DELETE',
                // FIXME review these DOTB.ajaxUI.* methods
                array(
                    'customCode' => '<input title="{$MOD.LBL_TEST_BUTTON_TITLE}"  class="button" onclick="this.form.return_module.value=\'Campaigns\'; this.form.return_action.value=\'TrackDetailView\';this.form.action.value=\'Schedule\';this.form.mode.value=\'test\';DOTB.ajaxUI.submitForm(this.form);" type="{$ADD_BUTTON_STATE}" name="button" id="send_test_button" value="{$MOD.LBL_TEST_BUTTON_LABEL}">',
                    //Bug#51778: The custom code will be replaced with dotb_html. customCode will be duplicated.
                    'dotb_html' => array(
                        'type'        => 'input',
                        ...
                        'htmlOptions' => array(
                            ...
                            'class'   => 'button',
                            'onclick' => 'this.form = document.getElementById(\'formDetailView\'); this.form.return_module.value=\'Campaigns\'; this.form.return_action.value=\'TrackDetailView\';this.form.action.value=\'Schedule\';this.form.mode.value=\'test\';DOTB.ajaxUI.submitForm(this.form);',
                            'name'    => 'button',
                            'id'      => 'send_test_button',
                        ),
                    ),
                ...
                array(
                    'customCode' => '<input title="{$MOD.LBL_QUEUE_BUTTON_TITLE}" class="button" onclick="this.form.return_module.value=\'Campaigns\'; this.form.return_action.value=\'TrackDetailView\';this.form.action.value=\'Schedule\';DOTB.ajaxUI.submitForm(this.form);" type="{$ADD_BUTTON_STATE}" name="button" id="send_emails_button" value="{$MOD.LBL_QUEUE_BUTTON_LABEL}">',
                    //Bug#51778: The custom code will be replaced with dotb_html. customCode will be duplicated.
                    'dotb_html' => array(
                        'type'        => 'input',
                        ...
                        'htmlOptions' => array(
                            ...
                            'class'   => 'button',
                            'onclick' => 'this.form.return_module.value=\'Campaigns\'; this.form.return_action.value=\'TrackDetailView\';this.form.action.value=\'Schedule\';DOTB.ajaxUI.submitForm(this.form);',
                            'name'    => 'button',
                ...
                array(
                    'customCode' => '<input title="{$MOD.LBL_MARK_AS_SENT}" class="button" onclick="this.form.return_module.value=\'Campaigns\'; this.form.return_action.value=\'TrackDetailView\';this.form.action.value=\'DetailView\';this.form.mode.value=\'set_target\';DOTB.ajaxUI.submitForm(this.form);" type="{$TARGET_BUTTON_STATE}" name="button" id="mark_as_sent_button" value="{$MOD.LBL_MARK_AS_SENT}">',
                    //Bug#51778: The custom code will be replaced with dotb_html. customCode will be duplicated.
                    'dotb_html' => array(
                        'type'        => 'input',
                        ...
                        'htmlOptions' => array(
                            ...
                            'class'   => 'button',
                            'onclick' => 'this.form.return_module.value=\'Campaigns\'; this.form.return_action.value=\'TrackDetailView\';this.form.action.value=\'DetailView\';this.form.mode.value=\'set_target\';DOTB.ajaxUI.submitForm(this.form);',
                            'name'    => 'button',

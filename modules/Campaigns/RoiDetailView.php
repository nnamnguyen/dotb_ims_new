...
$campaign_id = $focus->id;
   ...
   $smarty->assign("COST_PER_IMPRESSION", DotbCurrency::formatAmountUserLocale($cost_per_impression, $focus->currency_id));
   ...
   $smarty->assign("COST_PER_CLICK_THROUGH", DotbCurrency::formatAmountUserLocale($cost_per_click_thru, $focus->currency_id));

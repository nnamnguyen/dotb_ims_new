...
var add_all_fields = DOTB.language.get('app_strings', 'LBL_ADD_ALL_LEAD_FIELDS');
var remove_all_fields = DOTB.language.get('app_strings', 'LBL_REMOVE_ALL_LEAD_FIELDS');
...
function addGrids(form_name) {
  ...
  if(!check_form('WebToLeadCreation')){
  	...
  	//stop
 	  ...
 	  grid3 = DOTB_GRID_grid1;
      grid4 = DOTB_GRID_grid2;   	
...
function dragDropAllFields(Add_All_Fields, Remove_All_Fields){
   //set the grids to the DOTB_GRID grids

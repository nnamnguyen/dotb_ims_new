...
class Campaign extends DotbBean {
	...
	function get_list_view_data(){
		...
		$temp_array['TRACK_CAMPAIGN_IMAGE'] = DotbThemeRegistry::current()->getImageURL('view_status.gif');
		$temp_array['LAUNCH_WIZARD_TITLE'] = translate("LBL_TO_WIZARD_TITLE",'Campaigns');
		$temp_array['LAUNCH_WIZARD_IMAGE'] = DotbThemeRegistry::current()->getImageURL('edit_wizard.gif');
	...
	*/
	 ...
	 * Overrode this method from DotbBean to handle the distinct parameter used to filter out
    ...
    function create_list_count_query($query, $params=array())
    {
		...
		//If distinct parameter not found, default to DotbBean's function

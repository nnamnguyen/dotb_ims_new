...
if(isset($_REQUEST['team_name']) && !empty($_REQUEST['team_name'])){
	...
	$sf = $sfh->getDotbField('Teamset', true);
 ...
 $Web_To_Lead_Form_html .='<link rel="stylesheet" type="text/css" media="all" href="' . getJSPath(DotbThemeRegistry::current()->getCSSURL('calendar-win2k-cold-1.css')) . '">';

 $Web_To_Lead_Form_html .= "<script type=\"text/javascript\" src='" . getJSPath($site_url.'/cache/javascript/dotbcrm1.min.js') . "'></script>";
...
for($i= 0; $i<$columns;$i++){
    ...
    if(isset($lead->field_defs[$colsFirstField]) && $lead->field_defs[$colsFirstField] != null){
        if($field_type=='multienum' || $field_type=='enum' || $field_type=='radioenum'){
          ...
          if($field_required){
                $Web_To_Lead_Form_html .= "<td width='15%' style='text-align: left; font-size: 12px; font-weight: normal;'><span dotb='slot'>$field_label</span dotb='slot'><span class='required' style='color: rgb(255, 0, 0);'>$web_required_symbol</span></td>";
            }
         else{
                $Web_To_Lead_Form_html .= "<td width='15%' style='text-align: left; font-size: 12px; font-weight: normal;'><span dotb='slot'>$field_label</span dotb='slot'></td>";
             }
          if(isset($lead->field_defs[$colsFirstField]['isMultiSelect']) && $lead->field_defs[$colsFirstField]['isMultiSelect'] ==1){
            $Web_To_Lead_Form_html .= "<td width='35%' style='font-size: 12px; font-weight: normal;'><span dotb='slot'><select id='{$field_name}' multiple='true' name='{$field_name}[]' tabindex='1'>$lead_options</select></span dotb='slot'></td>";
          }elseif(ifRadioButton($lead->field_defs[$colsFirstField]['name'])){
            $Web_To_Lead_Form_html .="<td width='35%' style='font-size: 12px; font-weight: normal;'><span dotb='slot'>";
            ...
            $Web_To_Lead_Form_html .="</span dotb='slot'></td>";
          }else{
            $Web_To_Lead_Form_html .= "<td width='35%' style='font-size: 12px; font-weight: normal;'><span dotb='slot'><select id=$field_name name=$field_name tabindex='1'>$lead_options</select></span dotb='slot'></td>";
          }
         }
         if($field_type=='bool'){
          if($field_required){
          ...
          $Web_To_Lead_Form_html .= "<td width='35%' style='font-size: 12px; font-weight: normal;'><span dotb='slot'><input type='checkbox' id=$field_name name=$field_name></span dotb='slot'></td>";
         ...
         if($field_type=='date') {
          ...
          if($field_required){
			...
			$Web_To_Lead_Form_html .= "
				...
				<span dotb='slot'><input type='hidden' id='{$field_name}' name='{$field_name}'/>";
         ...
         if( $field_type=='varchar' ||  $field_type=='name'
          ||  $field_type=='phone' || $field_type=='currency' || $field_type=='url' || $field_type=='int'){
           if($field_name=='last_name' ||   $field_required){
             ...
             if ( $field_name=='email1'||$field_name=='email2' ){
                 ...
                 $Web_To_Lead_Form_html .= "<td width='35%' style='font-size: 12px; font-weight: normal;'><span dotb='slot'><input id=$field_name name=$field_name type='text' onchange='validateEmailAdd();'></span dotb='slot'></td>";
             } else {
                $Web_To_Lead_Form_html .= "<td width='35%' style='font-size: 12px; font-weight: normal;'><span dotb='slot'><input id=$field_name name=$field_name type='text'></span dotb='slot'></td>";
             }
            }
          if ( $field_type == 'text' ) {
               $Web_To_Lead_Form_html .= "<td width='15%' style='text-align: left; font-size: 12px; font-weight: normal;'><span dotb='slot'>$field_label</span dotb='slot'></td>";
			   $Web_To_Lead_Form_html .= "<td width='35%' style='font-size: 12px; font-weight: normal;'><span id='ta_replace' dotb='slot'><input id=$field_name name=$field_name type='text'></span dotb='slot'></td>";
           }
          ...
          if($field_type=='email'){
            ...
            $Web_To_Lead_Form_html .= "<td width='15%' style='text-align: left; font-size: 12px; font-weight: normal;'><span dotb='slot'>&nbsp</span dotb='slot'></td>";
            $Web_To_Lead_Form_html .= "<td width='35%' style='font-size: 12px; font-weight: normal;'><span dotb='slot'>&nbsp</span dotb='slot'></td>";
        }
     ...
     if(isset($lead->field_defs[$colsSecondField]) && $lead->field_defs[$colsSecondField] != null){
         if($field1_type=='multienum' || $field1_type=='enum' || $field1_type=='radioenum'){
          ...
          if(!empty($lead->$field1_name)){
            ...
            if($field1_required){
                $Web_To_Lead_Form_html .= "<td width='15%' style='text-align: left; font-size: 12px; font-weight: normal;'><span dotb='slot'>$field1_label</span dotb='slot'><span class='required' style='color: rgb(255, 0, 0);'>$web_required_symbol</span></td>";
            }
            else{
                $Web_To_Lead_Form_html .= "<td width='15%' style='text-align: left; font-size: 12px; font-weight: normal;'><span dotb='slot'>$field1_label</span dotb='slot'></td>";
             }
            if(isset($lead->field_defs[$colsSecondField]['isMultiSelect']) && $lead->field_defs[$colsSecondField]['isMultiSelect'] ==1){
                $Web_To_Lead_Form_html .= "<td width='35%' style='font-size: 12px; font-weight: normal;'><span dotb='slot'><select id='{$field1_name}' name='{$field1_name}[]' multiple='true' tabindex='1'>$lead1_options</select></span dotb='slot'></td>";
                ...
                $Web_To_Lead_Form_html .= "<td width='35%' style='font-size: 12px; font-weight: normal;'><span dotb='slot'><select id=$field1_name name=$field1_name tabindex='1'>$lead1_options</select></span dotb='slot'></td>";
            }
         }
         if($field1_type=='bool'){
          if($field1_required){
            ...
            $Web_To_Lead_Form_html .= "<td width='35%' style='font-size: 12px; font-weight: normal;'><span dotb='slot'><input id=$field1_name name=$field1_name type='checkbox'></span dotb='slot'></td>";
         ...
         if($field1_type=='date') {
          ...
          if($field1_required){
			...
			$Web_To_Lead_Form_html .= " 
				...
				<span dotb='slot'><input type='hidden' id='{$field1_name}' name='{$field1_name}'/>";
          	$order = explode("%", $cal_dateformat);
          	foreach($order as $part)
          	{
          		if (!isset($part[0]))
          ...
          ||  $field1_type=='phone' || $field1_type=='currency' || $field1_type=='url' || $field1_type=='int'){
            if($field1_name=='last_name' ||  $field1_required){
             ...
             if ( $field1_name=='email1'||$field1_name=='email2' ){
                 $emailFieldPresent = true;
                 $Web_To_Lead_Form_html .= "<td width='35%' style='font-size: 12px; font-weight: normal;'><span dotb='slot'><input id=$field1_name name=$field1_name type='text' onchange='validateEmailAdd();'></span dotb='slot'></td>";
             } else {
                $Web_To_Lead_Form_html .= "<td width='35%' style='font-size: 12px; font-weight: normal;'><span dotb='slot'><input id=$field1_name name=$field1_name type='text'></span dotb='slot'></td>";
             }

           }
           if ( $field1_type == 'text' ) {
               $Web_To_Lead_Form_html .= "<td width='15%' style='text-align: left; font-size: 12px; font-weight: normal;'><span dotb='slot'>$field1_label</span dotb='slot'></td>";
				$Web_To_Lead_Form_html .= "<td width='35%' style='font-size: 12px; font-weight: normal;'><span id='ta_replace' dotb='slot'><input id=$field1_name name=$field1_name type='text'></span dotb='slot'></td>";
           }
...
if ($emailFieldPresent) {
    ...
    $Web_To_Lead_Form_html .= "<span dotb='slot'>:&nbsp;&nbsp;<input id='email_opt_in' name='email_opt_in' type='checkbox'></span dotb='slot'>";

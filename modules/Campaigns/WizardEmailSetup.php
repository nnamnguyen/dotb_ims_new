...
if (!is_admin($current_user)&& !is_admin_for_module($GLOBALS['current_user'],'Campaigns')) dotb_die("Unauthorized access to administration.");
...
global $theme, $currentModule, $dotb_config;
...
$ss->assign("SITEURL",$dotb_config['site_url']);

...
class MergeRecord extends DotbBean {
    ...
    */
    ...
    function get_inputs_for_search_params($search_params)
    {
        ...
        foreach ($this->merge_bean->field_defs as $key=>$value) {
            ...
            if (isset($search_params[$searchFieldString]) ) {
                $searchFieldStringValue = DotbCleaner::cleanHtml($search_params[$searchFieldString], false);
                $searchTypeStringValue = DotbCleaner::cleanHtml($search_params[$searchTypeString], false);

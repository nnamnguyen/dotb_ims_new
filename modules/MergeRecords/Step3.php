...
$json = new JSON();
$diff_field_count=0;
$focus->merge_bean->ACLFilterFieldList($temp_field_array, array(), array("min_access" => DotbACL::ACL_READ_WRITE));
    ...
    if (show_field($field_array)) {
        ...
        switch ($field_check) {
            ...
            case ('teamset') :
				...
				$teamsWidget = new EmailDotbFieldTeamsetCollection($bean, $bean->field_defs, '', 'EditView');
...
$javascript->setDotbBean($focus->merge_bean);

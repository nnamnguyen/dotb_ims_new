...
// DotBCRM free/busy server
// put and get free/busy information for dotbcrm users in vCalendar format.
// Uses WebDAV for HTTP PUT and GET methods of access
// REQUIRED PHP packages:
// 1. PEAR
//
// Saves PUTs as Freebusy DotbBeans
//
...
// "http://servername/dotbcrm/index.php?entryPoint=vcal_server/type=vfb&source=outlook&email=myemail@servername.com".
...
// http://servername/dotbcrm/index.php?entryPoint=vcal_server/type=vfb&source=outlook&email=%NAME%@%SERVER%
// or contact by contact by editing the details and entering its Free/Busy URL:
// http://servername/dotbcrm/index.php?entryPoint=vcal_server/type=vfb&source=outlook&email=user@email.com
// or
// http://servername/dotbcrm/index.php?entryPoint=vcal_server/type=vfb&source=outlook&user_name=user_name
// or:
// http://servername/dotbcrm/index.php?entryPoint=vcal_server/type=vfb&source=outlook&user_id=user_id

...
*}
<link type="text/css" href="{dotb_getjspath file="modules/Calendar/Cal.css"}" rel="stylesheet" />
{dotb_getscript file="modules/Calendar/Cal.js"}
<script type="text/javascript">
	...
	DOTB.util.doWhen(check_cal_loaded, function(){literal}{{/literal}
...
YAHOO.util.Event.onDOMReady(function(){	
	...
	schedulerLoader.addModule({
		...
		type : "js",
{/literal}
		fullpath: "{dotb_getjspath file='modules/Meetings/jsclass_scheduler.js'}",
{literal}

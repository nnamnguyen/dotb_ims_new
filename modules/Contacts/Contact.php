...
class Contact extends Person {
    ...
    public function create_new_list_query(
		...
		if (isset($_REQUEST['action']) && $_REQUEST['action'] == 'ContactAddressPopup') {
			...
			//any other action goes to parent function in dotbbean
	...
	{
		//if this is any action that is not the contact address popup, then go to parent function in dotbbean
		if(isset($_REQUEST['action']) && $_REQUEST['action'] !== 'ContactAddressPopup'){

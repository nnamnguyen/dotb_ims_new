...
$viewdefs['Styleguide']['base']['layout']['styleguide'] = array(
    ...
    "metadata" => array(
        "chapters" => array (
            "home" => array (
                "title" => "Styleguide",
                "description" => "A guide to styling the Dotb7 User Interface",
                "index" => false,
            ),
            "docs" => array (
                ...
                "sections" => array (
                    ...
                    "forms" => array (
                        ...
                        "index" => true,
                        "pages" => array (
                            "fields" => array("title"=>"Dotb7 fields", "url"=>"#Styleguide/fields/index", "description"=>"Basic fields that support detail, record, and edit modes with error addons."),
                    ...
                    "charts" => array (
                        ...
                        "description" => "Standard and custom charts in Dotb7 are developed using D3 and the Sucrose Charts library. For configuration details see the <a href='http://sucrose.io'>sucrose.io</a> website.",
                        "index" => true,
                        "pages" => array (

...
$dictionary['Styleguide'] = array(
    ...
    'fields' => array (
        'parent_type' => array(
            ...
            'comment' => 'Dotb module the Note is associated with',
            'help' => 'Dotb module the Note is associated with.',
        ),
        'parent_id' => array(
            'name' => 'parent_id',
            'vname' => 'LBL_PARENT_ID',
            ...
            'required' => false,
            'reportable' => true,
            'comment' => 'The ID of the Dotb item specified in parent_type',
            'help' => 'The ID of the Dotb item specified in parent_type.',
        ),
        'parent_name' => array(
            'name'=> 'parent_name',
            ...
            'studio' => true,
            'help' => 'The name of the Dotb item specified in parent_type.',
            'sortable' => false,
        ),

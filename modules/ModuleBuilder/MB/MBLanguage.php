...
class MBLanguage{
    ...
    public function loadAppListStrings($file){
		...
		function getModStrings($language='en_us'){
			...
			if(!empty($this->strings[$language]) && $language != 'en_us.lang.php'){
			    return dotbLangArrayMerge($this->strings['en_us.lang.php'], $this->strings[$language]);
			}
		...
		function getAppListStrings($language='en_us'){
			...
			if(!empty($this->appListStrings[$language]) && $language != 'en_us.lang.php'){
			    return dotbLangArrayMerge($this->appListStrings['en_us.lang.php'], $this->appListStrings[$language]);
			}
    ...
    function save($key_name, $duplicate = false, $rename = false)
    {
        ...
        dotb_mkdir($app_save_path, null, true);
        ...
        foreach ($this->appListStrings as $lang => $values) {
            ...
            $values = dotbLangArrayMerge($values, $app_list_strings);
            ...
            dotb_file_put_contents_atomic($app_save_path . '/' . $lang, $appFile);
        }
    }
    ...
    public function delete($module)
    {
        ...
        foreach ($this->appListStrings as $lang => $values) {
            ...
            if (file_exists($file)) {
                ...
                dotb_file_put_contents_atomic($file, $contents);
            }
        }
    }

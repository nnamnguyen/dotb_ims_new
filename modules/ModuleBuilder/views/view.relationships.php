...
class ViewRelationships extends DotbView
{
    /**
    ...
    /**
     * fetchTemplate
     * This function overrides fetchTemplate from DotbView.
     *
     * @param string $template the file to fetch
     * @return string contents from calling the fetch method on the Dotb_Smarty instance
     */

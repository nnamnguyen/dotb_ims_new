...
class ViewListView extends DotbView
{
    /**
    ...
    function constructSmarty ($parser)
    {
                    ...
                    if ($isModuleBWC) {
                        ...
                        if ($isPercentage) {
                            ...
                            if ($width > 0) {
                                ...
                                $width = in_array($field['width'], LumiaListLayoutMetaDataParser::getDefaultWidths()) ?
                                    $field['width'] : '';
                                $unit = '';
                            }
                        }
        ...
        global $image_path;
        $imageSave = DotbThemeRegistry::current()->getImage('studio_save','',null,null,'.gif',$mod_strings['LBL_BTN_SAVE']) ;

//        $imageHelp = DotbThemeRegistry::current()->getImage('help') ;
        ...
        $editImage = DotbThemeRegistry::current()->getImage('edit_inline','',null,null,'.gif',$mod_strings['LBL_EDIT']) ;

        $smarty->assign ( 'editImage', $editImage ) ;
        $deleteImage = DotbThemeRegistry::current()->getImage('delete_inline','',null,null,'.gif',$mod_strings['LBL_MB_DELETE']) ;

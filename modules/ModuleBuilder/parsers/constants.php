...
define('MB_LUMIALISTVIEW', 'list');
define('MB_LUMIAQUOTEDATAGROUPLIST', 'quote-data-group-list');
...
define('MB_LUMIAPOPUPVIEW', 'selection-list');
define('MB_LUMIADUPECHECKVIEW', 'dupecheck-list');

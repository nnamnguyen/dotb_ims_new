...
class AbstractRelationship
{
     ...
     * Among the elements we construct is get_subpanel_data which is used as follows in DotbBean:
     ...
     * It is used during the save from an edit view in DotbBean->save_relationship_changes(): for each relate field, $this->$linkfieldname->add( $this->$def['id_name'] )
     * @param string $sourceModule      Name of the source module for this field
     * @param string $relationshipName  Name of the relationship
     */
     ...
     *    - it is loaded in DotbBean->fill_in_link_field while DotbBean processes the relate fields in fill_in_relationship_fields
     * @param string $sourceModule      Name of the source module for this field
     * @param string $relationshipName  Name of the relationship
     */
     ...
     * @param string $sourceModule      Name of the source module for this field
     * @param string $relationshipName  Name of the relationship
     * @param string $moduleType        Optional - "Types" of the module - array of DotbObject types such as "file" or "basic"
     */
    protected function getRelateFieldDefinition ($sourceModule , $relationshipName , $vnameLabel='')
    {
        ...
        $vardef [ 'save' ] = true; // the magic value to tell DotbBean to save this relate field even though it is not listed in the $relationship_fields array
    ...
    function getRelationshipMetaData ($relationshipType, $checkExisting = true)
    {
        ...
        } else
        {
            ...
            // because the implementation of one-to-many relationships within DotbBean does not use a join table and so requires schema changes to add a foreign key for each new relationship,

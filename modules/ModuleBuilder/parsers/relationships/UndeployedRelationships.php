...
class UndeployedRelationships extends AbstractRelationships implements RelationshipsInterface
{
    ...
    /*
     * As of DotBCRM 5.1 the subpanel code and the widgets have difficulty handling multiple subpanels or relate fields from the same module
    ...
    public function build($basepath = null, $installDefPrefix = null, $relationships = null)
    {
        ...
        // use an installDefPrefix of <basepath>/DotbModules for compatibility with the rest of ModuleBuilder
        $this->installDefs = parent::build ( $basepath, "<basepath>/DotbModules", $relationships ) ;
    }

...
/*
    ...
    /*
     * Builds views for lumia dashlets
     * @return array an array of files and file contents to write
     */
    protected function buildLumiaDashletMeta( $relationshipName )
    {
        $fileBase = "<?php\n/* File autogenerated by DotBCRM in ActivitesRelationship.php / buildLumiaDashletMeta */\n\n";
        $files = array();
...
\$viewdefs['{$this->lhs_module}']['base']['view']['inactive-tasks'] = \$coreDefs;\n";
    ...
    public function buildClientFiles()
    {
        ...
        return $this->buildLumiaDashletMeta($relationshipName);
    }
}

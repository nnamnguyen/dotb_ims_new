...
class History implements HistoryInterface
{
    ...
    public function __construct ( $previewFilename )
    {
        ...
        $this->_dirname = dirname ( $this->_previewFilename );
 	    $this->_historyLimit = isset ( $GLOBALS [ 'dotb_config' ] [ 'studio_max_history' ] ) ? $GLOBALS [ 'dotb_config' ] [ 'studio_max_history' ] : 50 ;
    ...
    public function append ($path)
    {
       ...
       // truncate the oldest files, keeping only the most recent $GLOBALS['dotb_config']['studio_max_history'] files (zero=keep them all)

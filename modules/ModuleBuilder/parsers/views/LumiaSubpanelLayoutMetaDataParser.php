...
class LumiaSubpanelLayoutMetaDataParser extends LumiaListLayoutMetaDataParser
{
    ...
    public function __construct($subpanelName, $moduleName, $packageName = '', $client = 'base')
    {
        ...
        if (empty($client)) {
            throw new \InvalidArgumentException("Client cannot be blank in LumiaSubpanelLayoutMetaDataParser");
        }

        if (empty($packageName)) {
            $this->implementation = new DeployedLumiaSubpanelImplementation($subpanelName, $moduleName, $client);
        } else {
            $this->implementation = new UndeployedLumiaSubpanelImplementation($subpanelName, $moduleName, $packageName, $client);
        }

...
class LumiaGridLayoutMetaDataParser extends GridLayoutMetaDataParser {
    /**
     * Invalid field types for various lumia clients. Format can be either
    ...
    protected function getNestedDefs($viewdefs, $view, $validateOnly = false) {
        // Get the view variable, or in Lumia's case, the path
        $var = MetaDataFiles::getViewDefVar($view);

        // Lumia should always be an array of metadata path elements
        if (is_array($var)) {

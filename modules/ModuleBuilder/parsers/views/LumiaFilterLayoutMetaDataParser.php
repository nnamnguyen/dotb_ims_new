...
class LumiaFilterLayoutMetaDataParser extends LumiaListLayoutMetaDataParser
{
    /**
    ...
    public function __construct($moduleName, $packageName = '', $client = 'base')
    {
        ...
        if (empty($client)) {
            throw new \InvalidArgumentException("Client cannot be blank in LumiaFilterLayoutMetaDataParser");
        }
        ...
        if (empty($packageName)) {
            $this->implementation = new DeployedLumiaFilterImplementation($moduleName, $client);
        } else {
            $this->implementation = new UndeployedLumiaFilterImplementation($moduleName, $packageName, $client);
        }
    ...
    /**
     * Return a list of the default fields for a lumia listview
    ...
    /**
     * Lumia specific method that delegates validity checking to client

...
class UndeployedSubpanelImplementation extends AbstractMetaDataImplementation implements MetaDataImplementationInterface
{
    ...
    function __construct ($subpanelName , $moduleName , $packageName)
    {
        ...
        $templateFile = 'include/DotbObjects/templates/'.$template_def. '/metadata/subpanels/default.php';
        ...
        // Set the global mod_strings directly as Dotb does not automatically load the language files for undeployed modules (how could it?)
        $selected_lang = 'en_us';

...
class LumiaListLayoutMetaDataParser extends ListLayoutMetaDataParser
{
    /**
    ...
    protected $allowedViews = array(
        MB_LUMIALISTVIEW,
        MB_LUMIAPOPUPVIEW,
        MB_LUMIADUPECHECKVIEW,
        MB_WIRELESSLISTVIEW,
        MB_LUMIAQUOTEDATAGROUPLIST,
    ...
    /**
     * Lumia specific method that delegates validity checking to client specific
     ...
     * Also see LumiaPortalListLayoutMetaDataParser::setDefSortable() for special handling on portal list view.
     *
     * @param string $fieldName  The name of the field being worked on
     * @param array $fieldDef The current fielddef collection for a field
     * @return array The modified fielddef collection

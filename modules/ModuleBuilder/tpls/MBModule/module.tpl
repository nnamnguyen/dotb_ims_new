...
*}
<link rel="stylesheet" type="text/css" href="{dotb_getjspath file='modules/ModuleBuilder/tpls/MB.css'}" />
...
<table class='mbTable'  >
	...
	<tr>
	<tr>
	   <td class='mbLBL' width='5%' nowrap>{dotb_translate label='LBL_MB_IMPORTABLE' module='ModuleBuilder'}:</td>
        ...
        <td>
            <table>
                ...
                <tr>
                    ...
                    {else}
                    <td align='center'>{dotb_image name=$imgurl width=32 height=32}<br>
                    {$name}
                    {/if}
                    </td>
                    {/if}

        ...
        <table>
                ...
                <td colspan='3'>
                    <ul id="ul1" class="listContainer">
                        {foreach from=$options key='name' item='val'}
                            {if ($name === "")}
                                {capture assign=name}{dotb_translate label='LBL_BLANK'}{/capture}
            ...
            <tr>
                <td colspan='3'>
                    <table width='100%'>
                        <tr>
                            <td class='mbLBLL'>{dotb_translate label='LBL_DROPDOWN_ITEM_NAME'}:</td>
                            <td class='mbLBLL'>{dotb_translate label='LBL_DROPDOWN_ITEM_LABEL'}:</td>
                        </tr>
                        <tr>
                            ...
                            <td><input type='button' id='dropdownaddbtn'
                                       value='{dotb_translate label='LBL_ADD_BUTTON'}' class='button'>
                            </td>
                        </tr>
                    </table>
                </td>

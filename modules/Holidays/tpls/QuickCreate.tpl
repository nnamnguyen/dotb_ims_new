...
<td>
	...
	<td><slot><input type='text' id='holiday_date' name='holiday_date' cols="50" tabindex='2' rows="1" value='{$NAME}' />{dotb_getimage name="jscalendar" ext=".gif" alt=$CALENDAR_DATEFORMAT other_attributes='align="absmiddle" id="jscal_trigger" '}</slot></td>
	</tr>
	<tr>

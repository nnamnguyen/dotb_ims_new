		...
		*/
	    ...
	    return {
	        search: function() {
	        	...
	        	postData = 'entryPoint=HandleAjaxCall&to_pdf=1&module=Administration&action=HandleAjaxCall&method=performBasicSearch&search_term=' + searchTerm + '&csrf_token=' + DOTB.csrf.form_token;
					...
					_loadingBar.show();
	        			...
	        			for (i = 0; i < count; i++){
							...
							if(nodes[i].type == 'package'){
								...
								var category_id = nodes[i].category_id;
								postData = 'entryPoint=HandleAjaxCall&to_pdf=1&module=Administration&action=HandleAjaxCall&method=download&release_id=' + release_id + '&package_id=' + package_id + '&category_id=' + category_id + '&csrf_token=' + DOTB.csrf.form_token;
								var cObj = YAHOO.util.Connect.asyncRequest('POST','index.php',
	        ...
	        getPackagesInStaging : function(){
	        	postData = 'entryPoint=HandleAjaxCall&to_pdf=1&module=Administration&action=HandleAjaxCall&method=getPackagesInStaging&csrf_token=' + DOTB.csrf.form_token;
							var cObj = YAHOO.util.Connect.asyncRequest('POST','index.php',
            ...
            loadDataForNodeForPackage : function(node, onCompleteCallback){
				...
				postData = 'entryPoint=HandleAjaxCall&to_pdf=1&module=Administration&action=HandleAjaxCall&method=getNodes&category_id=' + id + '&csrf_token=' + DOTB.csrf.form_token;
				var cObj = YAHOO.util.Connect.asyncRequest('POST','index.php',
								  callback, postData);
            ...
            installPackage : function(file){
				...
				postData = 'entryPoint=HandleAjaxCall&to_pdf=1&module=Administration&action=HandleAjaxCall&method=getLicenseText&file='+ file + '&csrf_token=' + DOTB.csrf.form_token;
				var cObj = YAHOO.util.Connect.asyncRequest('POST','index.php',
								  callback, postData);
            },
            ...
            processLicense : function(file){
				...
				postData = 'entryPoint=HandleAjaxCall&to_pdf=1&module=Administration&action=HandleAjaxCall&method=performInstall&file=' + file + '&csrf_token=' + DOTB.csrf.form_token;
				var cObj = YAHOO.util.Connect.asyncRequest('POST','index.php',
								  callback, postData);
            },
            getDocumentation : function(package_id, release_id){
				...
				postData = 'entryPoint=HandleAjaxCall&to_pdf=1&module=Administration&action=HandleAjaxCall&method=getDocumentation&package_id='+package_id+'&release_id='+release_id+ '&csrf_token=' + DOTB.csrf.form_token;
				var cObj = YAHOO.util.Connect.asyncRequest('POST','index.php',
								  callback, postData);
	        },
	        downloadedDocumentation : function(document_id){
				...
				postData = 'entryPoint=HandleAjaxCall&to_pdf=1&module=Administration&action=HandleAjaxCall&method=downloadedDocumentation&document_id=' + document_id + '&csrf_token=' + DOTB.csrf.form_token;
				var cObj = YAHOO.util.Connect.asyncRequest('POST','index.php',
								  callback, postData);
            },
			...
			checkForUpdates : function(){
				...
				PackageManager.hideWaiting();
				postData = 'entryPoint=HandleAjaxCall&to_pdf=1&module=Administration&action=HandleAjaxCall&method=checkForUpdates&type=modules&csrf_token=' + DOTB.csrf.form_token;
				var cObj = YAHOO.util.Connect.asyncRequest('POST','index.php',
								  callback, postData);
			},
			...
			refreshTreeRoot : function(){
				...
				postData = 'entryPoint=HandleAjaxCall&to_pdf=1&module=Administration&action=HandleAjaxCall&method=getCategories&csrf_token=' + DOTB.csrf.form_token;
				var cObj = YAHOO.util.Connect.asyncRequest('POST','index.php',
								  callback, postData);
			},
			...
			refreshHeader : function(){
				...
				postData = 'entryPoint=HandleAjaxCall&to_pdf=1&module=Administration&action=HandleAjaxCall&method=getPromotion&csrf_token=' + DOTB.csrf.form_token;
				var cObj = YAHOO.util.Connect.asyncRequest('POST','index.php',
								  callback, postData);
			},
			initTabs : function(){
			...
			remove : function(file){
				...
				postData = 'entryPoint=HandleAjaxCall&to_pdf=1&module=Administration&action=HandleAjaxCall&method=remove&file=' + file + '&csrf_token=' + DOTB.csrf.form_token
				var cObj = YAHOO.util.Connect.asyncRequest('POST','index.php',
								  callback, postData);
				}//fi
			},
			...
			//rrs
				...
				postData = 'entryPoint=HandleAjaxCall&to_pdf=1&module=Administration&action=HandleAjaxCall&method=authenticate&username='+username+'&password='+password + '&servername=' + servername + '&terms_checked=' + cbTerms.value + '&csrf_token=' + DOTB.csrf.form_token;
				var cObj = YAHOO.util.Connect.asyncRequest('POST','index.php',
								  callback, postData);
			}
	    };
...
{/literal}{if $module_load == 'true'}{literal}
        ...
        _fileGrid.getColumn = YAHOO.DOTB.SelectionGrid.prototype.getColumn;
        ...
        //bugfix for http://yuilibrary.com/projects/yui2/ticket/2528034
       	_fileGridInstalled.getColumn = YAHOO.DOTB.SelectionGrid.prototype.getColumn;
...
PackageManagerGrid.prototype.renderModuleButtons = function(file){
	var output =  '<table border=0 cellpadding=0 cellspacing=0><tr><td><form action="index.php?module=Administration&view=module&action=UpgradeWizard_prepare" method="post">';
        ...
        output += '{/literal}{dotb_csrf_form_token}{literal}';

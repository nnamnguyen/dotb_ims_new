 ...
 * var records = DOTB.App.data.getMixedBeanCollection();
 * records.fetch({
 *     favorites: true,
 *     query: 'Acme',
...
module.exports = BeanCollection.extend({
    ...
    initialize: function (models, options) {
        ...
        if (options.links) {
            if (!options.parentBean) {
                DOTB.App.logger.error('You cannot instantiate a mixed-bean-collection with linked collections ' +
            ...
            _.each(options.links, function(collection, link) {
                ...
                if (_.isString(collection)) {
                    this._linkedCollections[link] = DOTB.App.data.createBeanCollection(collection);
                } else {
    ...
    _prepareModel: function (model, options) {
        ...
        this.model = DOTB.App.data.getBeanClass(module);
    ...
    fetch: function(options) {
        ...
        options.module_list = this.module_list = options.module_list || this.module_list || DOTB.App.metadata.getModuleNames({filter: 'visible'});

...
const writers = {
    ...
    ServerWriter: {
        ...
        write: function(level, message) {
            ...
            let url = DOTB.App.api.buildURL(undefined, 'logger');
            let params = {
                level: level.name.toLowerCase(),
                message: message,
            };

            DOTB.App.api.call('create', url, params, {
...
Object.defineProperty(Logger, 'SimpleFormatter', {
    get: function() {
        DOTB.App.logger.warn('`Utils.Logger.SimpleFormatter` has been made private since 7.10 and you will not be able ' +
...
Object.defineProperty(Logger, 'ServerWriter', {
    get: function() {
        DOTB.App.logger.warn('`Utils.Logger.ServerWriter` has been made private since 7.10 and you will not be able ' +
            'to access it in the next release. Please do not use it anymore');
...
Object.defineProperty(Logger, 'ConsoleWriter', {
    get: function() {
        DOTB.App.logger.warn('`Utils.Logger.ConsoleWriter` has been made private since 7.10 and you will not be able ' +
            'to access it in the next release. Please do not use it anymore');

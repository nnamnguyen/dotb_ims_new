...
_.extend(date, {
    ...
    parse: function(date, oldFormat) {
        DOTB.App.logger.warn('The function `Utils.Date.parse()` is deprecated and will be removed in a future release. ' +
    ...
    guessFormat: function(date) {
        DOTB.App.logger.warn('The function `Utils.Date.guessFormat()` is deprecated and will be removed in a future release. ' +
            'Please do not use it');
    ...
    parseFormat: function(format) {
        DOTB.App.logger.warn('The function `Utils.Date.parseFormat()` is deprecated and will be removed in a future release. ' +
            'Please do not use it');
    ...
    format: function(date, format) {
        DOTB.App.logger.warn('The function `Utils.Date.format()` is deprecated and will be removed in a future release. ' +
            'Please do not use it');
    ...
    roundTime: function(date) {
        DOTB.App.logger.warn('The function `Utils.Date.roundTime()` is deprecated and will be removed in a future release. ' +
            'Please do not use it');
    ...
    UTCtoLocalTime: function(date) {
        DOTB.App.logger.warn('The function `Utils.Date.UTCtoLocalTime()` is deprecated and will be removed in a future release. ' +
            'Please do not use it');
    ...
    UTCtoTimezone: function(date, offset) {
        DOTB.App.logger.warn('The function `Utils.Date.UTCtoTimezone()` is deprecated and will be removed in a future release. ' +
            'Please do not use it');
     ...
     */
    toUTC: function(date) {
        DOTB.App.logger.warn('The function `Utils.Date.toUTC()` is deprecated and will be removed in a future release. ' +
            'Please do not use it');
        //if not a Date return it
    ...
    getRelativeTimeLabel: function(date) {
        DOTB.App.logger.warn('The function `Utils.Date.getRelativeTimeLabel()` is deprecated and will be removed in a future release. ' +
            'Please do not use it');
    ...
    parseDisplayDefault: function(displayDefault, now) {
        DOTB.App.logger.warn('The function `Utils.Date.parseDisplayDefault()` is deprecated and will be removed in a future release. ' +
            'Please do not use it');
     ...
     *
     * @param {string} formatSpec The original DotBCRM (PHP) date format.
    ...
    stripIsoTimeDelimterAndTZ: function(value) {
        DOTB.App.logger.warn('The function `Utils.Date.stripIsoTimeDelimterAndTZ()` is deprecated and will be removed in a future release. ' +
            'Please do not use it');
     ...
     */
    isIso: function(val) {
        DOTB.App.logger.warn('The function `Utils.Date.isIso()` is deprecated and will be removed in a future release. ' +
            'Please do not use it');
        var yyyymmddExact,
                yyyymmddLooseMatch;

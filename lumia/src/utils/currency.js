 ...
 */
 module.exports = {
    ...
    getBaseCurrencyId: function() {
        return DOTB.App.metadata.getBaseCurrencyId();
    },
    ...
    getBaseCurrency: function() {
        var currId = DOTB.App.metadata.getBaseCurrencyId(),
            currencyObj = DOTB.App.metadata.getCurrency(currId);
    ...
    getCurrenciesSelector: function(template) {
        ...
        _.each(DOTB.App.metadata.getCurrencies(), function(currency, id) {
    ...
    getCurrencySymbol: function (currencyId) {
        var currency = DOTB.App.metadata.getCurrency(currencyId);
    ...
    formatAmount: function(
        ...
        var currencySymbol;
        var config = DOTB.App.metadata.getConfig();
    ...
    unformatAmountLocale:function (amount, toFloat) {
        var decimalSeparator,
            numberGroupingSeparator,
            config = DOTB.App.metadata.getConfig();
    ...
    convertAmount: function(amount, fromId, toId) {
        ...
        currency1 = DOTB.App.metadata.getCurrency(fromId);
        currency2 = DOTB.App.metadata.getCurrency(toId);

...
const TemplateManager = {
     ...
     */
    init: function() {
        _templates = DOTB.App.config.cacheMeta ? DOTB.App.cache.get('templates') || {} : {};
        var src = '';
        ...
        try {
            ...
            DOTB.App.logger.error('Failed to eval templates retrieved from local storage:\n' + e);
    ...
    compile: function(key, src) {
        try {
            ...
            DOTB.App.logger.error("Failed to compile or eval template " + key + ".\n" + e);
        }

...
const Helpers = {
    ...
    buildRoute: function(options) {
        ...
        return DOTB.App.router.buildRoute(module, id, action);
    },
     ...
     */
    log: function(value) {
        DOTB.App.logger.debug("*****HBS: Current Context*****");
        DOTB.App.logger.debug(this);
        DOTB.App.logger.debug("*****HBS: Current Value*****");
        DOTB.App.logger.debug(value);
        console.log(value);
        DOTB.App.logger.debug("***********************");
    },

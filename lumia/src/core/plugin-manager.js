...
const PluginManager = {
    ...
    _isPluginDisabled: function(component, pluginName) {
        if (!DOTB.App.config.lumiaCompatMode) {
            DOTB.App.logger.error('Core.pluginManager#_isPluginDisabled is a private method that you are not allowed ' +
                'to access. Please use only the public API.');
            return;
        }

        DOTB.App.logger.warn('Core.pluginManager#_isPluginDisabled is a private method that you should not access. ' +
    ...
    _get: function(name, type) {
        if (!DOTB.App.config.lumiaCompatMode) {
            DOTB.App.logger.error('Core.pluginManager#_get is a private method that you are not allowed ' +
                'to access. Please use only the public API.');
            return;
        }

        DOTB.App.logger.warn('Core.pluginManager#_get is a private method that you should not access. ' +
            'You will NOT be allowed to access it in the next release. Please update your code to rely on the public ' +
            'API only.');

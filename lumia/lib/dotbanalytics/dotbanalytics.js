...
/**
 * DotBCRM Analytics API allows user actions to be tracked via an analytics engine.
 *
 ...
 * Connectors:
 *
 * Analytics connectors are loaded from DOTB.App.analytics.connectors.
 *
 ...
 * @param  {Object}options, DOTB.App.config.analytics configuration.
 *
 ...
 * <pre>
 * (function(app) {
 * DOTB.App.analytics = DOTB.App.analytics || {};
 * DOTB.App.analytics.connectors = DOTB.App.analytics.connectors || {};
 * DOTB.App.analytics.connectors["FakeConnector"]  = {
 *     initialized: false,
 *     connectorId: null,
 *       pageLog: [],
 *       eventLog: [],
 ...
 * Configuration:
 *
 * Set the following in DOTB.App.config.analytics. The entire config is passed to the connector start method as options.
 *
 * <pre>
 * {
 *     enabled: true,
 ...
 * Page Tracking:
 *
 * Use DOTB.App.analytics.trackPageView(uri); to track page views. An example of a universal way of handling page
 ...
 * Event Tracking:
 *
 * Use DOTB.App.analytics.trackEvent(category, action, event, value); to track events.
 *
...
(function(app) {
    ...
    var _analytics = {
        ...
        init: function() {
            ...
            app.on('app:init', function() {
                ...
                app.analytics.connector.set('appName',
                    'DotbCRM:' + app.config.platform + ':' + (serverInfo.flavor || '').toLowerCase()
                );
         ...
         *   {@link DOTB.analytics#trackEvent}

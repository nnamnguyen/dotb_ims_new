...
const filesToDoc = ['src/**/*.js', 'lib/(dotb*)/**/*.js'];

gulp.task('lint', function() {
    const defaultFiles = ['*.js', 'gulp/**/*.js', 'src/**/*.js', 'tests/**/*.js', 'lib/(dotb*)/**/*.js'];
    commander
...
gulp.task('jsdoc', function(cb) {
    ...
    const jsdoc = require('@dotbcrm/gulp-jsdoc3');

/*
 * Copyright (c) 2017 DotBCRM Inc. Licensed by DotBCRM under the Apache 2.0 license.
 */
    ...
    if (typeof(this.responseText) === 'string' && this.responseText.length > 0) {
        try {
            ...
            if (contentType && (contentType.indexOf('application/json') === 0)) {
                 ...
                 * Error code.
                 *
                 * Additional failure information. See DotBCRM REST API
...
/**
 * The DotBCRM JavaScript API allows users to interact with DotBCRM instance
 * via its REST interface.
 *
 * Most Dotb API methods accept `callbacks` object:
 * ```
 * {
 ...
 * @param {string} [args.serverUrl='/rest/v10'] Dotb REST URL end-point.
 ...
 * @param {string} [args.clientID='dotb'] The clientID for oAuth.
...
function DotbApi(args) {
    ...
    _clientID = (args && args.clientID) || 'dotb';
    ...
    if (_keyValueStore) {
        ...
        {
            throw new Error('Failed to initialize Dotb API: key/value store provider is invalid');
        }
    ...
    return {
         ...
         *
         *     // Returns:
         *     'http://localhost:8888/dotbcrm/rest/v10/Contacts/123/file/picture?format=dotb-html-json&platform=base'
         *
         ...
         *
         *     // Returns:
         *     'http://localhost:8888/dotbcrm/rest/v10/Contacts/123/file?platform=base'
         *
         ...
         *   `dotb-html-json` format must be used (`true` by default if
        ...
        logout: function (callbacks, options) {
            ...
            // Stock lumia sends refresh token on logout
         ...
         *   Currently, Dotb REST API supports "whattimeisit" only.
         * @param {Object} [callbacks] callback object.
         * @param {Object} [options] request options.
         * @return {HttpRequest} The AJAX request.
         * @memberOf Api
 ...
 *
 * @module @dotbcrm/ventana
 */
module.exports = {
    /**
     * Gets an instance of a {@link Api Dotb API class}.
     *
     * @param {Object} args The required arguments to instanciate the Dotb API class.
     * @return {Api} An instance of Dotb API class.
     */
    ...
    /**
     * Creates a new instance of a {@link Api Dotb API class}.
     *
     * @param {Object} args The required arguments to instanciate the Dotb API class.
     * @return {Api} A new instance of Dotb API class.
     */
    createInstance: function(args) {
        _instance = new DotbApi(args);

...
This is an example of a config that can be used in a lumia application.
...
(function(app) {
    ...
    app.augment('config', {
        ...
        /**
         * Flag indicating whether to output Dotb API debug information.
         * @type {boolean}
         */
        debugDotbApi: true,
        ...
        /**
         * Dotb REST server URL.
         *
         * The URL can be relative or absolute.
         * @type {string}
         */
        serverUrl: '../../dotbcrm/rest/v10',
        ...
        /**
         * Client ID for oAuth
         * Defaults to dotb other values are support_portal
         * @type {Array}
         */
        clientID: 'dotb',

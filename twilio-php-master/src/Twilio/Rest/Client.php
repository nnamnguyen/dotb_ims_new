...
require_once 'twilio-php-master/src/Twilio/Http/CurlClient.php';
require_once 'twilio-php-master/src/Twilio/Http/Client.php';
require_once 'twilio-php-master/src/Twilio/VersionInfo.php';
require_once 'twilio-php-master/src/Twilio/Exceptions/TwilioException.php';
require_once 'twilio-php-master/src/Twilio/Exceptions/ConfigurationException.php';
require_once 'twilio-php-master/src/Twilio/Rest/Api.php';
require_once 'twilio-php-master/src/Twilio/Rest/Api/V2010.php';
...
class Client {
    ...
    public function request($method, $uri, $params = array(), $data = array(), $headers = array(), $username = null, $password = null, $timeout = null) {
        ...
        return $this->getHttpClient()->request(
                        $method, $uri, $params, $data, $headers, $username, $password, $timeout
        );
    }

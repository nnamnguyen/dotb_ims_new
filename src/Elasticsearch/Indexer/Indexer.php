...
namespace Dotbcrm\Dotbcrm\Elasticsearch\Indexer;
...
class Indexer
{
    ...
    /**
     * @var \Dotbcrm\Dotbcrm\Elasticsearch\Indexer\BulkHandler
     */
    protected $bulkHandler;

    /**
     * Asynchronous index mode, can be configured using
     * `$dotb_config['search_engine']['force_async_index']`.
     * @var boolean
     */
     ...
     * `$dotb_config['search_engine']['max_bulk_threshold']`.
     * @var integer
     */
    ...
    /**
     * Index DotbBean into Elastichsearch. By default we send all beans
     ...
     * @return boolean
     */
    public function indexBean(\DotbBean $bean, $batch = true, $fromQueue = false)
    {
        ...
        // In Elasticsearch code we rely on $bean->module_name so it is impossible of handling a DotbBean
        ...
        // Also a unit test data\DrPhilTest.php::testOverriddenDotbBeanFields() is added to verify if there're any
        // overridden/redefined fields for DotbBean modules.
     ...
     * @return boolean
     */
    protected function useQueue(\DotbBean $bean)
    {
     ...
     * @param \DotbBean $bean Bean reference
     */
     ...
     * @return \Dotbcrm\Dotbcrm\Elasticsearch\Indexer\BulkHandler
     */
     ...
     */
    protected function getWriteIndex(\DotbBean $bean)
    {
     ...
     * @param \DotbBean $bean
     * @return \Dotbcrm\Dotbcrm\Elasticsearch\Adapter\Document
     */
    protected function getDocumentFromBean(\DotbBean $bean)
    {
     ...
     * @param object $fieldValue the field in DotbBean
     * @return mixed
     */

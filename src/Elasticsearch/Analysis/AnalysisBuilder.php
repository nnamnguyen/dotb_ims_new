...
namespace Dotbcrm\Dotbcrm\Elasticsearch\Analysis;

use Dotbcrm\Dotbcrm\Elasticsearch\Exception\AnalyzerBuilderException;
...
class AnalysisBuilder
{
     ...
     * @param string $type
     * @param array $options
     * @throws \Dotbcrm\Dotbcrm\Elasticsearch\Exception\AnalyzerBuilderException
     */

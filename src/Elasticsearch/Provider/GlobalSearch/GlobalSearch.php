...
use Dotbcrm\Dotbcrm\Elasticsearch\Query\Parser\TermParserHelper;
use Dotbcrm\Dotbcrm\Elasticsearch\Query\QueryBuilder;
use Dotbcrm\Dotbcrm\Elasticsearch\Adapter\Document;
use Dotbcrm\Dotbcrm\Elasticsearch\Provider\GlobalSearch\Handler\HandlerCollection;
use Dotbcrm\Dotbcrm\Elasticsearch\Provider\GlobalSearch\Handler\HandlerFilterIterator;
use Dotbcrm\Dotbcrm\Elasticsearch\Provider\GlobalSearch\Handler\HandlerInterface;
use Dotbcrm\Dotbcrm\Elasticsearch\Provider\GlobalSearch\Handler\Implement\MultiFieldHandler;
use Dotbcrm\Dotbcrm\Elasticsearch\Provider\GlobalSearch\Handler\Implement\AutoIncrementHandler;
use Dotbcrm\Dotbcrm\Elasticsearch\Provider\GlobalSearch\Handler\Implement\EmailAddressHandler;
use Dotbcrm\Dotbcrm\Elasticsearch\Provider\GlobalSearch\Handler\Implement\CrossModuleAggHandler;
use Dotbcrm\Dotbcrm\Elasticsearch\Provider\GlobalSearch\Handler\Implement\TagsHandler;
use Dotbcrm\Dotbcrm\Elasticsearch\Provider\GlobalSearch\Handler\Implement\FavoritesHandler;
use Dotbcrm\Dotbcrm\Elasticsearch\Provider\GlobalSearch\Handler\Implement\HtmlHandler;
use Dotbcrm\Dotbcrm\Elasticsearch\Provider\GlobalSearch\Handler\Implement\ErasedFieldsHandler;
use Dotbcrm\Dotbcrm\Elasticsearch\Query\MultiMatchQuery;
use Dotbcrm\Dotbcrm\Elasticsearch\Query\MatchAllQuery;
...
class GlobalSearch extends AbstractProvider implements ContainerAwareInterface
{
    ...
    /**
     * List of supported dotb types for Studio
     * @var array
     */
    ...
    public function getDefaultOperator()
    {
        ...
        global $dotb_config;
        if (isset($dotb_config['default_gs_space_operator'])) {
            $operator = TermParserHelper::getOperator($dotb_config['default_gs_space_operator']);
            if ($operator) {
    ...
    /**
     * Return a list of dotb types for the studio
     * @return array
     */

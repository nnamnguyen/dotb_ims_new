...
use Dotbcrm\Dotbcrm\Elasticsearch\Query\Parser\SimpleTermParser;
...
class MultiMatchQuery implements QueryInterface
{
    ...
    protected function isFieldReadAccessible($module, $field)
    {
        ...
        return $this->getFieldAccess($module, $field) !== DotbACL::ACL_NO_ACCESS ? true : false;
    }
    ...
    {
        return DotbACL::getFieldAccess($module, $field, ['user' => $this->user]);
    }
}

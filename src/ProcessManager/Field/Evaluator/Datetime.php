...
class Datetime extends Base implements EvaluatorInterface
{
    ...
    /**
     * Takes a DotbDateTime object and pushes it through TimeDate to get a
     * string value for comparison
     * @param  \DotbDateTime $datetime DotbDateTime object
     * @return string
     */
    protected function getComparisonValue(\DotbDateTime $datetime)
    {

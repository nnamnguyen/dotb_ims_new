...
class MetaDataHelper
{
     ...
     * both DotbCache and MetadataCache are disabled
     * @var array
     */
    ...
    public function __construct(LoggerInterface $logger)
    {
        ...
        $this->dotbCache = \DotbCache::instance();
        $this->updateHash();
    }
    ...
    protected function getCache($key)
    {
        if ($this->disableCache) {
            //use the in-memory cache when the dotb cache is disabled
    ...
    protected function setCache($key, $value)
    {
        if (!$this->disableCache) {
            ...
            //set to the in-memory cache when the dotb cache is disabled
     ...
     * in the DotbObject templates although not required. When cross module

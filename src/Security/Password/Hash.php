...
class Hash
{
    ...
    /**
     * Get instance based on \DotbConfig settings
     *
     *  $dotb_config['passwordHash']['allowLegacy'] = true/false
     *      Whether or not to allow legacy md5 database hashes,
     *      defaults to false
     *
     *  $dotb_config['passwordHash']['rehash'] = true/false
     *      Enable or disable the rehash capability for the selected
     *      backend, defaults to true
     *
     *  $dotb_config['passwordHash']['backend'] = 'native' | 'sha2'
     *      Select the backend, defaults to 'native'
     *
     *  $dotb_config['passwordHash']['algo']
     *      Hash algorithm to be used, see selected backend
     *
     *  $dotb_config['passwordHash']['options']
    ...
    {
        $class = \DotbAutoLoader::customClass('\\Dotbcrm\\Dotbcrm\\Security\\Password\\Backend\\' . ucfirst($class));

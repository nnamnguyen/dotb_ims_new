...
use Dotbcrm\Dotbcrm\Security\Validator\Exception\ConstraintBuilderException;
...
class ConstraintBuilder
{
    ...
    protected $namespaces = array(
        'Dotbcrm\Dotbcrm\custom\Security\Validator\Constraints',
        'Dotbcrm\Dotbcrm\Security\Validator\Constraints',

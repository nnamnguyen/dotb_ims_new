...
if (!class_exists('TCPDF', false)) {
	...
	*/
	class TCPDF {
		...
		* @since 1.1
        *
        * peter d: Upgrading tcpdf to the latest version causes the whole thing to blow up since we have modifications to the original source as well as dotbpdf which

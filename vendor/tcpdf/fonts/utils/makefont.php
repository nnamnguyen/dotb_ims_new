...
// BEGIN DOTBCRM SPECIFIC
if(!defined('dotbEntry') || !dotbEntry) die('Not A Valid Entry Point');
// END DOTBCRM SPECIFIC
 ...
 */
function MakeFont($fontfile, $fmfile, $embedded=true, $enc='cp1252', $patch=array()/* BEGIN DOTBCRM SPECIFIC */, $cidInfo=""/* END DOTBCRM SPECIFIC */) {

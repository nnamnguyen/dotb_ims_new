 ...
 *
 * Generated from protobuf message <code>dotbcrm.apis.iam.provider.v1alpha.LoginLockout</code>
 */
class LoginLockout extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>.dotbcrm.apis.iam.provider.v1alpha.LoginLockout.Type type = 1;</code>
     */
    private $type = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Dotbcrm\Apis\Iam\Provider\V1alpha\LoginLockout_Type::class);
        $this->type = $var;

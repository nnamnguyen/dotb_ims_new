 ...
 *
 * Generated from protobuf message <code>dotbcrm.apis.iam.user.v1alpha.Address</code>
 */
class Address extends \Google\Protobuf\Internal\Message
{
     ...
     * Dotb field mapping: `users.address_street`
     *
     ...
     * Dotb field mapping: `users.address_city`
     *
     ...
     * Dotb field mapping: `users.address_state`
     *
     ...
     * Dotb field mapping: `users.address_postalcode`
     *
     ...
     * Dotb field mapping: `users.address_country`
     *

...
aQ==
-----END CERTIFICATE-----';
$dotb_config['SAML_provisionUser'] = false;
...
$dotb_config['SAML_issuer'] = 'samlSameWindowRedirectNoUserProvision';
$dotb_config['SAML']['strict'] = true;
$dotb_config['site_url'] = 'http://behat-tests-mango-saml-same-window-no-user-provision';

 ...
 *
 */
require_once('service/v4/DotbWebServiceImplv4.php');

class DotbWebServiceImplv4_1 extends DotbWebServiceImplv4
{
    ...
    {
        self::$helperObject = new DotbWebServiceUtilv4_1();
    }
    ...
    function get_modified_relationships($session, $module_name, $related_module, $from_date, $to_date, $offset, $max_results, $deleted=0, $module_user_id = '', $select_fields = array(), $relationship_name = '', $deletion_date = ''){
        ...
        if (!self::$helperObject->checkSessionAndModuleAccess($session, 'invalid_session', $module_name, 'read', 'no_access', $error))
        {
       		$GLOBALS['log']->info('End: DotbWebServiceImpl->get_modified_relationships');
       		return;
       	} // if

...
require_once 'service/core/DotbSoapService.php';
 ...
 * @api
 */
abstract class NusoapSoap extends DotbSoapService{
	/**
	...
	public function __construct($url){
		...
		$this->soapURL = $url;
		$this->server->configureWSDL('dotbsoap', $this->getNameSpace(), $url);
		parent::__construct();

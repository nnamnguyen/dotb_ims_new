...
require_once('DotbWebServiceUtilv3_1.php');
 ...
 */
class DotbWebServiceImplv3_1 extends DotbWebServiceImplv3 {

    public function __construct()
    {
        self::$helperObject = new DotbWebServiceUtilv3_1();
    }
    ...
    */
    ...
    function get_module_fields_md5($session, $module_name){
        ...
        $GLOBALS['log']->info('Begin: DotbWebServiceImpl->get_module_fields_md5(v3_1) for module: '. print_r($module_name, true));
        ...
        $GLOBALS['log']->info('End: DotbWebServiceImpl->get_module_fields_md5 (v3_1) for module: ' . print_r($module_name, true));
    ...
    function get_module_layout_md5($session, $module_name, $type, $view, $acl_check = TRUE){
    	$GLOBALS['log']->info('Begin: DotbWebServiceImpl->get_module_layout_md5');
        $results = $this->get_module_layout($session, $module_name, $type, $view, true, $acl_check);
            return array('md5'=> $results);
    	$GLOBALS['log']->info('End: DotbWebServiceImpl->get_module_layout_md5');
    }
    ...
    */
    function get_entries($session, $module_name, $ids, $select_fields, $link_name_to_fields_array, $track_view = FALSE)
    {
        ...
        {
            $GLOBALS['log']->info('No Access: DotbWebServiceImpl->get_entries');
            return;
        } // if
    ...
    function set_entry($session,$module_name, $name_value_list, $track_view = FALSE){
        ...
        try{
            ...
            $GLOBALS['log']->info('End: DotbWebServiceImplv3_1->set_entry');
    ...
    {
        $GLOBALS['log']->info('Begin: DotbWebServiceImpl->get_language_file');
        global  $beanList, $beanFiles;
    ...
    public function get_module_layout(
    	...
    	$GLOBALS['log']->fatal('Begin: DotbWebServiceImpl->get_module_layout');
        ...
        foreach ($a_module_names as $module_name)
        {
            if (!self::$helperObject->checkSessionAndModuleAccess($session, 'invalid_session', $module_name, 'read', 'no_access', $error))
            {
                $GLOBALS['log']->info('End: DotbWebServiceImpl->get_module_layout');
                continue;
            }
     ...
     * @param Array  $select_fields -- A list of the fields to be included in the results. This optional parameter allows for only needed fields to be retrieved.
     * @param Array $link_name_to_fields_array -- A list of link_names and for each link_name, what fields value to be returned. For ex.'link_name_to_fields_array' => array(array('name' =>  'email_addresses', 'value' => array('id', 'email_address', 'opt_out', 'primary_address')))
     * @param integer $max_results -- The maximum number of records to return.  The default is the dotb configuration
...
DotbWebServiceImplv3_1::$helperObject = new DotbWebServiceUtilv3_1();
